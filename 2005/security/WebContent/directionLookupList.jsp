...
<july:browseform action="/ShowDirectionLookupList.do">
...
<TR class="title">
 <TD class="title">
    <bean:message key="label.choose.direction"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
    ...
    <TR>
       ...
       <td class="title"><bean:write name="DirectionLookupListForm" property="companyname" /></td>
     </tr>        
     </table>
