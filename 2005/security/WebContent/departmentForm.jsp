...
<july:editform action="/ProcessDepartment.do">
...
<table  class="main">
    ...
    <tr>
        ...
        <td>
          <july:string property="department" size="5" insertable="false" updatable="false" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
          ...
          <july:lookupbutton action="/ShowWorkerLookupList.do" styleId="wlp" onclick="set_opt_params_wlp('?searchby=D&divcode='+document.all.department.value)" fieldNames="boss;bossname" insertable="false" updatable="true" />
