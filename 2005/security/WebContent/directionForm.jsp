...
<july:editform action="/ProcessDirection.do">

<html:hidden property="initIsactive"/>
...
<table  class="main">
    ...
    <tr>
        ...
        <td>
          <july:string property="direction" size="5" insertable="false" updatable="false" />
        </td>
    </tr>
    ...
    <tr>
        <td class="text"><july:reqmark><bean:message key="label.direction.shortname"/>:</july:reqmark></td>
        <td>
    ...
    <tr>
        <td class="text"><bean:message key="label.direction.boss"/>:</td>
        <td>
          <july:string property="bosscode" styleId="boss" size="5" insertable="false" updatable="true" />
          <july:lookupbutton action="/ShowWorkerLookupList.do" styleId="wlp" onclick="set_opt_params_wlp('?searchby=D&divcode='+document.all.direction.value)" fieldNames="boss;bossname" insertable="false" updatable="true" />
