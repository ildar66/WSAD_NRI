...
<july:browseform action="/ShowWorkerListC.do">
...
<table class="main">
	...
	<td class="title" colspan="<%= gColSpan %>">
		...
		<july:sepmark/>
		<july:currmark><bean:message key="label.workers"/></july:currmark>
	</td>
</tr>
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <tr class="title">
          <td colspan="<%= gColSpan %>"><TABLE class="buttons">
            <TR class="title">
              <TD class="buttons"><% if(canEdit) { %><july:addbutton page="/EditWorkerC.do?action=Add"/><% } %><july:backbutton page="/ShowCompanyList.do"/></TD>
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <logic:iterate id="worker" name="browseList" type="com.hps.july.persistence.WorkerAccessBean">
            ...
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                ...
                <td class="text">
                    <july:editlink page="/EditWorkerC.do" action="Edit" paramId="worker" paramName="worker" paramProperty="worker" paramScope="page">
...
<% if(canEdit) { %>
                <td class="link">
                    <july:delbutton page="/EditWorkerC.do?action=Delete" paramId="worker" paramName="worker" paramProperty="worker" paramScope="page"/>
                </td>
<% } %>
            </tr>
