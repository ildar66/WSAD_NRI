...
<july:browseform action="/ShowWorkerListG.do">
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <tr class="title">
          <td colspan="<%= gColSpan %>"><TABLE class="buttons">
            <TR class="title">
              <TD class="buttons"><% if(canEdit) { %><july:addbutton page="/EditWorkerG.do?action=Add"/><% } %><july:backbutton page="/ShowGroupList.do"/></TD>
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <logic:iterate id="worker" name="browseList" type="com.hps.july.persistence.WorkerAccessBean">
            ...
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                ...
                <td class="text">
                    <july:editlink page="/EditWorkerG.do" action="Edit" paramId="worker" paramName="worker" paramProperty="worker" paramScope="page">
...
<% if(canEdit) { %>
                <td class="link">
                    <july:delbutton page="/EditWorkerG.do?action=Delete" paramId="worker" paramName="worker" paramProperty="worker" paramScope="page"/>
                </td>
<% } %>
            </tr>
