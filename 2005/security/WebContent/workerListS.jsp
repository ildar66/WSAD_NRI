...
<july:browseform action="/ShowWorkerListS.do">
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <tr class="title">
          <td colspan="<%= gColSpan %>"><TABLE class="buttons">
            <TR class="title">
              <TD class="buttons"><% if(canEdit) { %><july:addbutton page="/EditWorkerS.do?action=Add"/><% } %><july:backbutton page="/ShowServiceList.do"/></TD>
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <logic:iterate id="worker" name="browseList" type="com.hps.july.persistence.WorkerAccessBean">
            ...
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                ...
                <td class="text">
                    <july:editlink page="/EditWorkerS.do" action="Edit" paramId="worker" paramName="worker" paramProperty="worker" paramScope="page">
...
<% if(canEdit) { %>
                <td class="link">
                    <july:delbutton page="/EditWorkerS.do?action=Delete" paramId="worker" paramName="worker" paramProperty="worker" paramScope="page"/>
                </td>
<% } %>
            </tr>
