...
<july:browseform action="/ShowRoleLookupList.do">
...
<TR class="title">
 <TD class="title">
    <bean:message key="label.choose.role"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
...
<TR>
  <TD>
    ...
    <table class="main" id="brtable">
        ...
        <!-- Table body -->
        <logic:iterate id="role" name="browseList" indexId="index">
	      <logic:present name="role">
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                <td class="number"><july:lookupreturn><bean:write name="role" property="role" filter="true"/></july:lookupreturn></td>
                <td class="text">
