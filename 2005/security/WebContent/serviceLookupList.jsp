...
<july:browseform action="/ShowServiceLookupList.do">
...
<TR class="title">
 <TD class="title">
    <bean:message key="label.choose.service"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
    ...
    <TR>
       ...
       <td class="title"><bean:write name="ServiceLookupListForm" property="directionname" /></td>
     </tr>        
     </table>
