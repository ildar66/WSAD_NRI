...
<july:editform action="/ProcessService.do">
...
<table  class="main">
    ...
    <tr>
        ...
        <td>
          <july:string property="service" size="5" insertable="false" updatable="false" />
        </td>
    </tr>
    ...
    <tr>
        <td class="text"><july:reqmark><bean:message key="label.service.shortname"/>:</july:reqmark></td>
        <td>
    ...
    <tr>
        ...
        <td>
          ...
          <july:lookupbutton action="/ShowWorkerLookupList.do" styleId="wlp" onclick="set_opt_params_wlp('?searchby=D&divcode='+document.all.service.value)" fieldNames="boss;bossname" insertable="false" updatable="true" />
