...
public class _JournalHome_Stub extends Stub implements JournalHome {
    ...
    private static final String[] _type_ids = {
        "RMI:com.hps.july.journal.beans.JournalHome:0000000000000000", 
    ...
    public Journal create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.journal.beans.JournalHome.class);
            if (so == null) {
                return create();
            }
            try {
                Journal result = ((com.hps.july.journal.beans.JournalHome)so.servant).create();
