...
public class _CfgAnten2SectorHome_Stub extends Stub implements CfgAnten2SectorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgAnten2SectorHome:0000000000000000", 
    ...
    public CfgAnten2Sector findByPrimaryKey(CfgAnten2SectorKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgAnten2SectorKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgAnten2Sector) in.read_Object(CfgAnten2Sector.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgAnten2SectorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgAnten2SectorKey arg0Copy = (CfgAnten2SectorKey) Util.copyObject(arg0,_orb());
                CfgAnten2Sector result = ((com.hps.july.config.beans.CfgAnten2SectorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgAnten2Sector)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgAnten2Sector create(int arg0, int arg1, int arg2, int arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgAnten2SectorHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                CfgAnten2Sector result = ((com.hps.july.config.beans.CfgAnten2SectorHome)so.servant).create(arg0, arg1, arg2, arg3, arg4);
                return (CfgAnten2Sector)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
