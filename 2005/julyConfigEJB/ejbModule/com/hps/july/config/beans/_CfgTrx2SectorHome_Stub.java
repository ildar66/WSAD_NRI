...
public class _CfgTrx2SectorHome_Stub extends Stub implements CfgTrx2SectorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgTrx2SectorHome:0000000000000000", 
    ...
    public CfgTrx2Sector findByPrimaryKey(CfgTrx2SectorKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgTrx2SectorKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgTrx2Sector) in.read_Object(CfgTrx2Sector.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgTrx2SectorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgTrx2SectorKey arg0Copy = (CfgTrx2SectorKey) Util.copyObject(arg0,_orb());
                CfgTrx2Sector result = ((com.hps.july.config.beans.CfgTrx2SectorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgTrx2Sector)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgTrx2Sector create(int arg0, int arg1, int arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgTrx2SectorHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                CfgTrx2Sector result = ((com.hps.july.config.beans.CfgTrx2SectorHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (CfgTrx2Sector)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
