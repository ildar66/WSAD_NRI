...
public class _EJSRemoteCMPCfgEquipObjectsCfg_087e3fc2_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPCfgEquipObjectsCfg_087e3fc2 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPCfgEquipObjectsCfg_087e3fc2) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 13: 
                    ...
                    } else if (method.equals("_get_objcfgid")) {
                        return _get_objcfgid(in, reply);
                    }
                case 14: 
                ...
                case 19: 
                    if (method.equals("_get_parentobjcfgid")) {
                        return _get_parentobjcfgid(in, reply);
                    } else if (method.equals("_set_parentobjcfgid")) {
                        return _set_parentobjcfgid(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_objcfgid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getObjcfgid();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream _get_parentobjcfgid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer result = target.getParentobjcfgid();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,Integer.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream _set_parentobjcfgid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        target.setParentobjcfgid(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
