...
public class _CfgBasestationHome_Stub extends Stub implements CfgBasestationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgBasestationHome:0000000000000000", 
    ...
    public CfgBasestation findByPrimaryKey(CfgBasestationKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgBasestationKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgBasestation) in.read_Object(CfgBasestation.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgBasestationHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgBasestationKey arg0Copy = (CfgBasestationKey) Util.copyObject(arg0,_orb());
                CfgBasestation result = ((com.hps.july.config.beans.CfgBasestationHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgBasestation)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgBasestation create(int arg0, int arg1, String arg2, boolean arg3, int arg4, String arg5, String arg6) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgBasestationHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
            }
            try {
                CfgBasestation result = ((com.hps.july.config.beans.CfgBasestationHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return (CfgBasestation)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
