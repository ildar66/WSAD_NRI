...
public class _CfgAntennaCableHome_Stub extends Stub implements CfgAntennaCableHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgAntennaCableHome:0000000000000000", 
    ...
    public CfgAntennaCable findByPrimaryKey(CfgAntennaCableKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgAntennaCableKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgAntennaCable) in.read_Object(CfgAntennaCable.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgAntennaCableHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgAntennaCableKey arg0Copy = (CfgAntennaCableKey) Util.copyObject(arg0,_orb());
                CfgAntennaCable result = ((com.hps.july.config.beans.CfgAntennaCableHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgAntennaCable)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgAntennaCable create(int arg0, int arg1, int arg2, int arg3, BigDecimal arg4, int arg5, String arg6) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgAntennaCableHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg4,arg6},_orb());
                BigDecimal arg4Copy = (BigDecimal) copies[0];
                String arg6Copy = (String) copies[1];
                CfgAntennaCable result = ((com.hps.july.config.beans.CfgAntennaCableHome)so.servant).create(arg0, arg1, arg2, arg3, arg4Copy, arg5, arg6Copy);
                return (CfgAntennaCable)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
