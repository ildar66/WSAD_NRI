...
public class _CfgTrxHome_Stub extends Stub implements CfgTrxHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgTrxHome:0000000000000000", 
    ...
    public CfgTrx findByPrimaryKey(CfgTrxKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgTrxKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgTrx) in.read_Object(CfgTrx.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgTrxHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgTrxKey arg0Copy = (CfgTrxKey) Util.copyObject(arg0,_orb());
                CfgTrx result = ((com.hps.july.config.beans.CfgTrxHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgTrx)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgTrx create(int arg0, int arg1, int arg2, int arg3, int arg4, String arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgTrxHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                CfgTrx result = ((com.hps.july.config.beans.CfgTrxHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5);
                return (CfgTrx)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
