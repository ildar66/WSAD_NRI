...
public class _CfgBsstandsHome_Stub extends Stub implements CfgBsstandsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgBsstandsHome:0000000000000000", 
    ...
    public CfgBsstands findByPrimaryKey(CfgBsstandsKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgBsstandsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgBsstands) in.read_Object(CfgBsstands.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgBsstandsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgBsstandsKey arg0Copy = (CfgBsstandsKey) Util.copyObject(arg0,_orb());
                CfgBsstands result = ((com.hps.july.config.beans.CfgBsstandsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgBsstands)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgBsstands create(int arg0, int arg1, int arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgBsstandsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                CfgBsstands result = ((com.hps.july.config.beans.CfgBsstandsHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (CfgBsstands)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
