...
public class _CfgEquipObjCfg2Sector_Stub extends Stub implements CfgEquipObjCfg2Sector {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgEquipObjCfg2Sector:0000000000000000", 
    ...
    public String getObjectstatus() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_objectstatus",com.hps.july.config.beans.CfgEquipObjCfg2Sector.class);
            if (so == null) {
                return getObjectstatus();
            }
            try {
                return ((com.hps.july.config.beans.CfgEquipObjCfg2Sector)so.servant).getObjectstatus();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setObjectstatus(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_objectstatus",com.hps.july.config.beans.CfgEquipObjCfg2Sector.class);
            if (so == null) {
                setObjectstatus(arg0);
                return;
            }
            try {
                ((com.hps.july.config.beans.CfgEquipObjCfg2Sector)so.servant).setObjectstatus(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
