...
public class _CfgSavedConfig_Stub extends Stub implements CfgSavedConfig {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgSavedConfig:0000000000000000", 
    ...
    public String getName() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_name",com.hps.july.config.beans.CfgSavedConfig.class);
            if (so == null) {
                return getName();
            }
            try {
                return ((com.hps.july.config.beans.CfgSavedConfig)so.servant).getName();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setName(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_name",com.hps.july.config.beans.CfgSavedConfig.class);
            if (so == null) {
                setName(arg0);
                return;
            }
            try {
                ((com.hps.july.config.beans.CfgSavedConfig)so.servant).setName(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public int getSavconfigid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_savconfigid",com.hps.july.config.beans.CfgSavedConfig.class);
            if (so == null) {
                return getSavconfigid();
            }
            try {
                return ((com.hps.july.config.beans.CfgSavedConfig)so.servant).getSavconfigid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
