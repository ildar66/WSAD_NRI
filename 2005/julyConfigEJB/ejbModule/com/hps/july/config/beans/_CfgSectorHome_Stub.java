...
public class _CfgSectorHome_Stub extends Stub implements CfgSectorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgSectorHome:0000000000000000", 
    ...
    public CfgSector findByPrimaryKey(CfgSectorKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgSectorKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgSector) in.read_Object(CfgSector.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgSectorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgSectorKey arg0Copy = (CfgSectorKey) Util.copyObject(arg0,_orb());
                CfgSector result = ((com.hps.july.config.beans.CfgSectorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgSector)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgSector create(int arg0, int arg1, int arg2, String arg3, short arg4, String arg5, int arg6, String arg7) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgSectorHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
            }
            try {
                CfgSector result = ((com.hps.july.config.beans.CfgSectorHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return (CfgSector)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
