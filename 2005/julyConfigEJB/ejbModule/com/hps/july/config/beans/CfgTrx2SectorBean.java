...
/**
 * Bean implementation class for Enterprise Bean: CfgTrx2Sector
 */
public class CfgTrx2SectorBean implements javax.ejb.EntityBean {
	 ...
	 */
	public com.hps.july.config.beans.CfgTrx2SectorKey ejbCreate(
		int savconfigid,
		int trxid,
		int id_sect,
		String objectstatus)
	 ...
	 * ejbPostCreate
	 */
	public void ejbPostCreate(int savconfigid, int trxid, int id_sect)
		throws javax.ejb.CreateException {
	}
	/**
	 * ejbActivate
