...
public class _CfgAntennaWorkBandHome_Stub extends Stub implements CfgAntennaWorkBandHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgAntennaWorkBandHome:0000000000000000", 
    ...
    public CfgAntennaWorkBand findByPrimaryKey(CfgAntennaWorkBandKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgAntennaWorkBandKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgAntennaWorkBand) in.read_Object(CfgAntennaWorkBand.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgAntennaWorkBandHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgAntennaWorkBandKey arg0Copy = (CfgAntennaWorkBandKey) Util.copyObject(arg0,_orb());
                CfgAntennaWorkBand result = ((com.hps.july.config.beans.CfgAntennaWorkBandHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgAntennaWorkBand)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgAntennaWorkBand create(int arg0, int arg1, short arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgAntennaWorkBandHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                CfgAntennaWorkBand result = ((com.hps.july.config.beans.CfgAntennaWorkBandHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (CfgAntennaWorkBand)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
