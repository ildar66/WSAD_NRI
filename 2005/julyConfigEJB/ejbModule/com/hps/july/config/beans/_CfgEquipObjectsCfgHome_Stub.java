...
public class _CfgEquipObjectsCfgHome_Stub extends Stub implements CfgEquipObjectsCfgHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgEquipObjectsCfgHome:0000000000000000", 
    ...
    public CfgEquipObjectsCfg findByPrimaryKey(CfgEquipObjectsCfgKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgEquipObjectsCfgKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgEquipObjectsCfg) in.read_Object(CfgEquipObjectsCfg.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgEquipObjectsCfgHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgEquipObjectsCfgKey arg0Copy = (CfgEquipObjectsCfgKey) Util.copyObject(arg0,_orb());
                CfgEquipObjectsCfg result = ((com.hps.july.config.beans.CfgEquipObjectsCfgHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgEquipObjectsCfg)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgEquipObjectsCfg create(int arg0, int arg1, int arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgEquipObjectsCfgHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                CfgEquipObjectsCfg result = ((com.hps.july.config.beans.CfgEquipObjectsCfgHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (CfgEquipObjectsCfg)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
