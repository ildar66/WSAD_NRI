...
public class _CfgSavedConfigHome_Stub extends Stub implements CfgSavedConfigHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.config.beans.CfgSavedConfigHome:0000000000000000", 
    ...
    public CfgSavedConfig findByPrimaryKey(CfgSavedConfigKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CfgSavedConfigKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CfgSavedConfig) in.read_Object(CfgSavedConfig.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.config.beans.CfgSavedConfigHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CfgSavedConfigKey arg0Copy = (CfgSavedConfigKey) Util.copyObject(arg0,_orb());
                CfgSavedConfig result = ((com.hps.july.config.beans.CfgSavedConfigHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CfgSavedConfig)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CfgSavedConfig create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.config.beans.CfgSavedConfigHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                CfgSavedConfig result = ((com.hps.july.config.beans.CfgSavedConfigHome)so.servant).create(arg0, arg1);
                return (CfgSavedConfig)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
