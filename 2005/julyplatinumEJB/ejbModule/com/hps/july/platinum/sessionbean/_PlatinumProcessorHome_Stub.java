...
public class _PlatinumProcessorHome_Stub extends Stub implements PlatinumProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.platinum.sessionbean.PlatinumProcessorHome:0000000000000000", 
    ...
    public PlatinumProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PlatinumProcessor) in.read_Object(PlatinumProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.platinum.sessionbean.PlatinumProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                PlatinumProcessor result = ((com.hps.july.platinum.sessionbean.PlatinumProcessorHome)so.servant).create();
                return (PlatinumProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
