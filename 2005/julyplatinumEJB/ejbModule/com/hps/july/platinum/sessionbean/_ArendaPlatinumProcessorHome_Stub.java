...
public class _ArendaPlatinumProcessorHome_Stub extends Stub implements ArendaPlatinumProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.platinum.sessionbean.ArendaPlatinumProcessorHome:0000000000000000", 
    ...
    public ArendaPlatinumProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ArendaPlatinumProcessor) in.read_Object(ArendaPlatinumProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.platinum.sessionbean.ArendaPlatinumProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                ArendaPlatinumProcessor result = ((com.hps.july.platinum.sessionbean.ArendaPlatinumProcessorHome)so.servant).create();
                return (ArendaPlatinumProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
