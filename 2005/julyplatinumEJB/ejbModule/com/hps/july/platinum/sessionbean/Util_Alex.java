...
/**
 * Insert the method's description here.
 * Creation date: (31.01.2003 18:56:24)
...
/**
 * Insert the method's description here.
 * Creation date: (23.01.2003 15:37:47)
 * @return java.lang.Integer
 * @param name java.lang.String
 */
public static int receiveIntConstant(String name) throws Exception {
   
	NamedValueAccessBean bean = new NamedValueAccessBean();
    bean.setInitKey_id(name);
 ...
 * @param name java.lang.String
 */
public static java.sql.Timestamp receiveTimeDateConstant(String name) throws Exception {
    NamedValueAccessBean bean = new NamedValueAccessBean();
    bean.setInitKey_id(name);
    bean.refreshCopyHelper();

    return bean.getDatevalue();
}
/**
 * Insert the method's description here.
