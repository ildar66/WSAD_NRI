<%@ page language = "java" %>
<%@ page import="org.apache.struts.util.*,com.hps.july.jdbcpersistence.lib.AppConstants"
...
<july:browseform action="/PositionOnmap.do" styleId="PosForm">
...
<tr class="title">
<td  class="buttons" style="width: 42%;"><SPAN style="height: 16; font-size:8pt; vertical-align: bottom; padding-top: 0; padding-bottom: 0; margin-top: 0; margin-bottom: 0;"><july:backbutton /> </span>&nbsp;<img src="/images/uvelichit.gif" border="0" onMouseOver="_onmouseover()" onMouseOut="_onmouseout()" onClick="Button_Click('zoomIn')" alt='<bean:message key="label.menu.map.zoomIn"/>' style="vertical-align: middle;">&nbsp;<img
  ...
  src="/images/center.gif" border="0" onMouseOver="_onmouseover()" onMouseOut="_onmouseout()" onClick="Button_Click('recenter')" alt='<bean:message key="label.menu.map.recenter"/>' style="vertical-align: middle;">&nbsp;
	<logic:equal name="PositionOnMapForm" property="siteinfo" value="true">
		<img src="/images/lookup.gif" border="0" onMouseOver="_onmouseover()" onMouseOut="_onmouseout()" onClick="Button_Click('position')" alt='<bean:message key="label.menu.map.info"/>' style="vertical-align: middle;">
	</logic:equal>  
  <SPAN style="height: 16; font-size:8pt; vertical-align: bottom; padding-top: 0; padding-bottom: 0; margin-top: 0; margin-bottom: 0;">&nbsp;<bean:message key="label.menu.map.scale"/>&nbsp;<input
...
<tr>
<td>
	<logic:equal name="PositionOnMapForm" property="errorSelection" value="false" scope="session">
		<input type="image" src="/siteinfo/mapByPosition?mapimage.x=<%=x%>&mapimage.y=<%=y%>&whatToDo=<%=whatToDo%>" name="mapimage" onLoad="changeCursor()">
	</logic:equal>
</td>
</tr>
<july:separator colspan="<%= gColSpan %>" />
<tr class="title">
 <td><table class="buttons">
<tr class="title">
<td  class="buttons" style="width: 42%;"><SPAN style="height: 16; font-size:8pt; vertical-align: bottom; padding-top: 0; padding-bottom: 0; margin-top: 0; margin-bottom: 0;"><july:backbutton /> </span>&nbsp;<img src="/images/uvelichit.gif" border="0" onClick="Button_Click('zoomIn')" alt="<bean:message key="label.menu.map.zoomIn"/>" style="vertical-align: middle;">&nbsp;<img
  src="/images/umensh.gif" border="0" onMouseOver="_onmouseover()" onMouseOut="_onmouseout()" onClick="Button_Click('zoomOut')" alt='<bean:message key="label.menu.map.zoomOut"/>' style="vertical-align: middle;">&nbsp;<img 
  src="/images/center.gif" border="0" onMouseOver="_onmouseover()" onMouseOut="_onmouseout()" onClick="Button_Click('recenter')" alt='<bean:message key="label.menu.map.recenter"/>' style="vertical-align: middle;">&nbsp;
	<logic:equal name="PositionOnMapForm" property="siteinfo" value="true">
		<img src="/images/lookup.gif" border="0" onMouseOver="_onmouseover()" onMouseOut="_onmouseout()" onClick="Button_Click('position')" alt='<bean:message key="label.menu.map.info"/>' style="vertical-align: middle;">
