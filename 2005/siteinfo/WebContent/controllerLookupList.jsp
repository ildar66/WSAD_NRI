...
<july:browseform action="/ShowControllerLookupList.do">
...
<TR>
  ...
  <TD>
    ...
    <table class="main" id="brtable">
        ...
        <logic:iterate id="cont" name="browseList" indexId="index">

	      <logic:present name="cont">

            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">

                <td class="number"><bean:write name="cont" property="number" filter="true"/></td>

                <td class="text"><july:lookupreturn><bean:write name="cont" property="controllerName" filter="true"/></july:lookupreturn></td>

                <td class="text"><bean:write name="cont" property="position.name" filter="true"/></td>
