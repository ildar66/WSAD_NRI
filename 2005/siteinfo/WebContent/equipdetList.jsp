...
<input type="text" size="10" id="c_editserial" value="" style="visibility:hidden;display:none;z-index:2;">

<IFRAME WIDTH="600" HEIGHT="200" ID="commFrame" STYLE="position:absolute;left:expression(document.body.clientWidth/2-200);top:expression(document.body.scrollTop + 200);z-index:1; visibility:hidden"></IFRAME>
...
<TR class="normal">
 <TD colspan="<%= gColSpan %>">
    ...
    <TR>
       ...
       <td class="title"><bean:write name="EquipdetListForm" property="equipmentname"/></td>
    </TR>
    </table>
    ...
    <july:separator colspan="<%= gColSpan %>" />
      ...
      <tr class="title">
          <td colspan="<%= gColSpan %>"><TABLE class="buttons">
            <TR class="title">
              <TD class="buttons"><july:backbutton/><july:printbutton href="/crystalclear/equipment.rpt?dll=pdsequip.dll&prompt1=0" paramId="prompt0" paramName="EquipdetListForm" paramProperty="storageplace" /></TD>
...
<tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
	...
	<td class="text"><%if(equ.getColumn("contents").asObject() != null && "S".equals(equ.getColumn("policy").asString())) {%><july:link page="/ShowEquipsdetList.do" paramId="storagecard" paramName="storagecard"><IMG SRC="/images/details.gif" BORDER="0" ALT='<bean:message key="label.eqipdet.cont"/>'></july:link><%}%></td>
