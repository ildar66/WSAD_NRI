...
<%	String gColSpan = "14";
	SchetFactForChargeListForm listForm =
		(SchetFactForChargeListForm) session.getAttribute("SchetFactForChargeListForm");
	String sortBy = listForm.getSortBy();
%>
<july:browseform action="/SchetFactForChargeList.do" styleId="listForm">
