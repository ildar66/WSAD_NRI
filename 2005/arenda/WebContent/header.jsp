<%
response.setContentType("text/html; name=header.htm; charset=windows-1251");
%>
...
<link id=Main-File rel=Main-File href="../DocTemp.htm">
</head>
...
<p class=MsoHeader style='margin-right:18.0pt'><![if !supportEmptyParas]>&nbsp;<![endif]><o:p></o:p></p>
...
<table cellspacing=0 cellpadding=0 hspace=0 vspace=0 align=right>
 <tr>
  ...
  class=MsoPageNumber>1</span><!--[if supportFields]><span class=MsoPageNumber><span
  style='mso-element:field-end'></span></span><![endif]--><span
  class=MsoPageNumber><span style='mso-ansi-language:EN-US'> </span> / </span><!--[if supportFields]><span
  class=MsoPageNumber><span style='mso-element:field-begin'></span> NUMPAGES <span
...
<p class=MsoHeader style='margin-right:18.0pt'><span lang=EN-US
style='mso-ansi-language:EN-US'> <%=session.getAttribute("colontitle") %><o:p></o:p></span></p>
...
<p class=MsoHeader><![if !supportEmptyParas]>&nbsp;<![endif]><o:p></o:p></p>
