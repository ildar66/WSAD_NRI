...
<table class="main">
	...
	<tr>
		<td class="text"><bean:message key="label.autoproc.prolongation.start"/></td>
	</tr>
...
<%
	out.flush();
	StartProlongationForm form = ((StartProlongationForm) request.getSession().getAttribute("StartProlongationForm"));
	...
	try {
		String forward = "/ShowJournalProlongationsList.do?taskStartcode=" + new ArendaDocumentProcessorAccessBean().prolongLeaseArendaAgreement(
			form.getDate1(), form.getDate2(), economist, contract, new Integer(operator));
%>
	<tr>
		<td class="text"><bean:message key="label.autoproc.prolongation.finish"/></td>
	</tr>
	<tr>
		<td class="text">&nbsp;</td>
	</tr>
...
<%	} catch (java.rmi.RemoteException e) { %>
	...
	<tr>
		<td class="text"><bean:message key="label.autoproc.prolongation.error"/></td>
	</tr>
