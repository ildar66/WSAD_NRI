...
<july:editform action="/ProcessArendaReport10Params.do">
...
--%>
	...
	<tr>
		...
		<td class="text"><bean:message key="label.report10.date"/></td>
	...
	<tr>
		...
		<td class="text"><bean:message key="label.report10.man"/></td>
