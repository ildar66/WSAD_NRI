...
<tr class="title">
       ...
       <td  class="title">
			<A title="Сортировать по полю 'Номер акта'" href="javascript:SortBy('docNumberCWA')">Номер акта</A><%=isUp(sortBy, "docNumberCWA")%></td>
       <td  class="title">
			<A title="Сортировать по полю 'Дата акта'" href="javascript:SortBy('docDateCWA')">Дата акта</A><%=isUp(sortBy, "docDateCWA")%></td>
       <td  class="title">
			<A title="Сортировать по полю 'Сумма акта'" href="javascript:SortBy('actSum')">Сумма акта</A><%=isUp(sortBy, "actSum")%></td>
       <td  class="title">
			<A title="Сортировать по полю 'НДС акта'" href="javascript:SortBy('actNds')">НДС акта</A><%=isUp(sortBy, "actNds")%></td>
       <td  class="title">
			<A title="Сортировать по полю 'Валюта акта'" href="javascript:SortBy('nameCurrency')">Валюта акта</A><%=isUp(sortBy, "nameCurrency")%></td>
       <td  class="title">
            ...
            <tr class="include" onMouseOver="className='select'" onMouseOut="className='include'">
            	<td class="text">
             	...
             	<%}else{%>
            		...
            		<A title="Изменить статус документа" href="javascript:revertStateDocCWA('<%= idStr %>', '<bean:write name="it" property="docState" filter="true"/>')">
