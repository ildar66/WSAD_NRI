...
<july:separator colspan="<%= gColSpan %>"/>	
	<tr>
		<td class="text"><july:reqmark>Опись №:</july:reqmark></td> 
		<td class="text">
...
<july:separator colspan="<%= gColSpan %>"/>
	<tr>
		<td class="text"><july:reqmark>Тип передачи:</july:reqmark></td>
		<td class="text">
			<july:select style="width: 200;" property="to.vo.typeRegistry" insertable="true" updatable="false">
				<html:option value="1">счета-фактуры</html:option>
				<html:option value="2">акты выполненных работ</html:option>
				<html:option value="3">договора</html:option>
				<html:option value="4">Сч-ф и Акты вып. работ</html:option>
				<html:option value="5">акты взаимозачета</html:option>
			</july:select>
		</td>
	</tr>
...
<july:separator colspan="<%= gColSpan %>"/>
	<tr>
		<td class="text"><july:reqmark>Инициатор:</july:reqmark></td>
		<td class="text">
