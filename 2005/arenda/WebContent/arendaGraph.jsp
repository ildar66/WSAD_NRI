...
<%--@include file="arendaGraphMenu.jsp"--%>  
...
<TABLE class=includer border="0" cellpadding="0" cellspacing="0">
	<TR>
		<TD colspan="3" width="100%" bgcolor="D6EBFF" height="43">
			<table height="100%" width="100%">
				<tr>
					<td nowrap>
						<div id="ctnrButton" class="<%=classButton%>"><iframe id="updateMenu1" name="updateMenu1" src="" width="100%" height="100%" frameborder="0" style="display:none"></iframe></div>
						<img src="/images/logo_beeline_dogovor.gif" border="0" alt="">
						<B style="color: blue; font-size: 80%"><%=curReg.getRegionName()%></B>
					</td>
                    <td width="10%" align="right"><a href="#" title="Помощь"
	...
	<TR>
		<TD vAlign=top width="225" id="menuCntr">

<table width="225" height="110">
	<tr class="select">
...
// Abonent Contracts Part End
	...
	case APPStates.LIST_FROM_POSITION:
		%>
	<jsp:include page="/listFromPosition.jsp" flush="true"></jsp:include>
		<%
		break;

	case APPStates.NFS_LIST_DETACH:
		%>
	<jsp:include page="/nfsListDetach.jsp" flush="true"></jsp:include>
		<%
		break;

	case APPStates.RESP_PAYS_LIST:
		%>
	<jsp:include page="/respPaysList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.CHARGE_LIST:
		%>
	<jsp:include page="/chargeList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.SCHET_FACT_LIST:
		%>
	<jsp:include page="/schetFactList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.SCHET_FACT_FOR_CHARGE_LIST:
		%>
	<jsp:include page="/schetFactForChargeList.jsp" flush="true"></jsp:include>
		<%
	break;	
	
	case APPStates.REGISTRY_BUCH_DOCS_LIST_FOR_INITIAL_GROUP:
		%>
	<jsp:include page="/registryBuchDocsListForInitialGroup.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_LIST_FOR_RETURN_DOCUMENT_GROUP:
		%>
	<jsp:include page="/registryBuchDocsListForReturnDocumentGroup.jsp" flush="true"></jsp:include>
		<%
	break;			
			
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_SF_IG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_SF_IG.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_SF_CWA_IG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_SF_CWA_IG.jsp" flush="true"></jsp:include>
		<%
	break;	
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_CWA_IG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_CWA_IG.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_LeaseDoc_IG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_LeaseDoc_IG.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_SF_RG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_SF_RG.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_SF_CWA_RG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_SF_CWA_RG.jsp" flush="true"></jsp:include>
		<%
	break;	
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_CWA_RG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_CWA_RG.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_LeaseDoc_RG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_LeaseDoc_RG.jsp" flush="true"></jsp:include>
		<%
	break;	
	
	case APPStates.LEASE_PAY_OFFICE_MEMO_LIST:
		%>
	<jsp:include page="/leasePayOfficeMemoList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.DOG_HISTORY_LIST:
		%>
	<jsp:include page="/doghistoryList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.LEASE_ZP_OFFICE_MEMO_LIST:
		%>
	<jsp:include page="/leaseZPOfficeMemoList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.LEASE_CONTRACT_PROBLEM_LIST:
		%>
	<jsp:include page="/leaseContractProblemList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.LEASE_PROBLEM_LIST:
		%>
	<jsp:include page="/leaseProblemList.jsp" flush="true"></jsp:include>
		<%
	break;						

	case APPStates.COMPLET_WORK_ACTS_FOR_CHARGE_LIST:
		%>
	<jsp:include page="/completWorkActsForChargeList.jsp" flush="true"></jsp:include>
		<%
	break;

	case APPStates.COMPLET_WORK_ACTS_LIST:
		%>
	<jsp:include page="/completWorkActsList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.DNOP_FOR_CHARGES_LIST:
		%>
	<jsp:include page="/dnopForChargeList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.DNOP_FOR_PAYMENTS_LIST:
		%>
	<jsp:include page="/dnopForPaymentList.jsp" flush="true"></jsp:include>
		<%
	break;	
	
	case APPStates.SALDO_DETAIL_LIST:
		%>
	<jsp:include page="/saldoDetailList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.ABONENT_SALDO_DETAIL_LIST:
		%>
	<jsp:include page="/abonentSaldoDetailList.jsp" flush="true"></jsp:include>
		<%
	break;
												
	case APPStates.CHOOSE_AVAILABLE_REGION:
		%><jsp:include page="/availableRegionForm.jsp" flush="true"></jsp:include><%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_LIST:
		%>
	<jsp:include page="/registryBuchDocsList.jsp" flush="true"></jsp:include>
		<%
	break;
	
	case APPStates.REGISTRY_BUCH_DOCS_COMPOSITION_MUTUAL_ACT_IG:
		%>
	<jsp:include page="/registryBuchDocsCompositionList_MutualAct.jsp" flush="true"></jsp:include>
		<%
	break;													
