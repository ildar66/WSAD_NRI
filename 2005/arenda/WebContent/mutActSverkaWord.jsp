...
<P align="center"><bean:write name="MutactWordPrintForm" property="sverkaHeader.header1" filter="true"/></P>
...
<B>Тип : <bean:write name="MutactWordPrintForm" property="sverkaHeader.typeView" filter="true"/></B><BR>
<%@include file="mutActSverkaWord_ShargesAndPay_include.jspf"%>
