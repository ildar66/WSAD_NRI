...
<july:editform action="/ProcessArendaReport7Params.do">
...
--%>
	...
	<tr>
		<td class="text"><bean:message key="label.report7.period"/></td>
		<td class="text">
	...
	<tr>
		<td class="text"><bean:message key="label.report7.rate"/></td>
