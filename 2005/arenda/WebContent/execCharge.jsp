...
<table class="main">
	...
	<tr>
		<td class="text"><bean:message key="label.autoproc.charges.start"/></td>
	</tr>
...
<%
	...
	out.flush();
	StartChargeForm form = (StartChargeForm) request.getSession().getAttribute("StartChargeForm");
	...
	try {
		String forward = "/ShowJournalChargesList.do?taskStartcode=" + new ArendaDocumentProcessorAccessBean().makeAutomaticCharges(
			form.getDate2(), economist, contract, new Integer(operator));

%>

	<tr>
		<td class="text"><bean:message key="label.autoproc.charges.finish"/></td>
	</tr>
	<tr>
		<td class="text">&nbsp;</td>
	</tr>
...
<%	} catch (java.rmi.RemoteException e) { %>
	...
	<july:separator/>
	<tr>
		<td class="text"><bean:message key="label.autoproc.charges.error"/></td>
	</tr>
