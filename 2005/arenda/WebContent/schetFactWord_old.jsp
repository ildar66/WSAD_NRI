...
<tr>
	<td align= "center"> <b>Руководитель организации</b>	</td>
	<td>&nbsp;</td>
	<td align= "center"> <b>Главный бухгалтер</b> </td>
	<td>&nbsp;</td>
	<td align= "center">Выдал</td>
	<td>&nbsp;</td>
</tr>
<tr>
    <td align= "center"><bean:write name="SchetFactPrintForm" property="header.nameManager" filter="true"/></td>
	<td align= "center">______________________</td>
    <td align= "center"><bean:write name="SchetFactPrintForm" property="header.nameBugalter" filter="true"/></td>
	<td align= "center">______________________</td>
    <td>&nbsp;</td>
	<td align= "center">______________________</td>
</tr>
<tr>
	...
	<td align= "center" style="font-size: 8pt;">подпись ответственного лица от продавца</td>
</tr> 
</table>
<P>&nbsp;</P><P>&nbsp;</P>
