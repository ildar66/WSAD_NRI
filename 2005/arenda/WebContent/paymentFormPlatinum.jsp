...
<tr>
	<td class="text" colspan="2"><bean:message key="label.platinum.taxfields"/>:
		...
		<TR>
			<TD class="text"><july:string size="5" property="fl101" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="5" property="fl104" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="10" property="fl105" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="5" property="fl106" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="10" property="fl107" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="10" property="fl108" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="10" property="fl109" insertable="true" updatable="<%= valueForEdit %>"/></TD>
			<TD class="text"><july:string size="5" property="fl110" insertable="true" updatable="<%= valueForEdit %>"/></TD>
		</TR>
		</TABLE>
	</td>
</tr>
