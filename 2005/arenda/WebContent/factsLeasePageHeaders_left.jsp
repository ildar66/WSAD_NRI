...
<html:html>
<HEAD>
	<TITLE>factsLeasePageHeaders_left.jsp</TITLE>
</HEAD>
	...
	<TBODY>
		<TR>
			...
			<TH nowrap style="width: 120px;">
				<A title="номер" href="javascript:SortBy('docNumber')">номер </A><%=isUp(sortBy, "docNumber")%>
			</TH>			
			<TH nowrap style="width: 60px;">
				<A title="дата"	href="javascript:SortBy('docDate')">дата </A><%=isUp(sortBy, "docDate")%>
			</TH>
