...
<%
	String gColSpan = "12";
	RegistryBuchDocsListForInitialGroupForm listForm = (RegistryBuchDocsListForInitialGroupForm)session.getAttribute("RegistryBuchDocsListForInitialGroupForm");
...
<july:browseform action="/RegistryBuchDocsListForInitialGroup.do" styleId="listForm">
...
<table class="main" id="tableID">
	...
	<logic:iterate id="it" name="browseList" type="LeaseRegistryBuchDocs_TO">
		...
		<%
			...
			java.util.List statesList = listForm.getRegBuchDocsState().getAvailableStateList(item.getVo().getState(), AbstractRegistryBuchDocsStateFactory.IG);
