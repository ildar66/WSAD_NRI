...
<!-- Текст служебки:-->
<!-- MemoType:Выдать оборудование для ссудных договоров-->
<P style='text-align:justify;text-indent:35.4pt'>Прошу Вас дать указание на выдачу оборудования <bean:write name="MemoWordForm" property="memo.useTypeVO.printLabel" filter="true" scope="request"/> ссудополучателю <bean:write name="LoanContractMemoListForm" property="vo.orgCustomer.name" filter="true" scope="session"/> согласно договору ссуды № <bean:write name="LoanContractMemoListForm" property="vo.docnumber" filter="true" scope="session"/> от <july:datewrite name="LoanContractMemoListForm" property="vo.docdate"/>
</P> 
<P>&nbsp;</P>
...
<P>&nbsp;</P>
	<P>Абонентский договор: &nbsp;&nbsp;<B>№ <bean:write name="MemoWordForm" property="abonent.ban" filter="true"/></B></P>
	<P>Позиция: &nbsp;&nbsp;№ <bean:write name="LoanContractMemoListForm" property="vo.mainpositionVO.name" filter="true" scope="session"/></P>
<P>&nbsp;</P><P>&nbsp;</P><P>&nbsp;</P><P>&nbsp;</P>
