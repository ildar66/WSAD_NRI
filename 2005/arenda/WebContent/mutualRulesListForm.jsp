	...
	<logic:iterate id="it" name="browseList">
		<logic:present name="it">
			<tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
				...
				<td class="text">
					<logic:equal name="it" property="rateType" value="1">Курс ЦБ РФ</logic:equal>
					<logic:equal name="it" property="rateType" value="3">Внутренний курс Вымпелкома</logic:equal>
				</td>				
				<td class="link">
					<july:canedit rolesProperty="editRoles">
						<logic:equal name="<%= form %>" property="state" value="A">
