...
--%>
	...
	<tr class="title">
		<td colspan="<%= gColSpan %>">
			<table class="buttons">
				<tr class="title"><td class="buttons"><july:backbutton page="/ArendaReport8Params.do"/></td></tr>
			</table>
		</td>
	</tr>
	...
	<tr class="title">
		<td>
			<%	ArendaReport8ParamsForm rp = (ArendaReport8ParamsForm) session.getAttribute("ArendaReport8ParamsForm");
				String p = "ArendaStat3.rpt?dll=pdsarendastat3.dll";
