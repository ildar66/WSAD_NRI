...
--%>
	...
	<tr class="title">
		<td colspan="<%= gColSpan %>">
			<table class="buttons">
				<tr class="title"><td class="buttons"><july:backbutton page="/ArendaReport4Params.do"/></td></tr>
			</table>
		</td>
	</tr>
	...
	<tr class="title">
		<td>
			<%	ArendaReport4ParamsForm rp = (ArendaReport4ParamsForm) session.getAttribute("ArendaReport4ParamsForm");
				String p = "ArendaReport4.rpt?dll=pdsarenda4.dll";
