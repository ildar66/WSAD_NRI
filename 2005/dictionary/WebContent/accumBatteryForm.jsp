...
<%   
	...
	String form = null;
	String navt = "L";
   	action = "/ProcessAccumBattery.do";
	form = "AccumBatteryForm";
	navt = "L";
%>
...
<july:separator/>          
	...
	<tr>
		<td><bean:message key="label.accumres.voltage"/>:&nbsp;</td>
		<td>
			<july:string property="voltageFrm" size="35" insertable="true" updatable="true" />
		</td>
	</tr>

	<july:separator/>
	<tr>
		<td><bean:message key="label.accumres.capacity"/>:&nbsp;</td>
		<td>
			<july:string property="capacityFrm" size="35" insertable="true" updatable="true" />
		</td>
	</tr>
	...
	<july:separator/>
		...
		<tr>
		<td><bean:message key="label.accumres.accutype"/>:&nbsp;</td>
		<td>
			<july:string property="accutype" size="35" insertable="true" updatable="true" />
		</td>
	</tr>
	...
	<july:separator/>
		...
		<tr>
		<td><bean:message key="label.accumres.accucount"/>:&nbsp;</td>
		<td>
			<july:string property="accucountFrm" size="35" insertable="true" updatable="true" />
		</td>
	</tr>
