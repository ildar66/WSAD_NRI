...
<%
	String action = "/VendorSiteProcess.do";
	String form = "VendorSiteDialogForm";
...
<table class="main" style="font-size:8pt;">
    ...
    <tr>
        ...
        <td>
			...
			<html:link page="/../dict/VendorLookupList.do?formname=VendorSiteDialogForm&onMySelect=changeTypeVendor();&fieldnames=to.vo.idVendor|vendor_VO.vendorCode|vendor_VO.name|vendor_VO.inn|to.vo.name|to.vo.address|to.vo.accountManagerFio|to.vo.directorFio|to.vo.directorJob|vendor_VO.typeVendor" onclick="return openDialog(this.href, 'VendorLookupList', 'top=40, left=100, width=700, height=650, scrollbars=yes, resizable=yes');" title="справочник поставщиков">		
    ...
    <tr>
        <td class="text"><bean:write name="<%= form %>" property="vendorFormView.nameInn"/> поставщика:</td>
        <td>
    ...
    <tr>
        ...
        <td>
		    <july:select style="width: 130; font-size:8pt;" collection="owners" property="to.vo.idOwnerNfs" insertable="true" updatable="<%=isUpdatable%>">
		    	<%--html:option value=""/--%>
