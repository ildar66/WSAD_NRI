...
<july:editform action="/ProcessResourceWN.do">
<%String cpupdate = "true";%>
<logic:equal name="ResourceWNForm" property="isresourceused" value="true"><%cpupdate = "false";%></logic:equal>
...
<tr>
	...
	<td class="text"><bean:write name="ResourceWNForm" property="resourcetypename" /></td>
</tr>
    ...
    <tr>
        ...
        <td>
		<july:string property="manufacturerFrm" styleId="manufacturer" size="5" insertable="true" updatable="true" />
