...
<july:browseform action="/ShowComplectForList.do" styleId="cflist">
...
<tr class="title">
	<td class="title" colspan="<%= gColSpan %>">
       ...
       <july:sepmark/> 
       <july:currmark><bean:message key="label.complectfor"/></july:currmark></td>
</tr>
--%>
...
<TR class="normal">
 <TD colspan="<%= gColSpan %>">
    ...
    <table class="find">
    <TR>
       <td class="title"><bean:message key="label.complectfor.part"/>:</td>
...
<july:separator colspan="<%= gColSpan %>" />
        ...
        <tr class="title">
          <td colspan="<%= gColSpan %>"><TABLE class="buttons">
            <TR class="title">
              <TD class="buttons"><july:includebutton page="/EditComplectFor.do?action=Add"/><july:backbutton/></TD>
      ...
      <july:separator colspan="<%= gColSpan %>" />
        ...
        <!-- Table header -->
        <tr class="title">
            <july:headercolumn key="label.complectfor.complect.code" colType="number"/>
            <july:headercolumn key="label.resource.model" colType="string"/>
            <july:headercolumn key="label.complectfor.complect.name" colType="string"/>
            <TD class="title">&nbsp;</TD>
        </tr>
        ...
        <logic:iterate id="ul" name="browseList">
	      <logic:present name="ul">
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                <td class="number">
                    <bean:write name="ul" property="complect.resource" filter="true"/>
                </td>
                <td class="text">
                    <bean:write name="ul" property="complect.model" filter="true"/>
                </td>
                <td class="text">
                    <bean:write name="ul" property="complect.name" filter="true"/>
                </td>
                <td class="link"><july:excludebutton page="/EditComplectFor.do?action=Delete" paramId="complectcode" paramName="ul" paramProperty="complect.resource" paramScope="page"/></td>
            </tr>
