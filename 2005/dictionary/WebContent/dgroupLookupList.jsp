...
<july:browseform action="/ShowDGroupLookupList.do">
...
<TR class="title">
 <TD class="title">
    <bean:message key="label.choose.dgroup"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
    ...
    <TR>
       ...
       <td class="title"><bean:write name="DGroupLookupListForm" property="departmentname" /></td>
     </tr>        
     </table>
