...
<july:browseform action="/ShowTranceiverList.do" styleId="TranceiverListForm">
...
<tr class="title">
	...
	<TR class="title">
		<TD class="buttons">
			<july:addbutton page="/EditTranceiver.do?action=Add"/>
			<july:backbutton/>
		</TD>
		<TD class="navigator">
			<july:navigator/>
...
<% } %>
<%--<tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">--%>
	<td class="link"><july:editbutton page="/EditTranceiver.do" action="Edit" paramId="resource" paramName="resource" paramScope="page"/></td>
	...
	<td class="link"><july:delbutton page="/EditTranceiver.do?action=Delete" paramId="resource" paramName="resource" paramScope="page"/></td>
</tr>
<july:separator colspan="<%= gColSpan %>"/>
</logic:present>
</logic:iterate>
