        ...
        <logic:iterate id="comp" name="browseList" indexId="index">
	      <logic:present name="comp">
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                <td class="number"><bean:write name="comp" property="company" filter="true"/></td>
                <td class="text"><july:lookupreturn><bean:write name="comp" property="name" filter="true"/></july:lookupreturn></td>
            </tr>
	      </logic:present>
