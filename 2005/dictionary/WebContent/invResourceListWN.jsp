...
<july:browseform action="/ShowInvResourceListWN.do">
...
<tr class="normal">
	<td colspan="<%= gColSpan %>">
      ...
      <july:select size="1" collection="categories" property="category"
          ...
          insertable="true" updatable="true" disabled="false">
...
<tr class="title">
	...
	<tr class="title">
		<td class="buttons">
			<july:addbutton page="/ChooseRtypeWN.do?action=Add"/>
			<a href="/dict/" title="Закрыть" onclick="document.body.style.cursor='wait'; document.body.style.cursor='auto';">
				<IMG SRC="/images/save.gif" BORDER='0' ALT='Закрыть' 
				onclick="document.body.style.cursor='auto'; if (opener != null) {opener.document.all.refreshFields.value=1; opener.document.forms(0).submit(); opener.focus();} window.close();">		
			</a>
		</td>
...
<tr class="title">
	...
	<table class="buttons">
	<tr class="title">
		<td class="buttons"><july:addbutton page="/ChooseRtypeWN.do?action=Add"/>
			<a href="/dict/" title="Закрыть" onclick="document.body.style.cursor='wait'; document.body.style.cursor='auto';">
				<IMG SRC="/images/save.gif" BORDER='0' ALT='Закрыть' 
				onclick="document.body.style.cursor='auto'; if (opener != null) {opener.document.all.refreshFields.value=1; opener.document.forms(0).submit(); opener.focus();} window.close();">		
			</a>
