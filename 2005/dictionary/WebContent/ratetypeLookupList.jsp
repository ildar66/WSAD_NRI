...
<july:browseform action="/ShowRatetypeLookupList.do">
...
<TR class="title">
 <TD class="title">
    <bean:message key="label.choose.ratetype"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
        ...
        <logic:iterate id="rtl" name="browseList" indexId="index">
	      <logic:present name="rtl">
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                <td class="number"><bean:write name="rtl" property="ratetype" filter="true"/></td>
