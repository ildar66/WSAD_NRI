...
<%
	// страница отображается в 2-х приложениях (справочники и аренда);
...
<tr>
	...
	<tr>
		...
		<td width="10%" align="right"><a href="#" title="Помощь" onclick="window.open('/dictionary.doc', '_blank', 'top=40, left=100, width=830, height=630, scrollbars=yes, resizable=yes'); return false;"><img src="/images/helph.gif" border="0" hspace="12"></a></td>
	</tr>
	</table>
	</td>
</tr>
