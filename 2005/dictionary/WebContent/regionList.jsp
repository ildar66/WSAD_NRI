...
function ChangeParantID(aParentRegName){
	...
	if(confirm('Изменить родителя у выбранных элементов на : ' + aParentRegName + ' ?')) {
          ...
          <td colspan="<%= gColSpan %>"><TABLE class="buttons">
            <TR class="title">
              ...
              <TD class="buttons" nowrap="nowrap">
				<A title="Изменить родителя" href="javascript:ChangeParantID(listForm.toParentRegName.value)">Изменить родителя на:</A>
				<html:hidden property="toParentRegID" value=""/>
				<input type="text" name="toParentRegName" size="15" value="" class="search">
			  	<html:link page="/RegionLookupList.do?formname=RegionListForm&fieldnames=toParentRegID|toParentRegName" onclick="window.open(this.href, 'pWindow', 'top=80, left=200, width=750, height=500, scrollbars=yes, resizable=yes').focus(); return false;" title="справочник регионов"><IMG SRC="/images/lookup.gif" BORDER='0' ALT='справочник Регионов'></html:link>
		 	  </TD>			  
