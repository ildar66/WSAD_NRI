...
public class _Environment_Stub extends Stub implements Environment {
    ...
    public Properties getEnvironmentProperties() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_environmentProperties", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Properties) in.read_value(Properties.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
            ...
            ServantObject so = _servant_preinvoke("_get_environmentProperties",com.hps.july.jdbcpersistence.Environment.class);
            if (so == null) {
                return getEnvironmentProperties();
            }
            try {
                Properties result = ((com.hps.july.jdbcpersistence.Environment)so.servant).getEnvironmentProperties();
                return (Properties)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
