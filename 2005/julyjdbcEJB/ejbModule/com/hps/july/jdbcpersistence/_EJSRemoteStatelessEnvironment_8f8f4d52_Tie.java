...
public class _EJSRemoteStatelessEnvironment_8f8f4d52_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessEnvironment_8f8f4d52 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.jdbcpersistence.Environment:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessEnvironment_8f8f4d52) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 26: 
                    if (method.equals("_get_environmentProperties")) {
                        return _get_environmentProperties(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_environmentProperties(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Properties result = target.getEnvironmentProperties();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,Properties.class);
        return out;
    }
}
