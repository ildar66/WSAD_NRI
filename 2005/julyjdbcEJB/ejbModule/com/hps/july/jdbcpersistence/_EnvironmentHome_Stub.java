...
public class _EnvironmentHome_Stub extends Stub implements EnvironmentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.jdbcpersistence.EnvironmentHome:0000000000000000", 
    ...
    public Environment create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Environment) in.read_Object(Environment.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.jdbcpersistence.EnvironmentHome.class);
            if (so == null) {
                return create();
            }
            try {
                Environment result = ((com.hps.july.jdbcpersistence.EnvironmentHome)so.servant).create();
                return (Environment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
