...
public class _ArendaRuleProcessorHome_Stub extends Stub implements ArendaRuleProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.ArendaRuleProcessorHome:0000000000000000", 
    ...
    public ArendaRuleProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ArendaRuleProcessor) in.read_Object(ArendaRuleProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.ArendaRuleProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                ArendaRuleProcessor result = ((com.hps.july.arenda.sessionbean.ArendaRuleProcessorHome)so.servant).create();
                return (ArendaRuleProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
