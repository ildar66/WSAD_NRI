...
public class _LeaseArendaAgreementProcessorHome_Stub extends Stub implements LeaseArendaAgreementProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.LeaseArendaAgreementProcessorHome:0000000000000000", 
    ...
    public LeaseArendaAgreementProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseArendaAgreementProcessor) in.read_Object(LeaseArendaAgreementProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.LeaseArendaAgreementProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                LeaseArendaAgreementProcessor result = ((com.hps.july.arenda.sessionbean.LeaseArendaAgreementProcessorHome)so.servant).create();
                return (LeaseArendaAgreementProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
