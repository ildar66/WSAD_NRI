...
public class _ArendaDocumentProcessorHome_Stub extends Stub implements ArendaDocumentProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.ArendaDocumentProcessorHome:0000000000000000", 
    ...
    public ArendaDocumentProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ArendaDocumentProcessor) in.read_Object(ArendaDocumentProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.ArendaDocumentProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                ArendaDocumentProcessor result = ((com.hps.july.arenda.sessionbean.ArendaDocumentProcessorHome)so.servant).create();
                return (ArendaDocumentProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
