...
public class _CalculateArendaActHome_Stub extends Stub implements CalculateArendaActHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.CalculateArendaActHome:0000000000000000", 
    ...
    public CalculateArendaAct create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CalculateArendaAct) in.read_Object(CalculateArendaAct.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.CalculateArendaActHome.class);
            if (so == null) {
                return create();
            }
            try {
                CalculateArendaAct result = ((com.hps.july.arenda.sessionbean.CalculateArendaActHome)so.servant).create();
                return (CalculateArendaAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
