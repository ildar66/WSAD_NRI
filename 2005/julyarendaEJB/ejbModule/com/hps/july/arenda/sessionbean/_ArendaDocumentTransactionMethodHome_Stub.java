...
public class _ArendaDocumentTransactionMethodHome_Stub extends Stub implements ArendaDocumentTransactionMethodHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.ArendaDocumentTransactionMethodHome:0000000000000000", 
    ...
    public ArendaDocumentTransactionMethod create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ArendaDocumentTransactionMethod) in.read_Object(ArendaDocumentTransactionMethod.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.ArendaDocumentTransactionMethodHome.class);
            if (so == null) {
                return create();
            }
            try {
                ArendaDocumentTransactionMethod result = ((com.hps.july.arenda.sessionbean.ArendaDocumentTransactionMethodHome)so.servant).create();
                return (ArendaDocumentTransactionMethod)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
