...
public class _LeaseSaldoProcessorHome_Stub extends Stub implements LeaseSaldoProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.LeaseSaldoProcessorHome:0000000000000000", 
    ...
    public LeaseSaldoProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseSaldoProcessor) in.read_Object(LeaseSaldoProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.LeaseSaldoProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                LeaseSaldoProcessor result = ((com.hps.july.arenda.sessionbean.LeaseSaldoProcessorHome)so.servant).create();
                return (LeaseSaldoProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
