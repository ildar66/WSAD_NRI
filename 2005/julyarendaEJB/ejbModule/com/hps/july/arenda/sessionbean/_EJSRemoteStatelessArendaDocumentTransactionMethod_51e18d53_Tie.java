...
public class _EJSRemoteStatelessArendaDocumentTransactionMethod_51e18d53_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessArendaDocumentTransactionMethod_51e18d53 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessArendaDocumentTransactionMethod_51e18d53) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 25: 
                    if (method.equals("makeAutoChargeOneContract")) {
                        return makeAutoChargeOneContract(in, reply);
                    }
                case 26: 
                    if (method.equals("makeAutoPaymentOneContract")) {
                        return makeAutoPaymentOneContract(in, reply);
                    }
                case 27: 
                    if (method.equals("makeProlongationOneContract")) {
                        return makeProlongationOneContract(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream calcNds(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        BigDecimal result = target.calcNds(arg0, arg1, arg2, arg3);
        org.omg.CORBA_2_3.portable.OutputStream out = 
    ...
    private org.omg.CORBA.portable.OutputStream makeAutoChargeOneContract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Date arg0 = (Date) in.read_value(Date.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        int arg2 = in.read_long();
        try {
            target.makeAutoChargeOneContract(arg0, arg1, arg2);
        } catch (Exception ex) {
    ...
    private org.omg.CORBA.portable.OutputStream makeAutoPaymentOneContract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Date arg0 = (Date) in.read_value(Date.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Integer arg2 = (Integer) in.read_value(Integer.class);
        int arg3 = in.read_long();
        try {
            target.makeAutoPaymentOneContract(arg0, arg1, arg2, arg3);
        } catch (Exception ex) {
            String id = "IDL:java/lang/Ex:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream makeProlongationOneContract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Handle arg0 = (Handle) in.read_abstract_interface(Handle.class);
        int arg1 = in.read_long();
        target.makeProlongationOneContract(arg0, arg1);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
