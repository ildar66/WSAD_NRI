...
public class _JournalHome_Stub extends Stub implements JournalHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.JournalHome:0000000000000000", 
    ...
    public Journal create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Journal) in.read_Object(Journal.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.JournalHome.class);
            if (so == null) {
                return create();
            }
            try {
                Journal result = ((com.hps.july.arenda.sessionbean.JournalHome)so.servant).create();
                return (Journal)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
