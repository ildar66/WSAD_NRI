...
public class _ArendaTransactionMethodHome_Stub extends Stub implements ArendaTransactionMethodHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.sessionbean.ArendaTransactionMethodHome:0000000000000000", 
    ...
    public ArendaTransactionMethod create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ArendaTransactionMethod) in.read_Object(ArendaTransactionMethod.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.sessionbean.ArendaTransactionMethodHome.class);
            if (so == null) {
                return create();
            }
            try {
                ArendaTransactionMethod result = ((com.hps.july.arenda.sessionbean.ArendaTransactionMethodHome)so.servant).create();
                return (ArendaTransactionMethod)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
