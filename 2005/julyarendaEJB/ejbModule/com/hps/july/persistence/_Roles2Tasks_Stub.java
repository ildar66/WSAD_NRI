...
public class _Roles2Tasks_Stub extends Stub implements Roles2Tasks {
    ...
    public Role getRole() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("getRole",com.hps.july.persistence.Roles2Tasks.class);
            if (so == null) {
                return getRole();
            }
            try {
                Role result = ((com.hps.july.persistence.Roles2Tasks)so.servant).getRole();
    ...
    public RoleKey getRoleKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_roleKey",com.hps.july.persistence.Roles2Tasks.class);
            if (so == null) {
                return getRoleKey();
            }
            try {
                RoleKey result = ((com.hps.july.persistence.Roles2Tasks)so.servant).getRoleKey();
    ...
    public Task getTask() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("getTask",com.hps.july.persistence.Roles2Tasks.class);
            if (so == null) {
                return getTask();
            }
            try {
                Task result = ((com.hps.july.persistence.Roles2Tasks)so.servant).getTask();
    ...
    public TaskKey getTaskKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_taskKey", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TaskKey) in.read_value(TaskKey.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
            ...
            ServantObject so = _servant_preinvoke("_get_taskKey",com.hps.july.persistence.Roles2Tasks.class);
            if (so == null) {
                return getTaskKey();
            }
            try {
                TaskKey result = ((com.hps.july.persistence.Roles2Tasks)so.servant).getTaskKey();
                return (TaskKey)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
