...
public class _CableResourceBand_Stub extends Stub implements CableResourceBand {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.CableResourceBand:0000000000000000", 
    ...
    public short getBand() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_band",com.hps.july.persistence.CableResourceBand.class);
            if (so == null) {
                return getBand();
            }
            try {
                return ((com.hps.july.persistence.CableResourceBand)so.servant).getBand();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public BigDecimal getLostfactor() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_lostfactor", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_lostfactor",com.hps.july.persistence.CableResourceBand.class);
            if (so == null) {
                return getLostfactor();
            }
            try {
                BigDecimal result = ((com.hps.july.persistence.CableResourceBand)so.servant).getLostfactor();
    ...
    public CableResource getResource() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("getResource",com.hps.july.persistence.CableResourceBand.class);
            if (so == null) {
                return getResource();
            }
            try {
                CableResource result = ((com.hps.july.persistence.CableResourceBand)so.servant).getResource();
    ...
    public ResourceKey getResourceKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_resourceKey",com.hps.july.persistence.CableResourceBand.class);
            if (so == null) {
                return getResourceKey();
            }
            try {
                ResourceKey result = ((com.hps.july.persistence.CableResourceBand)so.servant).getResourceKey();
    ...
    public void setLostfactor(BigDecimal arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_lostfactor",com.hps.july.persistence.CableResourceBand.class);
            if (so == null) {
                setLostfactor(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.CableResourceBand)so.servant).setLostfactor(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
