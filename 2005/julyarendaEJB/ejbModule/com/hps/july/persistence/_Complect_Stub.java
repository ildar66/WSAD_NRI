...
public class _Complect_Stub extends Stub implements Complect {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.Complect:0000000000000000", 
    ...
    public Resource getComplect() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("getComplect", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("getComplect",com.hps.july.persistence.Complect.class);
            if (so == null) {
                return getComplect();
            }
            try {
                Resource result = ((com.hps.july.persistence.Complect)so.servant).getComplect();
    ...
    public ResourceKey getComplectKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_complectKey", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_complectKey",com.hps.july.persistence.Complect.class);
            if (so == null) {
                return getComplectKey();
            }
            try {
                ResourceKey result = ((com.hps.july.persistence.Complect)so.servant).getComplectKey();
    ...
    public Resource getParts() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("getParts",com.hps.july.persistence.Complect.class);
            if (so == null) {
                return getParts();
            }
            try {
                Resource result = ((com.hps.july.persistence.Complect)so.servant).getParts();
                return (Resource)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public ResourceKey getPartsKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_get_partsKey",com.hps.july.persistence.Complect.class);
            if (so == null) {
                return getPartsKey();
            }
            try {
                ResourceKey result = ((com.hps.july.persistence.Complect)so.servant).getPartsKey();
                return (ResourceKey)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
