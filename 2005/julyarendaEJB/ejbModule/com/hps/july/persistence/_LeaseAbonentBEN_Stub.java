...
public class _LeaseAbonentBEN_Stub extends Stub implements LeaseAbonentBEN {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseAbonentBEN:0000000000000000", 
    ...
    public short getBen() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_ben",com.hps.july.persistence.LeaseAbonentBEN.class);
            if (so == null) {
                return getBen();
            }
            try {
                return ((com.hps.july.persistence.LeaseAbonentBEN)so.servant).getBen();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public LeaseAbonentBAN getLeaseabonentban() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("getLeaseabonentban",com.hps.july.persistence.LeaseAbonentBEN.class);
            if (so == null) {
                return getLeaseabonentban();
            }
            try {
                LeaseAbonentBAN result = ((com.hps.july.persistence.LeaseAbonentBEN)so.servant).getLeaseabonentban();
    ...
    public LeaseDocumentKey getLeaseabonentbanKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_leaseabonentbanKey",com.hps.july.persistence.LeaseAbonentBEN.class);
            if (so == null) {
                return getLeaseabonentbanKey();
            }
            try {
                LeaseDocumentKey result = ((com.hps.july.persistence.LeaseAbonentBEN)so.servant).getLeaseabonentbanKey();
