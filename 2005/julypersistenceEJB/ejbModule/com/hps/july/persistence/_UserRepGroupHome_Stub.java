...
public class _UserRepGroupHome_Stub extends Stub implements UserRepGroupHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.UserRepGroupHome:0000000000000000", 
    ...
    public UserRepGroup create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.UserRepGroupHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                UserRepGroup result = ((com.hps.july.persistence.UserRepGroupHome)so.servant).create(arg0, arg1);
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.UserRepGroupHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.UserRepGroupHome)so.servant).findAllOrderByNameAsc();
    ...
    public UserRepGroup findByPrimaryKey(UserRepGroupKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.UserRepGroupHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                UserRepGroupKey arg0Copy = (UserRepGroupKey) Util.copyObject(arg0,_orb());
                UserRepGroup result = ((com.hps.july.persistence.UserRepGroupHome)so.servant).findByPrimaryKey(arg0Copy);
                return (UserRepGroup)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
