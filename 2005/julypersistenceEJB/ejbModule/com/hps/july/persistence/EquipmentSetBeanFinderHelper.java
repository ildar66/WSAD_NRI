 ...
 **/
public interface EquipmentSetBeanFinderHelper extends com.hps.july.persistence.StoragePlaceBeanFinderHelper { 
	public java.sql.PreparedStatement findByPlatinumAndStatus(Integer position, Integer owner, String state, Integer order)
		throws Exception;
}
