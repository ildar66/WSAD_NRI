...
public class _EJSRemoteCMPPIEQueryListHome_543889f5_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEQueryListHome_543889f5 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEQueryListHome_543889f5) target;
    }
        ...
        try {
            ...
            switch (method.charAt(0)) {
                ...
                case 102: 
                    ...
                    } else if (method.equals("findPIEQueryListsByQuery")) {
                        return findPIEQueryListsByQuery(in, reply);
                    }
                case 114: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryListKey arg0 = (PIEQueryListKey) in.read_value(PIEQueryListKey.class);
        PIEQueryList result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEQueryListsByQuery(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryKey arg0 = (PIEQueryKey) in.read_value(PIEQueryKey.class);
        Enumeration result;
        try {
            result = target.findPIEQueryListsByQuery(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
