...
import javax.ejb.*;
import javax.naming.*;
public class LeaseContractToEconomistLink extends ManyToSingleLink {
...
public LeaseContractToEconomistLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.WorkerKey key = ((com.hps.july.persistence.LeaseContractBean)source).getEconomistKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseContractBean)source).getEconomistKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseContractBean)source).privateSetEconomistKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryAddLeaseContractEconomist((com.hps.july.persistence.LeaseContract)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryRemoveLeaseContractEconomist((com.hps.july.persistence.LeaseContract)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseContractBean)source).privateSetEconomistKey((com.hps.july.persistence.WorkerKey)targetEJB.getPrimaryKey());
}
}
