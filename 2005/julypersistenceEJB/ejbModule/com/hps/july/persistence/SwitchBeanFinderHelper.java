 ...
 **/
public interface SwitchBeanFinderHelper extends com.hps.july.persistence.EquipmentSetBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE( Boolean isNumber, Integer argNumber, Boolean isType, String argType, Integer order) throws Exception;
	public java.sql.PreparedStatement findByQBE2( Boolean isNumber, Integer argNumber, 
