...
import javax.ejb.*;
import javax.naming.*;
public class ProjectDivColumnsToProjectDivColValsLink extends SingleToManyLink {
	private static ProjectDivColValHome targetHome = null;
	private final static java.lang.String targetHomeName = "ProjectDivColVal";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public ProjectDivColumnsToProjectDivColValsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.ProjectDivColVal)anEJB).getProjectDivColumnKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.ProjectDivColValHome)getTargetHome(this)).findProjectDivColValsByProjectDivColumn((com.hps.july.persistence.ProjectDivColumnsKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.hps.july.persistence.ProjectDivColValHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized ProjectDivColValHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.ProjectDivColValHome)lookupTargetHome(homeName, com.hps.july.persistence.ProjectDivColValHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.ProjectDivColVal.class);
}
/**
