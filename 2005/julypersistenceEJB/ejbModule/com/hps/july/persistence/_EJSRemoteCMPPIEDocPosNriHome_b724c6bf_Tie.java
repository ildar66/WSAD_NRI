...
public class _EJSRemoteCMPPIEDocPosNriHome_b724c6bf_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEDocPosNriHome_b724c6bf target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEDocPosNriHome_b724c6bf) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 28: 
                    if (method.equals("findPIEDocPosNrisByPiedocnri")) {
                        return findPIEDocPosNrisByPiedocnri(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEDocPosNriKey arg0 = (PIEDocPosNriKey) in.read_value(PIEDocPosNriKey.class);
        PIEDocPosNri result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEDocPosNrisByPiedocnri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEDocNriKey arg0 = (PIEDocNriKey) in.read_value(PIEDocNriKey.class);
        Enumeration result;
        try {
            result = target.findPIEDocPosNrisByPiedocnri(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
