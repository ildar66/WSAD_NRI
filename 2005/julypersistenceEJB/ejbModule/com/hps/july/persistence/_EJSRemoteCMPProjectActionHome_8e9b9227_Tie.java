...
public class _EJSRemoteCMPProjectActionHome_8e9b9227_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectActionHome_8e9b9227 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectActionHome_8e9b9227) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findByProjectAndOrder")) {
                        return findByProjectAndOrder(in, reply);
                    }
                case 24: 
                ...
                case 27: 
                    if (method.equals("findProjectActionsByProject")) {
                        return findProjectActionsByProject(in, reply);
                    }
                case 28: 
                    if (method.equals("findByProjectOrderByOrderAsc")) {
                        return findByProjectOrderByOrderAsc(in, reply);
                    }
                case 29: 
                    if (method.equals("findProjectActionsByEquipment")) {
                        return findProjectActionsByEquipment(in, reply);
                    }
                case 33: 
                    if (method.equals("findByProjectAndProjectActionType")) {
                        return findByProjectAndProjectActionType(in, reply);
                    }
                case 37: 
                    if (method.equals("findProjectActionsByProjectactiontype")) {
                        return findProjectActionsByProjectactiontype(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByProjectAndOrder(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByProjectAndOrder(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByProjectAndProjectActionType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByProjectAndProjectActionType(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByProjectOrderByOrderAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByProjectOrderByOrderAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionsByEquipment(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionsByEquipment(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionsByProject(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectKey arg0 = (ProjectKey) in.read_value(ProjectKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionsByProject(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionsByProjectactiontype(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectActionTypeKey arg0 = (ProjectActionTypeKey) in.read_value(ProjectActionTypeKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionsByProjectactiontype(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
