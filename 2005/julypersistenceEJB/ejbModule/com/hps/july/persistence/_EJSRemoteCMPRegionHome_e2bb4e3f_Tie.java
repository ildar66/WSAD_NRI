...
public class _EJSRemoteCMPRegionHome_e2bb4e3f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPRegionHome_e2bb4e3f target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPRegionHome_e2bb4e3f) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 23: 
                    if (method.equals("findRegionBySuperregion")) {
                        return findRegionBySuperregion(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findRegionBySuperregion(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SuperRegionKey arg0 = (SuperRegionKey) in.read_value(SuperRegionKey.class);
        Enumeration result;
        try {
            result = target.findRegionBySuperregion(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
