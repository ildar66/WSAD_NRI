 ...
 **/
public interface LeaseSchetFaktBeanFinderHelper { 

	public static final String findByIdContractOrderByDateSchetFaktAscWhereClause = "T1.idContract = ? order by T1.DateSchetFakt asc";
	public static final String findByIdContractOrderByDateSchetFaktDescWhereClause = "T1.idContract = ? order by T1.DateSchetFakt desc";
	public static final String findByIdContractOrderByNumberSchetFaktAscWhereClause = "T1.idContract = ? order by T1.NumberSchetFakt asc";
	public static final String findByIdContractOrderByNumberSchetFaktDescWhereClause = "T1.idContract = ? order by T1.NumberSchetFakt desc";
	
	public static final String findByIdActOrderByNumberSchetFaktAscWhereClause = "T1.idAkt = ? order by T1.NumberSchetFakt asc";
	public static final String findByIdActOrderByNumberSchetFaktDescWhereClause = "T1.idAkt = ? order by T1.NumberSchetFakt desc";
	public static final String findByIdActOrderByDateSchetFaktAscWhereClause = "T1.idAkt = ? order by T1.DateSchetFakt asc";
	public static final String findByIdActOrderByDateSchetFaktDescWhereClause = "T1.idAkt = ? order by T1.DateSchetFakt desc";
