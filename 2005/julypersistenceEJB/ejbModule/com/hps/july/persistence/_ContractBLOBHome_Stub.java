...
public class _ContractBLOBHome_Stub extends Stub implements ContractBLOBHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ContractBLOBHome:0000000000000000", 
    ...
    public ContractBLOB create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ContractBLOB) in.read_Object(ContractBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.ContractBLOBHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                ContractBLOB result = ((com.hps.july.persistence.ContractBLOBHome)so.servant).create(arg0);
                return (ContractBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ContractBLOB findByPrimaryKey(ContractBLOBKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ContractBLOBKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ContractBLOB) in.read_Object(ContractBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ContractBLOBHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ContractBLOBKey arg0Copy = (ContractBLOBKey) Util.copyObject(arg0,_orb());
                ContractBLOB result = ((com.hps.july.persistence.ContractBLOBHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ContractBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
