...
public class _InWayBillBLOBHome_Stub extends Stub implements InWayBillBLOBHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.InWayBillBLOBHome:0000000000000000", 
    ...
    public InWayBillBLOB create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (InWayBillBLOB) in.read_Object(InWayBillBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.InWayBillBLOBHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                InWayBillBLOB result = ((com.hps.july.persistence.InWayBillBLOBHome)so.servant).create(arg0);
                return (InWayBillBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public InWayBillBLOB findByPrimaryKey(InWayBillBLOBKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,InWayBillBLOBKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (InWayBillBLOB) in.read_Object(InWayBillBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.InWayBillBLOBHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                InWayBillBLOBKey arg0Copy = (InWayBillBLOBKey) Util.copyObject(arg0,_orb());
                InWayBillBLOB result = ((com.hps.july.persistence.InWayBillBLOBHome)so.servant).findByPrimaryKey(arg0Copy);
                return (InWayBillBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
