...
public class _EJSRemoteCMPResourceSetHome_bc3c01ac_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPResourceSetHome_bc3c01ac target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPResourceSetHome_bc3c01ac) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 25: 
                    if (method.equals("findResourceSetsBySubtype")) {
                        return findResourceSetsBySubtype(in, reply);
                    }
                case 26: 
                    if (method.equals("findResourceSetsByMainpart")) {
                        return findResourceSetsByMainpart(in, reply);
                    }
                case 93: 
                    if (method.equals("create__long__CORBA_WStringValue__java_lang_Integer__java_math_BigDecimal__CORBA_WStringValue")) {
                        return create__long__CORBA_WStringValue__java_lang_Integer__java_math_BigDecimal__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSetKey arg0 = (ResourceSetKey) in.read_value(ResourceSetKey.class);
        ResourceSet result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findResourceSetsByMainpart(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findResourceSetsByMainpart(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findResourceSetsBySubtype(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findResourceSetsBySubtype(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream create__long__CORBA_WStringValue__java_lang_Integer__java_math_BigDecimal__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
