...
import javax.ejb.*;
import javax.naming.*;
public class ResourceToComplectsLink extends SingleToManyLink {
...
public ResourceToComplectsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Complect)anEJB).getComplectKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.ComplectHome)getTargetHome(this)).findComplectsByComplect((com.hps.july.persistence.ResourceKey)getEntityContext().getPrimaryKey());
	}
