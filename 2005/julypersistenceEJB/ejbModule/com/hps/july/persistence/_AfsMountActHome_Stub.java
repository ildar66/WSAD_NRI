...
public class _AfsMountActHome_Stub extends Stub implements AfsMountActHome {
    ...
    public AfsMountAct create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AfsMountAct) in.read_Object(AfsMountAct.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.AfsMountActHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                AfsMountAct result = ((com.hps.july.persistence.AfsMountActHome)so.servant).create(arg0);
                return (AfsMountAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public AfsMountAct create(int arg0, Integer arg1, Integer arg2, Integer arg3, Date arg4, int arg5, String arg6, String arg7, Boolean arg8, Boolean arg9, Boolean arg10) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean",com.hps.july.persistence.AfsMountActHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
            }
            try {
                ...
                AfsMountAct result = ((com.hps.july.persistence.AfsMountActHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5, arg6Copy, arg7Copy, arg8Copy, arg9Copy, arg10Copy);
                return (AfsMountAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public AfsMountAct create(int arg0, Integer arg1, Date arg2, int arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue",com.hps.july.persistence.AfsMountActHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                AfsMountAct result = ((com.hps.july.persistence.AfsMountActHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3, arg4Copy);
                return (AfsMountAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public AfsMountAct findByPrimaryKey(DocumentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.AfsMountActHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                DocumentKey arg0Copy = (DocumentKey) Util.copyObject(arg0,_orb());
                AfsMountAct result = ((com.hps.july.persistence.AfsMountActHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AfsMountAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByQBE(Boolean arg0, Date arg1, Date arg2, Boolean arg3, Integer arg4, Boolean arg5, Integer arg6, Boolean arg7, Integer arg8, Boolean arg9, Integer arg10, Integer arg11) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByQBE",com.hps.july.persistence.AfsMountActHome.class);
            if (so == null) {
                return findByQBE(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.AfsMountActHome)so.servant).findByQBE(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy, arg6Copy, arg7Copy, arg8Copy, arg9Copy, arg10Copy, arg11Copy);
    ...
    public Enumeration findByQBE2(Boolean arg0, Date arg1, Date arg2, Boolean arg3, Integer arg4, Boolean arg5, Integer arg6, Boolean arg7, Integer arg8, Boolean arg9, Integer arg10, Integer arg11) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByQBE2",com.hps.july.persistence.AfsMountActHome.class);
            if (so == null) {
                return findByQBE2(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
            }
            try {
                ...
                Integer arg10Copy = (Integer) copies[10];
                Integer arg11Copy = (Integer) copies[11];
                Enumeration result = ((com.hps.july.persistence.AfsMountActHome)so.servant).findByQBE2(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy, arg6Copy, arg7Copy, arg8Copy, arg9Copy, arg10Copy, arg11Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
