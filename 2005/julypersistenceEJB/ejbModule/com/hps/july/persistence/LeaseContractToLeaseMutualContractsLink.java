...
import javax.ejb.*;
import javax.naming.*;
public class LeaseContractToLeaseMutualContractsLink extends SingleToManyLink {
...
public LeaseContractToLeaseMutualContractsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseMutualContracts)anEJB).getContractKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseMutualContractsHome)getTargetHome(this)).findLeaseMutualContractsByContract((com.hps.july.persistence.LeaseDocumentKey)getEntityContext().getPrimaryKey());
	}
