...
public class _PIEBankPlatinumHome_Stub extends Stub implements PIEBankPlatinumHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEBankPlatinumHome:0000000000000000", 
    ...
    public PIEBankPlatinum create(String arg0, int arg1, String arg2, String arg3, String arg4, String arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEBankPlatinum) in.read_Object(PIEBankPlatinum.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEBankPlatinumHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                PIEBankPlatinum result = ((com.hps.july.persistence.PIEBankPlatinumHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5);
                return (PIEBankPlatinum)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEBankPlatinum findByPrimaryKey(PIEBankPlatinumKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEBankPlatinumKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEBankPlatinum) in.read_Object(PIEBankPlatinum.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEBankPlatinumHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEBankPlatinumKey arg0Copy = (PIEBankPlatinumKey) Util.copyObject(arg0,_orb());
                PIEBankPlatinum result = ((com.hps.july.persistence.PIEBankPlatinumHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEBankPlatinum)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findNotWorkedByOwner(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findNotWorkedByOwner", true);
                    ...
                    return findNotWorkedByOwner(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findNotWorkedByOwner",com.hps.july.persistence.PIEBankPlatinumHome.class);
            if (so == null) {
                return findNotWorkedByOwner(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEBankPlatinumHome)so.servant).findNotWorkedByOwner(arg0Copy);
