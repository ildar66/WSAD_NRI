...
public class _EJSRemoteCMPLeaseMutualRuleNewHome_ed76f092_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMutualRuleNewHome_ed76f092 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMutualRuleNewHome_ed76f092) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 31: 
                    if (method.equals("findLeaseMutualRulesByReglament")) {
                        return findLeaseMutualRulesByReglament(in, reply);
                    }
                case 33: 
                    if (method.equals("findLeaseMutualRuleNewsByResource")) {
                        return findLeaseMutualRuleNewsByResource(in, reply);
                    }
                case 52: 
                    if (method.equals("findLeaseMutualRuleNewsByReglamentOrderByResourceAsc")) {
                        return findLeaseMutualRuleNewsByReglamentOrderByResourceAsc(in, reply);
                    }
                case 99: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__boolean__long")) {
                        return create__java_lang_Integer__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__boolean__long(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseMutualRuleNewKey arg0 = (LeaseMutualRuleNewKey) in.read_value(LeaseMutualRuleNewKey.class);
        LeaseMutualRuleNew result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualRuleNewsByReglamentOrderByResourceAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualRuleNewsByReglamentOrderByResourceAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualRuleNewsByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualRuleNewsByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualRulesByReglament(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualRulesByReglament(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__boolean__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
