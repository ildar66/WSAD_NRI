...
public class _EJSRemoteCMPAbonentPaymentHome_a0239318_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAbonentPaymentHome_a0239318 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAbonentPaymentHome_a0239318) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 13: 
                    if (method.equals("findByBANDate")) {
                        return findByBANDate(in, reply);
                    }
                case 15: 
                ...
                case 17: 
                    ...
                    } else if (method.equals("findByFlagWorkNRI")) {
                ...
                case 36: 
                    if (method.equals("findAbonentPaymentsByLeaseabonentban")) {
                        return findAbonentPaymentsByLeaseabonentban(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAbonentPaymentsByLeaseabonentban(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findAbonentPaymentsByLeaseabonentban(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByBANDate(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Enumeration result;
        try {
            result = target.findByBANDate(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByDocumentQBE(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Enumeration result;
        try {
            result = target.findByDocumentQBE(arg0, arg1, arg2, arg3, arg4);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByDocumentQBE2(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Enumeration result;
        try {
            result = target.findByDocumentQBE2(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
