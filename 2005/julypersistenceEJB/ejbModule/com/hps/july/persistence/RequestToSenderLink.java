...
import javax.ejb.*;
import javax.naming.*;
public class RequestToSenderLink extends ManyToSingleLink {
...
public RequestToSenderLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.WorkerKey key = ((com.hps.july.persistence.RequestBean)source).getSenderKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.RequestBean)source).getSenderKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.RequestBean)source).privateSetSenderKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryAddRequestSender((com.hps.july.persistence.Request)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryRemoveRequestSender((com.hps.july.persistence.Request)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.RequestBean)source).privateSetSenderKey((com.hps.july.persistence.WorkerKey)targetEJB.getPrimaryKey());
}
}
