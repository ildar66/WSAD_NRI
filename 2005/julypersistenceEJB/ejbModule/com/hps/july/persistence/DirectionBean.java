 ...
 * Дирекция
 */
public class DirectionBean extends DivisionBean {
 ...
 */
public void ejbCreate(int argDivision, String argName, String argShortName, Integer argCompany ) throws javax.ejb.CreateException, java.rmi.RemoteException {
	super.ejbCreate( argDivision, argName, argShortName, argCompany, 'D' );
	_initLinks();
