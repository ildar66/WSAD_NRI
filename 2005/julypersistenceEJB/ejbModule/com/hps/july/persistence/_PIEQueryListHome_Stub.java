...
public class _PIEQueryListHome_Stub extends Stub implements PIEQueryListHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEQueryListHome:0000000000000000", 
    ...
    public PIEQueryList create(int arg0, int arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEQueryList) in.read_Object(PIEQueryList.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEQueryListHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                PIEQueryList result = ((com.hps.july.persistence.PIEQueryListHome)so.servant).create(arg0, arg1, arg2);
                return (PIEQueryList)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEQueryList findByPrimaryKey(PIEQueryListKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEQueryListKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEQueryList) in.read_Object(PIEQueryList.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEQueryListHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEQueryListKey arg0Copy = (PIEQueryListKey) Util.copyObject(arg0,_orb());
                PIEQueryList result = ((com.hps.july.persistence.PIEQueryListHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEQueryList)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findPIEQueryListsByQuery(PIEQueryKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPIEQueryListsByQuery", true);
                    ...
                    return findPIEQueryListsByQuery(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPIEQueryListsByQuery",com.hps.july.persistence.PIEQueryListHome.class);
            if (so == null) {
                return findPIEQueryListsByQuery(arg0);
            }
            try {
                PIEQueryKey arg0Copy = (PIEQueryKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEQueryListHome)so.servant).findPIEQueryListsByQuery(arg0Copy);
