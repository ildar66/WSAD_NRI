...
public class _EJSRemoteCMPRRLAntParamsHome_f2fc01d9_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPRRLAntParamsHome_f2fc01d9 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPRRLAntParamsHome_f2fc01d9) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findByResourceAndDiam")) {
                        return findByResourceAndDiam(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RRLAntParamsKey arg0 = (RRLAntParamsKey) in.read_value(RRLAntParamsKey.class);
        RRLAntParams result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByResourceAndDiam(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        BigDecimal arg1 = (BigDecimal) in.read_value(BigDecimal.class);
        Enumeration result;
        try {
            result = target.findByResourceAndDiam(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
