...
public class _ChangeLogHome_Stub extends Stub implements ChangeLogHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ChangeLogHome:0000000000000000", 
    ...
    public ChangeLog create(int arg0, Timestamp arg1, short arg2, int arg3, String arg4, int arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.ChangeLogHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg1,arg4},_orb());
                Timestamp arg1Copy = (Timestamp) copies[0];
                String arg4Copy = (String) copies[1];
                ChangeLog result = ((com.hps.july.persistence.ChangeLogHome)so.servant).create(arg0, arg1Copy, arg2, arg3, arg4Copy, arg5);
    ...
    public ChangeLog findByPrimaryKey(ChangeLogKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ChangeLogHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ChangeLogKey arg0Copy = (ChangeLogKey) Util.copyObject(arg0,_orb());
                ChangeLog result = ((com.hps.july.persistence.ChangeLogHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ChangeLog)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByQBE(Boolean arg0, Short arg1, Boolean arg2, Integer arg3, Boolean arg4, Timestamp arg5, Timestamp arg6, Boolean arg7, Integer arg8, Boolean arg9, String arg10, Integer arg11) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg1,Short.class);
            ...
            ServantObject so = _servant_preinvoke("findByQBE",com.hps.july.persistence.ChangeLogHome.class);
            if (so == null) {
                return findByQBE(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.ChangeLogHome)so.servant).findByQBE(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy, arg6Copy, arg7Copy, arg8Copy, arg9Copy, arg10Copy, arg11Copy);
    ...
    public Enumeration findChangeLogsByPeople(PeopleKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findChangeLogsByPeople", true);
                    ...
                    return findChangeLogsByPeople(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findChangeLogsByPeople",com.hps.july.persistence.ChangeLogHome.class);
            if (so == null) {
                return findChangeLogsByPeople(arg0);
            }
            try {
                PeopleKey arg0Copy = (PeopleKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.ChangeLogHome)so.servant).findChangeLogsByPeople(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
