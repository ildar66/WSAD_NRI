...
public class _EJSRemoteCMPContrParamsHome_7788f282_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPContrParamsHome_7788f282 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPContrParamsHome_7788f282) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findContrParamsByContraddinfo")) {
                        return findContrParamsByContraddinfo(in, reply);
                    }
                case 45: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ContrParamsKey arg0 = (ContrParamsKey) in.read_value(ContrParamsKey.class);
        ContrParams result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findContrParamsByContraddinfo(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ContrAddInfoKey arg0 = (ContrAddInfoKey) in.read_value(ContrAddInfoKey.class);
        Enumeration result;
        try {
            result = target.findContrParamsByContraddinfo(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
