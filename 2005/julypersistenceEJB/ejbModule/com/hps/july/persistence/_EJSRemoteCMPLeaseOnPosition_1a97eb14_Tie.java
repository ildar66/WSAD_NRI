...
public class _EJSRemoteCMPLeaseOnPosition_1a97eb14_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseOnPosition_1a97eb14 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseOnPosition_1a97eb14) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 97: 
                    if (method.equals("getLeaseArendaAgreementNew")) {
                        return getLeaseArendaAgreementNew(in, reply);
                    }
                case 101: 
                ...
                case 108: 
                    if (method.equals("_get_leaseArendaAgreementNewKey")) {
                        return _get_leaseArendaAgreementNewKey(in, reply);
                    }
                case 110: 
    ...
    private org.omg.CORBA.portable.OutputStream getLeaseArendaAgreementNew(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseArendaAgreementNew result;
        try {
            result = target.getLeaseArendaAgreementNew();
    ...
    private org.omg.CORBA.portable.OutputStream _get_leaseArendaAgreementNewKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey result = target.getLeaseArendaAgreementNewKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
