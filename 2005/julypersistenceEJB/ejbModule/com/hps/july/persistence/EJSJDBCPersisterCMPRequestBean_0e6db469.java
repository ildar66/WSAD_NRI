...
/**
 * EJSJDBCPersisterCMPRequestBean_0e6db469
 */
public class EJSJDBCPersisterCMPRequestBean_0e6db469 extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderRequestBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	private static final String[] _createString = {"INSERT INTO documents (document, insuranceact, blankdate, blanknumber, parentdocument, operator, isautodoc, blankindex, processsource, showtouser, state, processdestination, insurancedate, insuranceman, to2, needapprove, projectid, prjstatus, visualtype, owner, to, contragent, from, storagemanager, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", "INSERT INTO requests (document, navto, requeststate, divisionrequester, checker, sender, position) VALUES (?, ?, ?, ?, ?, ?, ?)"};
	private static final String[] _removeString = {"DELETE FROM requests  WHERE document = ?", "DELETE FROM documents  WHERE document = ?"};
	private static final String[] _storeString = {"UPDATE requests  SET navto = ?, requeststate = ?, divisionrequester = ?, checker = ?, sender = ?, position = ? WHERE document = ?", "UPDATE documents  SET insuranceact = ?, blankdate = ?, blanknumber = ?, parentdocument = ?, operator = ?, isautodoc = ?, blankindex = ?, processsource = ?, showtouser = ?, state = ?, processdestination = ?, insurancedate = ?, insuranceman = ?, to2 = ?, needapprove = ?, projectid = ?, prjstatus = ?, visualtype = ?, owner = ?, to = ?, contragent = ?, from = ?, storagemanager = ?, type = ? WHERE document = ?"};
	private static final String _loadString = "SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.navto, T2.requeststate, T2.divisionrequester, T2.checker, T2.sender, T2.position FROM requests  T2, documents  T1 WHERE T1.type = \'R\' AND T1.document = T2.document AND T1.document = ?";
	private static final String _loadForUpdateString = _loadString + " FOR UPDATE";
	private byte[] serObj = null;
	/**
	 * EJSJDBCPersisterCMPRequestBean_0e6db469
	 */
	public EJSJDBCPersisterCMPRequestBean_0e6db469() throws java.rmi.RemoteException {
		super();	}
	/**
	 * postInit
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		try {
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.nAvto);
			if (objectTemp == null) {
				pstmt.setNull(2, java.sql.Types.CHAR);
			}
			else {
			...
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.requeststate);
			if (objectTemp == null) {
			...
			if (b.divisionRequester_division == null) {
				pstmt.setNull(4, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(4, b.divisionRequester_division.intValue());
			}
			if (b.checker_worker == null) {
				pstmt.setNull(5, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(5, b.checker_worker.intValue());
			}
			if (b.sender_worker == null) {
				pstmt.setNull(6, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(6, b.sender_worker.intValue());
			}
			if (b.position_storageplace == null) {
				pstmt.setNull(7, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(7, b.position_storageplace.intValue());
			}
			pstmt.setInt(1, b.document);
			pstmt.executeUpdate();
		}
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		...
		b.nAvto = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(26));
		b.requeststate = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(27));
		tempint = resultSet.getInt(28);
		b.divisionRequester_division = resultSet.wasNull() ? null : new Integer(tempint);
		tempint = resultSet.getInt(29);
		b.checker_worker = resultSet.wasNull() ? null : new Integer(tempint);
		tempint = resultSet.getInt(30);
		b.sender_worker = resultSet.wasNull() ? null : new Integer(tempint);
	...
	public void store(EntityBean eb) throws Exception {
		...
		try {
			...
			if (b.divisionRequester_division == null) {
				...
				pstmt.setInt(3, b.divisionRequester_division.intValue());
			}
			if (b.checker_worker == null) {
				pstmt.setNull(4, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(4, b.checker_worker.intValue());
			}
			if (b.sender_worker == null) {
				pstmt.setNull(5, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(5, b.sender_worker.intValue());
			}
			if (b.position_storageplace == null) {
				pstmt.setNull(6, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(6, b.position_storageplace.intValue());
			}
			pstmt.executeUpdate();
		}
		finally {
...
return null;
	 ...
	 */
	public EJSFinder findRequestSenderBySender(com.hps.july.persistence.WorkerKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.navto, T2.requeststate, T2.divisionrequester, T2.checker, T2.sender, T2.position FROM requests  T2, documents  T1 WHERE T1.type = \'R\' AND T1.document = T2.document AND T2.sender = ?");
			Object objectTemp = null;
boolean nullData;
	 ...
	 */
	public EJSFinder findRequestByChecker(com.hps.july.persistence.WorkerKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.navto, T2.requeststate, T2.divisionrequester, T2.checker, T2.sender, T2.position FROM requests  T2, documents  T1 WHERE T1.type = \'R\' AND T1.document = T2.document AND T2.checker = ?");
			Object objectTemp = null;
boolean nullData;
			pstmt.setInt(1, inKey.worker);
			resultSet = pstmt.executeQuery();
	 ...
	 */
	public EJSFinder findRequestByDivisionRequester(com.hps.july.persistence.DivisionKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.navto, T2.requeststate, T2.divisionrequester, T2.checker, T2.sender, T2.position FROM requests  T2, documents  T1 WHERE T1.type = \'R\' AND T1.document = T2.document AND T2.divisionrequester = ?");
			Object objectTemp = null;
boolean nullData;
	...
	public com.hps.july.persistence.Request findByPrimaryKey(com.hps.july.persistence.DocumentKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		com.hps.july.persistence.Request result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DocumentKey _primaryKey = (com.hps.july.persistence.DocumentKey)key;
		try {
			try {
				result = (com.hps.july.persistence.Request)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.Request)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	 ...
	 */
	public EJSFinder findRequestByPosition(com.hps.july.persistence.StoragePlaceKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.navto, T2.requeststate, T2.divisionrequester, T2.checker, T2.sender, T2.position FROM requests  T2, documents  T1 WHERE T1.type = \'R\' AND T1.document = T2.document AND T2.position = ?");
			Object objectTemp = null;
boolean nullData;
	 ...
	 * findByQBE
	 */
	public EJSFinder findByQBE(java.lang.Boolean useDate, java.sql.Date datefrom, java.sql.Date dateto, java.lang.Boolean useDivision, java.lang.Integer division, java.lang.Boolean usePosition, java.lang.Integer position, java.lang.String requestType, java.lang.Boolean useOrganization, java.lang.Integer organization, java.lang.Boolean useWorker, java.lang.Integer worker, java.lang.Boolean hasNoLink) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getFinderObject().findByQBE(useDate, datefrom, dateto, useDivision, division, usePosition, position, requestType, useOrganization, organization, useWorker, worker, hasNoLink);
			resultSet = pstmt.executeQuery();
			return new EJSJDBCFinder(resultSet, this, pstmt);
		}
		catch (Exception ex) {
	...
	private RequestBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.RequestBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.RequestBeanFinderObject temp_finderObject = new com.hps.july.persistence.RequestBeanFinderObject();
