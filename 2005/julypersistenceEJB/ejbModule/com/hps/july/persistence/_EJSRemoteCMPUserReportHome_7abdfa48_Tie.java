...
public class _EJSRemoteCMPUserReportHome_7abdfa48_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPUserReportHome_7abdfa48 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPUserReportHome_7abdfa48) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 25: 
                    if (method.equals("findByGroupOrderByNameAsc")) {
                        return findByGroupOrderByNameAsc(in, reply);
                    }
                case 29: 
                    if (method.equals("findUserReportsByUserRepGroup")) {
                        return findUserReportsByUserRepGroup(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByGroupOrderByNameAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByGroupOrderByNameAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        UserReportKey arg0 = (UserReportKey) in.read_value(UserReportKey.class);
        UserReport result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findUserReportsByUserRepGroup(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        UserRepGroupKey arg0 = (UserRepGroupKey) in.read_value(UserRepGroupKey.class);
        Enumeration result;
        try {
            result = target.findUserReportsByUserRepGroup(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
