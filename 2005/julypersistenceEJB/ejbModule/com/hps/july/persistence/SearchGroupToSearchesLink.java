...
import javax.ejb.*;
import javax.naming.*;
public class SearchGroupToSearchesLink extends SingleToManyLink {
...
public SearchGroupToSearchesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Searches)anEJB).getGroupKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.SearchesHome)getTargetHome(this)).findSearchesByGroup((com.hps.july.persistence.SearchGroupKey)getEntityContext().getPrimaryKey());
	}
