...
public class _EJSRemoteCMPProjectActionTypeHome_c8c0ae31_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectActionTypeHome_c8c0ae31 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectActionTypeHome_c8c0ae31) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 31: 
                    if (method.equals("findByProjecttypeOrderByCodeAsc")) {
                        return findByProjecttypeOrderByCodeAsc(in, reply);
                    }
                case 39: 
                    if (method.equals("findProjectActionTypesByAction2division")) {
                        return findProjectActionTypesByAction2division(in, reply);
                    }
                case 42: 
                    if (method.equals("findProjectActionTypesByResponsibilitytype")) {
                        return findProjectActionTypesByResponsibilitytype(in, reply);
                    }
                case 84: 
                    if (method.equals("create__long__long__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__long")) {
                        return create__long__long__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__long(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findByProjecttypeOrderByCodeAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByProjecttypeOrderByCodeAsc(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionTypesByAction2division(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DivisionKey arg0 = (DivisionKey) in.read_value(DivisionKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionTypesByAction2division(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionTypesByResponsibilitytype(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResponsibilityTypeKey arg0 = (ResponsibilityTypeKey) in.read_value(ResponsibilityTypeKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionTypesByResponsibilitytype(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
