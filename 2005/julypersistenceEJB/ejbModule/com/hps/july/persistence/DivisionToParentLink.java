...
import javax.ejb.*;
import javax.naming.*;
public class DivisionToParentLink extends ManyToSingleLink {
...
public DivisionToParentLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DivisionKey key = ((com.hps.july.persistence.DivisionBean)source).getParentKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.DivisionBean)source).getParentKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.DivisionBean)source).privateSetParentKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryAddChilds((com.hps.july.persistence.Division)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryRemoveChilds((com.hps.july.persistence.Division)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.DivisionBean)source).privateSetParentKey((com.hps.july.persistence.DivisionKey)targetEJB.getPrimaryKey());
}
}
