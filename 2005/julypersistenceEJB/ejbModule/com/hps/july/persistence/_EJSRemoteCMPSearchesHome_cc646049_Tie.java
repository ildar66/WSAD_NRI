...
public class _EJSRemoteCMPSearchesHome_cc646049_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSearchesHome_cc646049 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSearchesHome_cc646049) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findSearchesByGroup")) {
                        return findSearchesByGroup(in, reply);
                    }
                case 23: 
                    if (method.equals("findSearchesByGroupping")) {
                        return findSearchesByGroupping(in, reply);
                    }
                case 24: 
                ...
                case 26: 
                    if (method.equals("findSearchesByOrganization")) {
                        return findSearchesByOrganization(in, reply);
                    }
                case 82: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer")) {
                        return create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SearchesKey arg0 = (SearchesKey) in.read_value(SearchesKey.class);
        Searches result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findSearchesByGroup(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SearchGroupKey arg0 = (SearchGroupKey) in.read_value(SearchGroupKey.class);
        Enumeration result;
        try {
            result = target.findSearchesByGroup(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findSearchesByGroupping(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SearchGrouppingKey arg0 = (SearchGrouppingKey) in.read_value(SearchGrouppingKey.class);
        Enumeration result;
        try {
            result = target.findSearchesByGroupping(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findSearchesByOrganization(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OrganizationKey arg0 = (OrganizationKey) in.read_value(OrganizationKey.class);
        Enumeration result;
        try {
            result = target.findSearchesByOrganization(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
