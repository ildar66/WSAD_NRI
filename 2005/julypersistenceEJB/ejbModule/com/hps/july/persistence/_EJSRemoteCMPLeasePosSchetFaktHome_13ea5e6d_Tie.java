...
public class _EJSRemoteCMPLeasePosSchetFaktHome_13ea5e6d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeasePosSchetFaktHome_13ea5e6d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeasePosSchetFaktHome_13ea5e6d) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 34: 
                    if (method.equals("findLeasePosSchetFaktByResourceNri")) {
                        return findLeasePosSchetFaktByResourceNri(in, reply);
                    }
                case 35: 
                    if (method.equals("findByIdSchetFaktOrderByPosorderAsc")) {
                        return findByIdSchetFaktOrderByPosorderAsc(in, reply);
                    } else if (method.equals("findLeasePosSchetFaktsByIdSchetFakt")) {
                        return findLeasePosSchetFaktsByIdSchetFakt(in, reply);
                    }
                case 36: 
                    if (method.equals("findByIdSchetFaktOrderByPosorderDesc")) {
                        return findByIdSchetFaktOrderByPosorderDesc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByIdSchetFaktOrderByPosorderAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByIdSchetFaktOrderByPosorderAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByIdSchetFaktOrderByPosorderDesc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByIdSchetFaktOrderByPosorderDesc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeasePosSchetFaktKey arg0 = (LeasePosSchetFaktKey) in.read_value(LeasePosSchetFaktKey.class);
        LeasePosSchetFakt result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeasePosSchetFaktByResourceNri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findLeasePosSchetFaktByResourceNri(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeasePosSchetFaktsByIdSchetFakt(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseSchetFaktKey arg0 = (LeaseSchetFaktKey) in.read_value(LeaseSchetFaktKey.class);
        Enumeration result;
        try {
            result = target.findLeasePosSchetFaktsByIdSchetFakt(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
