...
public class _EJSRemoteCMPPIEPayLinkHome_415658e8_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEPayLinkHome_415658e8 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEPayLinkHome_415658e8) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 31: 
                    if (method.equals("findPIEPayLinksByPiepayplatinum")) {
                        return findPIEPayLinksByPiepayplatinum(in, reply);
                    }
                case 38: 
                    if (method.equals("create__CORBA_WStringValue__long__long")) {
                        return create__CORBA_WStringValue__long__long(in, reply);
                    }
                case 52: 
                    if (method.equals("create__CORBA_WStringValue__long__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue__long__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__CORBA_WStringValue__long__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream create__CORBA_WStringValue__long__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        int arg1 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPayLinkKey arg0 = (PIEPayLinkKey) in.read_value(PIEPayLinkKey.class);
        PIEPayLink result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEPayLinksByPiepayplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPayPlatinumKey arg0 = (PIEPayPlatinumKey) in.read_value(PIEPayPlatinumKey.class);
        Enumeration result;
        try {
            result = target.findPIEPayLinksByPiepayplatinum(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
