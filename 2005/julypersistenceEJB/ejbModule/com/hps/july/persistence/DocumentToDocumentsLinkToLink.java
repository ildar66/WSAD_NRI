...
import javax.ejb.*;
import javax.naming.*;
public class DocumentToDocumentsLinkToLink extends SingleToManyLink {
...
public DocumentToDocumentsLinkToLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.DocumentsLink)anEJB).getDocumentToKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.DocumentsLinkHome)getTargetHome(this)).findDocumentsLinkToByDocumentTo((com.hps.july.persistence.DocumentKey)getEntityContext().getPrimaryKey());
	}
