...
public class _SiteDocTypeHome_Stub extends Stub implements SiteDocTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SiteDocTypeHome:0000000000000000", 
    ...
    public SiteDocType create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.SiteDocTypeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                SiteDocType result = ((com.hps.july.persistence.SiteDocTypeHome)so.servant).create(arg0, arg1);
    ...
    public Enumeration findAll() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",com.hps.july.persistence.SiteDocTypeHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.SiteDocTypeHome)so.servant).findAll();
    ...
    public SiteDocType findByPrimaryKey(SiteDocTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SiteDocTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SiteDocTypeKey arg0Copy = (SiteDocTypeKey) Util.copyObject(arg0,_orb());
                SiteDocType result = ((com.hps.july.persistence.SiteDocTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SiteDocType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
