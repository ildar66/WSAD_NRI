...
public class _PIEDopInfoContrHome_Stub extends Stub implements PIEDopInfoContrHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDopInfoContrHome:0000000000000000", 
    ...
    public PIEDopInfoContr create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDopInfoContr) in.read_Object(PIEDopInfoContr.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEDopInfoContrHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                PIEDopInfoContr result = ((com.hps.july.persistence.PIEDopInfoContrHome)so.servant).create(arg0);
                return (PIEDopInfoContr)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEDopInfoContr findByPrimaryKey(PIEDopInfoContrKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEDopInfoContrKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDopInfoContr) in.read_Object(PIEDopInfoContr.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEDopInfoContrHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEDopInfoContrKey arg0Copy = (PIEDopInfoContrKey) Util.copyObject(arg0,_orb());
                PIEDopInfoContr result = ((com.hps.july.persistence.PIEDopInfoContrHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEDopInfoContr)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
