 ...
 * Шапка документа "Внутренний расходный ордер"
 */
public class InternalOutBillBean extends DocumentBean {
...
protected com.ibm.ivj.ejb.associations.interfaces.SingleLink getMonterLink() {
	if (monterLink == null)
		monterLink = new InternalOutBillToMonterLink(this);
	return monterLink;
}
/**
...
protected com.ibm.ivj.ejb.associations.interfaces.SingleLink getPositionLink() {
	if (positionLink == null)
		positionLink = new InternalOutBillToPositionLink(this);
	return positionLink;
}
/**
