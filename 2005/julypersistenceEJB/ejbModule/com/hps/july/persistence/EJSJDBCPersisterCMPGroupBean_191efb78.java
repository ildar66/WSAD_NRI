...
/**
 * EJSJDBCPersisterCMPGroupBean_191efb78
 */
public class EJSJDBCPersisterCMPGroupBean_191efb78 extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderGroupBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	...
	private static final String _loadString = "SELECT T1.division, T1.name, T1.shortname, T1.isactive, T1.boss, T1.company, T1.encloser, T1.type FROM divisions  T1 WHERE T1.type = \'G\' AND T1.division = ?";
	private static final String _loadForUpdateString = _loadString + " FOR UPDATE";
	private byte[] serObj = null;
	/**
	 * EJSJDBCPersisterCMPGroupBean_191efb78
	 */
	public EJSJDBCPersisterCMPGroupBean_191efb78() throws java.rmi.RemoteException {
		super();	}
	/**
	 * postInit
	 */
...
return null;
	...
	public com.hps.july.persistence.Group findByPrimaryKey(com.hps.july.persistence.DivisionKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		com.hps.july.persistence.Group result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DivisionKey _primaryKey = (com.hps.july.persistence.DivisionKey)key;
		try {
			try {
				result = (com.hps.july.persistence.Group)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.Group)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	...
	private static final String genericFindSqlString = "SELECT T1.division, T1.name, T1.shortname, T1.isactive, T1.boss, T1.company, T1.encloser, T1.type FROM divisions  T1 WHERE T1.type = \'G\' AND ";
	...
	private GroupBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.GroupBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.GroupBeanFinderObject temp_finderObject = new com.hps.july.persistence.GroupBeanFinderObject();
