 ...
 **/
public interface RegionAccBeanFinderHelper { 
	public static final String findBySuperregionOrderByCodeAscWhereClause = "regionid IN (SELECT r.regionid " +
		" FROM regions r WHERE r.supregid = ?) ORDER BY accessid ASC";
	public static final String findByOperatorAndIdWhereClause = "operatorid = ? AND regionid = ?";
