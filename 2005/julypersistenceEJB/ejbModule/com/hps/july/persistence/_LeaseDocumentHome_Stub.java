...
public class _LeaseDocumentHome_Stub extends Stub implements LeaseDocumentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseDocumentHome:0000000000000000", 
    ...
    public LeaseDocument create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.LeaseDocumentHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                LeaseDocument result = ((com.hps.july.persistence.LeaseDocumentHome)so.servant).create(arg0);
    ...
    public LeaseDocument create(int arg0, Date arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("create__long__java_sql_Date__CORBA_WStringValue", true);
                    out.write_long(arg0);
            ...
            ServantObject so = _servant_preinvoke("create__long__java_sql_Date__CORBA_WStringValue",com.hps.july.persistence.LeaseDocumentHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                LeaseDocument result = ((com.hps.july.persistence.LeaseDocumentHome)so.servant).create(arg0, arg1Copy, arg2Copy);
                return (LeaseDocument)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public LeaseDocument findByPrimaryKey(LeaseDocumentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeaseDocumentHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseDocumentKey arg0Copy = (LeaseDocumentKey) Util.copyObject(arg0,_orb());
                LeaseDocument result = ((com.hps.july.persistence.LeaseDocumentHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseDocument)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByQBE(Boolean arg0, Date arg1, Boolean arg2, String arg3, Integer arg4) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByQBE",com.hps.july.persistence.LeaseDocumentHome.class);
            if (so == null) {
                return findByQBE(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.LeaseDocumentHome)so.servant).findByQBE(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
