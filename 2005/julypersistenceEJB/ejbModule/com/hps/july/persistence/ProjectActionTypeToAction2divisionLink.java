...
import javax.ejb.*;
import javax.naming.*;
public class ProjectActionTypeToAction2divisionLink extends ManyToSingleLink {
...
public ProjectActionTypeToAction2divisionLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DivisionKey key = ((com.hps.july.persistence.ProjectActionTypeBean)source).getAction2divisionKey();
	try {
		target = ((com.hps.july.persistence.DivisionHome)getTargetHome(this)).findByPrimaryKey(key);
	}
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.ProjectActionTypeBean)source).getAction2divisionKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.ProjectActionTypeBean)source).privateSetAction2divisionKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryAddProjectActionTypes((com.hps.july.persistence.ProjectActionType)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryRemoveProjectActionTypes((com.hps.july.persistence.ProjectActionType)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.ProjectActionTypeBean)source).privateSetAction2divisionKey((com.hps.july.persistence.DivisionKey)targetEJB.getPrimaryKey());
}
}
