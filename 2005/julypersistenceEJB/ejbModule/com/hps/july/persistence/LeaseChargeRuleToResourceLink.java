...
import javax.ejb.*;
import javax.naming.*;
public class LeaseChargeRuleToResourceLink extends ManyToSingleLink {
...
public LeaseChargeRuleToResourceLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.ResourceKey key = ((com.hps.july.persistence.LeaseChargeRuleBean)source).getResourceKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseChargeRuleBean)source).getResourceKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseChargeRuleBean)source).privateSetResourceKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryAddLeaseChargeRule((com.hps.july.persistence.LeaseChargeRule)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryRemoveLeaseChargeRule((com.hps.july.persistence.LeaseChargeRule)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseChargeRuleBean)source).privateSetResourceKey((com.hps.july.persistence.ResourceKey)targetEJB.getPrimaryKey());
}
}
