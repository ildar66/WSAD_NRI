...
public class _PIEDocPosNriHome_Stub extends Stub implements PIEDocPosNriHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDocPosNriHome:0000000000000000", 
    ...
    public PIEDocPosNri create(int arg0, int arg1, int arg2, BigDecimal arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDocPosNri) in.read_Object(PIEDocPosNri.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEDocPosNriHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg3,arg4},_orb());
                BigDecimal arg3Copy = (BigDecimal) copies[0];
                String arg4Copy = (String) copies[1];
                PIEDocPosNri result = ((com.hps.july.persistence.PIEDocPosNriHome)so.servant).create(arg0, arg1, arg2, arg3Copy, arg4Copy);
                return (PIEDocPosNri)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEDocPosNri findByPrimaryKey(PIEDocPosNriKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEDocPosNriKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDocPosNri) in.read_Object(PIEDocPosNri.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEDocPosNriHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEDocPosNriKey arg0Copy = (PIEDocPosNriKey) Util.copyObject(arg0,_orb());
                PIEDocPosNri result = ((com.hps.july.persistence.PIEDocPosNriHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEDocPosNri)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findPIEDocPosNrisByPiedocnri(PIEDocNriKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPIEDocPosNrisByPiedocnri", true);
                    ...
                    return findPIEDocPosNrisByPiedocnri(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPIEDocPosNrisByPiedocnri",com.hps.july.persistence.PIEDocPosNriHome.class);
            if (so == null) {
                return findPIEDocPosNrisByPiedocnri(arg0);
            }
            try {
                PIEDocNriKey arg0Copy = (PIEDocNriKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEDocPosNriHome)so.servant).findPIEDocPosNrisByPiedocnri(arg0Copy);
