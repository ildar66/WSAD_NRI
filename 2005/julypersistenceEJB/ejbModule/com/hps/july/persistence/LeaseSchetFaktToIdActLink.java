...
import javax.ejb.*;
import javax.naming.*;
public class LeaseSchetFaktToIdActLink extends ManyToSingleLink {
...
public LeaseSchetFaktToIdActLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.LeaseDocumentKey key = ((com.hps.july.persistence.LeaseSchetFaktBean)source).getIdActKey();
	try {
		target = ((com.hps.july.persistence.LeaseMutualActNewHome)getTargetHome(this)).findByPrimaryKey(key);
	}
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseSchetFaktBean)source).getIdActKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseSchetFaktBean)source).privateSetIdActKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualActNew)anEJB).secondaryAddLeaseSchetFakts((com.hps.july.persistence.LeaseSchetFakt)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualActNew)anEJB).secondaryRemoveLeaseSchetFakts((com.hps.july.persistence.LeaseSchetFakt)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseSchetFaktBean)source).privateSetIdActKey((com.hps.july.persistence.LeaseDocumentKey)targetEJB.getPrimaryKey());
}
}
