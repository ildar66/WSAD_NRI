...
public class _EJSRemoteCMPProjectDivColValHome_8858482b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectDivColValHome_8858482b target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectDivColValHome_8858482b) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 30: 
                    if (method.equals("findProjectDivColValsByProject")) {
                        return findProjectDivColValsByProject(in, reply);
                    }
                case 39: 
                    if (method.equals("findProjectDivColValsByProjectDivColumn")) {
                        return findProjectDivColValsByProjectDivColumn(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectDivColValKey arg0 = (ProjectDivColValKey) in.read_value(ProjectDivColValKey.class);
        ProjectDivColVal result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findProjectDivColValsByProject(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectKey arg0 = (ProjectKey) in.read_value(ProjectKey.class);
        Enumeration result;
        try {
            result = target.findProjectDivColValsByProject(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectDivColValsByProjectDivColumn(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectDivColumnsKey arg0 = (ProjectDivColumnsKey) in.read_value(ProjectDivColumnsKey.class);
        Enumeration result;
        try {
            result = target.findProjectDivColValsByProjectDivColumn(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
