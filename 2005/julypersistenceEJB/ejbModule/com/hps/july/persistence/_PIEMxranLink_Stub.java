...
public class _PIEMxranLink_Stub extends Stub implements PIEMxranLink {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEMxranLink:0000000000000000", 
    ...
    public int getMxrannri() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_mxrannri", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_mxrannri",com.hps.july.persistence.PIEMxranLink.class);
            if (so == null) {
                return getMxrannri();
            }
            try {
                return ((com.hps.july.persistence.PIEMxranLink)so.servant).getMxrannri();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public PIEMxranPlatinum getMxranplatinum() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("getMxranplatinum", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("getMxranplatinum",com.hps.july.persistence.PIEMxranLink.class);
            if (so == null) {
                return getMxranplatinum();
            }
            try {
                PIEMxranPlatinum result = ((com.hps.july.persistence.PIEMxranLink)so.servant).getMxranplatinum();
    ...
    public PIEMxranPlatinumKey getMxranplatinumKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_mxranplatinumKey", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEMxranPlatinumKey) in.read_value(PIEMxranPlatinumKey.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
                } catch (RemarshalException ex) {
                    return getMxranplatinumKey();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("_get_mxranplatinumKey",com.hps.july.persistence.PIEMxranLink.class);
            if (so == null) {
                return getMxranplatinumKey();
            }
            try {
                PIEMxranPlatinumKey result = ((com.hps.july.persistence.PIEMxranLink)so.servant).getMxranplatinumKey();
                return (PIEMxranPlatinumKey)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
