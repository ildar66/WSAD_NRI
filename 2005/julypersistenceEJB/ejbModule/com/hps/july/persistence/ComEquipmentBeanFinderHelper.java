 ...
 **/
public interface ComEquipmentBeanFinderHelper extends com.hps.july.persistence.EquipmentSetBeanFinderHelper { 
	public java.sql.PreparedStatement findByPositionType(Integer argPosition, String argType, Integer argOrder)
		 throws Exception;
}
