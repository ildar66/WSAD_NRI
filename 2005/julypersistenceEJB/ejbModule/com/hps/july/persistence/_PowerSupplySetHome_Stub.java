...
public class _PowerSupplySetHome_Stub extends Stub implements PowerSupplySetHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PowerSupplySetHome:0000000000000000", 
    ...
    public PowerSupplySet findByPrimaryKey(ResourceSetKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PowerSupplySet) in.read_Object(PowerSupplySet.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PowerSupplySetHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResourceSetKey arg0Copy = (ResourceSetKey) Util.copyObject(arg0,_orb());
                PowerSupplySet result = ((com.hps.july.persistence.PowerSupplySetHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PowerSupplySet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PowerSupplySet create(int arg0, String arg1, Integer arg2, BigDecimal arg3, String arg4, BigDecimal arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PowerSupplySetHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                ...
                PowerSupplySet result = ((com.hps.july.persistence.PowerSupplySetHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
                return (PowerSupplySet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
