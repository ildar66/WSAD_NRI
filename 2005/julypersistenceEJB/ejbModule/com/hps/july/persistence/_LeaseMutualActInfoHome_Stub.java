...
public class _LeaseMutualActInfoHome_Stub extends Stub implements LeaseMutualActInfoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseMutualActInfoHome:0000000000000000", 
    ...
    public LeaseMutualActInfo create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseMutualActInfo) in.read_Object(LeaseMutualActInfo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.LeaseMutualActInfoHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                LeaseMutualActInfo result = ((com.hps.july.persistence.LeaseMutualActInfoHome)so.servant).create(arg0);
                return (LeaseMutualActInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LeaseMutualActInfo findByPrimaryKey(LeaseMutualActInfoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LeaseMutualActInfoKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseMutualActInfo) in.read_Object(LeaseMutualActInfo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeaseMutualActInfoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseMutualActInfoKey arg0Copy = (LeaseMutualActInfoKey) Util.copyObject(arg0,_orb());
                LeaseMutualActInfo result = ((com.hps.july.persistence.LeaseMutualActInfoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseMutualActInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
