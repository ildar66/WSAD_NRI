...
public class _UnitHome_Stub extends Stub implements UnitHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.UnitHome:0000000000000000", 
    ...
    public Unit create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.UnitHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Unit result = ((com.hps.july.persistence.UnitHome)so.servant).create(arg0);
    ...
    public Unit create(int arg0, String arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.UnitHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Unit result = ((com.hps.july.persistence.UnitHome)so.servant).create(arg0, arg1, arg2);
                return (Unit)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAll() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",com.hps.july.persistence.UnitHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.UnitHome)so.servant).findAll();
    ...
    public Unit findByPrimaryKey(UnitKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.UnitHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                UnitKey arg0Copy = (UnitKey) Util.copyObject(arg0,_orb());
                Unit result = ((com.hps.july.persistence.UnitHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Unit)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
