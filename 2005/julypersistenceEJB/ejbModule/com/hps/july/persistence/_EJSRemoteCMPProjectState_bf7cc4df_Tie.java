...
public class _EJSRemoteCMPProjectState_bf7cc4df_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectState_bf7cc4df target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectState_bf7cc4df) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 110: 
                    ...
                    } else if (method.equals("getMan")) {
                        return getMan(in, reply);
                    } else if (method.equals("setMan")) {
    ...
    private org.omg.CORBA.portable.OutputStream _get_projectstate_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getProjectstate();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
