...
import javax.ejb.*;
import javax.naming.*;
public class LeaseMutualRuleNewToReglamentLink extends ManyToSingleLink {
...
public LeaseMutualRuleNewToReglamentLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.LeaseDocumentKey key = ((com.hps.july.persistence.LeaseMutualRuleNewBean)source).getReglamentKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.LeaseMutualRuleNewBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseMutualRuleNewBean)source).getReglamentKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseMutualRuleNewBean)source).privateSetReglamentKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualReglament)anEJB).secondaryAddLeaseMutualRules((com.hps.july.persistence.LeaseMutualRuleNew)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualReglament)anEJB).secondaryRemoveLeaseMutualRules((com.hps.july.persistence.LeaseMutualRuleNew)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseMutualRuleNewBean)source).privateSetReglamentKey((com.hps.july.persistence.LeaseDocumentKey)targetEJB.getPrimaryKey());
}
}
