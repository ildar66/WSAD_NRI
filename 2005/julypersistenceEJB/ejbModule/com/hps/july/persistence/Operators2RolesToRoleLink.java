...
import javax.ejb.*;
import javax.naming.*;
public class Operators2RolesToRoleLink extends ManyToSingleLink {
...
public Operators2RolesToRoleLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.RoleKey key = ((com.hps.july.persistence.Operators2RolesBean)source).getRoleKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.Operators2RolesBean)source).getRoleKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.Operators2RolesBean)source).privateSetRoleKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Role)anEJB).secondaryAddOperators2Roles((com.hps.july.persistence.Operators2Roles)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Role)anEJB).secondaryRemoveOperators2Roles((com.hps.july.persistence.Operators2Roles)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.Operators2RolesBean)source).privateSetRoleKey((com.hps.july.persistence.RoleKey)targetEJB.getPrimaryKey());
}
}
