...
public class _EJSRemoteCMPPIEPayPlatinumHome_fb1fdc8d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEPayPlatinumHome_fb1fdc8d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEPayPlatinumHome_fb1fdc8d) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 207: 
                    if (method.equals("create__CORBA_WStringValue__long__java_math_BigDecimal__java_math_BigDecimal__long__java_math_BigDecimal__java_math_BigDecimal__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__long__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue__long__java_math_BigDecimal__java_math_BigDecimal__long__java_math_BigDecimal__java_math_BigDecimal__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__long__CORBA_WStringValue(in, reply);
                    }
                case 213: 
                    if (method.equals("create__CORBA_WStringValue__long__long__java_math_BigDecimal__java_math_BigDecimal__long__java_math_BigDecimal__java_math_BigDecimal__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__long__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue__long__long__java_math_BigDecimal__java_math_BigDecimal__long__java_math_BigDecimal__java_math_BigDecimal__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__long__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__CORBA_WStringValue__long__long__java_math_BigDecimal__java_math_BigDecimal__long__java_math_BigDecimal__java_math_BigDecimal__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__long__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream create__CORBA_WStringValue__long__java_math_BigDecimal__java_math_BigDecimal__long__java_math_BigDecimal__java_math_BigDecimal__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__long__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        int arg1 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPayPlatinumKey arg0 = (PIEPayPlatinumKey) in.read_value(PIEPayPlatinumKey.class);
        PIEPayPlatinum result;
        try {
