...
import javax.ejb.*;
import javax.naming.*;
public class DocumentPositionToCardToLink extends ManyToSingleLink {
...
public DocumentPositionToCardToLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StorageCardKey key = ((com.hps.july.persistence.DocumentPositionBean)source).getCardToKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.DocumentPositionBean)source).getCardToKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.DocumentPositionBean)source).privateSetCardToKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryAddInDocumentPosition((com.hps.july.persistence.DocumentPosition)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryRemoveInDocumentPosition((com.hps.july.persistence.DocumentPosition)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.DocumentPositionBean)source).privateSetCardToKey((com.hps.july.persistence.StorageCardKey)targetEJB.getPrimaryKey());
}
}
