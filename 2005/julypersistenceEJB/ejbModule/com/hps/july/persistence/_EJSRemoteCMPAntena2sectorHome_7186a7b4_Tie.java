...
public class _EJSRemoteCMPAntena2sectorHome_7186a7b4_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAntena2sectorHome_7186a7b4 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAntena2sectorHome_7186a7b4) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 18: 
                    if (method.equals("create__long__long")) {
                        return create__long__long(in, reply);
                    }
                case 24: 
                ...
                case 26: 
                    if (method.equals("findAntena2sectorsBySector")) {
                        return findAntena2sectorsBySector(in, reply);
                    }
                case 27: 
                    if (method.equals("findAntena2sectorsByAntenna")) {
                        return findAntena2sectorsByAntenna(in, reply);
                    }
                case 37: 
                    if (method.equals("create__long__long__java_lang_Boolean")) {
                        return create__long__long__java_lang_Boolean(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        Antena2sector result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__java_lang_Boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findAntena2sectorsByAntenna(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AntennaKey arg0 = (AntennaKey) in.read_value(AntennaKey.class);
        Enumeration result;
        try {
            result = target.findAntena2sectorsByAntenna(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findAntena2sectorsBySector(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SectorKey arg0 = (SectorKey) in.read_value(SectorKey.class);
        Enumeration result;
        try {
            result = target.findAntena2sectorsBySector(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Antena2sectorKey arg0 = (Antena2sectorKey) in.read_value(Antena2sectorKey.class);
        Antena2sector result;
        try {
