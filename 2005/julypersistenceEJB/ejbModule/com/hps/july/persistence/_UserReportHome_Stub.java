...
public class _UserReportHome_Stub extends Stub implements UserReportHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.UserReportHome:0000000000000000", 
    ...
    public UserReport create(int arg0, Integer arg1, String arg2, String arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (UserReport) in.read_Object(UserReport.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.UserReportHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                UserReport result = ((com.hps.july.persistence.UserReportHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
                return (UserReport)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByGroupOrderByNameAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByGroupOrderByNameAsc", true);
                    ...
                    return findByGroupOrderByNameAsc(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByGroupOrderByNameAsc",com.hps.july.persistence.UserReportHome.class);
            if (so == null) {
                return findByGroupOrderByNameAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.UserReportHome)so.servant).findByGroupOrderByNameAsc(arg0Copy);
    ...
    public UserReport findByPrimaryKey(UserReportKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,UserReportKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (UserReport) in.read_Object(UserReport.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.UserReportHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                UserReportKey arg0Copy = (UserReportKey) Util.copyObject(arg0,_orb());
                UserReport result = ((com.hps.july.persistence.UserReportHome)so.servant).findByPrimaryKey(arg0Copy);
                return (UserReport)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findUserReportsByUserRepGroup(UserRepGroupKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findUserReportsByUserRepGroup", true);
                    ...
                    return findUserReportsByUserRepGroup(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findUserReportsByUserRepGroup",com.hps.july.persistence.UserReportHome.class);
            if (so == null) {
                return findUserReportsByUserRepGroup(arg0);
            }
            try {
                UserRepGroupKey arg0Copy = (UserRepGroupKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.UserReportHome)so.servant).findUserReportsByUserRepGroup(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
