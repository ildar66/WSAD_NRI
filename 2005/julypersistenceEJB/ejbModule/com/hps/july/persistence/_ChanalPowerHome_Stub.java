...
public class _ChanalPowerHome_Stub extends Stub implements ChanalPowerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ChanalPowerHome:0000000000000000", 
    ...
    public ChanalPower create(int arg0, int arg1, String arg2, int arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("create__long__long__CORBA_WStringValue__long", true);
                    out.write_long(arg0);
                    out.write_long(arg1);
                    out.write_value(arg2,String.class);
                    out.write_long(arg3);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ChanalPower) in.read_Object(ChanalPower.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long__long__CORBA_WStringValue__long",com.hps.july.persistence.ChanalPowerHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ChanalPower result = ((com.hps.july.persistence.ChanalPowerHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (ChanalPower)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ChanalPower create(int arg0, int arg1, String arg2, int arg3, int arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__long__long__CORBA_WStringValue__long__long", true);
                    out.write_long(arg0);
                    out.write_long(arg1);
                    out.write_value(arg2,String.class);
                    out.write_long(arg3);
            ...
            ServantObject so = _servant_preinvoke("create__long__long__CORBA_WStringValue__long__long",com.hps.july.persistence.ChanalPowerHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ChanalPower result = ((com.hps.july.persistence.ChanalPowerHome)so.servant).create(arg0, arg1, arg2, arg3, arg4);
                return (ChanalPower)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public ChanalPower findByPrimaryKey(ChanalPowerKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ChanalPowerKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ChanalPower) in.read_Object(ChanalPower.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ChanalPowerHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ChanalPowerKey arg0Copy = (ChanalPowerKey) Util.copyObject(arg0,_orb());
                ChanalPower result = ((com.hps.july.persistence.ChanalPowerHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ChanalPower)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findChanalPowersByBasestation(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findChanalPowersByBasestation", true);
                    ...
                    return findChanalPowersByBasestation(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findChanalPowersByBasestation",com.hps.july.persistence.ChanalPowerHome.class);
            if (so == null) {
                return findChanalPowersByBasestation(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.ChanalPowerHome)so.servant).findChanalPowersByBasestation(arg0Copy);
