 ...
 */
public class DivisionBeanFinderObject extends com.ibm.vap.finders.VapEJSJDBCFinderObject  implements DivisionBeanFinderHelper{
/**
...
public PreparedStatement findByParent( Integer argEncloser, int order ) throws Exception {
    ...
    for (i = 0; i < genericFindInsertPoints.length; i++) {
		sb.insert(genericFindInsertPoints[i], " encloser = ? and isactive = 'Y'	" );
    }
 ...
 * @return java.sql.PreparedStatement
 */
public PreparedStatement findByParentCompany( Integer parent, Integer company,
Boolean isRoot, Integer order ) throws Exception {
    ...
    //calculate where clause
	StringBuffer whereClause = new StringBuffer( " company = ? " );
	if( isRoot.booleanValue() )
		whereClause.append( " and encloser is null " );
	else
		whereClause.append( " and encloser = ? " );
