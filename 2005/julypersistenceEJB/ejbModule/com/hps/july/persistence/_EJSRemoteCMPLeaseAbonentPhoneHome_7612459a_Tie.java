...
public class _EJSRemoteCMPLeaseAbonentPhoneHome_7612459a_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseAbonentPhoneHome_7612459a target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseAbonentPhoneHome_7612459a) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 33: 
                    if (method.equals("findLeaseAbonentPhonesByPhone2ban")) {
                        return findLeaseAbonentPhonesByPhone2ban(in, reply);
                    }
                case 40: 
                    if (method.equals("findByLeaseDocumentOrderByPhoneNumberAsc")) {
                        return findByLeaseDocumentOrderByPhoneNumberAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByLeaseDocumentOrderByPhoneNumberAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByLeaseDocumentOrderByPhoneNumberAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseAbonentPhoneKey arg0 = (LeaseAbonentPhoneKey) in.read_value(LeaseAbonentPhoneKey.class);
        LeaseAbonentPhone result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseAbonentPhonesByPhone2ban(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseAbonentPhonesByPhone2ban(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
