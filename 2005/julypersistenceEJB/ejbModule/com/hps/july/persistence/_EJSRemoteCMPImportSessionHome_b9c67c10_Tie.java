...
public class _EJSRemoteCMPImportSessionHome_b9c67c10_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPImportSessionHome_b9c67c10 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPImportSessionHome_b9c67c10) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 28: 
                    if (method.equals("findImportSessionsByOperator")) {
                        return findImportSessionsByOperator(in, reply);
                    }
                case 30: 
                    if (method.equals("findImportSessionsByImporttask")) {
                        return findImportSessionsByImporttask(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findImportSessionsByImporttask(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ImportTaskKey arg0 = (ImportTaskKey) in.read_value(ImportTaskKey.class);
        Enumeration result;
        try {
            result = target.findImportSessionsByImporttask(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findImportSessionsByOperator(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OperatorKey arg0 = (OperatorKey) in.read_value(OperatorKey.class);
        Enumeration result;
        try {
            result = target.findImportSessionsByOperator(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
