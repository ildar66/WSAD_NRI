...
public class _EJSRemoteCMPSiteDocFileBLOB_29f7bad5_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSiteDocFileBLOB_29f7bad5 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SiteDocFileBLOB:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSiteDocFileBLOB_29f7bad5) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 16: 
                    if (method.equals("_get_sitedocfile")) {
                        return _get_sitedocfile(in, reply);
                    }
                case 20: 
                    if (method.equals("_get_sitedocfilebody")) {
                        return _get_sitedocfilebody(in, reply);
                    } else if (method.equals("_set_sitedocfilebody")) {
                        return _set_sitedocfilebody(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_sitedocfile(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream _get_sitedocfilebody(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] result = target.getSitedocfilebody();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_sitedocfilebody(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] arg0 = (byte[]) in.read_value(byte[].class);
        target.setSitedocfilebody(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
