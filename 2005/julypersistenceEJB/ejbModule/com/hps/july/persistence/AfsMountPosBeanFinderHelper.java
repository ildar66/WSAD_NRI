 ...
 **/
public interface AfsMountPosBeanFinderHelper extends com.hps.july.persistence.InternalWayBillPositionBeanFinderHelper {

	public static final String findChildByParentWhereClause = " parentdocpos = ? ";
	public static final String findChildrenByParentWhereClause = " parentdocpos = ? ";
	public static final String findByAfsWhereClause = " document = ? and parentdocpos is null ";
