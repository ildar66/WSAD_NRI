...
import javax.ejb.*;
import javax.naming.*;
public class PIEOtvUserPlatinumToPIEOtvUserLinksLink extends SingleToManyLink {
	private static PIEOtvUserLinkHome targetHome = null;
	private final static java.lang.String targetHomeName = "PIEOtvUserLink";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public PIEOtvUserPlatinumToPIEOtvUserLinksLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.PIEOtvUserLink)targetEJB).privateSetOtvuserplatinumKey((com.hps.july.persistence.PIEOtvUserPlatinumKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.PIEOtvUserLink)anEJB).getOtvuserplatinumKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.PIEOtvUserLinkHome)getTargetHome(this)).findPIEOtvUserLinksByOtvuserplatinum((com.hps.july.persistence.PIEOtvUserPlatinumKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.PIEOtvUserPlatinumBean)source).getEntityContext();
}
/**
 * Get the target home for the link.
 * @return com.hps.july.persistence.PIEOtvUserLinkHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized PIEOtvUserLinkHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.PIEOtvUserLinkHome)lookupTargetHome(homeName, com.hps.july.persistence.PIEOtvUserLinkHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.PIEOtvUserLink.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.PIEOtvUserLink)anEJB).secondarySetOtvuserplatinum((com.hps.july.persistence.PIEOtvUserPlatinum)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.PIEOtvUserLink)anEJB).secondarySetOtvuserplatinum(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.PIEOtvUserLink)anEJB).setOtvuserplatinum(null);
}
}
