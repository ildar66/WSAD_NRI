...
import javax.ejb.*;
import javax.naming.*;
public class LeaseTaskStartToStart2journalLink extends SingleToManyLink {
	private static LeaseTaskJournalHome targetHome = null;
	private final static java.lang.String targetHomeName = "LeaseTaskJournal";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public LeaseTaskStartToStart2journalLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.LeaseTaskJournal)targetEJB).privateSetJournal2startKey((com.hps.july.persistence.LeaseTaskStartKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseTaskJournal)anEJB).getJournal2startKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseTaskJournalHome)getTargetHome(this)).findStart2journalByJournal2start((com.hps.july.persistence.LeaseTaskStartKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.LeaseTaskStartBean)source).getEntityContext();
}
/**
 * Get the target home for the link.
 * @return com.hps.july.persistence.LeaseTaskJournalHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized LeaseTaskJournalHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.LeaseTaskJournalHome)lookupTargetHome(homeName, com.hps.july.persistence.LeaseTaskJournalHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.LeaseTaskJournal.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseTaskJournal)anEJB).secondarySetJournal2start((com.hps.july.persistence.LeaseTaskStart)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseTaskJournal)anEJB).secondarySetJournal2start(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseTaskJournal)anEJB).setJournal2start(null);
}
}
