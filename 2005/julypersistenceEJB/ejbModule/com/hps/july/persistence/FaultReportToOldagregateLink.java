...
import javax.ejb.*;
import javax.naming.*;
public class FaultReportToOldagregateLink extends ManyToSingleLink {
...
public FaultReportToOldagregateLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StorageCardKey key = ((com.hps.july.persistence.FaultReportBean)source).getOldagregateKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.FaultReportBean)source).getOldagregateKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.FaultReportBean)source).privateSetOldagregateKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryAddFaultReports1((com.hps.july.persistence.FaultReport)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryRemoveFaultReports1((com.hps.july.persistence.FaultReport)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.FaultReportBean)source).privateSetOldagregateKey((com.hps.july.persistence.StorageCardKey)targetEJB.getPrimaryKey());
}
}
