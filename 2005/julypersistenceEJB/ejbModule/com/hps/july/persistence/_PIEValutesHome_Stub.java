...
public class _PIEValutesHome_Stub extends Stub implements PIEValutesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEValutesHome:0000000000000000", 
    ...
    public PIEValutes create(String arg0, String arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEValutes) in.read_Object(PIEValutes.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEValutesHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                PIEValutes result = ((com.hps.july.persistence.PIEValutesHome)so.servant).create(arg0, arg1, arg2);
                return (PIEValutes)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.PIEValutesHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.PIEValutesHome)so.servant).findAllOrderByNameAsc();
    ...
    public Enumeration findByidvalutenriOrderByCodeAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByidvalutenriOrderByCodeAsc", true);
                    ...
                    return findByidvalutenriOrderByCodeAsc(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByidvalutenriOrderByCodeAsc",com.hps.july.persistence.PIEValutesHome.class);
            if (so == null) {
                return findByidvalutenriOrderByCodeAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEValutesHome)so.servant).findByidvalutenriOrderByCodeAsc(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public PIEValutes findByPrimaryKey(PIEValutesKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEValutesKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEValutes) in.read_Object(PIEValutes.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEValutesHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEValutesKey arg0Copy = (PIEValutesKey) Util.copyObject(arg0,_orb());
                PIEValutes result = ((com.hps.july.persistence.PIEValutesHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEValutes)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
