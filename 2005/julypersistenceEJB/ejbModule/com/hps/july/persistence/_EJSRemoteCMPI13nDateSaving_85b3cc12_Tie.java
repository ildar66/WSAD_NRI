...
public class _EJSRemoteCMPI13nDateSaving_85b3cc12_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPI13nDateSaving_85b3cc12 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPI13nDateSaving_85b3cc12) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 15: 
                    ...
                    } else if (method.equals("_get_I13nActKey")) {
                        return _get_I13nActKey(in, reply);
                    }
                case 16: 
                    if (method.equals("_get_oldI13nDate")) {
                        return _get_oldI13nDate(in, reply);
                    } else if (method.equals("_set_oldI13nDate")) {
                        return _set_oldI13nDate(in, reply);
                    }
                case 19: 
                    if (method.equals("_get_storageCardKey")) {
                        return _get_storageCardKey(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_I13nActKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DocumentKey result = target.getI13nActKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_oldI13nDate(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Date result = target.getOldI13nDate();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_storageCardKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCardKey result = target.getStorageCardKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_oldI13nDate(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Date arg0 = (Date) in.read_value(Date.class);
        target.setOldI13nDate(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
