...
import javax.ejb.*;
import javax.naming.*;
public class AntennaToAntena2sectorsLink extends SingleToManyLink {
	private static Antena2sectorHome targetHome = null;
	private final static java.lang.String targetHomeName = "Antena2sector";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public AntennaToAntena2sectorsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Antena2sector)anEJB).getAntennaKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.Antena2sectorHome)getTargetHome(this)).findAntena2sectorsByAntenna((com.hps.july.persistence.AntennaKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.hps.july.persistence.Antena2sectorHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized Antena2sectorHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.Antena2sectorHome)lookupTargetHome(homeName, com.hps.july.persistence.Antena2sectorHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.Antena2sector.class);
}
/**
