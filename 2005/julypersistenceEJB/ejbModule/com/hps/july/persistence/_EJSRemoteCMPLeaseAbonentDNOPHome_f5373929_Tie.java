...
public class _EJSRemoteCMPLeaseAbonentDNOPHome_f5373929_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseAbonentDNOPHome_f5373929 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseAbonentDNOPHome_f5373929) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 12: 
                    if (method.equals("findByPayPos")) {
                        return findByPayPos(in, reply);
                    }
                case 15: 
                ...
                case 21: 
                    if (method.equals("findByPayPosLeaseBill")) {
                        return findByPayPosLeaseBill(in, reply);
                    }
                case 24: 
                ...
                case 34: 
                    if (method.equals("findLeaseAbonentDNOPsByAbonentbill")) {
                        return findLeaseAbonentDNOPsByAbonentbill(in, reply);
                    }
                case 37: 
                    if (method.equals("findLeaseAbonentDNOPsByAbonentpayment")) {
                        return findLeaseAbonentDNOPsByAbonentpayment(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPayPos(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByPayPos(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPayPosLeaseBill(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByPayPosLeaseBill(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseAbonentDNOPKey arg0 = (LeaseAbonentDNOPKey) in.read_value(LeaseAbonentDNOPKey.class);
        LeaseAbonentDNOP result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseAbonentDNOPsByAbonentbill(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AbonentBillKey arg0 = (AbonentBillKey) in.read_value(AbonentBillKey.class);
        Enumeration result;
        try {
            result = target.findLeaseAbonentDNOPsByAbonentbill(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseAbonentDNOPsByAbonentpayment(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AbonentPaymentKey arg0 = (AbonentPaymentKey) in.read_value(AbonentPaymentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseAbonentDNOPsByAbonentpayment(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
