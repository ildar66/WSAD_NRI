...
public class _EJSRemoteCMPLeaseMutualRuleNew_ed76f092_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMutualRuleNew_ed76f092 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMutualRuleNew_ed76f092) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 12: 
                    ...
                    } else if (method.equals("getReglament")) {
                        return getReglament(in, reply);
                    }
                case 13: 
                    if (method.equals("_get_rateType")) {
                        return _get_rateType(in, reply);
                    } else if (method.equals("_set_rateType")) {
                        return _set_rateType(in, reply);
                ...
                case 16: 
                    if (method.equals("_get_paydaterule")) {
                        return _get_paydaterule(in, reply);
                    } else if (method.equals("_get_resourceKey")) {
                        return _get_resourceKey(in, reply);
                    } else if (method.equals("_set_paydaterule")) {
                        return _set_paydaterule(in, reply);
                    }
                case 17: 
                ...
                case 19: 
                    ...
                    } else if (method.equals("_get_dopchargdatrul")) {
                        return _get_dopchargdatrul(in, reply);
                    } else if (method.equals("_set_chargedaterule")) {
                        return _set_chargedaterule(in, reply);
                    } else if (method.equals("_set_dopchargdatrul")) {
                        return _set_dopchargdatrul(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_dopchargdatrul(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        boolean result = target.getDopchargdatrul();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_boolean(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _get_paydaterule(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getPaydaterule();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,String.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream _set_dopchargdatrul(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        boolean arg0 = in.read_boolean();
        target.setDopchargdatrul(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _set_paydaterule(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setPaydaterule(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _get_rateType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer result = target.getRateType();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_rateType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
