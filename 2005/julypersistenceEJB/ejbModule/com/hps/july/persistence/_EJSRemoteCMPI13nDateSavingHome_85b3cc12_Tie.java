...
public class _EJSRemoteCMPI13nDateSavingHome_85b3cc12_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPI13nDateSavingHome_85b3cc12 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPI13nDateSavingHome_85b3cc12) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 27: 
                    if (method.equals("findI13nDateSavingByI13nAct")) {
                        return findI13nDateSavingByI13nAct(in, reply);
                    }
                case 31: 
                    if (method.equals("findI13nDateSavingByStorageCard")) {
                        return findI13nDateSavingByStorageCard(in, reply);
                    }
                case 59: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__java_sql_Date")) {
                        return create__java_lang_Integer__java_lang_Integer__java_sql_Date(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__java_sql_Date(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        I13nDateSavingKey arg0 = (I13nDateSavingKey) in.read_value(I13nDateSavingKey.class);
        I13nDateSaving result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findI13nDateSavingByI13nAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DocumentKey arg0 = (DocumentKey) in.read_value(DocumentKey.class);
        Enumeration result;
        try {
            result = target.findI13nDateSavingByI13nAct(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findI13nDateSavingByStorageCard(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCardKey arg0 = (StorageCardKey) in.read_value(StorageCardKey.class);
        Enumeration result;
        try {
            result = target.findI13nDateSavingByStorageCard(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
