...
import javax.ejb.*;
import javax.naming.*;
public class PositionResponsibleWorkersToWorkerLink extends ManyToSingleLink {
...
public PositionResponsibleWorkersToWorkerLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.WorkerKey key = ((com.hps.july.persistence.PositionResponsibleWorkersBean)source).getWorkerKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.PositionResponsibleWorkersBean)source).getWorkerKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.PositionResponsibleWorkersBean)source).privateSetWorkerKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryAddPositionResponsibleWorkers((com.hps.july.persistence.PositionResponsibleWorkers)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryRemovePositionResponsibleWorkers((com.hps.july.persistence.PositionResponsibleWorkers)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.PositionResponsibleWorkersBean)source).privateSetWorkerKey((com.hps.july.persistence.WorkerKey)targetEJB.getPrimaryKey());
}
}
