...
public class _EJSRemoteCMPLeaseMRCntPriorHome_5e3fe006_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMRCntPriorHome_5e3fe006 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMRCntPriorHome_5e3fe006) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 31: 
                    if (method.equals("findLeaseMRCntPriorsByReglament")) {
                        return findLeaseMRCntPriorsByReglament(in, reply);
                    }
                case 32: 
                    if (method.equals("findLeaseMRCntPriors1ByContract1")) {
                        return findLeaseMRCntPriors1ByContract1(in, reply);
                    } else if (method.equals("findLeaseMRCntPriors2ByContract2")) {
                        return findLeaseMRCntPriors2ByContract2(in, reply);
                    }
                case 41: 
                    if (method.equals("findByReglamentContractOrderbyPriorityAsc")) {
                        return findByReglamentContractOrderbyPriorityAsc(in, reply);
                    }
                case 80: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Short")) {
                        return create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Short(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Short(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Short arg3 = (Short) in.read_value(Short.class);
        LeaseMRCntPrior result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseMRCntPriorKey arg0 = (LeaseMRCntPriorKey) in.read_value(LeaseMRCntPriorKey.class);
        LeaseMRCntPrior result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByReglamentContractOrderbyPriorityAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Integer arg2 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByReglamentContractOrderbyPriorityAsc(arg0, arg1, arg2);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMRCntPriors1ByContract1(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMRCntPriors1ByContract1(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMRCntPriors2ByContract2(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMRCntPriors2ByContract2(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMRCntPriorsByReglament(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMRCntPriorsByReglament(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
