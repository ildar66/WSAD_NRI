...
public class _DopInfoLPaymentHome_Stub extends Stub implements DopInfoLPaymentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.DopInfoLPaymentHome:0000000000000000", 
    ...
    public DopInfoLPayment create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DopInfoLPayment) in.read_Object(DopInfoLPayment.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.DopInfoLPaymentHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                DopInfoLPayment result = ((com.hps.july.persistence.DopInfoLPaymentHome)so.servant).create(arg0);
                return (DopInfoLPayment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public DopInfoLPayment findByPrimaryKey(DopInfoLPaymentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,DopInfoLPaymentKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DopInfoLPayment) in.read_Object(DopInfoLPayment.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.DopInfoLPaymentHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                DopInfoLPaymentKey arg0Copy = (DopInfoLPaymentKey) Util.copyObject(arg0,_orb());
                DopInfoLPayment result = ((com.hps.july.persistence.DopInfoLPaymentHome)so.servant).findByPrimaryKey(arg0Copy);
                return (DopInfoLPayment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
