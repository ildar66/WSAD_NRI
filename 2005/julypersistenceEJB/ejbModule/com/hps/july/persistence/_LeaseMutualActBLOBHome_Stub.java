...
public class _LeaseMutualActBLOBHome_Stub extends Stub implements LeaseMutualActBLOBHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseMutualActBLOBHome:0000000000000000", 
    ...
    public LeaseMutualActBLOB create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseMutualActBLOB) in.read_Object(LeaseMutualActBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.LeaseMutualActBLOBHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                LeaseMutualActBLOB result = ((com.hps.july.persistence.LeaseMutualActBLOBHome)so.servant).create(arg0);
                return (LeaseMutualActBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LeaseMutualActBLOB findByPrimaryKey(LeaseMutualActBLOBKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LeaseMutualActBLOBKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseMutualActBLOB) in.read_Object(LeaseMutualActBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeaseMutualActBLOBHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseMutualActBLOBKey arg0Copy = (LeaseMutualActBLOBKey) Util.copyObject(arg0,_orb());
                LeaseMutualActBLOB result = ((com.hps.july.persistence.LeaseMutualActBLOBHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseMutualActBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
