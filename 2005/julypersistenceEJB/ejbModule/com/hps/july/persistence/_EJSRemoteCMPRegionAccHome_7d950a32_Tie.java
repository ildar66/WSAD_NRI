...
public class _EJSRemoteCMPRegionAccHome_7d950a32_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPRegionAccHome_7d950a32 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPRegionAccHome_7d950a32) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findRegionAccsByRegion")) {
                        return findRegionAccsByRegion(in, reply);
                    }
                case 24: 
                    ...
                    } else if (method.equals("findRegionAccsByOperator")) {
                        return findRegionAccsByOperator(in, reply);
                    }
                case 31: 
                    if (method.equals("findBySuperregionOrderByCodeAsc")) {
                        return findBySuperregionOrderByCodeAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RegionAccKey arg0 = (RegionAccKey) in.read_value(RegionAccKey.class);
        RegionAcc result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findBySuperregionOrderByCodeAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findBySuperregionOrderByCodeAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findRegionAccsByOperator(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OperatorKey arg0 = (OperatorKey) in.read_value(OperatorKey.class);
        Enumeration result;
        try {
            result = target.findRegionAccsByOperator(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findRegionAccsByRegion(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RegionKey arg0 = (RegionKey) in.read_value(RegionKey.class);
        Enumeration result;
        try {
            result = target.findRegionAccsByRegion(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
