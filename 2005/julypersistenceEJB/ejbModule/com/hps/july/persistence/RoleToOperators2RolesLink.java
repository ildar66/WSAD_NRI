...
import javax.ejb.*;
import javax.naming.*;
public class RoleToOperators2RolesLink extends SingleToManyLink {
...
public RoleToOperators2RolesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Operators2Roles)anEJB).getRoleKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.Operators2RolesHome)getTargetHome(this)).findOperators2RolesByRole((com.hps.july.persistence.RoleKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.RoleBean)source).getEntityContext();
}
/**
