...
public class _EJSRemoteCMPPIEDocInfoDocPos_e77ba69e_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEDocInfoDocPos_e77ba69e target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDocInfoDocPos:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEDocInfoDocPos_e77ba69e) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 102: 
                    if (method.equals("_get_flagfulllink")) {
                        return _get_flagfulllink(in, reply);
                    } else if (method.equals("_set_flagfulllink")) {
                        return _set_flagfulllink(in, reply);
                    }
                case 104: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_flagfulllink(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Boolean result = target.getFlagfulllink();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_flagfulllink(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Boolean arg0 = (Boolean) in.read_value(Boolean.class);
        target.setFlagfulllink(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
