...
public class _EJSRemoteCMPAgregateContent_d4664c44_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAgregateContent_d4664c44 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAgregateContent_d4664c44) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 112: 
                    ...
                    } else if (method.equals("_get_partsKey")) {
                        return _get_partsKey(in, reply);
                    }
                case 113: 
                ...
                case 114: 
                    ...
                    } else if (method.equals("getParts")) {
                        return getParts(in, reply);
                    } else if (method.equals("setAgregate")) {
                        return setAgregate(in, reply);
                    } else if (method.equals("setParts")) {
                        return setParts(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream getParts(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCard result;
        try {
            result = target.getParts();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_partsKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCardKey result = target.getPartsKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,StorageCardKey.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream setParts(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCard arg0 = (StorageCard) in.read_Object(StorageCard.class);
        target.setParts(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
