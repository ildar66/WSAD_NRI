...
public class _StoragePlaceHome_Stub extends Stub implements StoragePlaceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.StoragePlaceHome:0000000000000000", 
    ...
    public StoragePlace create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.StoragePlaceHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                StoragePlace result = ((com.hps.july.persistence.StoragePlaceHome)so.servant).create(arg0);
    ...
    public StoragePlace create(int arg0, Integer arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.StoragePlaceHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                StoragePlace result = ((com.hps.july.persistence.StoragePlaceHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
                return (StoragePlace)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public StoragePlace create(int arg0, String arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.StoragePlaceHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                StoragePlace result = ((com.hps.july.persistence.StoragePlaceHome)so.servant).create(arg0, arg1, arg2);
                return (StoragePlace)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.StoragePlaceHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.StoragePlaceHome)so.servant).findAllOrderByNameAsc();
    ...
    public StoragePlace findByPrimaryKey(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.StoragePlaceHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                StoragePlace result = ((com.hps.july.persistence.StoragePlaceHome)so.servant).findByPrimaryKey(arg0Copy);
                return (StoragePlace)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findStoragePlaceByDivision(DivisionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findStoragePlaceByDivision", true);
                    ...
                    return findStoragePlaceByDivision(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findStoragePlaceByDivision",com.hps.july.persistence.StoragePlaceHome.class);
            if (so == null) {
                return findStoragePlaceByDivision(arg0);
            }
            try {
                DivisionKey arg0Copy = (DivisionKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.StoragePlaceHome)so.servant).findStoragePlaceByDivision(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
