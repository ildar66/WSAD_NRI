...
public class EJSJDBCPersisterCMPContractPositionBean_d1d2b2d1 extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderContractPositionBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	...
	public void _create(EntityBean eb) throws Exception {
		...
		ContractPositionBean b = (ContractPositionBean) eb;
		...
		try {
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.contractPositionOrder);
			if (objectTemp == null) {
				pstmt.setNull(2, java.sql.Types.CHAR);
			}
			else {
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		...
		b.contractPositionOrder = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(39));
...
return null;
	...
	public com.hps.july.persistence.ContractPosition findByPrimaryKey(com.hps.july.persistence.DocumentPositionKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		...
		com.hps.july.persistence.ContractPosition result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DocumentPositionKey _primaryKey = (com.hps.july.persistence.DocumentPositionKey)key;
		try {
			try {
				result = (com.hps.july.persistence.ContractPosition)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.ContractPosition)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	 ...
	 */
	public EJSFinder findByDocOrderByContractPositionOrderAsc(java.lang.Integer argDocument) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getFinderObject().findByDocOrderByContractPositionOrderAsc(argDocument);
			resultSet = pstmt.executeQuery();
	...
	private static final int[] genericFindInsertPoints = {715};
	/**
	...
	private ContractPositionBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.ContractPositionBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.ContractPositionBeanFinderObject temp_finderObject = new com.hps.july.persistence.ContractPositionBeanFinderObject();
