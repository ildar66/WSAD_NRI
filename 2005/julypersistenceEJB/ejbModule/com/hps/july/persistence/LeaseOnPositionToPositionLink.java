...
import javax.ejb.*;
import javax.naming.*;
public class LeaseOnPositionToPositionLink extends ManyToSingleLink {
...
public LeaseOnPositionToPositionLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StoragePlaceKey key = ((com.hps.july.persistence.LeaseOnPositionBean)source).getPositionKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseOnPositionBean)source).getPositionKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseOnPositionBean)source).privateSetPositionKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Position)anEJB).secondaryAddLeaseOnPosition((com.hps.july.persistence.LeaseOnPosition)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Position)anEJB).secondaryRemoveLeaseOnPosition((com.hps.july.persistence.LeaseOnPosition)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseOnPositionBean)source).privateSetPositionKey((com.hps.july.persistence.StoragePlaceKey)targetEJB.getPrimaryKey());
}
}
