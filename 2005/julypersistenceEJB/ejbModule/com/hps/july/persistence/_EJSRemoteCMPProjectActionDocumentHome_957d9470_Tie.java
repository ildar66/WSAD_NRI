...
public class _EJSRemoteCMPProjectActionDocumentHome_957d9470_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectActionDocumentHome_957d9470 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectActionDocumentHome_957d9470) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 41: 
                    if (method.equals("findProjectActionDocumentsByProjectaction")) {
                        return findProjectActionDocumentsByProjectaction(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectActionDocumentKey arg0 = (ProjectActionDocumentKey) in.read_value(ProjectActionDocumentKey.class);
        ProjectActionDocument result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionDocumentsByProjectaction(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectActionKey arg0 = (ProjectActionKey) in.read_value(ProjectActionKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionDocumentsByProjectaction(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
