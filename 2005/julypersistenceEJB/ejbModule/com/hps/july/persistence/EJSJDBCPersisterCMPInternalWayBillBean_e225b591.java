...
/**
 * EJSJDBCPersisterCMPInternalWayBillBean_e225b591
 */
public class EJSJDBCPersisterCMPInternalWayBillBean_e225b591 extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderInternalWayBillBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	private static final String[] _createString = {"INSERT INTO documents (document, insuranceact, blankdate, blanknumber, parentdocument, operator, isautodoc, blankindex, processsource, showtouser, state, processdestination, insurancedate, insuranceman, to2, needapprove, projectid, prjstatus, visualtype, owner, to, contragent, from, storagemanager, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", "INSERT INTO internalwaybills (document, fixing, equiptype, position, monter) VALUES (?, ?, ?, ?, ?)"};
	private static final String[] _removeString = {"DELETE FROM internalwaybills  WHERE document = ?", "DELETE FROM documents  WHERE document = ?"};
	private static final String[] _storeString = {"UPDATE internalwaybills  SET fixing = ?, equiptype = ?, position = ?, monter = ? WHERE document = ?", "UPDATE documents  SET insuranceact = ?, blankdate = ?, blanknumber = ?, parentdocument = ?, operator = ?, isautodoc = ?, blankindex = ?, processsource = ?, showtouser = ?, state = ?, processdestination = ?, insurancedate = ?, insuranceman = ?, to2 = ?, needapprove = ?, projectid = ?, prjstatus = ?, visualtype = ?, owner = ?, to = ?, contragent = ?, from = ?, storagemanager = ?, type = ? WHERE document = ?"};
	private static final String _loadString = "(SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, CAST(NULL AS CHAR(1)) FROM documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T2.type = \'T\' AND T2.document = ?)  UNION ALL (SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, T1.afstype FROM afsmountact  T1, documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T3.document = T1.document AND T2.type = \'B\' AND T2.document = ?) ";
	private static final String _loadForUpdateString = _loadString + " FOR UPDATE";
	private byte[] serObj = null;
	/**
	 * EJSJDBCPersisterCMPInternalWayBillBean_e225b591
	 */
	public EJSJDBCPersisterCMPInternalWayBillBean_e225b591() throws java.rmi.RemoteException {
		super();	}
	/**
	 * postInit
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		InternalWayBillBean b = (InternalWayBillBean) eb;
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		...
		b.equiptype = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(27));
...
return null;
	 ...
	 */
	public EJSFinder findInternalWayBillByPosition(com.hps.july.persistence.StoragePlaceKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("(SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, CAST(NULL AS CHAR(1)) FROM documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T2.type = \'T\' AND T3.position = ?)  UNION ALL (SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, T1.afstype FROM afsmountact  T1, documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T3.document = T1.document AND T2.type = \'B\' AND T3.position = ?) ");
			Object objectTemp = null;
boolean nullData;
	 ...
	 */
	public EJSFinder findInternalWayBillByMonter(com.hps.july.persistence.WorkerKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("(SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, CAST(NULL AS CHAR(1)) FROM documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T2.type = \'T\' AND T3.monter = ?)  UNION ALL (SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, T1.afstype FROM afsmountact  T1, documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T3.document = T1.document AND T2.type = \'B\' AND T3.monter = ?) ");
			Object objectTemp = null;
boolean nullData;
	...
	public com.hps.july.persistence.InternalWayBill findByPrimaryKey(com.hps.july.persistence.DocumentKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		com.hps.july.persistence.InternalWayBill result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DocumentKey _primaryKey = (com.hps.july.persistence.DocumentKey)key;
		try {
			try {
				result = (com.hps.july.persistence.InternalWayBill)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.InternalWayBill)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	 ...
	 * findByQBE
	 */
	public EJSFinder findByQBE(java.lang.Boolean isDate, java.sql.Date startDate, java.sql.Date endDate, java.lang.Boolean isOwner, java.lang.Integer owner, java.lang.Boolean isStorage, java.lang.Integer storage, java.lang.Boolean isContractor, java.lang.Integer contractor, java.lang.Boolean isWorker, java.lang.Integer worker, java.lang.Integer order) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getFinderObject().findByQBE(isDate, startDate, endDate, isOwner, owner, isStorage, storage, isContractor, contractor, isWorker, worker, order);
			resultSet = pstmt.executeQuery();
			return new EJSJDBCFinder(resultSet, this, pstmt);
		}
		catch (Exception ex) {
	...
	private static final String genericFindSqlString = "(SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, CAST(NULL AS CHAR(1)) FROM documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T2.type = \'T\' AND )  UNION ALL (SELECT T2.insuranceact, T2.blankdate, T2.blanknumber, T2.parentdocument, T2.operator, T2.isautodoc, T2.blankindex, T2.processsource, T2.showtouser, T2.state, T2.processdestination, T2.insurancedate, T2.insuranceman, T2.to2, T2.document, T2.needapprove, T2.projectid, T2.prjstatus, T2.visualtype, T2.owner, T2.to, T2.contragent, T2.from, T2.storagemanager, T2.type, T3.fixing, T3.equiptype, T3.position, T3.monter, T1.afstype FROM afsmountact  T1, documents  T2, internalwaybills  T3 WHERE T2.document = T3.document AND T3.document = T1.document AND T2.type = \'B\' AND ) ";
	private static final int[] genericFindInsertPoints = {1113, 532};
	/**
	...
	private InternalWayBillBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.InternalWayBillBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.InternalWayBillBeanFinderObject temp_finderObject = new com.hps.july.persistence.InternalWayBillBeanFinderObject();
