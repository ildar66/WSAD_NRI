...
import javax.ejb.*;
import javax.naming.*;
public class LeaseMutualContractsToReglamentLink extends ManyToSingleLink {
...
public LeaseMutualContractsToReglamentLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.LeaseDocumentKey key = ((com.hps.july.persistence.LeaseMutualContractsBean)source).getReglamentKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseMutualContractsBean)source).getReglamentKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseMutualContractsBean)source).privateSetReglamentKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualReglament)anEJB).secondaryAddLeaseMutualContracts((com.hps.july.persistence.LeaseMutualContracts)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualReglament)anEJB).secondaryRemoveLeaseMutualContracts((com.hps.july.persistence.LeaseMutualContracts)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseMutualContractsBean)source).privateSetReglamentKey((com.hps.july.persistence.LeaseDocumentKey)targetEJB.getPrimaryKey());
}
}
