...
public class _ResourceTypeHome_Stub extends Stub implements ResourceTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ResourceTypeHome:0000000000000000", 
    ...
    public ResourceType create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.ResourceTypeHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                ResourceType result = ((com.hps.july.persistence.ResourceTypeHome)so.servant).create(arg0);
    ...
    public ResourceType create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.ResourceTypeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ResourceType result = ((com.hps.july.persistence.ResourceTypeHome)so.servant).create(arg0, arg1);
                return (ResourceType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAll() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",com.hps.july.persistence.ResourceTypeHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.ResourceTypeHome)so.servant).findAll();
    ...
    public ResourceType findByPrimaryKey(ResourceTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ResourceTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResourceTypeKey arg0Copy = (ResourceTypeKey) Util.copyObject(arg0,_orb());
                ResourceType result = ((com.hps.july.persistence.ResourceTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ResourceType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
