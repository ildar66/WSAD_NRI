...
public class _EJSRemoteCMPChanalPowerHome_a231b69f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPChanalPowerHome_a231b69f target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPChanalPowerHome_a231b69f) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findChanalPowersByBasestation")) {
                        return findChanalPowersByBasestation(in, reply);
                    }
                case 44: 
                    if (method.equals("create__long__long__CORBA_WStringValue__long")) {
                        return create__long__long__CORBA_WStringValue__long(in, reply);
                    }
                case 50: 
                    if (method.equals("create__long__long__CORBA_WStringValue__long__long")) {
                        return create__long__long__CORBA_WStringValue__long__long(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__long__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
        int arg3 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ChanalPowerKey arg0 = (ChanalPowerKey) in.read_value(ChanalPowerKey.class);
        ChanalPower result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findChanalPowersByBasestation(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findChanalPowersByBasestation(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
