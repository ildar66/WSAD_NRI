...
import javax.ejb.*;
import javax.naming.*;
public class StoragePlaceToSitedoc2SplacesLink extends SingleToManyLink {
...
public StoragePlaceToSitedoc2SplacesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Sitedoc2Splace)anEJB).getStoragePlaceKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.Sitedoc2SplaceHome)getTargetHome(this)).findSitedoc2SplacesByStoragePlace((com.hps.july.persistence.StoragePlaceKey)getEntityContext().getPrimaryKey());
	}
