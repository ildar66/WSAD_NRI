...
public class _OtherEquipmentHome_Stub extends Stub implements OtherEquipmentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.OtherEquipmentHome:0000000000000000", 
    ...
    public OtherEquipment create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OtherEquipment) in.read_Object(OtherEquipment.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.OtherEquipmentHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                OtherEquipment result = ((com.hps.july.persistence.OtherEquipmentHome)so.servant).create(arg0);
                return (OtherEquipment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public OtherEquipment create(int arg0, Integer arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.OtherEquipmentHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                OtherEquipment result = ((com.hps.july.persistence.OtherEquipmentHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
                return (OtherEquipment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public OtherEquipment create(int arg0, Integer arg1, String arg2, String arg3, Integer arg4, String arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue", true);
                    out.write_long(arg0);
                    out.write_value(arg1,Integer.class);
                    out.write_value(arg2,String.class);
                    out.write_value(arg3,String.class);
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue",com.hps.july.persistence.OtherEquipmentHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                ...
                OtherEquipment result = ((com.hps.july.persistence.OtherEquipmentHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
                return (OtherEquipment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.OtherEquipmentHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.OtherEquipmentHome)so.servant).findAllOrderByNameAsc();
    ...
    public OtherEquipment findByPrimaryKey(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.OtherEquipmentHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                OtherEquipment result = ((com.hps.july.persistence.OtherEquipmentHome)so.servant).findByPrimaryKey(arg0Copy);
                return (OtherEquipment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
