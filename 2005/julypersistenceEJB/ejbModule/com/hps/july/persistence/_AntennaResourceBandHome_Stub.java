...
public class _AntennaResourceBandHome_Stub extends Stub implements AntennaResourceBandHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.AntennaResourceBandHome:0000000000000000", 
    ...
    public AntennaResourceBand create(int arg0, short arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennaResourceBand) in.read_Object(AntennaResourceBand.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.AntennaResourceBandHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                AntennaResourceBand result = ((com.hps.july.persistence.AntennaResourceBandHome)so.servant).create(arg0, arg1);
                return (AntennaResourceBand)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findAntennaResourceBandsByResource(ResourceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("findAntennaResourceBandsByResource", true);
                    ...
                    return findAntennaResourceBandsByResource(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAntennaResourceBandsByResource",com.hps.july.persistence.AntennaResourceBandHome.class);
            if (so == null) {
                return findAntennaResourceBandsByResource(arg0);
            }
            try {
                ResourceKey arg0Copy = (ResourceKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.AntennaResourceBandHome)so.servant).findAntennaResourceBandsByResource(arg0Copy);
    ...
    public AntennaResourceBand findByPrimaryKey(AntennaResourceBandKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,AntennaResourceBandKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennaResourceBand) in.read_Object(AntennaResourceBand.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.AntennaResourceBandHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AntennaResourceBandKey arg0Copy = (AntennaResourceBandKey) Util.copyObject(arg0,_orb());
                AntennaResourceBand result = ((com.hps.july.persistence.AntennaResourceBandHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AntennaResourceBand)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
