 ...
 **/
public interface LeaseChargeRuleBeanFinderHelper extends com.hps.july.persistence.LeaseRuleBeanFinderHelper { 
	public java.sql.PreparedStatement findByLeaseDocumentAndResource(Integer leaseDocument, 
		Integer argResource, Integer order) throws Exception;
}
