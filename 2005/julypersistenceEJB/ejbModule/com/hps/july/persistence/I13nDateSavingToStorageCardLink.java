...
import javax.ejb.*;
import javax.naming.*;
public class I13nDateSavingToStorageCardLink extends ManyToSingleLink {
...
public I13nDateSavingToStorageCardLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StorageCardKey key = ((com.hps.july.persistence.I13nDateSavingBean)source).getStorageCardKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.I13nDateSavingBean)source).getStorageCardKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.I13nDateSavingBean)source).privateSetStorageCardKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryAddI13nDateSaving((com.hps.july.persistence.I13nDateSaving)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryRemoveI13nDateSaving((com.hps.july.persistence.I13nDateSaving)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.I13nDateSavingBean)source).privateSetStorageCardKey((com.hps.july.persistence.StorageCardKey)targetEJB.getPrimaryKey());
}
}
