...
public class _PIEDocInfoDocPos_Stub extends Stub implements PIEDocInfoDocPos {
    ...
    public int getDocposition() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_docposition",com.hps.july.persistence.PIEDocInfoDocPos.class);
            if (so == null) {
                return getDocposition();
            }
            try {
                return ((com.hps.july.persistence.PIEDocInfoDocPos)so.servant).getDocposition();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public Boolean getFlagfulllink() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_flagfulllink", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_flagfulllink",com.hps.july.persistence.PIEDocInfoDocPos.class);
            if (so == null) {
                return getFlagfulllink();
            }
            try {
                Boolean result = ((com.hps.july.persistence.PIEDocInfoDocPos)so.servant).getFlagfulllink();
    ...
    public void setFlagfulllink(Boolean arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_flagfulllink", true);
            ...
            ServantObject so = _servant_preinvoke("_set_flagfulllink",com.hps.july.persistence.PIEDocInfoDocPos.class);
            if (so == null) {
                setFlagfulllink(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.PIEDocInfoDocPos)so.servant).setFlagfulllink(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
