...
public class _EJSRemoteCMPPhotoBlob_e4daa2aa_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPhotoBlob_e4daa2aa target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPhotoBlob_e4daa2aa) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 102: 
                    ...
                    } else if (method.equals("_set_filename")) {
                ...
                case 105: 
                    if (method.equals("_get_image")) {
                        return _get_image(in, reply);
                    } else if (method.equals("_set_image")) {
                        return _set_image(in, reply);
                    }
                case 110: 
                ...
                case 112: 
                    ...
                    } else if (method.equals("_get_photo")) {
                        return _get_photo(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_image(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] result = target.getImage();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_photo(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream _set_image(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
