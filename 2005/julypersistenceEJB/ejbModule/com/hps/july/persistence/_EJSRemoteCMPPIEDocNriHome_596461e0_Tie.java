...
public class _EJSRemoteCMPPIEDocNriHome_596461e0_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEDocNriHome_596461e0 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEDocNriHome_596461e0) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findPIEDocNrisByQuery")) {
                        return findPIEDocNrisByQuery(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findPIEDocNrisByQuery(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryKey arg0 = (PIEQueryKey) in.read_value(PIEQueryKey.class);
        Enumeration result;
        try {
            result = target.findPIEDocNrisByQuery(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
