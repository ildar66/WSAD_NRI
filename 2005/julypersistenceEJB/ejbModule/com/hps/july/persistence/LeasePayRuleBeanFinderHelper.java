 ...
 **/
public interface LeasePayRuleBeanFinderHelper extends com.hps.july.persistence.LeaseRuleBeanFinderHelper {

	public static final String findByLeasedocumentResourcePaytypeWhereClause = 
		" leasedocument = ? and resource = ? and paytype = ? ";
	java.sql.PreparedStatement findByLeaseDocument(Integer leaseDocument, Boolean isPpType, Integer order) throws Exception;
}
