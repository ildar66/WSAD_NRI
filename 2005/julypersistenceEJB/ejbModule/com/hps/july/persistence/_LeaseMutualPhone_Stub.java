...
public class _LeaseMutualPhone_Stub extends Stub implements LeaseMutualPhone {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseMutualPhone:0000000000000000", 
    ...
    public LeaseMutualReglament getLeaseDocument() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("getLeaseDocument",com.hps.july.persistence.LeaseMutualPhone.class);
            if (so == null) {
                return getLeaseDocument();
            }
            try {
                LeaseMutualReglament result = ((com.hps.july.persistence.LeaseMutualPhone)so.servant).getLeaseDocument();
    ...
    public LeaseDocumentKey getLeaseDocumentKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_leaseDocumentKey",com.hps.july.persistence.LeaseMutualPhone.class);
            if (so == null) {
                return getLeaseDocumentKey();
            }
            try {
                LeaseDocumentKey result = ((com.hps.july.persistence.LeaseMutualPhone)so.servant).getLeaseDocumentKey();
    ...
    public String getPhone() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_phone",com.hps.july.persistence.LeaseMutualPhone.class);
            if (so == null) {
                return getPhone();
            }
            try {
                return ((com.hps.july.persistence.LeaseMutualPhone)so.servant).getPhone();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setPhone(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_phone",com.hps.july.persistence.LeaseMutualPhone.class);
            if (so == null) {
                setPhone(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.LeaseMutualPhone)so.servant).setPhone(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
