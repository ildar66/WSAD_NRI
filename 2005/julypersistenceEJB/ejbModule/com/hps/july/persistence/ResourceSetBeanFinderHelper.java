 ...
 **/
public interface ResourceSetBeanFinderHelper { 
	public static final String findResourceSetsBySubtypeWhereClause = "T1.mainpart IN " + 
		" (SELECT resource FROM resources r1 WHERE r1.resourcesubtype = ?) ";
	 public java.sql.PreparedStatement findByQBE( Boolean isSubtypekey, ResourceSubTypeKey subtypeKey,
