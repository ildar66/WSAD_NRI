...
import javax.ejb.*;
import javax.naming.*;
public class SectorToAntena2sectorsLink extends SingleToManyLink {
...
public SectorToAntena2sectorsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Antena2sector)anEJB).getSectorKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.Antena2sectorHome)getTargetHome(this)).findAntena2sectorsBySector((com.hps.july.persistence.SectorKey)getEntityContext().getPrimaryKey());
	}
