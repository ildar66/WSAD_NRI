...
public class _EJSRemoteCMPPIEPayNRIHome_6b039a46_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEPayNRIHome_6b039a46 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEPayNRIHome_6b039a46) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findPIEPayNRIsByQuery")) {
                        return findPIEPayNRIsByQuery(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPayNRIKey arg0 = (PIEPayNRIKey) in.read_value(PIEPayNRIKey.class);
        PIEPayNRI result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEPayNRIsByQuery(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryKey arg0 = (PIEQueryKey) in.read_value(PIEQueryKey.class);
        Enumeration result;
        try {
            result = target.findPIEPayNRIsByQuery(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
