 ...
 **/
public interface AntennaBeanFinderHelper { 
	public static final String findByEquipmentOrderByNumAscWhereClause = "equipment = ? AND planfacttype=1 ORDER BY num_ant ASC";
