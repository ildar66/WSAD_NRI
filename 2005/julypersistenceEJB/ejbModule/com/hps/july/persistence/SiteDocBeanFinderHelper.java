 ...
 **/
public interface SiteDocBeanFinderHelper {
	public static final String findByProjectactionWhereClause = " projectaction = ? ";
	public static final String findByProjectactions_ProjectWhereClause = 
		" projectaction in(select projectaction from projectactions where project = ?)";
