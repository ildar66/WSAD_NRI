...
import javax.ejb.*;
import javax.naming.*;
public class ProjectToProjectDivColValsLink extends SingleToManyLink {
...
public ProjectToProjectDivColValsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.ProjectDivColVal)anEJB).getProjectKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.ProjectDivColValHome)getTargetHome(this)).findProjectDivColValsByProject((com.hps.july.persistence.ProjectKey)getEntityContext().getPrimaryKey());
	}
