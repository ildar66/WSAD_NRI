...
import javax.ejb.*;
import javax.naming.*;
public class CurrencyToLeaseCalcRatesLink extends SingleToManyLink {
...
public CurrencyToLeaseCalcRatesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseCalcRate)anEJB).getCurrencyKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseCalcRateHome)getTargetHome(this)).findLeaseCalcRatesByCurrency((com.hps.july.persistence.CurrencyKey)getEntityContext().getPrimaryKey());
	}
