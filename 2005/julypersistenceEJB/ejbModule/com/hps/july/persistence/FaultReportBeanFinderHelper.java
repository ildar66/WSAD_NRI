 ...
 **/
public interface FaultReportBeanFinderHelper extends com.hps.july.persistence.DocumentBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE(Boolean useDate, java.sql.Date datefrom, java.sql.Date dateto, // поиск по
