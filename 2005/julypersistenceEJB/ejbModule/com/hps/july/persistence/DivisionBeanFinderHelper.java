 ...
 **/
public interface DivisionBeanFinderHelper {

	public static final String findAllByProjectColumnsOrderByNameAscWhereClause = 
		"division IN (SELECT p.division FROM projectdivcolumns p) order by name asc";

	public static final String findAllByProjectActionTypeOrderByNameAscWhereClause = 
		" division IN (SELECT p.division FROM projectactiontypes p) order by name asc ";

	public static final String findAllByProjectCommsByNameAscWhereClause = 
		" division IN (SELECT p.division FROM projectactioncomms p) order by name asc";
	public java.sql.PreparedStatement findByParentCompany( Integer parent, Integer company,
        Boolean isRoot, Integer order )	throws java.lang.Exception;
	public java.sql.PreparedStatement findByParentOrderByNameAsc(Integer argEncloser) throws java.lang.Exception;
	public java.sql.PreparedStatement findByParentOrderByNameDesc(Integer argEncloser) throws java.lang.Exception;
