...
public class _EJSRemoteCMPRoles2TasksHome_76e15e86_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPRoles2TasksHome_76e15e86 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPRoles2TasksHome_76e15e86) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 14: 
                    if (method.equals("findRoleByTask")) {
                        return findRoleByTask(in, reply);
                    }
                case 15: 
                    if (method.equals("_get_homeHandle")) {
                        return _get_homeHandle(in, reply);
                    } else if (method.equals("findTasksByRole")) {
                        return findTasksByRole(in, reply);
                    }
                case 16: 
                ...
                case 27: 
                    if (method.equals("findRoles2TasksByRoleString")) {
                        return findRoles2TasksByRoleString(in, reply);
                    }
                case 45: 
                    if (method.equals("create__CORBA_WStringValue__java_lang_Integer")) {
                        return create__CORBA_WStringValue__java_lang_Integer(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__CORBA_WStringValue__java_lang_Integer(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Roles2TasksKey arg0 = (Roles2TasksKey) in.read_value(Roles2TasksKey.class);
        Roles2Tasks result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findRoleByTask(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        TaskKey arg0 = (TaskKey) in.read_value(TaskKey.class);
        Enumeration result;
        try {
            result = target.findRoleByTask(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findRoles2TasksByRoleString(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findRoles2TasksByRoleString(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findTasksByRole(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RoleKey arg0 = (RoleKey) in.read_value(RoleKey.class);
        Enumeration result;
        try {
            result = target.findTasksByRole(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
