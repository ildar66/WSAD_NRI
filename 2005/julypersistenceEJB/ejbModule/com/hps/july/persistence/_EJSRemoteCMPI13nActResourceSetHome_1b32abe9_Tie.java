...
public class _EJSRemoteCMPI13nActResourceSetHome_1b32abe9_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPI13nActResourceSetHome_1b32abe9 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPI13nActResourceSetHome_1b32abe9) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 18: 
                    if (method.equals("findBlockingRecord")) {
                        return findBlockingRecord(in, reply);
                    }
                case 24: 
                ...
                case 31: 
                    if (method.equals("findI13nActResourceSetByI13nAct")) {
                        return findI13nActResourceSetByI13nAct(in, reply);
                    }
                case 32: 
                    if (method.equals("findI13nActResourceSetByResource")) {
                        return findI13nActResourceSetByResource(in, reply);
                    }
                case 44: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer")) {
                        return create__java_lang_Integer__java_lang_Integer(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findBlockingRecord(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        ...
        I13nActResourceSet result;
        try {
            result = target.findBlockingRecord(arg0, arg1, arg2, arg3);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        I13nActResourceSetKey arg0 = (I13nActResourceSetKey) in.read_value(I13nActResourceSetKey.class);
        I13nActResourceSet result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findI13nActResourceSetByI13nAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DocumentKey arg0 = (DocumentKey) in.read_value(DocumentKey.class);
        Enumeration result;
        try {
            result = target.findI13nActResourceSetByI13nAct(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findI13nActResourceSetByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findI13nActResourceSetByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
