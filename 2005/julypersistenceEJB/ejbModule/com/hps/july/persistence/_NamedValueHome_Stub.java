...
public class _NamedValueHome_Stub extends Stub implements NamedValueHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.NamedValueHome:0000000000000000", 
    ...
    public NamedValue create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (NamedValue) in.read_Object(NamedValue.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.NamedValueHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                NamedValue result = ((com.hps.july.persistence.NamedValueHome)so.servant).create(arg0);
                return (NamedValue)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findAll() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",com.hps.july.persistence.NamedValueHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.NamedValueHome)so.servant).findAll();
    ...
    public NamedValue findByPrimaryKey(NamedValueKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,NamedValueKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (NamedValue) in.read_Object(NamedValue.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.NamedValueHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                NamedValueKey arg0Copy = (NamedValueKey) Util.copyObject(arg0,_orb());
                NamedValue result = ((com.hps.july.persistence.NamedValueHome)so.servant).findByPrimaryKey(arg0Copy);
                return (NamedValue)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
