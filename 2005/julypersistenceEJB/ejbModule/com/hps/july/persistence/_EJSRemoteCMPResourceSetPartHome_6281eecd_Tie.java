...
public class _EJSRemoteCMPResourceSetPartHome_6281eecd_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPResourceSetPartHome_6281eecd target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPResourceSetPartHome_6281eecd) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 17: 
                    if (method.equals("findSetPartsBySet")) {
                        return findSetPartsBySet(in, reply);
                    }
                case 24: 
                ...
                case 26: 
                    if (method.equals("findResourceSetPartsByPart")) {
                        return findResourceSetPartsByPart(in, reply);
                    }
                case 66: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSetPartKey arg0 = (ResourceSetPartKey) in.read_value(ResourceSetPartKey.class);
        ResourceSetPart result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findResourceSetPartsByPart(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findResourceSetPartsByPart(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findSetPartsBySet(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSetKey arg0 = (ResourceSetKey) in.read_value(ResourceSetKey.class);
        Enumeration result;
        try {
            result = target.findSetPartsBySet(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
