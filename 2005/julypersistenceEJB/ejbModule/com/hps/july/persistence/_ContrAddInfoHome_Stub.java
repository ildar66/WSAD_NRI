...
public class _ContrAddInfoHome_Stub extends Stub implements ContrAddInfoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ContrAddInfoHome:0000000000000000", 
    ...
    public ContrAddInfo create(Integer arg0, Date arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.ContrAddInfoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ...
                ContrAddInfo result = ((com.hps.july.persistence.ContrAddInfoHome)so.servant).create(arg0Copy, arg1Copy);
    ...
    public Enumeration findByEquipmentOrderByActdateAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByEquipmentOrderByActdateAsc",com.hps.july.persistence.ContrAddInfoHome.class);
            if (so == null) {
                return findByEquipmentOrderByActdateAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.ContrAddInfoHome)so.servant).findByEquipmentOrderByActdateAsc(arg0Copy);
    ...
    public ContrAddInfo findByPrimaryKey(ContrAddInfoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ContrAddInfoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ContrAddInfoKey arg0Copy = (ContrAddInfoKey) Util.copyObject(arg0,_orb());
                ContrAddInfo result = ((com.hps.july.persistence.ContrAddInfoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ContrAddInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findContrAddInfosByController(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findContrAddInfosByController", true);
                    ...
                    return findContrAddInfosByController(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findContrAddInfosByController",com.hps.july.persistence.ContrAddInfoHome.class);
            if (so == null) {
                return findContrAddInfosByController(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.ContrAddInfoHome)so.servant).findContrAddInfosByController(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
