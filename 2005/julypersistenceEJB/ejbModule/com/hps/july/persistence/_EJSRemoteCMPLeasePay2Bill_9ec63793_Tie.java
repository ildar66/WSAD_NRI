...
public class _EJSRemoteCMPLeasePay2Bill_9ec63793_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeasePay2Bill_9ec63793 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeasePay2Bill_9ec63793) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 102: 
                    ...
                    } else if (method.equals("_set_flagworkpie")) {
                ...
                case 108: 
                    ...
                    } else if (method.equals("_get_leasemutualact")) {
                        return _get_leasemutualact(in, reply);
                    }
                case 110: 
                ...
                case 115: 
                    if (method.equals("_get_sumusd")) {
                        return _get_sumusd(in, reply);
                    } else if (method.equals("_set_sumusd")) {
                        return _set_sumusd(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_leasecontract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getLeasecontract();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _get_leasemutualact(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getLeasemutualact();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream _get_sumusd(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        BigDecimal result = target.getSumusd();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_sumusd(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        BigDecimal arg0 = (BigDecimal) in.read_value(BigDecimal.class);
        target.setSumusd(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
