 ...
 **/
public interface AbonentBillBeanFinderHelper { 
	public static final String findByFlagWorkNRIWhereClause = "flagworknri = ?";
	public static final String findByBenWhereClause = "ben = ?";
	public static final String findByBanStartServDateWhereClause = "flagworknri = 'Y' AND leasedocument IN " +
		"(SELECT leaseDocument FROM LeaseAbonentBan WHERE ban = ? AND bil_StartServDate > ?)";
