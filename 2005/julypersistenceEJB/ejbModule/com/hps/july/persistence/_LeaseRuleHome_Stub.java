...
public class _LeaseRuleHome_Stub extends Stub implements LeaseRuleHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseRuleHome:0000000000000000", 
    ...
    public LeaseRule create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseRule) in.read_Object(LeaseRule.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__",com.hps.july.persistence.LeaseRuleHome.class);
            if (so == null) {
                return create();
            }
            try {
                LeaseRule result = ((com.hps.july.persistence.LeaseRuleHome)so.servant).create();
                return (LeaseRule)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LeaseRule create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.LeaseRuleHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                LeaseRule result = ((com.hps.july.persistence.LeaseRuleHome)so.servant).create(arg0);
                return (LeaseRule)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public LeaseRule create(Integer arg0, Integer arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__java_lang_Integer__java_lang_Integer",com.hps.july.persistence.LeaseRuleHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ...
                LeaseRule result = ((com.hps.july.persistence.LeaseRuleHome)so.servant).create(arg0Copy, arg1Copy);
                return (LeaseRule)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findByLeaseDocument(Integer arg0, Integer arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByLeaseDocument",com.hps.july.persistence.LeaseRuleHome.class);
            if (so == null) {
                return findByLeaseDocument(arg0, arg1);
            }
            try {
                ...
                Integer arg0Copy = (Integer) copies[0];
                Integer arg1Copy = (Integer) copies[1];
                Enumeration result = ((com.hps.july.persistence.LeaseRuleHome)so.servant).findByLeaseDocument(arg0Copy, arg1Copy);
    ...
    public LeaseRule findByPrimaryKey(LeaseRuleKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeaseRuleHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseRuleKey arg0Copy = (LeaseRuleKey) Util.copyObject(arg0,_orb());
                LeaseRule result = ((com.hps.july.persistence.LeaseRuleHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseRule)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findLeaseRulesByLeaseDocument(LeaseDocumentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findLeaseRulesByLeaseDocument", true);
                    ...
                    return findLeaseRulesByLeaseDocument(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findLeaseRulesByLeaseDocument",com.hps.july.persistence.LeaseRuleHome.class);
            if (so == null) {
                return findLeaseRulesByLeaseDocument(arg0);
            }
            try {
                LeaseDocumentKey arg0Copy = (LeaseDocumentKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.LeaseRuleHome)so.servant).findLeaseRulesByLeaseDocument(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
