...
/**
 * 
 * @return com.hps.july.persistence.Service
 ...
 */
com.hps.july.persistence.Service create(int argDivision, String argName, String argShortName, Integer parent) throws javax.ejb.CreateException, java.rmi.RemoteException;
 ...
 */
com.hps.july.persistence.Service findByPrimaryKey(DivisionKey key) throws java.rmi.RemoteException, javax.ejb.FinderException;
