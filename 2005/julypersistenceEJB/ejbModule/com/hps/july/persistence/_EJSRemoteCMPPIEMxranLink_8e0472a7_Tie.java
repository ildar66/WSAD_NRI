...
public class _EJSRemoteCMPPIEMxranLink_8e0472a7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEMxranLink_8e0472a7 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEMxranLink_8e0472a7) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 109: 
                    if (method.equals("_get_mxrannri")) {
                        return _get_mxrannri(in, reply);
                    } else if (method.equals("_get_mxranplatinumKey")) {
                        return _get_mxranplatinumKey(in, reply);
                    }
                case 110: 
                ...
                case 114: 
                    if (method.equals("getMxranplatinum")) {
                        return getMxranplatinum(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_mxrannri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getMxrannri();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream getMxranplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEMxranPlatinum result;
        try {
            result = target.getMxranplatinum();
    ...
    private org.omg.CORBA.portable.OutputStream _get_mxranplatinumKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEMxranPlatinumKey result = target.getMxranplatinumKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,PIEMxranPlatinumKey.class);
        return out;
    }
}
