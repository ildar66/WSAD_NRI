...
import javax.ejb.*;
import javax.naming.*;
public class OrganizationToPIEMxranPlatinumsLink extends SingleToManyLink {
...
public OrganizationToPIEMxranPlatinumsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.PIEMxranPlatinum)anEJB).getOwnerKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.PIEMxranPlatinumHome)getTargetHome(this)).findPIEMxranPlatinumsByOwner((com.hps.july.persistence.OrganizationKey)getEntityContext().getPrimaryKey());
	}
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.PIEMxranPlatinum.class);
}
/**
