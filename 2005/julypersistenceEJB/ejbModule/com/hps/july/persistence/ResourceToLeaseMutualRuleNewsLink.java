...
import javax.ejb.*;
import javax.naming.*;
public class ResourceToLeaseMutualRuleNewsLink extends SingleToManyLink {
...
public ResourceToLeaseMutualRuleNewsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseMutualRuleNew)anEJB).getResourceKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseMutualRuleNewHome)getTargetHome(this)).findLeaseMutualRuleNewsByResource((com.hps.july.persistence.ResourceKey)getEntityContext().getPrimaryKey());
	}
