...
public class _SearchGrouppingHome_Stub extends Stub implements SearchGrouppingHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SearchGrouppingHome:0000000000000000", 
    ...
    public SearchGroupping create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.SearchGrouppingHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                SearchGroupping result = ((com.hps.july.persistence.SearchGrouppingHome)so.servant).create(arg0);
    ...
    public SearchGroupping create(int arg0, Integer arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("create__long__java_lang_Integer__CORBA_WStringValue", true);
                    out.write_long(arg0);
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue",com.hps.july.persistence.SearchGrouppingHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                SearchGroupping result = ((com.hps.july.persistence.SearchGrouppingHome)so.servant).create(arg0, arg1Copy, arg2Copy);
                return (SearchGroupping)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public SearchGroupping findByPrimaryKey(SearchGrouppingKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SearchGrouppingHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SearchGrouppingKey arg0Copy = (SearchGrouppingKey) Util.copyObject(arg0,_orb());
                SearchGroupping result = ((com.hps.july.persistence.SearchGrouppingHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SearchGroupping)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findSearchGrouppingBySearchGroup(SearchGroupKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findSearchGrouppingBySearchGroup", true);
                    ...
                    return findSearchGrouppingBySearchGroup(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findSearchGrouppingBySearchGroup",com.hps.july.persistence.SearchGrouppingHome.class);
            if (so == null) {
                return findSearchGrouppingBySearchGroup(arg0);
            }
            try {
                SearchGroupKey arg0Copy = (SearchGroupKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.SearchGrouppingHome)so.servant).findSearchGrouppingBySearchGroup(arg0Copy);
