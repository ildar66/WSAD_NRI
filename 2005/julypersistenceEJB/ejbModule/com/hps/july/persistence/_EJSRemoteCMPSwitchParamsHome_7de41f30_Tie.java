...
public class _EJSRemoteCMPSwitchParamsHome_7de41f30_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSwitchParamsHome_7de41f30 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSwitchParamsHome_7de41f30) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 31: 
                    if (method.equals("findSwitchParamsBySwitchaddinfo")) {
                        return findSwitchParamsBySwitchaddinfo(in, reply);
                    }
                case 45: 
                    if (method.equals("findByEquipmentAndActdateOrderByParamlevelAsc")) {
                        return findByEquipmentAndActdateOrderByParamlevelAsc(in, reply);
                    }
                case 53: 
                    if (method.equals("findByEquipment_Actdate_ParamtypeOrderByParamlevelAsc")) {
                        return findByEquipment_Actdate_ParamtypeOrderByParamlevelAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByEquipment_Actdate_ParamtypeOrderByParamlevelAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Enumeration result;
        try {
            result = target.findByEquipment_Actdate_ParamtypeOrderByParamlevelAsc(arg0, arg1, arg2);
    ...
    private org.omg.CORBA.portable.OutputStream findByEquipmentAndActdateOrderByParamlevelAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Enumeration result;
        try {
            result = target.findByEquipmentAndActdateOrderByParamlevelAsc(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SwitchParamsKey arg0 = (SwitchParamsKey) in.read_value(SwitchParamsKey.class);
        SwitchParams result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findSwitchParamsBySwitchaddinfo(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SwitchAddInfoKey arg0 = (SwitchAddInfoKey) in.read_value(SwitchAddInfoKey.class);
        Enumeration result;
        try {
            result = target.findSwitchParamsBySwitchaddinfo(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
