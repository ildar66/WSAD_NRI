...
/**
 * CableResourceAccessBean
 * @generated
 */
public class CableResourceAccessBean
	extends AbstractEntityAccessBean
	implements com.hps.july.persistence.CableResourceAccessBeanData {
	/**
	 * @generated
	 */
	private CableResource __ejbRef;
	/**
	 * @generated
	 */
	...
	public int getCablediamid()
		...
		return (((Integer) __getCache("cablediamid")).intValue());
	}
	/**
	 * setCablediamid
	 * @generated
	 */
	public void setCablediamid(int newValue) {
		__setCache("cablediamid", new Integer(newValue));
	}
	/**
	 * getUnitKey
	 * @generated
	 ...
	 * @generated
	 */
	public CableResourceAccessBean() {
		super();
	}
	/**
	 * CableResourceAccessBean
	 * @generated
	 */
	public CableResourceAccessBean(javax.ejb.EJBObject o)
	 ...
	 * @generated
	 */
	private com.hps.july.persistence.CableResourceHome ejbHome()
		...
		return (
			com
				...
				.july
				.persistence
				.CableResourceHome) PortableRemoteObject
				.narrow(
			getHome(),
			com.hps.july.persistence.CableResourceHome.class);
	}
	/**
	 * ejbRef
	 * @generated
	 */
	private com.hps.july.persistence.CableResource ejbRef()
		throws java.rmi.RemoteException {
		if (ejbRef == null)
			return null;
		if (__ejbRef == null)
			__ejbRef =
				(
					com
						...
						.july
						.persistence
						.CableResource) PortableRemoteObject
						.narrow(
					ejbRef,
					com.hps.july.persistence.CableResource.class);
	...
	public java.util.Enumeration findResourcesByLeasePayRules(
		...
		throws
			...
			javax.ejb.FinderException,
			java.rmi.RemoteException {
		com.hps.july.persistence.CableResourceHome localHome = ejbHome();
	...
	public java.util.Enumeration findByQBE4(
		...
		com.hps.july.persistence.CableResourceHome localHome = ejbHome();
		java.util.Enumeration ejbs =
			localHome.findByQBE4(isType, typeId, isSubType, subTypeId, order);
		return (java.util.Enumeration) createAccessBeans(ejbs);
	}
	/**
	 * CableResourceAccessBean
	 ...
	 * @generated
	 */
	public CableResourceAccessBean(int argResource)
		throws
			javax.naming.NamingException,
			javax.ejb.CreateException,
			java.rmi.RemoteException {
	 ...
	 * @generated
	 */
	public void secondaryAddCableResourceBands(
		com.hps.july.persistence.CableResourceBand aCableResourceBands)
		throws
			javax.naming.NamingException,
			javax.ejb.FinderException,
			java.rmi.RemoteException {
		instantiateEJB();
		ejbRef().secondaryAddCableResourceBands(aCableResourceBands);
	}
	/**
	 ...
	 * @generated
	 */
	public void removeAntennes(com.hps.july.persistence.Antenna anAntennes)
		throws
			javax.naming.NamingException,
			javax.ejb.FinderException,
			java.rmi.RemoteException {
		instantiateEJB();
		ejbRef().removeAntennes(anAntennes);
	}
	/**
	 * setSubtype
	 * @generated
	 ...
	 * @generated
	 */
	public java.util.Enumeration getCableResourceBands()
		throws
			javax.naming.NamingException,
			javax.ejb.FinderException,
			java.rmi.RemoteException {
		instantiateEJB();
		return ejbRef().getCableResourceBands();
	}
	/**
	 ...
	 * @generated
	 */
	public void secondaryRemoveCableResourceBands(
		com.hps.july.persistence.CableResourceBand aCableResourceBands)
		throws
			javax.naming.NamingException,
			javax.ejb.FinderException,
			java.rmi.RemoteException {
		instantiateEJB();
		ejbRef().secondaryRemoveCableResourceBands(aCableResourceBands);
	}
	/**
	 * addAbonentBillPoses
	 * @generated
