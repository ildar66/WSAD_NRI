...
public class _RRLAntParamsHome_Stub extends Stub implements RRLAntParamsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.RRLAntParamsHome:0000000000000000", 
    ...
    public RRLAntParams create(int arg0, int arg1, BigDecimal arg2, BigDecimal arg3, BigDecimal arg4, BigDecimal arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLAntParams) in.read_Object(RRLAntParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.RRLAntParamsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg2,arg3,arg4,arg5},_orb());
                BigDecimal arg2Copy = (BigDecimal) copies[0];
                BigDecimal arg3Copy = (BigDecimal) copies[1];
                BigDecimal arg4Copy = (BigDecimal) copies[2];
                BigDecimal arg5Copy = (BigDecimal) copies[3];
                RRLAntParams result = ((com.hps.july.persistence.RRLAntParamsHome)so.servant).create(arg0, arg1, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
                return (RRLAntParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RRLAntParams findByPrimaryKey(RRLAntParamsKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,RRLAntParamsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLAntParams) in.read_Object(RRLAntParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.RRLAntParamsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RRLAntParamsKey arg0Copy = (RRLAntParamsKey) Util.copyObject(arg0,_orb());
                RRLAntParams result = ((com.hps.july.persistence.RRLAntParamsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (RRLAntParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByResource(int arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findByResource", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findByResource",com.hps.july.persistence.RRLAntParamsHome.class);
            if (so == null) {
                return findByResource(arg0);
            }
            try {
                Enumeration result = ((com.hps.july.persistence.RRLAntParamsHome)so.servant).findByResource(arg0);
    ...
    public Enumeration findByResourceAndDiam(int arg0, BigDecimal arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByResourceAndDiam", true);
                    out.write_long(arg0);
                    ...
                    return findByResourceAndDiam(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByResourceAndDiam",com.hps.july.persistence.RRLAntParamsHome.class);
            if (so == null) {
                return findByResourceAndDiam(arg0, arg1);
            }
            try {
                BigDecimal arg1Copy = (BigDecimal) Util.copyObject(arg1,_orb());
                Enumeration result = ((com.hps.july.persistence.RRLAntParamsHome)so.servant).findByResourceAndDiam(arg0, arg1Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
