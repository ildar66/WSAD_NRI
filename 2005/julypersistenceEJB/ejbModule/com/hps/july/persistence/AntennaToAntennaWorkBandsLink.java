...
import javax.ejb.*;
import javax.naming.*;
public class AntennaToAntennaWorkBandsLink extends SingleToManyLink {
	private static AntennaWorkBandHome targetHome = null;
	private final static java.lang.String targetHomeName = "AntennaWorkBand";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public AntennaToAntennaWorkBandsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.AntennaWorkBand)anEJB).getAntennaKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.AntennaWorkBandHome)getTargetHome(this)).findAntennaWorkBandsByAntenna((com.hps.july.persistence.AntennaKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.hps.july.persistence.AntennaWorkBandHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized AntennaWorkBandHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.AntennaWorkBandHome)lookupTargetHome(homeName, com.hps.july.persistence.AntennaWorkBandHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.AntennaWorkBand.class);
}
/**
