...
public class _PIEReferenceHome_Stub extends Stub implements PIEReferenceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEReferenceHome:0000000000000000", 
    ...
    public PIEReference create(int arg0, int arg1, String arg2, String arg3, String arg4, String arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEReference) in.read_Object(PIEReference.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEReferenceHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                PIEReference result = ((com.hps.july.persistence.PIEReferenceHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5);
                return (PIEReference)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByOwnerAndSpravOrderByNameAsc(Integer arg0, String arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByOwnerAndSpravOrderByNameAsc", true);
                    ...
                    return findByOwnerAndSpravOrderByNameAsc(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByOwnerAndSpravOrderByNameAsc",com.hps.july.persistence.PIEReferenceHome.class);
            if (so == null) {
                return findByOwnerAndSpravOrderByNameAsc(arg0, arg1);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PIEReferenceHome)so.servant).findByOwnerAndSpravOrderByNameAsc(arg0Copy, arg1Copy);
    ...
    public PIEReference findByPrimaryKey(PIEReferenceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEReferenceKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEReference) in.read_Object(PIEReference.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEReferenceHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEReferenceKey arg0Copy = (PIEReferenceKey) Util.copyObject(arg0,_orb());
                PIEReference result = ((com.hps.july.persistence.PIEReferenceHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEReference)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findBySpravOrderByCodeAsc(String arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findBySpravOrderByCodeAsc", true);
                    ...
                    return findBySpravOrderByCodeAsc(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findBySpravOrderByCodeAsc",com.hps.july.persistence.PIEReferenceHome.class);
            if (so == null) {
                return findBySpravOrderByCodeAsc(arg0);
            }
            try {
                Enumeration result = ((com.hps.july.persistence.PIEReferenceHome)so.servant).findBySpravOrderByCodeAsc(arg0);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
