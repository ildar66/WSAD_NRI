...
public class _PhotoBlob_Stub extends Stub implements PhotoBlob {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PhotoBlob:0000000000000000", 
    ...
    public String getFilename() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_filename",com.hps.july.persistence.PhotoBlob.class);
            if (so == null) {
                return getFilename();
            }
            try {
                return ((com.hps.july.persistence.PhotoBlob)so.servant).getFilename();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public byte[] getImage() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_image", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_image",com.hps.july.persistence.PhotoBlob.class);
            if (so == null) {
                return getImage();
            }
            try {
                byte[] result = ((com.hps.july.persistence.PhotoBlob)so.servant).getImage();
    ...
    public int getPhoto() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_photo", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_photo",com.hps.july.persistence.PhotoBlob.class);
            if (so == null) {
                return getPhoto();
            }
            try {
                return ((com.hps.july.persistence.PhotoBlob)so.servant).getPhoto();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setFilename(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_filename",com.hps.july.persistence.PhotoBlob.class);
            if (so == null) {
                setFilename(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.PhotoBlob)so.servant).setFilename(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setImage(byte[] arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_image",com.hps.july.persistence.PhotoBlob.class);
            if (so == null) {
                setImage(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.PhotoBlob)so.servant).setImage(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
