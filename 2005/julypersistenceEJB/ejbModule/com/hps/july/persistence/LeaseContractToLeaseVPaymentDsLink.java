...
import javax.ejb.*;
import javax.naming.*;
public class LeaseContractToLeaseVPaymentDsLink extends SingleToManyLink {
...
public LeaseContractToLeaseVPaymentDsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseVPayment)anEJB).getDebetcontractKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseVPaymentHome)getTargetHome(this)).findLeaseVPaymentDsByDebetcontract((com.hps.july.persistence.LeaseDocumentKey)getEntityContext().getPrimaryKey());
	}
