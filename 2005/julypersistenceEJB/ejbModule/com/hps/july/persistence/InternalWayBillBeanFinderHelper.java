 ...
 **/
public interface InternalWayBillBeanFinderHelper extends com.hps.july.persistence.DocumentBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE(Boolean isDate, java.sql.Date startDate, java.sql.Date endDate, Boolean isOwner, Integer
owner, Boolean isStorage, Integer storage, Boolean isContractor, Integer
contractor, Boolean isWorker, Integer worker, Integer order) throws Exception;
	public java.sql.PreparedStatement findByQBE2(Boolean isDate, java.sql.Date datefrom, java.sql.Date dateto, 
