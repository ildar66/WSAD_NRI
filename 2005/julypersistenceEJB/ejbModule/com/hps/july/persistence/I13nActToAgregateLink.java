...
import javax.ejb.*;
import javax.naming.*;
public class I13nActToAgregateLink extends ManyToSingleLink {
...
public I13nActToAgregateLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StorageCardKey key = ((com.hps.july.persistence.I13nActBean)source).getAgregateKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.I13nActBean)source).getAgregateKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.I13nActBean)source).privateSetAgregateKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryAddI13nAct((com.hps.july.persistence.I13nAct)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryRemoveI13nAct((com.hps.july.persistence.I13nAct)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.I13nActBean)source).privateSetAgregateKey((com.hps.july.persistence.StorageCardKey)targetEJB.getPrimaryKey());
}
}
