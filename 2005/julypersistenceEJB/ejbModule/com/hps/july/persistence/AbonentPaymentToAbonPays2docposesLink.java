...
import javax.ejb.*;
import javax.naming.*;
public class AbonentPaymentToAbonPays2docposesLink extends SingleToManyLink {
...
public AbonentPaymentToAbonPays2docposesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.AbonPays2docpos)targetEJB).privateSetPayposKey((com.hps.july.persistence.AbonentPaymentKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.AbonPays2docpos)anEJB).getPayposKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.AbonPays2docposHome)getTargetHome(this)).findAbonPays2docposesByPaypos((com.hps.july.persistence.AbonentPaymentKey)getEntityContext().getPrimaryKey());
	}
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.AbonPays2docpos.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.AbonPays2docpos)anEJB).secondarySetPaypos((com.hps.july.persistence.AbonentPayment)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.AbonPays2docpos)anEJB).secondarySetPaypos(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.AbonPays2docpos)anEJB).setPaypos(null);
}
}
