...
public class _LeasePay2BillHome_Stub extends Stub implements LeasePay2BillHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeasePay2BillHome:0000000000000000", 
    ...
    public LeasePay2Bill create(int arg0, int arg1, BigDecimal arg2, boolean arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeasePay2Bill) in.read_Object(LeasePay2Bill.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.LeasePay2BillHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                LeasePay2Bill result = ((com.hps.july.persistence.LeasePay2BillHome)so.servant).create(arg0, arg1, arg2Copy, arg3, arg4Copy);
                return (LeasePay2Bill)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByAct(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByAct",com.hps.july.persistence.LeasePay2BillHome.class);
            if (so == null) {
                return findByAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.LeasePay2BillHome)so.servant).findByAct(arg0Copy);
    ...
    public Enumeration findByFlagWorkPIE(String arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByFlagWorkPIE",com.hps.july.persistence.LeasePay2BillHome.class);
            if (so == null) {
                return findByFlagWorkPIE(arg0);
            }
            try {
                Enumeration result = ((com.hps.july.persistence.LeasePay2BillHome)so.servant).findByFlagWorkPIE(arg0);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public LeasePay2Bill findByPrimaryKey(LeasePay2BillKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LeasePay2BillKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeasePay2Bill) in.read_Object(LeasePay2Bill.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeasePay2BillHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeasePay2BillKey arg0Copy = (LeasePay2BillKey) Util.copyObject(arg0,_orb());
                LeasePay2Bill result = ((com.hps.july.persistence.LeasePay2BillHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeasePay2Bill)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
