...
public class _PIESerialResLink_Stub extends Stub implements PIESerialResLink {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIESerialResLink:0000000000000000", 
    ...
    public String getIdResPlatinum() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_idResPlatinum",com.hps.july.persistence.PIESerialResLink.class);
            if (so == null) {
                return getIdResPlatinum();
            }
            try {
                return ((com.hps.july.persistence.PIESerialResLink)so.servant).getIdResPlatinum();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getOwner() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_owner",com.hps.july.persistence.PIESerialResLink.class);
            if (so == null) {
                return getOwner();
            }
            try {
                return ((com.hps.july.persistence.PIESerialResLink)so.servant).getOwner();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getSerialplatinum() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_serialplatinum", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (String) in.read_value(String.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_serialplatinum",com.hps.july.persistence.PIESerialResLink.class);
            if (so == null) {
                return getSerialplatinum();
            }
            try {
                return ((com.hps.july.persistence.PIESerialResLink)so.servant).getSerialplatinum();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getStoragecard() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_storagecard",com.hps.july.persistence.PIESerialResLink.class);
            if (so == null) {
                return getStoragecard();
            }
            try {
                return ((com.hps.july.persistence.PIESerialResLink)so.servant).getStoragecard();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setIdResPlatinum(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_idResPlatinum",com.hps.july.persistence.PIESerialResLink.class);
            if (so == null) {
                setIdResPlatinum(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.PIESerialResLink)so.servant).setIdResPlatinum(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setSerialplatinum(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_serialplatinum", true);
                    out.write_value(arg0,String.class);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_serialplatinum",com.hps.july.persistence.PIESerialResLink.class);
            if (so == null) {
                setSerialplatinum(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.PIESerialResLink)so.servant).setSerialplatinum(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
