 ...
 **/
public interface LeaseSaldoBeanFinderHelper {
	public static final String findByLeaseContractAndResourceOrderDateAscWhereClause = "leasecontract=? and resource=? order by saldate asc";
	public static final String findByLeaseContractAndResourceOrderDateDescWhereClause = "leasecontract=? and resource=? order by saldate desc";

    public java.sql.PreparedStatement findByQBE(Integer leaseContract,
		Boolean isDateStart,
        java.sql.Date fromDateStart, java.sql.Date toDateStart, 
        Integer order
    ) throws Exception;
}
