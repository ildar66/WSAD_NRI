...
import javax.ejb.*;
import javax.naming.*;
public class AbonentBillToLeaseAbonentDNOPsLink extends SingleToManyLink {
...
public AbonentBillToLeaseAbonentDNOPsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.LeaseAbonentDNOP)targetEJB).privateSetAbonentbillKey((com.hps.july.persistence.AbonentBillKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseAbonentDNOP)anEJB).getAbonentbillKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseAbonentDNOPHome)getTargetHome(this)).findLeaseAbonentDNOPsByAbonentbill((com.hps.july.persistence.AbonentBillKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.AbonentBillBean)source).getEntityContext();
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseAbonentDNOP)anEJB).secondarySetAbonentbill((com.hps.july.persistence.AbonentBill)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseAbonentDNOP)anEJB).secondarySetAbonentbill(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseAbonentDNOP)anEJB).setAbonentbill(null);
}
}
