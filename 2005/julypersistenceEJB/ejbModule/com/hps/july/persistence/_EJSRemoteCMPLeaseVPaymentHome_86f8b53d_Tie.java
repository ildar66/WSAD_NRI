...
public class _EJSRemoteCMPLeaseVPaymentHome_86f8b53d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseVPaymentHome_86f8b53d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseVPaymentHome_86f8b53d) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 23: 
                    if (method.equals("findLeaseVPaymentsByAct")) {
                        return findLeaseVPaymentsByAct(in, reply);
                    }
                case 24: 
                ...
                case 34: 
                    if (method.equals("findLeaseVPaymentDsByDebetcontract")) {
                        return findLeaseVPaymentDsByDebetcontract(in, reply);
                    }
                case 35: 
                    if (method.equals("findLeaseVPaymentCsByCreditcontract")) {
                        return findLeaseVPaymentCsByCreditcontract(in, reply);
                    }
                case 85: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_math_BigDecimal")) {
                        return create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_math_BigDecimal(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_math_BigDecimal(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseVPaymentKey arg0 = (LeaseVPaymentKey) in.read_value(LeaseVPaymentKey.class);
        LeaseVPayment result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseVPaymentCsByCreditcontract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseVPaymentCsByCreditcontract(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseVPaymentDsByDebetcontract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseVPaymentDsByDebetcontract(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseVPaymentsByAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseVPaymentsByAct(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
