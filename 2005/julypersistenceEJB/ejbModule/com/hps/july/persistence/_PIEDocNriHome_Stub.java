...
public class _PIEDocNriHome_Stub extends Stub implements PIEDocNriHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDocNriHome:0000000000000000", 
    ...
    public PIEDocNri create(int arg0, int arg1, short arg2, int arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEDocNriHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                PIEDocNri result = ((com.hps.july.persistence.PIEDocNriHome)so.servant).create(arg0, arg1, arg2, arg3);
    ...
    public PIEDocNri findByPrimaryKey(PIEDocNriKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEDocNriHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEDocNriKey arg0Copy = (PIEDocNriKey) Util.copyObject(arg0,_orb());
                PIEDocNri result = ((com.hps.july.persistence.PIEDocNriHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEDocNri)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findPIEDocNrisByQuery(PIEQueryKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPIEDocNrisByQuery", true);
                    ...
                    return findPIEDocNrisByQuery(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPIEDocNrisByQuery",com.hps.july.persistence.PIEDocNriHome.class);
            if (so == null) {
                return findPIEDocNrisByQuery(arg0);
            }
            try {
                PIEQueryKey arg0Copy = (PIEQueryKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEDocNriHome)so.servant).findPIEDocNrisByQuery(arg0Copy);
