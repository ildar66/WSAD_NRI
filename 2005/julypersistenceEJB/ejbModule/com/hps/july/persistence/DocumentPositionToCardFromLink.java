...
import javax.ejb.*;
import javax.naming.*;
public class DocumentPositionToCardFromLink extends ManyToSingleLink {
...
public DocumentPositionToCardFromLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StorageCardKey key = ((com.hps.july.persistence.DocumentPositionBean)source).getCardFromKey();
	try {
		target = ((com.hps.july.persistence.StorageCardHome)getTargetHome(this)).findByPrimaryKey(key);
	}
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.DocumentPositionBean)source).getCardFromKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.DocumentPositionBean)source).privateSetCardFromKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryAddOutDocumentPosition((com.hps.july.persistence.DocumentPosition)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryRemoveOutDocumentPosition((com.hps.july.persistence.DocumentPosition)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.DocumentPositionBean)source).privateSetCardFromKey((com.hps.july.persistence.StorageCardKey)targetEJB.getPrimaryKey());
}
}
