...
public class _RoleHome_Stub extends Stub implements RoleHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.RoleHome:0000000000000000", 
    ...
    public Role create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__CORBA_WStringValue",com.hps.july.persistence.RoleHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Role result = ((com.hps.july.persistence.RoleHome)so.servant).create(arg0);
    ...
    public Role create(String arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.RoleHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Role result = ((com.hps.july.persistence.RoleHome)so.servant).create(arg0, arg1);
                return (Role)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAll() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",com.hps.july.persistence.RoleHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.RoleHome)so.servant).findAll();
    ...
    public Role findByPrimaryKey(RoleKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.RoleHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RoleKey arg0Copy = (RoleKey) Util.copyObject(arg0,_orb());
                Role result = ((com.hps.july.persistence.RoleHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Role)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
