...
public class _PIEMxranLinkHome_Stub extends Stub implements PIEMxranLinkHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEMxranLinkHome:0000000000000000", 
    ...
    public PIEMxranLink create(int arg0, int arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEMxranLink) in.read_Object(PIEMxranLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEMxranLinkHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                PIEMxranLink result = ((com.hps.july.persistence.PIEMxranLinkHome)so.servant).create(arg0, arg1, arg2);
                return (PIEMxranLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByMxrannriOwner(Integer arg0, Integer arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByMxrannriOwner", true);
                    ...
                    return findByMxrannriOwner(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByMxrannriOwner",com.hps.july.persistence.PIEMxranLinkHome.class);
            if (so == null) {
                return findByMxrannriOwner(arg0, arg1);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PIEMxranLinkHome)so.servant).findByMxrannriOwner(arg0Copy, arg1Copy);
    ...
    public PIEMxranLink findByPrimaryKey(PIEMxranLinkKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEMxranLinkKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEMxranLink) in.read_Object(PIEMxranLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEMxranLinkHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEMxranLinkKey arg0Copy = (PIEMxranLinkKey) Util.copyObject(arg0,_orb());
                PIEMxranLink result = ((com.hps.july.persistence.PIEMxranLinkHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEMxranLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findPIEMxranLinksByMxranplatinum(PIEMxranPlatinumKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPIEMxranLinksByMxranplatinum", true);
                    ...
                    return findPIEMxranLinksByMxranplatinum(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPIEMxranLinksByMxranplatinum",com.hps.july.persistence.PIEMxranLinkHome.class);
            if (so == null) {
                return findPIEMxranLinksByMxranplatinum(arg0);
            }
            try {
                PIEMxranPlatinumKey arg0Copy = (PIEMxranPlatinumKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEMxranLinkHome)so.servant).findPIEMxranLinksByMxranplatinum(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
