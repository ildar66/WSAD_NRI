 ...
 **/
public interface ControllerBeanFinderHelper extends com.hps.july.persistence.EquipmentSetBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE( Boolean isNumber, Integer argNumber, Boolean isName, String argName,
	Boolean isSwitch, Integer argSwitch, Integer order) throws Exception;
}
