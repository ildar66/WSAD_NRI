...
import javax.ejb.*;
import javax.naming.*;
public class FaultReportToStoragecardFromLink extends ManyToSingleLink {
...
public FaultReportToStoragecardFromLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StorageCardKey key = ((com.hps.july.persistence.FaultReportBean)source).getStoragecardFromKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.FaultReportBean)source).getStoragecardFromKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.FaultReportBean)source).privateSetStoragecardFromKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryAddFaultReports2((com.hps.july.persistence.FaultReport)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.StorageCard)anEJB).secondaryRemoveFaultReports2((com.hps.july.persistence.FaultReport)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.FaultReportBean)source).privateSetStoragecardFromKey((com.hps.july.persistence.StorageCardKey)targetEJB.getPrimaryKey());
}
}
