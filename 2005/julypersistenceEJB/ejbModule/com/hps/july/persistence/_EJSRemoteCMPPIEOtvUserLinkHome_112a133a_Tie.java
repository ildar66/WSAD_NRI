...
public class _EJSRemoteCMPPIEOtvUserLinkHome_112a133a_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEOtvUserLinkHome_112a133a target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEOtvUserLinkHome_112a133a) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 36: 
                    if (method.equals("findPIEOtvUserLinksByOtvuserplatinum")) {
                        return findPIEOtvUserLinksByOtvuserplatinum(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEOtvUserLinkKey arg0 = (PIEOtvUserLinkKey) in.read_value(PIEOtvUserLinkKey.class);
        PIEOtvUserLink result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEOtvUserLinksByOtvuserplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEOtvUserPlatinumKey arg0 = (PIEOtvUserPlatinumKey) in.read_value(PIEOtvUserPlatinumKey.class);
        Enumeration result;
        try {
            result = target.findPIEOtvUserLinksByOtvuserplatinum(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
