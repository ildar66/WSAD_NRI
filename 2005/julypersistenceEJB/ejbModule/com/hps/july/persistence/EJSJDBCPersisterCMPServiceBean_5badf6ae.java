...
/**
 * EJSJDBCPersisterCMPServiceBean_5badf6ae
 */
public class EJSJDBCPersisterCMPServiceBean_5badf6ae extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderServiceBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	...
	private static final String _loadString = "SELECT T1.division, T1.name, T1.shortname, T1.isactive, T1.boss, T1.company, T1.encloser, T1.type FROM divisions  T1 WHERE T1.type = \'S\' AND T1.division = ?";
	private static final String _loadForUpdateString = _loadString + " FOR UPDATE";
	private byte[] serObj = null;
	/**
	 * EJSJDBCPersisterCMPServiceBean_5badf6ae
	 */
	public EJSJDBCPersisterCMPServiceBean_5badf6ae() throws java.rmi.RemoteException {
		super();	}
	/**
	 * postInit
	 */
...
return null;
	...
	public com.hps.july.persistence.Service findByPrimaryKey(com.hps.july.persistence.DivisionKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		com.hps.july.persistence.Service result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DivisionKey _primaryKey = (com.hps.july.persistence.DivisionKey)key;
		try {
			try {
				result = (com.hps.july.persistence.Service)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.Service)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	...
	private static final String genericFindSqlString = "SELECT T1.division, T1.name, T1.shortname, T1.isactive, T1.boss, T1.company, T1.encloser, T1.type FROM divisions  T1 WHERE T1.type = \'S\' AND ";
	...
	private ServiceBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.ServiceBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.ServiceBeanFinderObject temp_finderObject = new com.hps.july.persistence.ServiceBeanFinderObject();
