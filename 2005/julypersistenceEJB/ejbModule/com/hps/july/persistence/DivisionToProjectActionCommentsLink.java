...
import javax.ejb.*;
import javax.naming.*;
public class DivisionToProjectActionCommentsLink extends SingleToManyLink {
...
public DivisionToProjectActionCommentsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.ProjectActionComments)anEJB).getDivisionKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.ProjectActionCommentsHome)getTargetHome(this)).findProjectActionCommentsByDivision((com.hps.july.persistence.DivisionKey)getEntityContext().getPrimaryKey());
	}
