...
public class _EJSRemoteCMPPIEReferenceHome_9693a3c8_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEReferenceHome_9693a3c8 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEReferenceHome_9693a3c8) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 25: 
                    if (method.equals("findBySpravOrderByCodeAsc")) {
                        return findBySpravOrderByCodeAsc(in, reply);
                    }
                case 33: 
                    if (method.equals("findByOwnerAndSpravOrderByNameAsc")) {
                        return findByOwnerAndSpravOrderByNameAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByOwnerAndSpravOrderByNameAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        String arg1 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByOwnerAndSpravOrderByNameAsc(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEReferenceKey arg0 = (PIEReferenceKey) in.read_value(PIEReferenceKey.class);
        PIEReference result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findBySpravOrderByCodeAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findBySpravOrderByCodeAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
