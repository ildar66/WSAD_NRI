...
import javax.ejb.*;
import javax.naming.*;
public class ChangeActPositionToNewresourceLink extends ManyToSingleLink {
...
public ChangeActPositionToNewresourceLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.ResourceKey key = ((com.hps.july.persistence.ChangeActPositionBean)source).getNewresourceKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.ChangeActPositionBean)source).getNewresourceKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.ChangeActPositionBean)source).privateSetNewresourceKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryAddChangeActPositions((com.hps.july.persistence.ChangeActPosition)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryRemoveChangeActPositions((com.hps.july.persistence.ChangeActPosition)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.ChangeActPositionBean)source).privateSetNewresourceKey((com.hps.july.persistence.ResourceKey)targetEJB.getPrimaryKey());
}
}
