...
public class _AntennaWorkBand_Stub extends Stub implements AntennaWorkBand {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.AntennaWorkBand:0000000000000000", 
    ...
    public Antenna getAntenna() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("getAntenna",com.hps.july.persistence.AntennaWorkBand.class);
            if (so == null) {
                return getAntenna();
            }
            try {
                Antenna result = ((com.hps.july.persistence.AntennaWorkBand)so.servant).getAntenna();
    ...
    public AntennaKey getAntennaKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_antennaKey",com.hps.july.persistence.AntennaWorkBand.class);
            if (so == null) {
                return getAntennaKey();
            }
            try {
                AntennaKey result = ((com.hps.july.persistence.AntennaWorkBand)so.servant).getAntennaKey();
    ...
    public short getBand() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_band",com.hps.july.persistence.AntennaWorkBand.class);
            if (so == null) {
                return getBand();
            }
            try {
                return ((com.hps.july.persistence.AntennaWorkBand)so.servant).getBand();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
