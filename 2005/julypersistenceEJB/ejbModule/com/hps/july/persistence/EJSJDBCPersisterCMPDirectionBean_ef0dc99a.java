...
/**
 * EJSJDBCPersisterCMPDirectionBean_ef0dc99a
 */
public class EJSJDBCPersisterCMPDirectionBean_ef0dc99a extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderDirectionBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	...
	private static final String _loadString = "SELECT T1.division, T1.name, T1.shortname, T1.isactive, T1.boss, T1.company, T1.encloser, T1.type FROM divisions  T1 WHERE T1.type = \'D\' AND T1.division = ?";
	private static final String _loadForUpdateString = _loadString + " FOR UPDATE";
	private byte[] serObj = null;
	/**
	 * EJSJDBCPersisterCMPDirectionBean_ef0dc99a
	 */
	public EJSJDBCPersisterCMPDirectionBean_ef0dc99a() throws java.rmi.RemoteException {
		super();	}
	/**
	 * postInit
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		DirectionBean b = (DirectionBean) eb;
...
return null;
	...
	public com.hps.july.persistence.Direction findByPrimaryKey(com.hps.july.persistence.DivisionKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		com.hps.july.persistence.Direction result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DivisionKey _primaryKey = (com.hps.july.persistence.DivisionKey)key;
		try {
			try {
				result = (com.hps.july.persistence.Direction)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.Direction)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	...
	private static final String genericFindSqlString = "SELECT T1.division, T1.name, T1.shortname, T1.isactive, T1.boss, T1.company, T1.encloser, T1.type FROM divisions  T1 WHERE T1.type = \'D\' AND ";
	...
	private DirectionBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.DirectionBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.DirectionBeanFinderObject temp_finderObject = new com.hps.july.persistence.DirectionBeanFinderObject();
