...
import javax.ejb.*;
import javax.naming.*;
public class ResponsibilityTypeToPositionResponsibleWorkersLink extends SingleToManyLink {
...
public ResponsibilityTypeToPositionResponsibleWorkersLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.PositionResponsibleWorkers)anEJB).getTypeKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.PositionResponsibleWorkersHome)getTargetHome(this)).findPositionResponsibleWorkersByType((com.hps.july.persistence.ResponsibilityTypeKey)getEntityContext().getPrimaryKey());
	}
