...
public class _OrganizationNfsHome_Stub extends Stub implements OrganizationNfsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.OrganizationNfsHome:0000000000000000", 
    ...
    public OrganizationNfs create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.OrganizationNfsHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                OrganizationNfs result = ((com.hps.july.persistence.OrganizationNfsHome)so.servant).create(arg0);
    ...
    public OrganizationNfs findByPrimaryKey(OrganizationNfsKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.OrganizationNfsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                OrganizationNfsKey arg0Copy = (OrganizationNfsKey) Util.copyObject(arg0,_orb());
                OrganizationNfs result = ((com.hps.july.persistence.OrganizationNfsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (OrganizationNfs)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
