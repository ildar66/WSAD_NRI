...
public class _EJSRemoteCMPLeaseAbonentBENHome_269c14e7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseAbonentBENHome_269c14e7 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseAbonentBENHome_269c14e7) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 32: 
                    if (method.equals("findByLeasedocumentOrderByBenAsc")) {
                        return findByLeasedocumentOrderByBenAsc(in, reply);
                    }
                case 37: 
                    if (method.equals("findLeaseAbonentBENsByLeaseabonentban")) {
                        return findLeaseAbonentBENsByLeaseabonentban(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByLeasedocumentOrderByBenAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByLeasedocumentOrderByBenAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseAbonentBENKey arg0 = (LeaseAbonentBENKey) in.read_value(LeaseAbonentBENKey.class);
        LeaseAbonentBEN result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseAbonentBENsByLeaseabonentban(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseAbonentBENsByLeaseabonentban(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
