 ...
 **/
public interface PositionBeanFinderHelper extends com.hps.july.persistence.StoragePlaceBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE( Boolean isNetZone, Integer argNetZone, Boolean isGsmId, String argGsmId,
	Boolean isDampsId, String argDampsId, Boolean isName, String argName, 
	Boolean isAddr, String argAddr, Integer order ) throws Exception;
	public java.sql.PreparedStatement findByQBE2( Boolean isNetZone, Integer argNetZone, Boolean isGsmId, String argGsmId,
	Boolean isDampsId, String argDampsId, Boolean isName, String argName, 
	Boolean isAddr, String argAddr, Boolean isRenter, Integer argRenter,Boolean isResponsableWorker, Integer argResponsableWorker, Integer order  ) throws Exception;
	public java.sql.PreparedStatement findByQBE3( Boolean isNetZone, Integer argNetZone, Boolean isGsmId, String argGsmId,
	Boolean isDampsId, String argDampsId, Boolean isName, String argName, 
	Boolean isAddr, String argAddr, Boolean isRenter, Integer argRenter,Boolean isResponsableWorker, 
	Integer argResponsableWorker, Boolean isInAction, String inAction, Integer order  ) throws Exception;
	java.sql.PreparedStatement findByQBE4(
            ...
            Boolean isWorker, Integer argWorker ) throws Exception;
}
