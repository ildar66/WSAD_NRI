...
public class _EJSRemoteCMPLeaseMutualActNewHome_c0a2cc67_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMutualActNewHome_c0a2cc67 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMutualActNewHome_c0a2cc67) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 43: 
                    if (method.equals("findLeaseMutualActNewByLeaseMutualReglament")) {
                        return findLeaseMutualActNewByLeaseMutualReglament(in, reply);
                    }
                case 125: 
                    if (method.equals("create__long__java_sql_Date__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue__java_sql_Date__java_sql_Date__boolean")) {
                        return create__long__java_sql_Date__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue__java_sql_Date__java_sql_Date__boolean(in, reply);
                    }
                case 144: 
                    if (method.equals("create__long__java_sql_Date__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue__java_sql_Date__java_sql_Date__boolean__java_lang_Boolean")) {
                        return create__long__java_sql_Date__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue__java_sql_Date__java_sql_Date__boolean__java_lang_Boolean(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualActNewByLeaseMutualReglament(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualActNewByLeaseMutualReglament(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_sql_Date__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue__java_sql_Date__java_sql_Date__boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_sql_Date__CORBA_WStringValue__java_lang_Integer__CORBA_WStringValue__java_sql_Date__java_sql_Date__boolean__java_lang_Boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Date arg1 = (Date) in.read_value(Date.class);
        String arg2 = (String) in.read_value(String.class);
        Integer arg3 = (Integer) in.read_value(Integer.class);
