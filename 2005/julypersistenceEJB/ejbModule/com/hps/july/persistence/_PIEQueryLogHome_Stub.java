...
public class _PIEQueryLogHome_Stub extends Stub implements PIEQueryLogHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEQueryLogHome:0000000000000000", 
    ...
    public PIEQueryLog create(int arg0, int arg1, String arg2, int arg3, String arg4, Timestamp arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEQueryLog) in.read_Object(PIEQueryLog.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEQueryLogHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                ...
                Timestamp arg5Copy = (Timestamp) copies[2];
                PIEQueryLog result = ((com.hps.july.persistence.PIEQueryLogHome)so.servant).create(arg0, arg1, arg2Copy, arg3, arg4Copy, arg5Copy);
                return (PIEQueryLog)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEQueryLog findByPrimaryKey(PIEQueryLogKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEQueryLogKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEQueryLog) in.read_Object(PIEQueryLog.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEQueryLogHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEQueryLogKey arg0Copy = (PIEQueryLogKey) Util.copyObject(arg0,_orb());
                PIEQueryLog result = ((com.hps.july.persistence.PIEQueryLogHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEQueryLog)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByQueryTypeOrderByCodeAsc(Integer arg0, String arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByQueryTypeOrderByCodeAsc", true);
                    ...
                    return findByQueryTypeOrderByCodeAsc(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByQueryTypeOrderByCodeAsc",com.hps.july.persistence.PIEQueryLogHome.class);
            if (so == null) {
                return findByQueryTypeOrderByCodeAsc(arg0, arg1);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PIEQueryLogHome)so.servant).findByQueryTypeOrderByCodeAsc(arg0Copy, arg1Copy);
    ...
    public Enumeration findPIEQueryLogsByQuery(PIEQueryKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPIEQueryLogsByQuery", true);
                    ...
                    return findPIEQueryLogsByQuery(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPIEQueryLogsByQuery",com.hps.july.persistence.PIEQueryLogHome.class);
            if (so == null) {
                return findPIEQueryLogsByQuery(arg0);
            }
            try {
                PIEQueryKey arg0Copy = (PIEQueryKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEQueryLogHome)so.servant).findPIEQueryLogsByQuery(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
