...
import javax.ejb.*;
import javax.naming.*;
public class SwitchToControllerLink extends SingleToManyLink {
...
public SwitchToControllerLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.Controller)targetEJB).privateSetSwitchKey((com.hps.july.persistence.StoragePlaceKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Controller)anEJB).getSwitchKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.ControllerHome)getTargetHome(this)).findControllerBySwitch((com.hps.july.persistence.StoragePlaceKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.SwitchBean)source).getEntityContext();
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.Controller.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Controller)anEJB).secondarySetSwitch((com.hps.july.persistence.Switch)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Controller)anEJB).secondarySetSwitch(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Controller)anEJB).setSwitch(null);
}
}
