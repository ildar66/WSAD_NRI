...
public class _EJSRemoteCMPChangeActHome_1004ca71_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPChangeActHome_1004ca71 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPChangeActHome_1004ca71) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 17: 
                    if (method.equals("findByQBEPosition")) {
                        return findByQBEPosition(in, reply);
                    } else if (method.equals("findDocumentByQBE")) {
                        return findDocumentByQBE(in, reply);
                    }
                case 18: 
                    if (method.equals("findByQBEPosition2")) {
                        return findByQBEPosition2(in, reply);
                    }
                case 24: 
                ...
                case 188: 
                    if (method.equals("create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean__CORBA_WStringValue")) {
                        return create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findByQBEPosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Boolean arg0 = (Boolean) in.read_value(Boolean.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Date arg2 = (Date) in.read_value(Date.class);
        Boolean arg3 = (Boolean) in.read_value(Boolean.class);
        Integer arg4 = (Integer) in.read_value(Integer.class);
        Character arg5 = (Character) in.read_value(Character.class);
        Boolean arg6 = (Boolean) in.read_value(Boolean.class);
        Integer arg7 = (Integer) in.read_value(Integer.class);
        Integer arg8 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByQBEPosition(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByQBEPosition2(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Boolean arg0 = (Boolean) in.read_value(Boolean.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Date arg2 = (Date) in.read_value(Date.class);
        Boolean arg3 = (Boolean) in.read_value(Boolean.class);
        ...
        Boolean arg6 = (Boolean) in.read_value(Boolean.class);
        Integer arg7 = (Integer) in.read_value(Integer.class);
        Character arg8 = (Character) in.read_value(Character.class);
        Integer arg9 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByQBEPosition2(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
