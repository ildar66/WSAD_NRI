...
public class _SearchGroupHome_Stub extends Stub implements SearchGroupHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SearchGroupHome:0000000000000000", 
    ...
    public SearchGroup create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.SearchGroupHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                SearchGroup result = ((com.hps.july.persistence.SearchGroupHome)so.servant).create(arg0);
    ...
    public SearchGroup create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.SearchGroupHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                SearchGroup result = ((com.hps.july.persistence.SearchGroupHome)so.servant).create(arg0, arg1);
                return (SearchGroup)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAll() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",com.hps.july.persistence.SearchGroupHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.SearchGroupHome)so.servant).findAll();
    ...
    public SearchGroup findByPrimaryKey(SearchGroupKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SearchGroupHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SearchGroupKey arg0Copy = (SearchGroupKey) Util.copyObject(arg0,_orb());
                SearchGroup result = ((com.hps.july.persistence.SearchGroupHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SearchGroup)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
