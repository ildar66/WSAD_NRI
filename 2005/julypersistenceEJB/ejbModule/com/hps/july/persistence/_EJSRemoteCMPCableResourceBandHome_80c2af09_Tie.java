...
public class _EJSRemoteCMPCableResourceBandHome_80c2af09_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPCableResourceBandHome_80c2af09 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPCableResourceBandHome_80c2af09) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 25: 
                    if (method.equals("findByCableResOrderByBand")) {
                        return findByCableResOrderByBand(in, reply);
                    }
                case 32: 
                    if (method.equals("findCableResourceBandsByResource")) {
                        return findCableResourceBandsByResource(in, reply);
                    }
                case 35: 
                    if (method.equals("findByCableResAndAntennaOrderByBand")) {
                        return findByCableResAndAntennaOrderByBand(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByCableResAndAntennaOrderByBand(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByCableResAndAntennaOrderByBand(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByCableResOrderByBand(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByCableResOrderByBand(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CableResourceBandKey arg0 = (CableResourceBandKey) in.read_value(CableResourceBandKey.class);
        CableResourceBand result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findCableResourceBandsByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findCableResourceBandsByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
