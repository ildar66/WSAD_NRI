...
public class _EJSRemoteCMPPIEPartyResLinkHome_35cfdc71_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEPartyResLinkHome_35cfdc71 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEPartyResLinkHome_35cfdc71) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 72: 
                    if (method.equals("create__CORBA_WStringValue__long__CORBA_WStringValue__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue__long__CORBA_WStringValue__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__CORBA_WStringValue__long__CORBA_WStringValue__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPartyResLinkKey arg0 = (PIEPartyResLinkKey) in.read_value(PIEPartyResLinkKey.class);
        PIEPartyResLink result;
        try {
