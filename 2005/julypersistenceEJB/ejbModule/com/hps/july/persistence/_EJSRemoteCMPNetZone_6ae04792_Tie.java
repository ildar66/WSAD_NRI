...
public class _EJSRemoteCMPNetZone_6ae04792_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPNetZone_6ae04792 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPNetZone_6ae04792) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.hashCode()) {
                ...
                case -1628845899: 
                    if (method.equals("_set_zonecode")) {
                        return _set_zonecode(in, reply);
                    }
                case -1550521068: 
                ...
                case -1161310254: 
                    if (method.equals("_set_netzone_")) {
                        return _set_netzone_(in, reply);
                    }
                case -1011244123: 
                ...
                case -556393275: 
                    if (method.equals("_set_tcode")) {
                        return _set_tcode(in, reply);
                    }
                case -421907529: 
                ...
                case -345582495: 
                    if (method.equals("secondaryRemovePosition")) {
                        return secondaryRemovePosition(in, reply);
                    }
                case -341776199: 
                    if (method.equals("_get_tcode")) {
                        return _get_tcode(in, reply);
                    }
                case -226474774: 
                    if (method.equals("addPosition")) {
                        return addPosition(in, reply);
                    }
                case -89929002: 
                    if (method.equals("secondaryAddPosition")) {
                        return secondaryAddPosition(in, reply);
                    }
                case 176000952: 
                ...
                case 1117128769: 
                    if (method.equals("_get_zonecode")) {
                        return _get_zonecode(in, reply);
                    }
                case 1127085099: 
                ...
                case 1584664414: 
                    if (method.equals("_get_netzone_")) {
                        return _get_netzone_(in, reply);
                    }
                case 1944413392: 
    ...
    private org.omg.CORBA.portable.OutputStream addPosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Position arg0 = (Position) in.read_Object(Position.class);
        target.addPosition(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream _get_netzone_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getNetzone();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_zonecode(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getZonecode();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,String.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream secondaryAddPosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Position arg0 = (Position) in.read_Object(Position.class);
        target.secondaryAddPosition(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream secondaryRemovePosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Position arg0 = (Position) in.read_Object(Position.class);
        target.secondaryRemovePosition(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream _set_netzone_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream _set_zonecode(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setZonecode(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _get_tcode(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        BigDecimal result = target.getTcode();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_tcode(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        BigDecimal arg0 = (BigDecimal) in.read_value(BigDecimal.class);
        target.setTcode(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
