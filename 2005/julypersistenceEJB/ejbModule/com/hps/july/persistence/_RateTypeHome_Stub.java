...
public class _RateTypeHome_Stub extends Stub implements RateTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.RateTypeHome:0000000000000000", 
    ...
    public RateType create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.RateTypeHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                RateType result = ((com.hps.july.persistence.RateTypeHome)so.servant).create(arg0);
    ...
    public RateType create(int arg0, String arg1, Integer arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__java_lang_Integer",com.hps.july.persistence.RateTypeHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                RateType result = ((com.hps.july.persistence.RateTypeHome)so.servant).create(arg0, arg1Copy, arg2Copy);
                return (RateType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.RateTypeHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.RateTypeHome)so.servant).findAllOrderByNameAsc();
    ...
    public RateType findByPrimaryKey(RateTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.RateTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RateTypeKey arg0Copy = (RateTypeKey) Util.copyObject(arg0,_orb());
                RateType result = ((com.hps.july.persistence.RateTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (RateType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findRateTypeByBasecurrency(CurrencyKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findRateTypeByBasecurrency", true);
                    ...
                    return findRateTypeByBasecurrency(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findRateTypeByBasecurrency",com.hps.july.persistence.RateTypeHome.class);
            if (so == null) {
                return findRateTypeByBasecurrency(arg0);
            }
            try {
                CurrencyKey arg0Copy = (CurrencyKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.RateTypeHome)so.servant).findRateTypeByBasecurrency(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
