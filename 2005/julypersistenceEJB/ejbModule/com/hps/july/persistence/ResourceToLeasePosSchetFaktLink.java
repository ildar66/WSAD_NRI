...
import javax.ejb.*;
import javax.naming.*;
public class ResourceToLeasePosSchetFaktLink extends SingleToManyLink {
...
public ResourceToLeasePosSchetFaktLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.LeasePosSchetFakt)targetEJB).privateSetResourceNriKey((com.hps.july.persistence.ResourceKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeasePosSchetFakt)anEJB).getResourceNriKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeasePosSchetFaktHome)getTargetHome(this)).findLeasePosSchetFaktByResourceNri((com.hps.july.persistence.ResourceKey)getEntityContext().getPrimaryKey());
	}
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeasePosSchetFakt)anEJB).secondarySetResourceNri((com.hps.july.persistence.Resource)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeasePosSchetFakt)anEJB).secondarySetResourceNri(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeasePosSchetFakt)anEJB).setResourceNri(null);
}
}
