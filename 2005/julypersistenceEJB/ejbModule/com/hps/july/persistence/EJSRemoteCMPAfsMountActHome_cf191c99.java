...
/**
 * EJSRemoteCMPAfsMountActHome_cf191c99
 */
public class EJSRemoteCMPAfsMountActHome_cf191c99 extends EJSWrapper implements com.hps.july.persistence.AfsMountActHome {
	/**
	 * EJSRemoteCMPAfsMountActHome_cf191c99
	 */
	public EJSRemoteCMPAfsMountActHome_cf191c99() throws java.rmi.RemoteException {
		super();	}
	/**
	 * getDeployedSupport
	 */
	...
	public com.hps.july.persistence.AfsMountAct create(int argDocument) throws javax.ejb.CreateException, java.rmi.RemoteException {
		...
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 0, _EJS_s);
	...
	public com.hps.july.persistence.AfsMountAct create(int argDocument, java.lang.Integer argOwner, java.lang.Integer argFrom, java.lang.Integer argTo, java.sql.Date argBlankDate, int argBlankindex, java.lang.String argBlankNumber, java.lang.String argState, java.lang.Boolean argProcessSource, java.lang.Boolean argProcessDestination, java.lang.Boolean argFixing) throws javax.ejb.CreateException, java.rmi.RemoteException {
		...
		com.hps.july.persistence.AfsMountAct _EJS_result = null;
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 1, _EJS_s);
	...
	public com.hps.july.persistence.AfsMountAct create(int argDocument, java.lang.Integer argOwner, java.sql.Date argBlankDate, int argBlankindex, java.lang.String argState) throws javax.ejb.CreateException, java.rmi.RemoteException {
		...
		com.hps.july.persistence.AfsMountAct _EJS_result = null;
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 2, _EJS_s);
	...
	public com.hps.july.persistence.AfsMountAct findByPrimaryKey(com.hps.july.persistence.DocumentKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		...
		com.hps.july.persistence.AfsMountAct _EJS_result = null;
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 3, _EJS_s);
	...
	public java.util.Enumeration findByQBE(java.lang.Boolean isDate, java.sql.Date startDate, java.sql.Date endDate, java.lang.Boolean isOwner, java.lang.Integer owner, java.lang.Boolean isStorage, java.lang.Integer storage, java.lang.Boolean isContractor, java.lang.Integer contractor, java.lang.Boolean isWorker, java.lang.Integer worker, java.lang.Integer order) throws java.rmi.RemoteException, javax.ejb.FinderException {
		...
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 4, _EJS_s);
			_EJS_result = beanRef.findByQBE(isDate, startDate, endDate, isOwner, owner, isStorage, storage, isContractor, contractor, isWorker, worker, order);
		}
		catch (java.rmi.RemoteException ex) {
			_EJS_s.setUncheckedException(ex);
		}
	...
	public java.util.Enumeration findByQBE2(java.lang.Boolean isDate, java.sql.Date datefrom, java.sql.Date dateto, java.lang.Boolean isOwner, java.lang.Integer owner, java.lang.Boolean isPosition, java.lang.Integer position, java.lang.Boolean isProvider, java.lang.Integer provider, java.lang.Boolean isWorker, java.lang.Integer worker, java.lang.Integer order) throws java.rmi.RemoteException, javax.ejb.FinderException {
		...
		java.util.Enumeration _EJS_result = null;
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 5, _EJS_s);
	...
	public javax.ejb.EJBMetaData getEJBMetaData() throws java.rmi.RemoteException {
		...
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 6, _EJS_s);
	...
	public javax.ejb.HomeHandle getHomeHandle() throws java.rmi.RemoteException {
		...
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 7, _EJS_s);
	...
	public void remove(java.lang.Object arg0) throws java.rmi.RemoteException, javax.ejb.RemoveException {
		...
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 8, _EJS_s);
			beanRef.remove(arg0);
		}
		catch (java.rmi.RemoteException ex) {
			_EJS_s.setUncheckedException(ex);
	...
	public void remove(javax.ejb.Handle arg0) throws java.rmi.RemoteException, javax.ejb.RemoveException {
		...
		try {
			com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99 beanRef = (com.hps.july.persistence.EJSCMPAfsMountActHomeBean_cf191c99)container.preInvoke(this, 9, _EJS_s);
			beanRef.remove(arg0);
		}
		catch (java.rmi.RemoteException ex) {
			_EJS_s.setUncheckedException(ex);
