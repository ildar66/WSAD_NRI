 ...
 */
public class LeaseChargesBeanFinderObject extends LeaseDocPositionBeanFinderObject  
	implements LeaseChargesBeanFinderHelper{
...
public java.sql.PreparedStatement findByQBE2(
  ...
  String alias2 = (String)(m.get("LEASECHARGES"));
...
public java.sql.PreparedStatement findByQBE3(Integer leaseContract, Integer resource, 
	java.sql.Date startInterval, java.sql.Date finishInterval)
	  ...
	  //calculate where clause
	  StringBuffer whereClause = new StringBuffer( alias1+".leasecontract = ? and "+
		alias1+".resource = ? AND ( " +
...
public java.sql.PreparedStatement findByQBE4(
	  ...
	  if (isRemainder.booleanValue())
	  	whereClause = whereClause.append(" AND " + alias2 + ".remaindersum > ? ");
