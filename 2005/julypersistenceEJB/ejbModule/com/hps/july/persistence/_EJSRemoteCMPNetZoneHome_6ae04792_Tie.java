...
public class _EJSRemoteCMPNetZoneHome_6ae04792_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPNetZoneHome_6ae04792 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPNetZoneHome_6ae04792) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 52: 
                    if (method.equals("create__long__CORBA_WStringValue__CORBA_WStringValue")) {
                        return create__long__CORBA_WStringValue__CORBA_WStringValue(in, reply);
                    }
                case 58: 
                    if (method.equals("create__long__CORBA_WStringValue__CORBA_WStringValue__long")) {
                        return create__long__CORBA_WStringValue__CORBA_WStringValue__long(in, reply);
                    }
                case 80: 
                    if (method.equals("create__long__CORBA_WStringValue__CORBA_WStringValue__long__java_math_BigDecimal")) {
                        return create__long__CORBA_WStringValue__CORBA_WStringValue__long__java_math_BigDecimal(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__CORBA_WStringValue__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream create__long__CORBA_WStringValue__CORBA_WStringValue__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        String arg1 = (String) in.read_value(String.class);
        String arg2 = (String) in.read_value(String.class);
    ...
    private org.omg.CORBA.portable.OutputStream create__long__CORBA_WStringValue__CORBA_WStringValue__long__java_math_BigDecimal(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        String arg1 = (String) in.read_value(String.class);
        String arg2 = (String) in.read_value(String.class);
        int arg3 = in.read_long();
