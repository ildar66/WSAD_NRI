...
public class _LeaseMutualPhoneHome_Stub extends Stub implements LeaseMutualPhoneHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseMutualPhoneHome:0000000000000000", 
    ...
    public LeaseMutualPhone create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseMutualPhone) in.read_Object(LeaseMutualPhone.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__",com.hps.july.persistence.LeaseMutualPhoneHome.class);
            if (so == null) {
                return create();
            }
            try {
                LeaseMutualPhone result = ((com.hps.july.persistence.LeaseMutualPhoneHome)so.servant).create();
                return (LeaseMutualPhone)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LeaseMutualPhone create(Integer arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__java_lang_Integer__CORBA_WStringValue",com.hps.july.persistence.LeaseMutualPhoneHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ...
                LeaseMutualPhone result = ((com.hps.july.persistence.LeaseMutualPhoneHome)so.servant).create(arg0Copy, arg1Copy);
                return (LeaseMutualPhone)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public LeaseMutualPhone findByPrimaryKey(LeaseMutualPhoneKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LeaseMutualPhoneKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseMutualPhone) in.read_Object(LeaseMutualPhone.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeaseMutualPhoneHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseMutualPhoneKey arg0Copy = (LeaseMutualPhoneKey) Util.copyObject(arg0,_orb());
                LeaseMutualPhone result = ((com.hps.july.persistence.LeaseMutualPhoneHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseMutualPhone)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findLeaseMutualPhoneByLeaseDocument(LeaseDocumentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findLeaseMutualPhoneByLeaseDocument", true);
                    ...
                    return findLeaseMutualPhoneByLeaseDocument(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findLeaseMutualPhoneByLeaseDocument",com.hps.july.persistence.LeaseMutualPhoneHome.class);
            if (so == null) {
                return findLeaseMutualPhoneByLeaseDocument(arg0);
            }
            try {
                LeaseDocumentKey arg0Copy = (LeaseDocumentKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.LeaseMutualPhoneHome)so.servant).findLeaseMutualPhoneByLeaseDocument(arg0Copy);
