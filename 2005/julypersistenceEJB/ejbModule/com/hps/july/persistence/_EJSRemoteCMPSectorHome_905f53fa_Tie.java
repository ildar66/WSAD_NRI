...
public class _EJSRemoteCMPSectorHome_905f53fa_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSectorHome_905f53fa target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSectorHome_905f53fa) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findSectorsByEquipment")) {
                        return findSectorsByEquipment(in, reply);
                    }
                case 24: 
                ...
                case 33: 
                    if (method.equals("findByBasestationOrderByNumberAsc")) {
                        return findByBasestationOrderByNumberAsc(in, reply);
                    }
                case 65: 
                    if (method.equals("create__long__long__CORBA_WStringValue__short__CORBA_WStringValue")) {
                        return create__long__long__CORBA_WStringValue__short__CORBA_WStringValue(in, reply);
                    }
                case 84: 
                    if (method.equals("create__long__long__CORBA_WStringValue__short__CORBA_WStringValue__java_lang_Boolean")) {
                        return create__long__long__CORBA_WStringValue__short__CORBA_WStringValue__java_lang_Boolean(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__short__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
        short arg3 = in.read_short();
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__short__CORBA_WStringValue__java_lang_Boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
        short arg3 = in.read_short();
    ...
    private org.omg.CORBA.portable.OutputStream findByBasestationOrderByNumberAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByBasestationOrderByNumberAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findSectorsByEquipment(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findSectorsByEquipment(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
