...
public class _StorageHome_Stub extends Stub implements StorageHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.StorageHome:0000000000000000", 
    ...
    public Storage create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Storage) in.read_Object(Storage.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.StorageHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Storage result = ((com.hps.july.persistence.StorageHome)so.servant).create(arg0);
                return (Storage)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Storage create(int arg0, Integer arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.StorageHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                Storage result = ((com.hps.july.persistence.StorageHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
                return (Storage)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Storage create(int arg0, Integer arg1, String arg2, String arg3, int arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__long", true);
                    out.write_long(arg0);
                    out.write_value(arg1,Integer.class);
                    out.write_value(arg2,String.class);
                    out.write_value(arg3,String.class);
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__long",com.hps.july.persistence.StorageHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                String arg2Copy = (String) copies[1];
                String arg3Copy = (String) copies[2];
                Storage result = ((com.hps.july.persistence.StorageHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4);
                return (Storage)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.StorageHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.StorageHome)so.servant).findAllOrderByNameAsc();
    ...
    public Enumeration findByPlatinumAndStatus(Integer arg0, String arg1, Integer arg2) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    return findByPlatinumAndStatus(arg0,arg1,arg2);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByPlatinumAndStatus",com.hps.july.persistence.StorageHome.class);
            if (so == null) {
                return findByPlatinumAndStatus(arg0, arg1, arg2);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.StorageHome)so.servant).findByPlatinumAndStatus(arg0Copy, arg1Copy, arg2Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Storage findByPrimaryKey(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.StorageHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Storage result = ((com.hps.july.persistence.StorageHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Storage)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
