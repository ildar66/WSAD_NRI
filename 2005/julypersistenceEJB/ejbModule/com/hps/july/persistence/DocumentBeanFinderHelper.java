 ...
 **/
public interface DocumentBeanFinderHelper {
	public static final String findDocumentByParentWhereClause = "parentdocument = ? AND type = ?";
	public java.sql.PreparedStatement findDocumentByQBE(Boolean isDate, java.sql.Date datefrom, java.sql.Date dateto,
