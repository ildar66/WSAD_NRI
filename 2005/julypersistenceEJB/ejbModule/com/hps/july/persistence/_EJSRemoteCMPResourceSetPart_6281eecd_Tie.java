...
public class _EJSRemoteCMPResourceSetPart_6281eecd_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPResourceSetPart_6281eecd target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPResourceSetPart_6281eecd) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 112: 
                    ...
                    } else if (method.equals("_get_partKey")) {
                        return _get_partKey(in, reply);
                    }
                case 113: 
                ...
                case 114: 
                    if (method.equals("getPart")) {
                        return getPart(in, reply);
                    }
                case 115: 
                    if (method.equals("_get_setKey")) {
                        return _get_setKey(in, reply);
                    }
                case 116: 
                    if (method.equals("getSet")) {
                        return getSet(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream getPart(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Resource result;
        try {
            result = target.getPart();
    ...
    private org.omg.CORBA.portable.OutputStream _get_partKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey result = target.getPartKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream getSet(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSet result;
        try {
            result = target.getSet();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_setKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSetKey result = target.getSetKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,ResourceSetKey.class);
        return out;
    }
