...
public class _EJSRemoteCMPControllerHome_7e6b4ceb_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPControllerHome_7e6b4ceb target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPControllerHome_7e6b4ceb) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findControllerBySwitch")) {
                        return findControllerBySwitch(in, reply);
                    }
                case 24: 
                ...
                case 25: 
                    if (method.equals("findControllersByResource")) {
                        return findControllersByResource(in, reply);
                    }
                case 71: 
                ...
                case 129: 
                    if (method.equals("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Integer__CORBA_WStringValue")) {
                        return create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Integer__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Integer__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Integer arg1 = (Integer) in.read_value(Integer.class);
        String arg2 = (String) in.read_value(String.class);
        String arg3 = (String) in.read_value(String.class);
    ...
    private org.omg.CORBA.portable.OutputStream findControllerBySwitch(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findControllerBySwitch(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findControllersByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findControllersByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
