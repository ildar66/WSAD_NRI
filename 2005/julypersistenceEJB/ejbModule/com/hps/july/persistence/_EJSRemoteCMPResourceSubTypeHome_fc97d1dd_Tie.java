...
public class _EJSRemoteCMPResourceSubTypeHome_fc97d1dd_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPResourceSubTypeHome_fc97d1dd target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPResourceSubTypeHome_fc97d1dd) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 33: 
                    if (method.equals("findResourceSubTypeByResourcetype")) {
                        return findResourceSubTypeByResourcetype(in, reply);
                    }
                case 51: 
    ...
    private org.omg.CORBA.portable.OutputStream findResourceSubTypeByResourcetype(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceTypeKey arg0 = (ResourceTypeKey) in.read_value(ResourceTypeKey.class);
        Enumeration result;
        try {
            result = target.findResourceSubTypeByResourcetype(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
