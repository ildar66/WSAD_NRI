...
public class _EJSRemoteCMPAccountHome_d70748de_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAccountHome_d70748de target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAccountHome_d70748de) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 23: 
                    if (method.equals("findAccountinbankByBank")) {
                        return findAccountinbankByBank(in, reply);
                    }
                case 24: 
                ...
                case 25: 
                    if (method.equals("findAccountByOrganization")) {
                        return findAccountByOrganization(in, reply);
                    }
                case 70: 
                    if (method.equals("create__long__java_lang_Integer__java_lang_Integer__CORBA_WStringValue")) {
                        return create__long__java_lang_Integer__java_lang_Integer__CORBA_WStringValue(in, reply);
                    }
                case 82: 
                    if (method.equals("create__long__com_hps_july_persistence_Organization__com_hps_july_persistence_Bank")) {
                        return create__long__com_hps_july_persistence_Organization__com_hps_july_persistence_Bank(in, reply);
                    }
                case 89: 
                    if (method.equals("create__long__java_lang_Integer__java_lang_Integer__CORBA_WStringValue__java_lang_Boolean")) {
                        return create__long__java_lang_Integer__java_lang_Integer__CORBA_WStringValue__java_lang_Boolean(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_lang_Integer__java_lang_Integer__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_lang_Integer__java_lang_Integer__CORBA_WStringValue__java_lang_Boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Integer arg2 = (Integer) in.read_value(Integer.class);
        String arg3 = (String) in.read_value(String.class);
    ...
    private org.omg.CORBA.portable.OutputStream findAccountByOrganization(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OrganizationKey arg0 = (OrganizationKey) in.read_value(OrganizationKey.class);
        Enumeration result;
        try {
            result = target.findAccountByOrganization(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream create__long__com_hps_july_persistence_Organization__com_hps_july_persistence_Bank(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Organization arg1 = (Organization) in.read_Object(Organization.class);
        Bank arg2 = (Bank) in.read_Object(Bank.class);
        Account result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findAccountinbankByBank(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findAccountinbankByBank(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
