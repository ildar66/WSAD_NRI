...
public class _PIEDocInfoDocPosHome_Stub extends Stub implements PIEDocInfoDocPosHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDocInfoDocPosHome:0000000000000000", 
    ...
    public PIEDocInfoDocPos create(int arg0, boolean arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDocInfoDocPos) in.read_Object(PIEDocInfoDocPos.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEDocInfoDocPosHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                PIEDocInfoDocPos result = ((com.hps.july.persistence.PIEDocInfoDocPosHome)so.servant).create(arg0, arg1);
                return (PIEDocInfoDocPos)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEDocInfoDocPos findByPrimaryKey(PIEDocInfoDocPosKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEDocInfoDocPosKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDocInfoDocPos) in.read_Object(PIEDocInfoDocPos.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEDocInfoDocPosHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEDocInfoDocPosKey arg0Copy = (PIEDocInfoDocPosKey) Util.copyObject(arg0,_orb());
                PIEDocInfoDocPos result = ((com.hps.july.persistence.PIEDocInfoDocPosHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEDocInfoDocPos)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
