...
import javax.ejb.*;
import javax.naming.*;
public class LeaseAbonentBANToLeaseAbonentPhonesLink extends SingleToManyLink {
	private static LeaseAbonentPhoneHome targetHome = null;
	private final static java.lang.String targetHomeName = "LeaseAbonentPhone";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public LeaseAbonentBANToLeaseAbonentPhonesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseAbonentPhone)anEJB).getPhone2banKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseAbonentPhoneHome)getTargetHome(this)).findLeaseAbonentPhonesByPhone2ban((com.hps.july.persistence.LeaseDocumentKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.hps.july.persistence.LeaseAbonentPhoneHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized LeaseAbonentPhoneHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.LeaseAbonentPhoneHome)lookupTargetHome(homeName, com.hps.july.persistence.LeaseAbonentPhoneHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.LeaseAbonentPhone.class);
}
/**
