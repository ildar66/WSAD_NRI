 ...
 **/
public interface BaseStationBeanFinderHelper extends com.hps.july.persistence.EquipmentSetBeanFinderHelper { 
	public static final String findByBSNumberWhereClause = "number = ?";
}
