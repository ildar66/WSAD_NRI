 ...
 **/
public interface LeaseDocPositionBeanFinderHelper {
	java.sql.PreparedStatement findByQBE(Boolean isLeaseContract, Integer leaseContract,
	...
	java.sql.PreparedStatement findByQBE2(Integer leaseContract, Integer resource, java.sql.Date date, String docposvid) throws Exception;
	java.sql.PreparedStatement findByQBE5(Boolean isLeaseContract, Integer leaseContract,
            Boolean isDate, java.sql.Date fromDate, java.sql.Date toDate, 
            Boolean isResource, Integer resource,
