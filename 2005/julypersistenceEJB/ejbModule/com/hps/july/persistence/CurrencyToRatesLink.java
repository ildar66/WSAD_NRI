...
import javax.ejb.*;
import javax.naming.*;
public class CurrencyToRatesLink extends SingleToManyLink {
...
public CurrencyToRatesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Rate)anEJB).getCurrencyKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.RateHome)getTargetHome(this)).findRatesByCurrency((com.hps.july.persistence.CurrencyKey)getEntityContext().getPrimaryKey());
	}
