...
public class _ExpeditionHome_Stub extends Stub implements ExpeditionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ExpeditionHome:0000000000000000", 
    ...
    public Expedition create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Expedition) in.read_Object(Expedition.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.ExpeditionHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Expedition result = ((com.hps.july.persistence.ExpeditionHome)so.servant).create(arg0);
                return (Expedition)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Expedition create(int arg0, Integer arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.ExpeditionHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                Expedition result = ((com.hps.july.persistence.ExpeditionHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
                return (Expedition)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.ExpeditionHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.ExpeditionHome)so.servant).findAllOrderByNameAsc();
    ...
    public Expedition findByPrimaryKey(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ExpeditionHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Expedition result = ((com.hps.july.persistence.ExpeditionHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Expedition)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findExpeditionByExpeditor(WorkerKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findExpeditionByExpeditor", true);
                    ...
                    return findExpeditionByExpeditor(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findExpeditionByExpeditor",com.hps.july.persistence.ExpeditionHome.class);
            if (so == null) {
                return findExpeditionByExpeditor(arg0);
            }
            try {
                WorkerKey arg0Copy = (WorkerKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.ExpeditionHome)so.servant).findExpeditionByExpeditor(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findExpeditionByOrganization(OrganizationKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findExpeditionByOrganization", true);
                    ...
                    return findExpeditionByOrganization(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findExpeditionByOrganization",com.hps.july.persistence.ExpeditionHome.class);
            if (so == null) {
                return findExpeditionByOrganization(arg0);
            }
            try {
                OrganizationKey arg0Copy = (OrganizationKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.ExpeditionHome)so.servant).findExpeditionByOrganization(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
