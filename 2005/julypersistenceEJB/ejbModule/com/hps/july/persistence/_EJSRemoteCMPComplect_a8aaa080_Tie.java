...
public class _EJSRemoteCMPComplect_a8aaa080_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPComplect_a8aaa080 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPComplect_a8aaa080) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 99: 
                    if (method.equals("_get_complectKey")) {
                        return _get_complectKey(in, reply);
                    }
                case 101: 
                ...
                case 109: 
                    if (method.equals("getComplect")) {
                        return getComplect(in, reply);
                    }
                case 110: 
    ...
    private org.omg.CORBA.portable.OutputStream getComplect(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Resource result;
        try {
            result = target.getComplect();
    ...
    private org.omg.CORBA.portable.OutputStream _get_complectKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey result = target.getComplectKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_partsKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey result = target.getPartsKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,ResourceKey.class);
        return out;
