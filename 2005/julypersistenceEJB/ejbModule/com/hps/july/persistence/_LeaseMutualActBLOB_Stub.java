...
public class _LeaseMutualActBLOB_Stub extends Stub implements LeaseMutualActBLOB {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseMutualActBLOB:0000000000000000", 
    ...
    public String getActfilename() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_actfilename",com.hps.july.persistence.LeaseMutualActBLOB.class);
            if (so == null) {
                return getActfilename();
            }
            try {
                return ((com.hps.july.persistence.LeaseMutualActBLOB)so.servant).getActfilename();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getLeasedocument() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_leasedocument",com.hps.july.persistence.LeaseMutualActBLOB.class);
            if (so == null) {
                return getLeasedocument();
            }
            try {
                return ((com.hps.july.persistence.LeaseMutualActBLOB)so.servant).getLeasedocument();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setActfilename(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_actfilename", true);
            ...
            ServantObject so = _servant_preinvoke("_set_actfilename",com.hps.july.persistence.LeaseMutualActBLOB.class);
            if (so == null) {
                setActfilename(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.LeaseMutualActBLOB)so.servant).setActfilename(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
