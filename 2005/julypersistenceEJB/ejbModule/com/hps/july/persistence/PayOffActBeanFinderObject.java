 ...
 */
public class PayOffActBeanFinderObject extends DocumentBeanFinderObject 
implements PayOffActBeanFinderHelper{
...
public java.sql.PreparedStatement findDocumentByQBE(
  ...
  String alias = (String)(m.get("DOCUMENTS"));
	...
	StringBuffer whereClause = new StringBuffer( alias + ".showtouser = 'Y' AND not exists (select d.* from docdependencies d where "+
		"d.documentto="+alias+".document and d.type=\"P\") " );
