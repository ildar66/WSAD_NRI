...
public class _BankHome_Stub extends Stub implements BankHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.BankHome:0000000000000000", 
    ...
    public Bank create(Integer arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.BankHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Bank result = ((com.hps.july.persistence.BankHome)so.servant).create(arg0Copy);
    ...
    public Bank findByPrimaryKey(Integer arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.BankHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Bank result = ((com.hps.july.persistence.BankHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Bank)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Bank findBankByBik(String arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findBankByBik",com.hps.july.persistence.BankHome.class);
            if (so == null) {
                return findBankByBik(arg0);
            }
            try {
                Bank result = ((com.hps.july.persistence.BankHome)so.servant).findBankByBik(arg0);
                return (Bank)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
