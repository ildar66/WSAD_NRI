...
public class _EJSRemoteCMPLeaseVPayment_86f8b53d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseVPayment_86f8b53d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseVPayment_86f8b53d) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 98: 
                    if (method.equals("getDebetcontract")) {
                        return getDebetcontract(in, reply);
                    }
                case 99: 
                    if (method.equals("_get_creditcontractKey")) {
                        return _get_creditcontractKey(in, reply);
                    }
                case 100: 
                    if (method.equals("_get_debetcontractKey")) {
                        return _get_debetcontractKey(in, reply);
                    }
                case 101: 
                    if (method.equals("remove")) {
                        return remove(in, reply);
                    } else if (method.equals("getCreditcontract")) {
                        return getCreditcontract(in, reply);
                    }
                case 104: 
                ...
                case 115: 
                    ...
                    } else if (method.equals("_set_summ")) {
    ...
    private org.omg.CORBA.portable.OutputStream getCreditcontract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseContract result;
        try {
            result = target.getCreditcontract();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_creditcontractKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey result = target.getCreditcontractKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,LeaseDocumentKey.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream getDebetcontract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseContract result;
        try {
            result = target.getDebetcontract();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_debetcontractKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey result = target.getDebetcontractKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,LeaseDocumentKey.class);
        return out;
