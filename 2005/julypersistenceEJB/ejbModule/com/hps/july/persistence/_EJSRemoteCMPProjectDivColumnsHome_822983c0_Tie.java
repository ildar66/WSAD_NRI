...
public class _EJSRemoteCMPProjectDivColumnsHome_822983c0_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectDivColumnsHome_822983c0 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectDivColumnsHome_822983c0) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 31: 
                    if (method.equals("findProjectDivColumnsByDivision")) {
                        return findProjectDivColumnsByDivision(in, reply);
                    }
                case 34: 
                    if (method.equals("findProjectDivColumnsByProjectType")) {
                        return findProjectDivColumnsByProjectType(in, reply);
                    }
                case 42: 
                    if (method.equals("findByColDivisionActtypeOrderByAfterColAsc")) {
                        return findByColDivisionActtypeOrderByAfterColAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByColDivisionActtypeOrderByAfterColAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Enumeration result;
        try {
            result = target.findByColDivisionActtypeOrderByAfterColAsc(arg0, arg1, arg2);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectDivColumnsKey arg0 = (ProjectDivColumnsKey) in.read_value(ProjectDivColumnsKey.class);
        ProjectDivColumns result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findProjectDivColumnsByDivision(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DivisionKey arg0 = (DivisionKey) in.read_value(DivisionKey.class);
        Enumeration result;
        try {
            result = target.findProjectDivColumnsByDivision(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectDivColumnsByProjectType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectTypeKey arg0 = (ProjectTypeKey) in.read_value(ProjectTypeKey.class);
        Enumeration result;
        try {
            result = target.findProjectDivColumnsByProjectType(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
