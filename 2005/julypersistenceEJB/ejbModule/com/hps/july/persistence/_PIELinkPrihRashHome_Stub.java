...
public class _PIELinkPrihRashHome_Stub extends Stub implements PIELinkPrihRashHome {
    ...
    public PIELinkPrihRash create(int arg0, int arg1, int arg2, int arg3, BigDecimal arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIELinkPrihRash) in.read_Object(PIELinkPrihRash.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIELinkPrihRashHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                BigDecimal arg4Copy = (BigDecimal) Util.copyObject(arg4,_orb());
                PIELinkPrihRash result = ((com.hps.july.persistence.PIELinkPrihRashHome)so.servant).create(arg0, arg1, arg2, arg3, arg4Copy);
                return (PIELinkPrihRash)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByDocposPrihod(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByDocposPrihod", true);
                    ...
                    return findByDocposPrihod(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByDocposPrihod",com.hps.july.persistence.PIELinkPrihRashHome.class);
            if (so == null) {
                return findByDocposPrihod(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIELinkPrihRashHome)so.servant).findByDocposPrihod(arg0Copy);
    ...
    public Enumeration findByDocposRashod(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByDocposRashod", true);
                    out.write_value(arg0,Integer.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Enumeration) in.read_value(Enumeration.class);
                } catch (ApplicationException ex) {
                    ...
                    return findByDocposRashod(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByDocposRashod",com.hps.july.persistence.PIELinkPrihRashHome.class);
            if (so == null) {
                return findByDocposRashod(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIELinkPrihRashHome)so.servant).findByDocposRashod(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public PIELinkPrihRash findByPrimaryKey(PIELinkPrihRashKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIELinkPrihRashKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIELinkPrihRash) in.read_Object(PIELinkPrihRash.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIELinkPrihRashHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIELinkPrihRashKey arg0Copy = (PIELinkPrihRashKey) Util.copyObject(arg0,_orb());
                PIELinkPrihRash result = ((com.hps.july.persistence.PIELinkPrihRashHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIELinkPrihRash)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
