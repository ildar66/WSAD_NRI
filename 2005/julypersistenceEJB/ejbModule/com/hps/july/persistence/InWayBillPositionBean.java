 ...
 * Позиция документа "Внешняя приходная накладная"
 */
public class InWayBillPositionBean extends DocumentPositionBean {
	private final static long serialVersionUID = 3206093459760846163L;
	public java.lang.Integer outerDocPosition_outerDocPosition;
	private transient com.ibm.ivj.ejb.associations.interfaces.SingleLink outerDocPositionLink = null;
	public java.math.BigDecimal sourcePrice;
	/**
	 * _copyFromEJB
	 */
	public java.util.Hashtable _copyFromEJB() {
		...
		h.put("outerDocPositionKey", getOuterDocPositionKey());
		h.put("sourcePrice", getSourcePrice());
	...
	public void _copyToEJB(java.util.Hashtable h) {
		java.math.BigDecimal localSourcePrice =
			(java.math.BigDecimal) h.get("sourcePrice");
		...
		if (h.containsKey("sourcePrice"))
			setSourcePrice((localSourcePrice));
...
public void ejbCreate(int argDocposition, Integer argResource, Integer argOwner, Integer argDocument, 
	...
	Boolean argSourceClosed, Boolean argResultClosed, Integer argOuterDocPos ) throws javax.ejb.CreateException, java.rmi.RemoteException {
	...
	outerDocPosition_outerDocPosition = argOuterDocPos;
}
/**
 * ejbCreate method for a CMP entity bean
 * @param argDocposition int
...
public void ejbCreate(int argDocposition, Integer argResource, Integer argOwner, Integer argDocument, 
	int argOrder, java.math.BigDecimal argQty, java.math.BigDecimal argPrice, 
	Boolean argSourceBoxed, Boolean argResultBoxed, Boolean argSourceBroken , Boolean argResultBroken, 
	Boolean argSourceClosed, Boolean argResultClosed, 
	Integer argOuterDocPos, java.math.BigDecimal argSourcePrice ) throws javax.ejb.CreateException, java.rmi.RemoteException {
	super.ejbCreate(argDocposition, argResource, argOwner, argDocument, 
	argOrder, argQty, argPrice, 
	argSourceBoxed, argResultBoxed, argSourceBroken , argResultBroken, 
	argSourceClosed, argResultClosed);
...
public com.hps.july.persistence.OuterDocPosition getOuterDocPosition() throws java.rmi.RemoteException, javax.ejb.FinderException {
	return (com.hps.july.persistence.OuterDocPosition)this.getOuterDocPositionLink().value();
}
/**
 * This method was generated for supporting the association named InWayBillPosition2OuterDocPosition.  
 * 	It will be deleted/edited when the association is deleted/edited.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public com.hps.july.persistence.OuterDocPositionKey getOuterDocPositionKey() {
	com.hps.july.persistence.OuterDocPositionKey temp = null;
	temp = new com.hps.july.persistence.OuterDocPositionKey();
	boolean outerDocPosition_NULLTEST = true;
	outerDocPosition_NULLTEST &= (outerDocPosition_outerDocPosition == null);
	temp.outerDocPosition = ((outerDocPosition_outerDocPosition == null) ? 0 : outerDocPosition_outerDocPosition.intValue());
	if (outerDocPosition_NULLTEST) temp = null;
	return temp;
}
/**
 * This method was generated for supporting the association named InWayBillPosition2OuterDocPosition.  
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected com.ibm.ivj.ejb.associations.interfaces.SingleLink getOuterDocPositionLink() {
	if (outerDocPositionLink == null)
		outerDocPositionLink = new InWayBillPositionToOuterDocPositionLink(this);
	return outerDocPositionLink;
}
/**
 * Getter method for sourcePrice
 */
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public void privateSetOuterDocPositionKey(com.hps.july.persistence.OuterDocPositionKey inKey) {
	boolean outerDocPosition_NULLTEST = (inKey == null);
	if (outerDocPosition_NULLTEST) outerDocPosition_outerDocPosition = null; else outerDocPosition_outerDocPosition = (new Integer(inKey.outerDocPosition));
}
/**
 * This method was generated for supporting the association named InWayBillPosition2OuterDocPosition.  
 * 	It will be deleted/edited when the association is deleted/edited.
...
public void secondarySetOuterDocPosition(com.hps.july.persistence.OuterDocPosition anOuterDocPosition) throws java.rmi.RemoteException {
	this.getOuterDocPositionLink().secondarySet(anOuterDocPosition);
}
/**
 * This method was generated for supporting the association named InWayBillPosition2OuterDocPosition.  
 * 	It will be deleted/edited when the association is deleted/edited.
...
public void setOuterDocPosition(com.hps.july.persistence.OuterDocPosition anOuterDocPosition) throws java.rmi.RemoteException {
	this.getOuterDocPositionLink().set(anOuterDocPosition);
}
/**
 * Setter method for sourcePrice
 */
public void setSourcePrice(java.math.BigDecimal newValue) {
	this.sourcePrice = newValue;
}
}
