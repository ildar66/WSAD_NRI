...
public class _LeaseMutualActInfo_Stub extends Stub implements LeaseMutualActInfo {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseMutualActInfo:0000000000000000", 
    ...
    public Timestamp getLastcalctime() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_lastcalctime", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_lastcalctime",com.hps.july.persistence.LeaseMutualActInfo.class);
            if (so == null) {
                return getLastcalctime();
            }
            try {
                Timestamp result = ((com.hps.july.persistence.LeaseMutualActInfo)so.servant).getLastcalctime();
    ...
    public int getLeasedocument() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_leasedocument",com.hps.july.persistence.LeaseMutualActInfo.class);
            if (so == null) {
                return getLeasedocument();
            }
            try {
                return ((com.hps.july.persistence.LeaseMutualActInfo)so.servant).getLeasedocument();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setLastcalctime(Timestamp arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_lastcalctime", true);
            ...
            ServantObject so = _servant_preinvoke("_set_lastcalctime",com.hps.july.persistence.LeaseMutualActInfo.class);
            if (so == null) {
                setLastcalctime(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.LeaseMutualActInfo)so.servant).setLastcalctime(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
