 ...
 **/
public interface ResourceBeanFinderHelper { 
	 public static final String findActiveResourceBySubtypeWhereClause = "resourcesubtype = ? AND active = ?";
	 public java.sql.PreparedStatement findResourceByReglamentOrderByCodeAsc(java.lang.Integer argReglament) throws Exception;
	 public java.sql.PreparedStatement findResourcesByLeaseChargeRules( java.util.Vector listContracts ) throws Exception;
	 public java.sql.PreparedStatement findResourcesByLeasePayRules( java.util.Vector listContracts ) throws Exception;
	 public java.sql.PreparedStatement findResourcesByQBE( Boolean isSubtypekey, ResourceSubTypeKey subtypeKey,
                                    Boolean isModel, String model,
                                    Boolean isName, String name,
                                    Integer order ) throws Exception;
	 public java.sql.PreparedStatement findResourcesByQBE2(Boolean isSubtypekey, ResourceSubTypeKey subtypeKey,
    Boolean isModel, String model,
    Boolean isName, String name,
