...
public class _EJSRemoteCMPSearchGrouppingHome_251bf269_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSearchGrouppingHome_251bf269 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSearchGrouppingHome_251bf269) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 32: 
                    if (method.equals("findSearchGrouppingBySearchGroup")) {
                        return findSearchGrouppingBySearchGroup(in, reply);
                    }
                case 51: 
                    if (method.equals("create__long__java_lang_Integer__CORBA_WStringValue")) {
                        return create__long__java_lang_Integer__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_lang_Integer__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findSearchGrouppingBySearchGroup(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SearchGroupKey arg0 = (SearchGroupKey) in.read_value(SearchGroupKey.class);
        Enumeration result;
        try {
            result = target.findSearchGrouppingBySearchGroup(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
