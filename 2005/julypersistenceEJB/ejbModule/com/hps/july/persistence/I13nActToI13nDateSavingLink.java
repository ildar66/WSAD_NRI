...
import javax.ejb.*;
import javax.naming.*;
public class I13nActToI13nDateSavingLink extends SingleToManyLink {
...
public I13nActToI13nDateSavingLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.I13nDateSaving)anEJB).getI13nActKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.I13nDateSavingHome)getTargetHome(this)).findI13nDateSavingByI13nAct((com.hps.july.persistence.DocumentKey)getEntityContext().getPrimaryKey());
	}
