...
public class _EJSRemoteCMPPIEQueryLogHome_a5116b49_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEQueryLogHome_a5116b49 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEQueryLogHome_a5116b49) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 23: 
                    if (method.equals("findPIEQueryLogsByQuery")) {
                        return findPIEQueryLogsByQuery(in, reply);
                    }
                case 24: 
                ...
                case 29: 
                    if (method.equals("findByQueryTypeOrderByCodeAsc")) {
                        return findByQueryTypeOrderByCodeAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryLogKey arg0 = (PIEQueryLogKey) in.read_value(PIEQueryLogKey.class);
        PIEQueryLog result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByQueryTypeOrderByCodeAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        String arg1 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByQueryTypeOrderByCodeAsc(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findPIEQueryLogsByQuery(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryKey arg0 = (PIEQueryKey) in.read_value(PIEQueryKey.class);
        Enumeration result;
        try {
            result = target.findPIEQueryLogsByQuery(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
