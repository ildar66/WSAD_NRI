...
public class _LeaseContractBLOBHome_Stub extends Stub implements LeaseContractBLOBHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseContractBLOBHome:0000000000000000", 
    ...
    public LeaseContractBLOB create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseContractBLOB) in.read_Object(LeaseContractBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.LeaseContractBLOBHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                LeaseContractBLOB result = ((com.hps.july.persistence.LeaseContractBLOBHome)so.servant).create(arg0);
                return (LeaseContractBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LeaseContractBLOB findByPrimaryKey(LeaseContractBLOBKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LeaseContractBLOBKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseContractBLOB) in.read_Object(LeaseContractBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.LeaseContractBLOBHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseContractBLOBKey arg0Copy = (LeaseContractBLOBKey) Util.copyObject(arg0,_orb());
                LeaseContractBLOB result = ((com.hps.july.persistence.LeaseContractBLOBHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseContractBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
