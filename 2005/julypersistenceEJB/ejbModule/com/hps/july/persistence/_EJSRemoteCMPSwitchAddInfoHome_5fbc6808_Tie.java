...
public class _EJSRemoteCMPSwitchAddInfoHome_5fbc6808_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSwitchAddInfoHome_5fbc6808 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSwitchAddInfoHome_5fbc6808) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 26: 
                    if (method.equals("findSwitchAddInfosBySwitch")) {
                        return findSwitchAddInfosBySwitch(in, reply);
                    }
                case 32: 
                    if (method.equals("findByEquipmentOrderByActdateAsc")) {
                        return findByEquipmentOrderByActdateAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByEquipmentOrderByActdateAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByEquipmentOrderByActdateAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findSwitchAddInfosBySwitch(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findSwitchAddInfosBySwitch(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
