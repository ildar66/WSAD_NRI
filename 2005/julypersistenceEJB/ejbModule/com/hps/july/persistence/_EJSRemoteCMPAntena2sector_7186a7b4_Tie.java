...
public class _EJSRemoteCMPAntena2sector_7186a7b4_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAntena2sector_7186a7b4 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAntena2sector_7186a7b4) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 97: 
                    if (method.equals("_get_antennaKey")) {
                        return _get_antennaKey(in, reply);
                    }
                case 98: 
                ...
                case 99: 
                    if (method.equals("getSector")) {
                        return getSector(in, reply);
                    }
                case 100: 
                ...
                case 115: 
                    if (method.equals("_get_sectorKey")) {
                        return _get_sectorKey(in, reply);
                    }
                case 116: 
                    if (method.equals("getAntenna")) {
                        return getAntenna(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream getAntenna(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Antenna result;
        try {
            result = target.getAntenna();
    ...
    private org.omg.CORBA.portable.OutputStream _get_antennaKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AntennaKey result = target.getAntennaKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream getSector(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Sector result;
        try {
            result = target.getSector();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_sectorKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SectorKey result = target.getSectorKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
