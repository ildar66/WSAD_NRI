...
import javax.ejb.*;
import javax.naming.*;
public class OrganizationToSearchesLink extends SingleToManyLink {
...
public OrganizationToSearchesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Searches)anEJB).getOrganizationKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.SearchesHome)getTargetHome(this)).findSearchesByOrganization((com.hps.july.persistence.OrganizationKey)getEntityContext().getPrimaryKey());
	}
