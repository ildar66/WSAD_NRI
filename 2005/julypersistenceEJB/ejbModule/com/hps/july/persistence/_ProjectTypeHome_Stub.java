...
public class _ProjectTypeHome_Stub extends Stub implements ProjectTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ProjectTypeHome:0000000000000000", 
    ...
    public ProjectType create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.ProjectTypeHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                ProjectType result = ((com.hps.july.persistence.ProjectTypeHome)so.servant).create(arg0);
    ...
    public ProjectType create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.ProjectTypeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ProjectType result = ((com.hps.july.persistence.ProjectTypeHome)so.servant).create(arg0, arg1);
                return (ProjectType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByCodeAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByCodeAsc",com.hps.july.persistence.ProjectTypeHome.class);
            if (so == null) {
                return findAllOrderByCodeAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.ProjectTypeHome)so.servant).findAllOrderByCodeAsc();
    ...
    public ProjectType findByPrimaryKey(ProjectTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ProjectTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ProjectTypeKey arg0Copy = (ProjectTypeKey) Util.copyObject(arg0,_orb());
                ProjectType result = ((com.hps.july.persistence.ProjectTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ProjectType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
