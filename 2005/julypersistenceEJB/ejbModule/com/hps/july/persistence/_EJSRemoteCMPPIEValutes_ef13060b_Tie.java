...
public class _EJSRemoteCMPPIEValutes_ef13060b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEValutes_ef13060b target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEValutes_ef13060b) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 16: 
                    if (method.equals("_get_idvalutenri")) {
                        return _get_idvalutenri(in, reply);
                    } else if (method.equals("_set_idvalutenri")) {
                        return _set_idvalutenri(in, reply);
                    }
                case 21: 
                    if (method.equals("_get_idvaluteplatinum")) {
                        return _get_idvaluteplatinum(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_idvalutenri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer result = target.getIdvalutenri();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_idvaluteplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getIdvaluteplatinum();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_idvalutenri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        target.setIdvalutenri(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
