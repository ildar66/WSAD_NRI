...
public class _EJSRemoteCMPPIEPayLink_415658e8_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEPayLink_415658e8 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEPayLink_415658e8) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 101: 
                    ...
                    } else if (method.equals("getPiepayplatinum")) {
                        return getPiepayplatinum(in, reply);
                    }
                case 104: 
                ...
                case 112: 
                    ...
                    } else if (method.equals("_get_piepayplatinumKey")) {
                        return _get_piepayplatinumKey(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream getPiepayplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPayPlatinum result;
        try {
            result = target.getPiepayplatinum();
    ...
    private org.omg.CORBA.portable.OutputStream _get_piepayplatinumKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEPayPlatinumKey result = target.getPiepayplatinumKey();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,PIEPayPlatinumKey.class);
        return out;
    }
}
