...
public class _PIEPayLink_Stub extends Stub implements PIEPayLink {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEPayLink:0000000000000000", 
    ...
    public PIEPayPlatinum getPiepayplatinum() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("getPiepayplatinum", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("getPiepayplatinum",com.hps.july.persistence.PIEPayLink.class);
            if (so == null) {
                return getPiepayplatinum();
            }
            try {
                PIEPayPlatinum result = ((com.hps.july.persistence.PIEPayLink)so.servant).getPiepayplatinum();
    ...
    public PIEPayPlatinumKey getPiepayplatinumKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_piepayplatinumKey", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEPayPlatinumKey) in.read_value(PIEPayPlatinumKey.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
                } catch (RemarshalException ex) {
                    return getPiepayplatinumKey();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("_get_piepayplatinumKey",com.hps.july.persistence.PIEPayLink.class);
            if (so == null) {
                return getPiepayplatinumKey();
            }
            try {
                PIEPayPlatinumKey result = ((com.hps.july.persistence.PIEPayLink)so.servant).getPiepayplatinumKey();
                return (PIEPayPlatinumKey)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
