...
import javax.ejb.*;
import javax.naming.*;
public class FaultReportToDivisionLink extends ManyToSingleLink {
...
public FaultReportToDivisionLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DivisionKey key = ((com.hps.july.persistence.FaultReportBean)source).getDivisionKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.FaultReportBean)source).getDivisionKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.FaultReportBean)source).privateSetDivisionKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryAddFaultReport((com.hps.july.persistence.FaultReport)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryRemoveFaultReport((com.hps.july.persistence.FaultReport)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.FaultReportBean)source).privateSetDivisionKey((com.hps.july.persistence.DivisionKey)targetEJB.getPrimaryKey());
}
}
