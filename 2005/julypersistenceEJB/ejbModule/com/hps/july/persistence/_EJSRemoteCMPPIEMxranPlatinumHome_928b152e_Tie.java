...
public class _EJSRemoteCMPPIEMxranPlatinumHome_928b152e_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEMxranPlatinumHome_928b152e target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEMxranPlatinumHome_928b152e) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 20: 
                    if (method.equals("findByMxranNameOwner")) {
                        return findByMxranNameOwner(in, reply);
                    }
                case 24: 
                ...
                case 28: 
                    if (method.equals("findPIEMxranPlatinumsByOwner")) {
                        return findPIEMxranPlatinumsByOwner(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByMxranNameOwner(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Enumeration result;
        try {
            result = target.findByMxranNameOwner(arg0, arg1, arg2, arg3, arg4, arg5);
    ...
    private org.omg.CORBA.portable.OutputStream findPIEMxranPlatinumsByOwner(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OrganizationKey arg0 = (OrganizationKey) in.read_value(OrganizationKey.class);
        Enumeration result;
        try {
            result = target.findPIEMxranPlatinumsByOwner(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
