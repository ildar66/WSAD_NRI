...
public class _RepiterDonorUnitsHome_Stub extends Stub implements RepiterDonorUnitsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.RepiterDonorUnitsHome:0000000000000000", 
    ...
    public RepiterDonorUnits findByPrimaryKey(ResourceKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RepiterDonorUnits) in.read_Object(RepiterDonorUnits.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.RepiterDonorUnitsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResourceKey arg0Copy = (ResourceKey) Util.copyObject(arg0,_orb());
                RepiterDonorUnits result = ((com.hps.july.persistence.RepiterDonorUnitsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (RepiterDonorUnits)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RepiterDonorUnits create(int arg0, String arg1, String arg2, String arg3, Boolean arg4, String arg5, Boolean arg6, Boolean arg7, Boolean arg8, Boolean arg9, int arg10) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_lang_Boolean__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__long",com.hps.july.persistence.RepiterDonorUnitsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
            }
            try {
                ...
                RepiterDonorUnits result = ((com.hps.july.persistence.RepiterDonorUnitsHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy, arg6Copy, arg7Copy, arg8Copy, arg9Copy, arg10);
                return (RepiterDonorUnits)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RepiterDonorUnits create(int arg0, Unit arg1, ResourceSubType arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__com_hps_july_persistence_Unit__com_hps_july_persistence_ResourceSubType",com.hps.july.persistence.RepiterDonorUnitsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                RepiterDonorUnits result = ((com.hps.july.persistence.RepiterDonorUnitsHome)so.servant).create(arg0, arg1Copy, arg2Copy);
                return (RepiterDonorUnits)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
