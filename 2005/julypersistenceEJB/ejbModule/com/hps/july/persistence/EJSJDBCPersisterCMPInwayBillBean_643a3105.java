...
/**
 * EJSJDBCPersisterCMPInwayBillBean_643a3105
 */
public class EJSJDBCPersisterCMPInwayBillBean_643a3105 extends EJSJDBCPersister implements com.hps.july.persistence.EJSFinderInwayBillBean, com.ibm.vap.finders.VapEJSJDBCRawFinderStatementHelper {
	private static final String[] _createString = {"INSERT INTO documents (document, insuranceact, blankdate, blanknumber, parentdocument, operator, isautodoc, blankindex, processsource, showtouser, state, processdestination, insurancedate, insuranceman, to2, needapprove, projectid, prjstatus, visualtype, owner, to, contragent, from, storagemanager, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", "INSERT INTO inwaybills (document, supplycondition, gtddate, dactrepresentative, dactnumber, dactdate, gtdnumber, cordocdate, cordocnum, representtype, currency, dactstormanager, dacttechstuf, representative) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"};
	private static final String[] _removeString = {"DELETE FROM inwaybills  WHERE document = ?", "DELETE FROM documents  WHERE document = ?"};
	private static final String[] _storeString = {"UPDATE inwaybills  SET supplycondition = ?, gtddate = ?, dactrepresentative = ?, dactnumber = ?, dactdate = ?, gtdnumber = ?, cordocdate = ?, cordocnum = ?, representtype = ?, currency = ?, dactstormanager = ?, dacttechstuf = ?, representative = ? WHERE document = ?", "UPDATE documents  SET insuranceact = ?, blankdate = ?, blanknumber = ?, parentdocument = ?, operator = ?, isautodoc = ?, blankindex = ?, processsource = ?, showtouser = ?, state = ?, processdestination = ?, insurancedate = ?, insuranceman = ?, to2 = ?, needapprove = ?, projectid = ?, prjstatus = ?, visualtype = ?, owner = ?, to = ?, contragent = ?, from = ?, storagemanager = ?, type = ? WHERE document = ?"};
	private static final String _loadString = "SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.supplycondition, T2.gtddate, T2.dactrepresentative, T2.dactnumber, T2.dactdate, T2.gtdnumber, T2.cordocdate, T2.cordocnum, T2.representtype, T2.currency, T2.dactstormanager, T2.dacttechstuf, T2.representative FROM inwaybills  T2, documents  T1 WHERE T1.type = \'W\' AND T1.document = T2.document AND T1.document = ?";
	private static final String _loadForUpdateString = _loadString + " FOR UPDATE";
	private byte[] serObj = null;
	/**
	 * EJSJDBCPersisterCMPInwayBillBean_643a3105
	 */
	public EJSJDBCPersisterCMPInwayBillBean_643a3105() throws java.rmi.RemoteException {
		super();	}
	/**
	 * postInit
	 */
	...
	public void _create(EntityBean eb) throws Exception {
		...
		InwayBillBean b = (InwayBillBean) eb;
		...
		try {
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.supplyCondition);
			if (objectTemp == null) {
				pstmt.setNull(2, java.sql.Types.CHAR);
			}
			else {
			...
			if (b.gtddate == null) {
				...
				pstmt.setDate(3, b.gtddate);
			}
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.dActRepresentative);
			if (objectTemp == null) {
				pstmt.setNull(4, java.sql.Types.CHAR);
			}
			else {
			...
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.dActNumber);
			if (objectTemp == null) {
			...
			if (b.dActDate == null) {
				...
				pstmt.setDate(6, b.dActDate);
			}
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.gtdnumber);
			if (objectTemp == null) {
				pstmt.setNull(7, java.sql.Types.CHAR);
			}
			else {
			...
			if (b.cordocdate == null) {
				pstmt.setNull(8, java.sql.Types.DATE);
			}
			else {
				pstmt.setDate(8, b.cordocdate);
			}
			...
			objectTemp = com.ibm.vap.converters.VapTrimStringConverter.singleton().dataFrom(b.representtype);
			if (objectTemp == null) {
				pstmt.setNull(10, java.sql.Types.CHAR);
			}
			else {
			...
			if (b.dActStorManager_worker == null) {
				pstmt.setNull(12, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(12, b.dActStorManager_worker.intValue());
			}
			if (b.dActTechStuf_worker == null) {
				pstmt.setNull(13, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(13, b.dActTechStuf_worker.intValue());
			}
			if (b.representative_worker == null) {
				pstmt.setNull(14, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(14, b.representative_worker.intValue());
			}
			pstmt.setInt(1, b.document);
			pstmt.executeUpdate();
		}
	...
	public void hydrate(EntityBean eb, Object data, Object pKey) throws Exception {
		...
		b.supplyCondition = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(26));
		b.gtddate = resultSet.getDate(27);
		b.dActRepresentative = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(28));
		b.dActNumber = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(29));
		b.dActDate = resultSet.getDate(30);
		b.gtdnumber = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(31));
		b.cordocdate = resultSet.getDate(32);
		b.cordocnum = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(33));
		b.representtype = (java.lang.String)com.ibm.vap.converters.VapTrimStringConverter.singleton().objectFrom(resultSet.getString(34));
		tempint = resultSet.getInt(35);
		b.currency_currency = resultSet.wasNull() ? null : new Integer(tempint);
		tempint = resultSet.getInt(36);
		b.dActStorManager_worker = resultSet.wasNull() ? null : new Integer(tempint);
		tempint = resultSet.getInt(37);
		b.dActTechStuf_worker = resultSet.wasNull() ? null : new Integer(tempint);
		tempint = resultSet.getInt(38);
		b.representative_worker = resultSet.wasNull() ? null : new Integer(tempint);
	...
	public void store(EntityBean eb) throws Exception {
		...
		try {
			...
			if (b.dActStorManager_worker == null) {
				...
				pstmt.setInt(11, b.dActStorManager_worker.intValue());
			}
			if (b.dActTechStuf_worker == null) {
				pstmt.setNull(12, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(12, b.dActTechStuf_worker.intValue());
			}
			if (b.representative_worker == null) {
				pstmt.setNull(13, java.sql.Types.INTEGER);
			}
			else {
				pstmt.setInt(13, b.representative_worker.intValue());
			}
			pstmt.executeUpdate();
		}
		finally {
...
return null;
	 ...
	 */
	public EJSFinder findInwayBilltechstufByDActTechStuf(com.hps.july.persistence.WorkerKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.supplycondition, T2.gtddate, T2.dactrepresentative, T2.dactnumber, T2.dactdate, T2.gtdnumber, T2.cordocdate, T2.cordocnum, T2.representtype, T2.currency, T2.dactstormanager, T2.dacttechstuf, T2.representative FROM inwaybills  T2, documents  T1 WHERE T1.type = \'W\' AND T1.document = T2.document AND T2.dacttechstuf = ?");
			Object objectTemp = null;
boolean nullData;
	 ...
	 */
	public EJSFinder findInwayBillByCurrency(com.hps.july.persistence.CurrencyKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.supplycondition, T2.gtddate, T2.dactrepresentative, T2.dactnumber, T2.dactdate, T2.gtdnumber, T2.cordocdate, T2.cordocnum, T2.representtype, T2.currency, T2.dactstormanager, T2.dacttechstuf, T2.representative FROM inwaybills  T2, documents  T1 WHERE T1.type = \'W\' AND T1.document = T2.document AND T2.currency = ?");
			Object objectTemp = null;
boolean nullData;
	 ...
	 */
	public EJSFinder findInwayBillstorManagersByDActStorManager(com.hps.july.persistence.WorkerKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.supplycondition, T2.gtddate, T2.dactrepresentative, T2.dactnumber, T2.dactdate, T2.gtdnumber, T2.cordocdate, T2.cordocnum, T2.representtype, T2.currency, T2.dactstormanager, T2.dacttechstuf, T2.representative FROM inwaybills  T2, documents  T1 WHERE T1.type = \'W\' AND T1.document = T2.document AND T2.dactstormanager = ?");
			Object objectTemp = null;
boolean nullData;
			pstmt.setInt(1, inKey.worker);
			resultSet = pstmt.executeQuery();
	...
	public com.hps.july.persistence.InwayBill findByPrimaryKey(com.hps.july.persistence.DocumentKey key) throws java.rmi.RemoteException, javax.ejb.FinderException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		com.hps.july.persistence.InwayBill result = null;

		EJSJDBCFinder tmpFinder = null;
		com.hps.july.persistence.DocumentKey _primaryKey = (com.hps.july.persistence.DocumentKey)key;
		try {
			try {
				result = (com.hps.july.persistence.InwayBill)home.getBean(key);
			}
			catch (Throwable ex) {
				result=null;
			}
			if (result == null) {
				...
				if (tmpFinder.hasMoreElements()) {
					result = (com.hps.july.persistence.InwayBill)tmpFinder.nextElement();
				}
			}
		}
		catch (Exception ex) {
	 ...
	 */
	public EJSFinder findInwayBillsByRepresentative(com.hps.july.persistence.WorkerKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException {
		ResultSet resultSet = null;
		PreparedStatement pstmt = null;
		try {
			preFind();
			pstmt = getPreparedStatement("SELECT T1.insuranceact, T1.blankdate, T1.blanknumber, T1.parentdocument, T1.operator, T1.isautodoc, T1.blankindex, T1.processsource, T1.showtouser, T1.state, T1.processdestination, T1.insurancedate, T1.insuranceman, T1.to2, T1.document, T1.needapprove, T1.projectid, T1.prjstatus, T1.visualtype, T1.owner, T1.to, T1.contragent, T1.from, T1.storagemanager, T1.type, T2.supplycondition, T2.gtddate, T2.dactrepresentative, T2.dactnumber, T2.dactdate, T2.gtdnumber, T2.cordocdate, T2.cordocnum, T2.representtype, T2.currency, T2.dactstormanager, T2.dacttechstuf, T2.representative FROM inwaybills  T2, documents  T1 WHERE T1.type = \'W\' AND T1.document = T2.document AND T2.representative = ?");
			Object objectTemp = null;
boolean nullData;
			pstmt.setInt(1, inKey.worker);
			resultSet = pstmt.executeQuery();
	...
	private InwayBillBeanFinderObject finderObject = null;
	/**
	 * getFinderObject
	 */
	public com.hps.july.persistence.InwayBillBeanFinderObject getFinderObject() {
		if (finderObject == null) {
			com.hps.july.persistence.InwayBillBeanFinderObject temp_finderObject = new com.hps.july.persistence.InwayBillBeanFinderObject();
