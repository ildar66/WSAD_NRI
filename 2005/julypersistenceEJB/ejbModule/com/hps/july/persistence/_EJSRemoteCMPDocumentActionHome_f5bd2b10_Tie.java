...
public class _EJSRemoteCMPDocumentActionHome_f5bd2b10_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPDocumentActionHome_f5bd2b10 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPDocumentActionHome_f5bd2b10) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 28: 
                    if (method.equals("findDocumentActionByOperator")) {
                        return findDocumentActionByOperator(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DocumentActionKey arg0 = (DocumentActionKey) in.read_value(DocumentActionKey.class);
        DocumentAction result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findDocumentActionByOperator(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OperatorKey arg0 = (OperatorKey) in.read_value(OperatorKey.class);
        Enumeration result;
        try {
            result = target.findDocumentActionByOperator(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
