...
import javax.ejb.*;
import javax.naming.*;
public class DocumentsLinkToDocumentToLink extends ManyToSingleLink {
...
public DocumentsLinkToDocumentToLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DocumentKey key = ((com.hps.july.persistence.DocumentsLinkBean)source).getDocumentToKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.DocumentsLinkBean)source).getDocumentToKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.DocumentsLinkBean)source).privateSetDocumentToKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Document)anEJB).secondaryAddDocumentsLinkTo((com.hps.july.persistence.DocumentsLink)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Document)anEJB).secondaryRemoveDocumentsLinkTo((com.hps.july.persistence.DocumentsLink)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.DocumentsLinkBean)source).privateSetDocumentToKey((com.hps.july.persistence.DocumentKey)targetEJB.getPrimaryKey());
}
}
