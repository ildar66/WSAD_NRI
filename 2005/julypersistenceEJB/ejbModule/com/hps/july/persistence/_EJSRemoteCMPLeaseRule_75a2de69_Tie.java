...
public class _EJSRemoteCMPLeaseRule_75a2de69_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseRule_75a2de69 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseRule_75a2de69) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 15: 
                    ...
                    } else if (method.equals("_get_leaseRule_")) {
                        return _get_leaseRule_(in, reply);
                    } else if (method.equals("_set_leaseRule_")) {
                        return _set_leaseRule_(in, reply);
                    }
                case 16: 
                    if (method.equals("getLeaseDocument")) {
                        return getLeaseDocument(in, reply);
                    } else if (method.equals("setLeaseDocument")) {
    ...
    private org.omg.CORBA.portable.OutputStream _get_leaseRule_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream _set_leaseRule_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
