 ...
 **/
public interface OutWayBillBeanFinderHelper extends com.hps.july.persistence.DocumentBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE(Boolean isDate, java.sql.Date dateFrom, java.sql.Date dateTo, 
