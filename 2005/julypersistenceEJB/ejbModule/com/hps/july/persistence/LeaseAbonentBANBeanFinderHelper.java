 ...
 **/
public interface LeaseAbonentBANBeanFinderHelper extends com.hps.july.persistence.LeaseContractBeanFinderHelper { 
	public static final String findByBANWhereClause = "ban = ?";
	public static final String findByFlagWorkPIEWhereClause = "flagworkpie = ?";
