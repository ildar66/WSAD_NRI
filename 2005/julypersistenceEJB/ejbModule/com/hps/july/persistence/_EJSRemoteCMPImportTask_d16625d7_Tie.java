...
public class _EJSRemoteCMPImportTask_d16625d7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPImportTask_d16625d7 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPImportTask_d16625d7) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 12: 
                    ...
                    } else if (method.equals("_get_xmlfile")) {
                        return _get_xmlfile(in, reply);
                    } else if (method.equals("_set_xmlfile")) {
                        return _set_xmlfile(in, reply);
                    }
                case 13: 
                ...
                case 14: 
                    if (method.equals("_get_imptaskid")) {
                        return _get_imptaskid(in, reply);
                    }
                case 15: 
                ...
                case 17: 
                    ...
                    } else if (method.equals("getImportSessions")) {
    ...
    private org.omg.CORBA.portable.OutputStream _get_imptaskid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getImptaskid();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_xmlfile(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] result = target.getXmlfile();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_xmlfile(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] arg0 = (byte[]) in.read_value(byte[].class);
        target.setXmlfile(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
