...
public class _SiteDocFileBLOB_Stub extends Stub implements SiteDocFileBLOB {
    ...
    public int getSitedocfile() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_sitedocfile", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_sitedocfile",com.hps.july.persistence.SiteDocFileBLOB.class);
            if (so == null) {
                return getSitedocfile();
            }
            try {
                return ((com.hps.july.persistence.SiteDocFileBLOB)so.servant).getSitedocfile();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public byte[] getSitedocfilebody() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_sitedocfilebody", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_sitedocfilebody",com.hps.july.persistence.SiteDocFileBLOB.class);
            if (so == null) {
                return getSitedocfilebody();
            }
            try {
                byte[] result = ((com.hps.july.persistence.SiteDocFileBLOB)so.servant).getSitedocfilebody();
    ...
    public void setSitedocfilebody(byte[] arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_sitedocfilebody", true);
            ...
            ServantObject so = _servant_preinvoke("_set_sitedocfilebody",com.hps.july.persistence.SiteDocFileBLOB.class);
            if (so == null) {
                setSitedocfilebody(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.SiteDocFileBLOB)so.servant).setSitedocfilebody(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
