...
public class _PIEDogovorLinkHome_Stub extends Stub implements PIEDogovorLinkHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDogovorLinkHome:0000000000000000", 
    ...
    public PIEDogovorLink create(int arg0, String arg1, int arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDogovorLink) in.read_Object(PIEDogovorLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEDogovorLinkHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                PIEDogovorLink result = ((com.hps.july.persistence.PIEDogovorLinkHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (PIEDogovorLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEDogovorLink findByPrimaryKey(PIEDogovorLinkKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEDogovorLinkKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDogovorLink) in.read_Object(PIEDogovorLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEDogovorLinkHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEDogovorLinkKey arg0Copy = (PIEDogovorLinkKey) Util.copyObject(arg0,_orb());
                PIEDogovorLink result = ((com.hps.july.persistence.PIEDogovorLinkHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEDogovorLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
