...
public class _RRLSpeedParamsHome_Stub extends Stub implements RRLSpeedParamsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.RRLSpeedParamsHome:0000000000000000", 
    ...
    public RRLSpeedParams create(int arg0, int arg1, String arg2, String arg3, BigDecimal arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLSpeedParams) in.read_Object(RRLSpeedParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.RRLSpeedParamsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                RRLSpeedParams result = ((com.hps.july.persistence.RRLSpeedParamsHome)so.servant).create(arg0, arg1, arg2Copy, arg3Copy, arg4Copy);
                return (RRLSpeedParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RRLSpeedParams findByPrimaryKey(RRLSpeedParamsKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,RRLSpeedParamsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLSpeedParams) in.read_Object(RRLSpeedParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.RRLSpeedParamsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RRLSpeedParamsKey arg0Copy = (RRLSpeedParamsKey) Util.copyObject(arg0,_orb());
                RRLSpeedParams result = ((com.hps.july.persistence.RRLSpeedParamsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (RRLSpeedParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByResource(int arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByResource",com.hps.july.persistence.RRLSpeedParamsHome.class);
            if (so == null) {
                return findByResource(arg0);
            }
            try {
                Enumeration result = ((com.hps.july.persistence.RRLSpeedParamsHome)so.servant).findByResource(arg0);
    ...
    public Enumeration findByResourceAndSpeed(int arg0, String arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByResourceAndSpeed", true);
                    out.write_long(arg0);
                    ...
                    return findByResourceAndSpeed(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByResourceAndSpeed",com.hps.july.persistence.RRLSpeedParamsHome.class);
            if (so == null) {
                return findByResourceAndSpeed(arg0, arg1);
            }
            try {
                Enumeration result = ((com.hps.july.persistence.RRLSpeedParamsHome)so.servant).findByResourceAndSpeed(arg0, arg1);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
