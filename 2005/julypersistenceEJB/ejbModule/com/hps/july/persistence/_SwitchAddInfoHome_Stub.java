...
public class _SwitchAddInfoHome_Stub extends Stub implements SwitchAddInfoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SwitchAddInfoHome:0000000000000000", 
    ...
    public SwitchAddInfo create(Integer arg0, Date arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.SwitchAddInfoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ...
                SwitchAddInfo result = ((com.hps.july.persistence.SwitchAddInfoHome)so.servant).create(arg0Copy, arg1Copy);
    ...
    public Enumeration findByEquipmentOrderByActdateAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByEquipmentOrderByActdateAsc", true);
                    out.write_value(arg0,Integer.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findByEquipmentOrderByActdateAsc(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByEquipmentOrderByActdateAsc",com.hps.july.persistence.SwitchAddInfoHome.class);
            if (so == null) {
                return findByEquipmentOrderByActdateAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.SwitchAddInfoHome)so.servant).findByEquipmentOrderByActdateAsc(arg0Copy);
    ...
    public SwitchAddInfo findByPrimaryKey(SwitchAddInfoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SwitchAddInfoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SwitchAddInfoKey arg0Copy = (SwitchAddInfoKey) Util.copyObject(arg0,_orb());
                SwitchAddInfo result = ((com.hps.july.persistence.SwitchAddInfoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SwitchAddInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findSwitchAddInfosBySwitch(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findSwitchAddInfosBySwitch", true);
                    ...
                    return findSwitchAddInfosBySwitch(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findSwitchAddInfosBySwitch",com.hps.july.persistence.SwitchAddInfoHome.class);
            if (so == null) {
                return findSwitchAddInfosBySwitch(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.SwitchAddInfoHome)so.servant).findSwitchAddInfosBySwitch(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
