...
import javax.ejb.*;
import javax.naming.*;
public class TaskToRoleLink extends SingleToManyLink {
...
public TaskToRoleLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.Roles2Tasks)anEJB).getTaskKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.Roles2TasksHome)getTargetHome(this)).findRoleByTask((com.hps.july.persistence.TaskKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.TaskBean)source).getEntityContext();
}
/**
