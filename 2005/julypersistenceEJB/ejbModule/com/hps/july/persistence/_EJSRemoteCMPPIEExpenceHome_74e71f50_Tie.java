...
public class _EJSRemoteCMPPIEExpenceHome_74e71f50_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEExpenceHome_74e71f50 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEExpenceHome_74e71f50) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 40: 
                    if (method.equals("findByOwnerAndRecordstatusOrderByNameAsc")) {
                        return findByOwnerAndRecordstatusOrderByNameAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByOwnerAndRecordstatusOrderByNameAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        String arg1 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByOwnerAndRecordstatusOrderByNameAsc(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEExpenceKey arg0 = (PIEExpenceKey) in.read_value(PIEExpenceKey.class);
        PIEExpence result;
        try {
