 ...
 **/
public interface StorageBeanFinderHelper extends com.hps.july.persistence.StoragePlaceBeanFinderHelper { 
	public java.sql.PreparedStatement findByPlatinumAndStatus(Integer owner, String state, Integer order)
		throws Exception;
}
