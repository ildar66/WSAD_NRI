...
public class _EJSRemoteCMPAbonBillpos2docposHome_d13558d4_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAbonBillpos2docposHome_d13558d4 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAbonBillpos2docposHome_d13558d4) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 33: 
                    if (method.equals("findAbonBillpos2docposesByBillpos")) {
                        return findAbonBillpos2docposesByBillpos(in, reply);
                    }
                case 40: 
                    if (method.equals("findAbonBillpos2docposByLeasedocposition")) {
                        return findAbonBillpos2docposByLeasedocposition(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAbonBillpos2docposByLeasedocposition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocPositionKey arg0 = (LeaseDocPositionKey) in.read_value(LeaseDocPositionKey.class);
        AbonBillpos2docpos result;
        try {
            result = target.findAbonBillpos2docposByLeasedocposition(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findAbonBillpos2docposesByBillpos(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AbonentBillPosKey arg0 = (AbonentBillPosKey) in.read_value(AbonentBillPosKey.class);
        Enumeration result;
        try {
            result = target.findAbonBillpos2docposesByBillpos(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AbonBillpos2docposKey arg0 = (AbonBillpos2docposKey) in.read_value(AbonBillpos2docposKey.class);
        AbonBillpos2docpos result;
        try {
