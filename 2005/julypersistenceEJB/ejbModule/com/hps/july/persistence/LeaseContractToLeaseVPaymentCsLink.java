...
import javax.ejb.*;
import javax.naming.*;
public class LeaseContractToLeaseVPaymentCsLink extends SingleToManyLink {
...
public LeaseContractToLeaseVPaymentCsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseVPayment)anEJB).getCreditcontractKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseVPaymentHome)getTargetHome(this)).findLeaseVPaymentCsByCreditcontract((com.hps.july.persistence.LeaseDocumentKey)getEntityContext().getPrimaryKey());
	}
