...
public class _EJSRemoteCMPChangeActPositionHome_e8688648_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPChangeActPositionHome_e8688648 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPChangeActPositionHome_e8688648) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 18: 
                    if (method.equals("findByDocNewSerial")) {
                        return findByDocNewSerial(in, reply);
                    }
                case 24: 
                ...
                case 32: 
                    if (method.equals("findChangeActPositionByChangeAct")) {
                        return findChangeActPositionByChangeAct(in, reply);
                    }
                case 35: 
                    if (method.equals("findChangeActPositionsByNewresource")) {
                        return findChangeActPositionsByNewresource(in, reply);
                    }
                case 71: 
    ...
    private org.omg.CORBA.portable.OutputStream findByDocNewSerial(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        String arg1 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByDocNewSerial(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ChangeActPositionKey arg0 = (ChangeActPositionKey) in.read_value(ChangeActPositionKey.class);
        ChangeActPosition result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findChangeActPositionByChangeAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DocumentKey arg0 = (DocumentKey) in.read_value(DocumentKey.class);
        Enumeration result;
        try {
            result = target.findChangeActPositionByChangeAct(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findChangeActPositionsByNewresource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findChangeActPositionsByNewresource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
