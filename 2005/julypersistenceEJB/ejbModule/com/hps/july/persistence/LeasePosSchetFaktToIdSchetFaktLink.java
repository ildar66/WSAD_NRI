...
import javax.ejb.*;
import javax.naming.*;
public class LeasePosSchetFaktToIdSchetFaktLink extends ManyToSingleLink {
...
public LeasePosSchetFaktToIdSchetFaktLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.LeaseSchetFaktKey key = ((com.hps.july.persistence.LeasePosSchetFaktBean)source).getIdSchetFaktKey();
	try {
		target = ((com.hps.july.persistence.LeaseSchetFaktHome)getTargetHome(this)).findByPrimaryKey(key);
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.LeasePosSchetFaktBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeasePosSchetFaktBean)source).getIdSchetFaktKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeasePosSchetFaktBean)source).privateSetIdSchetFaktKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseSchetFakt)anEJB).secondaryAddLeasePosSchetFakts((com.hps.july.persistence.LeasePosSchetFakt)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseSchetFakt)anEJB).secondaryRemoveLeasePosSchetFakts((com.hps.july.persistence.LeasePosSchetFakt)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeasePosSchetFaktBean)source).privateSetIdSchetFaktKey((com.hps.july.persistence.LeaseSchetFaktKey)targetEJB.getPrimaryKey());
}
}
