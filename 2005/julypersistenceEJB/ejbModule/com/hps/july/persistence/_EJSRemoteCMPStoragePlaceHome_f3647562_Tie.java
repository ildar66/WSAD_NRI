...
public class _EJSRemoteCMPStoragePlaceHome_f3647562_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPStoragePlaceHome_f3647562 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPStoragePlaceHome_f3647562) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 26: 
                    if (method.equals("findStoragePlaceByDivision")) {
                        return findStoragePlaceByDivision(in, reply);
                    }
                case 52: 
    ...
    private org.omg.CORBA.portable.OutputStream findStoragePlaceByDivision(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DivisionKey arg0 = (DivisionKey) in.read_value(DivisionKey.class);
        Enumeration result;
        try {
            result = target.findStoragePlaceByDivision(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
