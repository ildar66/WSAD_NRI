...
public class _PhotoBlobHome_Stub extends Stub implements PhotoBlobHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PhotoBlobHome:0000000000000000", 
    ...
    public PhotoBlob create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PhotoBlob) in.read_Object(PhotoBlob.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PhotoBlobHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                PhotoBlob result = ((com.hps.july.persistence.PhotoBlobHome)so.servant).create(arg0);
                return (PhotoBlob)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PhotoBlob findByPrimaryKey(PhotoBlobKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PhotoBlobKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PhotoBlob) in.read_Object(PhotoBlob.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PhotoBlobHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PhotoBlobKey arg0Copy = (PhotoBlobKey) Util.copyObject(arg0,_orb());
                PhotoBlob result = ((com.hps.july.persistence.PhotoBlobHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PhotoBlob)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
