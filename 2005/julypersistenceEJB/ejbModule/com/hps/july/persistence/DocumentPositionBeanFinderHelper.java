 ...
 **/
public interface DocumentPositionBeanFinderHelper {

	//public static final String findByRequestResourceWhereClause = "document IN "
	//+"(SELECT documentto FROM docdependencies WHERE type = 'O' AND documentfrom = ?) AND resource = ?";
	public java.sql.PreparedStatement findBadAgregatesByDocument( Integer argDocument ) throws Exception;
	public java.sql.PreparedStatement findByAgregateAfterDate( String argAgregatSerial, java.sql.Date argDate ) throws Exception;
	public java.sql.PreparedStatement findByDocOrderByAgregateAsc( Integer argDocument ) throws Exception;
	public java.sql.PreparedStatement findByDocOrderByAgregateDesc( Integer argDocument ) throws Exception;
...
public java.sql.PreparedStatement findByDocumentQBE2(
	...
	public java.sql.PreparedStatement findByDocumentSerialnum( Integer argDocument, String argSerial ) throws Exception;//WhereClause = "t1.document = ? and t1.serialnumber = ?";
	...
	public java.sql.PreparedStatement findByRequestResource(Integer requestId, Integer resourceId) throws Exception;
	public java.sql.PreparedStatement findByResourceSetAndStorageAfterDate( Integer argDocument, Integer argStorage, java.sql.Date argDate ) throws Exception;
	public java.sql.PreparedStatement findByStorageAfterDate( Integer argStorage, java.sql.Date argDate ) throws Exception;
	public java.sql.PreparedStatement findDocPositionsByDocAndPolicyOrderByOrderAsc( Integer argDocument, String argPolicy ) throws Exception;
	public java.sql.PreparedStatement findDocPositionsByDocAndPolicyOrderByOrderDesc( Integer argDocument, String argPolicy ) throws Exception;
	public java.sql.PreparedStatement findDocPositionsByDocOrderByOrderAsc( Integer argDocument ) throws Exception;
	public java.sql.PreparedStatement findDocPositionsByDocOrderByOrderDesc( Integer argDocument ) throws Exception;
	public java.sql.PreparedStatement findMaxOrderPosition( Integer argDocument ) throws Exception;// "t1.document = ? and t1.order=(select max(dp.order) from docpositions dp where dp.document=t1.document)";
}
