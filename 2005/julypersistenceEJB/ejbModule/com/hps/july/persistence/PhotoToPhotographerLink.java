...
import javax.ejb.*;
import javax.naming.*;
public class PhotoToPhotographerLink extends ManyToSingleLink {
...
public PhotoToPhotographerLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.WorkerKey key = ((com.hps.july.persistence.PhotoBean)source).getPhotographerKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.PhotoBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.PhotoBean)source).getPhotographerKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.PhotoBean)source).privateSetPhotographerKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryAddPhoto((com.hps.july.persistence.Photo)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Worker)anEJB).secondaryRemovePhoto((com.hps.july.persistence.Photo)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.PhotoBean)source).privateSetPhotographerKey((com.hps.july.persistence.WorkerKey)targetEJB.getPrimaryKey());
}
}
