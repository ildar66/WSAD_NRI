...
public class _PIEDopInfoDocHome_Stub extends Stub implements PIEDopInfoDocHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEDopInfoDocHome:0000000000000000", 
    ...
    public PIEDopInfoDoc create(int arg0, boolean arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDopInfoDoc) in.read_Object(PIEDopInfoDoc.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEDopInfoDocHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                PIEDopInfoDoc result = ((com.hps.july.persistence.PIEDopInfoDocHome)so.servant).create(arg0, arg1);
                return (PIEDopInfoDoc)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEDopInfoDoc findByPrimaryKey(PIEDopInfoDocKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEDopInfoDocKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEDopInfoDoc) in.read_Object(PIEDopInfoDoc.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEDopInfoDocHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEDopInfoDocKey arg0Copy = (PIEDopInfoDocKey) Util.copyObject(arg0,_orb());
                PIEDopInfoDoc result = ((com.hps.july.persistence.PIEDopInfoDocHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEDopInfoDoc)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
