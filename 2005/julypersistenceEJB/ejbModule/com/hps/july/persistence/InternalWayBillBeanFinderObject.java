 ...
 */
public class InternalWayBillBeanFinderObject extends DocumentBeanFinderObject  
	implements InternalWayBillBeanFinderHelper{
...
public java.sql.PreparedStatement findByQBE(
	java.lang.Boolean isDate, 				java.sql.Date startDate, java.sql.Date endDate,
	java.lang.Boolean isOwner, 				java.lang.Integer owner, 
	java.lang.Boolean isStorage, 			java.lang.Integer storage, 
	java.lang.Boolean isContractor, 		java.lang.Integer contractor, 
  ...
  String alias2 = (String)(m.get("DOCUMENTS"));
	...
	StringBuffer whereClause = new StringBuffer( alias2 + ".showtouser = 'Y' AND exists (select s.storageplace from storages s where s.storageplace="+alias2+".to )  " );
	...
	if( isStorage.booleanValue() ) {
		whereClause.append( "and "+alias2+".to = ? " );
	}
	...
	for( i = 0; i < getMergedWhereCount(); i++) {
		...
		if( isContractor.booleanValue() ) {
			ps.setInt( j++, contractor.intValue() );
		}
		if( isWorker.booleanValue() ) {
