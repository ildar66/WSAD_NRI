...
public class _EJSRemoteCMPLeaseCalcRateHome_be50a3fb_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseCalcRateHome_be50a3fb target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseCalcRateHome_be50a3fb) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 23: 
                    if (method.equals("findLeaseCalcRatesByAct")) {
                        return findLeaseCalcRatesByAct(in, reply);
                    }
                case 24: 
                ...
                case 28: 
                    if (method.equals("findBy_Hand_LeaseDocPosition")) {
                        return findBy_Hand_LeaseDocPosition(in, reply);
                    } else if (method.equals("findLeaseCalcRatesByCurrency")) {
                        return findLeaseCalcRatesByCurrency(in, reply);
                    }
                case 31: 
                    if (method.equals("findLeaseCalcRatesByDocposition")) {
                        return findLeaseCalcRatesByDocposition(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findBy_Hand_LeaseDocPosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findBy_Hand_LeaseDocPosition(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseCalcRateKey arg0 = (LeaseCalcRateKey) in.read_value(LeaseCalcRateKey.class);
        LeaseCalcRate result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseCalcRatesByAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseCalcRatesByAct(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseCalcRatesByCurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencyKey arg0 = (CurrencyKey) in.read_value(CurrencyKey.class);
        Enumeration result;
        try {
            result = target.findLeaseCalcRatesByCurrency(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseCalcRatesByDocposition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocPositionKey arg0 = (LeaseDocPositionKey) in.read_value(LeaseDocPositionKey.class);
        Enumeration result;
        try {
            result = target.findLeaseCalcRatesByDocposition(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
