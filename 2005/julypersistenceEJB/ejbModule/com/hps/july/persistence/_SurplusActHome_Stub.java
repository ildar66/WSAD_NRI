...
public class _SurplusActHome_Stub extends Stub implements SurplusActHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SurplusActHome:0000000000000000", 
    ...
    public SurplusAct create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (SurplusAct) in.read_Object(SurplusAct.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.SurplusActHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                SurplusAct result = ((com.hps.july.persistence.SurplusActHome)so.servant).create(arg0);
                return (SurplusAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public SurplusAct create(int arg0, Integer arg1, Integer arg2, Integer arg3, Date arg4, int arg5, String arg6, String arg7, Boolean arg8, Boolean arg9) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean",com.hps.july.persistence.SurplusActHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
            }
            try {
                ...
                SurplusAct result = ((com.hps.july.persistence.SurplusActHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5, arg6Copy, arg7Copy, arg8Copy, arg9Copy);
                return (SurplusAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public SurplusAct create(int arg0, Integer arg1, Date arg2, int arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__java_sql_Date__long__CORBA_WStringValue",com.hps.july.persistence.SurplusActHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                SurplusAct result = ((com.hps.july.persistence.SurplusActHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3, arg4Copy);
                return (SurplusAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public SurplusAct findByPrimaryKey(DocumentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SurplusActHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                DocumentKey arg0Copy = (DocumentKey) Util.copyObject(arg0,_orb());
                SurplusAct result = ((com.hps.july.persistence.SurplusActHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SurplusAct)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
