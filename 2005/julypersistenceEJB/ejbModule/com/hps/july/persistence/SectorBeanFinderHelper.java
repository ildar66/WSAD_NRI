 ...
 **/
public interface SectorBeanFinderHelper { 
	public static final String findByBasestationOrderByNumberAscWhereClause = "planfacttype=1 AND equipment = ? ORDER BY num_sect ASC";
