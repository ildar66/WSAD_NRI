...
public class _EJSRemoteCMPAntennaWorkBandHome_8b2ccd86_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAntennaWorkBandHome_8b2ccd86 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAntennaWorkBandHome_8b2ccd86) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findAntennaWorkBandsByAntenna")) {
                        return findAntennaWorkBandsByAntenna(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAntennaWorkBandsByAntenna(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AntennaKey arg0 = (AntennaKey) in.read_value(AntennaKey.class);
        Enumeration result;
        try {
            result = target.findAntennaWorkBandsByAntenna(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AntennaWorkBandKey arg0 = (AntennaWorkBandKey) in.read_value(AntennaWorkBandKey.class);
        AntennaWorkBand result;
        try {
