...
public class _EJSRemoteCMPResourceType_482c8901_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPResourceType_482c8901 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPResourceType_482c8901) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 100: 
                    if (method.equals("secondaryAddResourceSubType")) {
                        return secondaryAddResourceSubType(in, reply);
                    } else if (method.equals("secondaryRemoveResourceSubType")) {
                        return secondaryRemoveResourceSubType(in, reply);
                    }
                case 101: 
                ...
                case 114: 
                    if (method.equals("_get_resourcetype_")) {
                        return _get_resourcetype_(in, reply);
                    } else if (method.equals("_set_resourcetype_")) {
                        return _set_resourcetype_(in, reply);
                    }
                case 115: 
                    if (method.equals("addResourceSubType")) {
                        return addResourceSubType(in, reply);
                    } else if (method.equals("getResourceSubType")) {
                        return getResourceSubType(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream addResourceSubType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSubType arg0 = (ResourceSubType) in.read_Object(ResourceSubType.class);
        target.addResourceSubType(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream getResourceSubType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Enumeration result;
        try {
            result = target.getResourceSubType();
    ...
    private org.omg.CORBA.portable.OutputStream _get_resourcetype_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getResourcetype();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream secondaryAddResourceSubType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSubType arg0 = (ResourceSubType) in.read_Object(ResourceSubType.class);
        target.secondaryAddResourceSubType(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream secondaryRemoveResourceSubType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceSubType arg0 = (ResourceSubType) in.read_Object(ResourceSubType.class);
        target.secondaryRemoveResourceSubType(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream _set_resourcetype_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
