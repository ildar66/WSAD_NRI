...
public class _EJSRemoteCMPOperators2RolesHome_a0bb30ab_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPOperators2RolesHome_a0bb30ab target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPOperators2RolesHome_a0bb30ab) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 25: 
                    if (method.equals("findOperators2RolesByRole")) {
                        return findOperators2RolesByRole(in, reply);
                    }
                case 29: 
                    if (method.equals("findOperators2RolesByOperator")) {
                        return findOperators2RolesByOperator(in, reply);
                    }
                case 45: 
                    if (method.equals("create__java_lang_Integer__CORBA_WStringValue")) {
                        return create__java_lang_Integer__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Operators2RolesKey arg0 = (Operators2RolesKey) in.read_value(Operators2RolesKey.class);
        Operators2Roles result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findOperators2RolesByOperator(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OperatorKey arg0 = (OperatorKey) in.read_value(OperatorKey.class);
        Enumeration result;
        try {
            result = target.findOperators2RolesByOperator(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findOperators2RolesByRole(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RoleKey arg0 = (RoleKey) in.read_value(RoleKey.class);
        Enumeration result;
        try {
            result = target.findOperators2RolesByRole(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
