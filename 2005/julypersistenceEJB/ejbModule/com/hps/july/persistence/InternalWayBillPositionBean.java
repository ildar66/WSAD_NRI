 ...
 * Позиция документа "Внутренняя приходная накладная"
 */
public class InternalWayBillPositionBean extends DocumentPositionBean {
	public java.math.BigDecimal docQty;
