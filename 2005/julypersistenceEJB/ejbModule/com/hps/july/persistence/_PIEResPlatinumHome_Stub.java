...
public class _PIEResPlatinumHome_Stub extends Stub implements PIEResPlatinumHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEResPlatinumHome:0000000000000000", 
    ...
    public PIEResPlatinum create(String arg0, int arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEResPlatinumHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                PIEResPlatinum result = ((com.hps.july.persistence.PIEResPlatinumHome)so.servant).create(arg0, arg1, arg2);
    ...
    public Enumeration findByIdresplatinNameOwner(Boolean arg0, String arg1, Boolean arg2, String arg3, Integer arg4, Integer arg5) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByIdresplatinNameOwner", true);
                    ...
                    return findByIdresplatinNameOwner(arg0,arg1,arg2,arg3,arg4,arg5);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByIdresplatinNameOwner",com.hps.july.persistence.PIEResPlatinumHome.class);
            if (so == null) {
                return findByIdresplatinNameOwner(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PIEResPlatinumHome)so.servant).findByIdresplatinNameOwner(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
    ...
    public PIEResPlatinum findByPrimaryKey(PIEResPlatinumKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEResPlatinumHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEResPlatinumKey arg0Copy = (PIEResPlatinumKey) Util.copyObject(arg0,_orb());
                PIEResPlatinum result = ((com.hps.july.persistence.PIEResPlatinumHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEResPlatinum)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
