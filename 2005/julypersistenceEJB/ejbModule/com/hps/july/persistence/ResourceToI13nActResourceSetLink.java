...
import javax.ejb.*;
import javax.naming.*;
public class ResourceToI13nActResourceSetLink extends SingleToManyLink {
...
public ResourceToI13nActResourceSetLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.I13nActResourceSet)anEJB).getResourceKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.I13nActResourceSetHome)getTargetHome(this)).findI13nActResourceSetByResource((com.hps.july.persistence.ResourceKey)getEntityContext().getPrimaryKey());
	}
