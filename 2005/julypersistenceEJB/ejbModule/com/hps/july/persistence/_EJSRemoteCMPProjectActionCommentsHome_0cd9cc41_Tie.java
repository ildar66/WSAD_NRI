...
public class _EJSRemoteCMPProjectActionCommentsHome_0cd9cc41_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProjectActionCommentsHome_0cd9cc41 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProjectActionCommentsHome_0cd9cc41) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 35: 
                    if (method.equals("findProjectActionCommentsByDivision")) {
                        return findProjectActionCommentsByDivision(in, reply);
                    }
                case 40: 
                    if (method.equals("findProjectActionCommentsByProjectaction")) {
                        return findProjectActionCommentsByProjectaction(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectActionCommentsKey arg0 = (ProjectActionCommentsKey) in.read_value(ProjectActionCommentsKey.class);
        ProjectActionComments result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionCommentsByDivision(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DivisionKey arg0 = (DivisionKey) in.read_value(DivisionKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionCommentsByDivision(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProjectActionCommentsByProjectaction(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectActionKey arg0 = (ProjectActionKey) in.read_value(ProjectActionKey.class);
        Enumeration result;
        try {
            result = target.findProjectActionCommentsByProjectaction(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
