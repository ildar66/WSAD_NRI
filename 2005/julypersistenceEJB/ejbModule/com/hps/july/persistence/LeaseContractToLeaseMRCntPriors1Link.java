...
import javax.ejb.*;
import javax.naming.*;
public class LeaseContractToLeaseMRCntPriors1Link extends SingleToManyLink {
...
public LeaseContractToLeaseMRCntPriors1Link(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseMRCntPrior)anEJB).getContract1Key()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseMRCntPriorHome)getTargetHome(this)).findLeaseMRCntPriors1ByContract1((com.hps.july.persistence.LeaseDocumentKey)getEntityContext().getPrimaryKey());
	}
