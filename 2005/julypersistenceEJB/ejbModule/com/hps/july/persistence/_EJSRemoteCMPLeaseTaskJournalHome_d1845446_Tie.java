...
public class _EJSRemoteCMPLeaseTaskJournalHome_d1845446_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseTaskJournalHome_d1845446 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseTaskJournalHome_d1845446) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findByTaskStartType")) {
                        return findByTaskStartType(in, reply);
                    }
                case 24: 
                ...
                case 29: 
                    if (method.equals("findByTaskStartOrderByJrnDate")) {
                        return findByTaskStartOrderByJrnDate(in, reply);
                    }
                case 32: 
                    if (method.equals("findStart2journalByJournal2start")) {
                        return findStart2journalByJournal2start(in, reply);
                    }
                case 49: 
                    if (method.equals("findByTaskStartOrderByJrndateAscAndTaskjournalAsc")) {
                        return findByTaskStartOrderByJrndateAscAndTaskjournalAsc(in, reply);
                    }
                case 64: 
                    if (method.equals("create__long__long__java_sql_Timestamp__long__CORBA_WStringValue")) {
                        return create__long__long__java_sql_Timestamp__long__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__java_sql_Timestamp__long__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseTaskJournalKey arg0 = (LeaseTaskJournalKey) in.read_value(LeaseTaskJournalKey.class);
        LeaseTaskJournal result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByTaskStartOrderByJrnDate(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByTaskStartOrderByJrnDate(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByTaskStartOrderByJrndateAscAndTaskjournalAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Boolean arg1 = (Boolean) in.read_value(Boolean.class);
        Boolean arg2 = (Boolean) in.read_value(Boolean.class);
        Boolean arg3 = (Boolean) in.read_value(Boolean.class);
        Enumeration result;
        try {
            result = target.findByTaskStartOrderByJrndateAscAndTaskjournalAsc(arg0, arg1, arg2, arg3);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByTaskStartType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Boolean arg1 = (Boolean) in.read_value(Boolean.class);
        ...
        Enumeration result;
        try {
            result = target.findByTaskStartType(arg0, arg1, arg2, arg3);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findStart2journalByJournal2start(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseTaskStartKey arg0 = (LeaseTaskStartKey) in.read_value(LeaseTaskStartKey.class);
        Enumeration result;
        try {
            result = target.findStart2journalByJournal2start(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
