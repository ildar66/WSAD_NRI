...
public class _EJSRemoteCMPLeaseMutualPhoneHome_a18d2f5c_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMutualPhoneHome_a18d2f5c target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMutualPhoneHome_a18d2f5c) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 35: 
                    if (method.equals("findLeaseMutualPhoneByLeaseDocument")) {
                        return findLeaseMutualPhoneByLeaseDocument(in, reply);
                    }
                case 45: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseMutualPhoneKey arg0 = (LeaseMutualPhoneKey) in.read_value(LeaseMutualPhoneKey.class);
        LeaseMutualPhone result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualPhoneByLeaseDocument(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualPhoneByLeaseDocument(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
