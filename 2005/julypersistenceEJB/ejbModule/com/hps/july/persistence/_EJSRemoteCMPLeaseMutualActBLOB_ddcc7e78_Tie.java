...
public class _EJSRemoteCMPLeaseMutualActBLOB_ddcc7e78_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMutualActBLOB_ddcc7e78 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMutualActBLOB_ddcc7e78) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 97: 
                    ...
                    } else if (method.equals("_set_actfilename")) {
                        return _set_actfilename(in, reply);
                    }
                case 101: 
    ...
    private org.omg.CORBA.portable.OutputStream _set_actfilename(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setActfilename(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
