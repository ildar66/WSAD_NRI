...
public class _WorkPositionHome_Stub extends Stub implements WorkPositionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.WorkPositionHome:0000000000000000", 
    ...
    public WorkPosition create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.WorkPositionHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                WorkPosition result = ((com.hps.july.persistence.WorkPositionHome)so.servant).create(arg0);
    ...
    public WorkPosition create(int arg0, Boolean arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("create__long__java_lang_Boolean", true);
                    out.write_long(arg0);
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Boolean",com.hps.july.persistence.WorkPositionHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Boolean arg1Copy = (Boolean) Util.copyObject(arg1,_orb());
                WorkPosition result = ((com.hps.july.persistence.WorkPositionHome)so.servant).create(arg0, arg1Copy);
                return (WorkPosition)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public WorkPosition create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__long__CORBA_WStringValue", true);
                    out.write_long(arg0);
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.WorkPositionHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                WorkPosition result = ((com.hps.july.persistence.WorkPositionHome)so.servant).create(arg0, arg1);
                return (WorkPosition)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.WorkPositionHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.WorkPositionHome)so.servant).findAllOrderByNameAsc();
    ...
    public WorkPosition findByPrimaryKey(WorkPositionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.WorkPositionHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                WorkPositionKey arg0Copy = (WorkPositionKey) Util.copyObject(arg0,_orb());
                WorkPosition result = ((com.hps.july.persistence.WorkPositionHome)so.servant).findByPrimaryKey(arg0Copy);
                return (WorkPosition)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findByQBE(Boolean arg0, Boolean arg1, Integer arg2) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByQBE",com.hps.july.persistence.WorkPositionHome.class);
            if (so == null) {
                return findByQBE(arg0, arg1, arg2);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.WorkPositionHome)so.servant).findByQBE(arg0Copy, arg1Copy, arg2Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
