...
public class _PIESerialResLinkHome_Stub extends Stub implements PIESerialResLinkHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIESerialResLinkHome:0000000000000000", 
    ...
    public PIESerialResLink create(int arg0, int arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("create__long__long__CORBA_WStringValue", true);
                    out.write_long(arg0);
                    out.write_long(arg1);
                    out.write_value(arg2,String.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIESerialResLink) in.read_Object(PIESerialResLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__long__long__CORBA_WStringValue",com.hps.july.persistence.PIESerialResLinkHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                PIESerialResLink result = ((com.hps.july.persistence.PIESerialResLinkHome)so.servant).create(arg0, arg1, arg2);
                return (PIESerialResLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIESerialResLink create(int arg0, int arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__long__long__CORBA_WStringValue__CORBA_WStringValue", true);
                    out.write_long(arg0);
                    out.write_long(arg1);
                    out.write_value(arg2,String.class);
            ...
            ServantObject so = _servant_preinvoke("create__long__long__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.PIESerialResLinkHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                PIESerialResLink result = ((com.hps.july.persistence.PIESerialResLinkHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (PIESerialResLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public PIESerialResLink findByPrimaryKey(PIESerialResLinkKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIESerialResLinkKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIESerialResLink) in.read_Object(PIESerialResLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIESerialResLinkHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIESerialResLinkKey arg0Copy = (PIESerialResLinkKey) Util.copyObject(arg0,_orb());
                PIESerialResLink result = ((com.hps.july.persistence.PIESerialResLinkHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIESerialResLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
