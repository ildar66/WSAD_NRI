...
public class _PIEQueryHome_Stub extends Stub implements PIEQueryHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEQueryHome:0000000000000000", 
    ...
    public PIEQuery create(int arg0, String arg1, String arg2, String arg3, String arg4, Timestamp arg5) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEQueryHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                ...
                Timestamp arg5Copy = (Timestamp) copies[4];
                PIEQuery result = ((com.hps.july.persistence.PIEQueryHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
    ...
    public PIEQuery findByPrimaryKey(PIEQueryKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEQueryHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEQueryKey arg0Copy = (PIEQueryKey) Util.copyObject(arg0,_orb());
                PIEQuery result = ((com.hps.july.persistence.PIEQueryHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEQuery)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByTypeStatusOrderByCodeAsc(String arg0, String arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByTypeStatusOrderByCodeAsc", true);
                    ...
                    return findByTypeStatusOrderByCodeAsc(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByTypeStatusOrderByCodeAsc",com.hps.july.persistence.PIEQueryHome.class);
            if (so == null) {
                return findByTypeStatusOrderByCodeAsc(arg0, arg1);
            }
            try {
                Enumeration result = ((com.hps.july.persistence.PIEQueryHome)so.servant).findByTypeStatusOrderByCodeAsc(arg0, arg1);
