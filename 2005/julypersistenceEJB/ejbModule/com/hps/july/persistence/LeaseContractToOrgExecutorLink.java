...
import javax.naming.*;
/**
 * LeaseContractToOrgExecutorLink
 * @generated
 */
public class LeaseContractToOrgExecutorLink extends com.ibm.ivj.ejb.associations.links.ManyToSingleLink {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public LeaseContractToOrgExecutorLink(javax.ejb.EntityBean anEntityBean) {
		super(anEntityBean);
	}
	/**
	...
	protected javax.ejb.EJBObject fetchTarget() throws javax.ejb.FinderException, java.rmi.RemoteException {
		...
		com.hps.july.persistence.OrganizationNfsKey key = ((com.hps.july.persistence.LeaseContractBean) source).getOrgExecutorKey();
		try {
	...
	protected boolean isKeyValid() {
		return (((com.hps.july.persistence.LeaseContractBean) source).getOrgExecutorKey() != null);
	}
	/**
	...
	public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			((com.hps.july.persistence.OrganizationNfs) anEJB).secondaryRemoveLeaseContractExecutor(
	...
	public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			((com.hps.july.persistence.OrganizationNfs) anEJB).secondaryAddLeaseContractExecutor(
				(com.hps.july.persistence.LeaseContract) javax.rmi.PortableRemoteObject.narrow(getEntityContext().getEJBObject(), com.hps.july.persistence.LeaseContract.class));
	}
	/**
	...
	public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
		super.set(targetEJB);
		if (targetEJB == null)
			 ((com.hps.july.persistence.LeaseContractBean) source).privateSetOrgExecutorKey(null);
		else
			 ((com.hps.july.persistence.LeaseContractBean) source).privateSetOrgExecutorKey((com.hps.july.persistence.OrganizationNfsKey) targetEJB.getPrimaryKey());
	}
	/**
	 * Reset my target key.
	 * @generated
