...
public class _PIEBudjetHome_Stub extends Stub implements PIEBudjetHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEBudjetHome:0000000000000000", 
    ...
    public PIEBudjet create(int arg0, int arg1, String arg2, String arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEBudjet) in.read_Object(PIEBudjet.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEBudjetHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                PIEBudjet result = ((com.hps.july.persistence.PIEBudjetHome)so.servant).create(arg0, arg1, arg2, arg3, arg4);
                return (PIEBudjet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByOwnerAndRecordstatusOrderByNameAsc(Integer arg0, String arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByOwnerAndRecordstatusOrderByNameAsc",com.hps.july.persistence.PIEBudjetHome.class);
            if (so == null) {
                return findByOwnerAndRecordstatusOrderByNameAsc(arg0, arg1);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PIEBudjetHome)so.servant).findByOwnerAndRecordstatusOrderByNameAsc(arg0Copy, arg1Copy);
    ...
    public PIEBudjet findByPrimaryKey(PIEBudjetKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEBudjetKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEBudjet) in.read_Object(PIEBudjet.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEBudjetHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEBudjetKey arg0Copy = (PIEBudjetKey) Util.copyObject(arg0,_orb());
                PIEBudjet result = ((com.hps.july.persistence.PIEBudjetHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEBudjet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
