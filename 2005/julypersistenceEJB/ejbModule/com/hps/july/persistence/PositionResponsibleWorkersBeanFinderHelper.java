 ...
 **/
public interface PositionResponsibleWorkersBeanFinderHelper {
	public static final String findAllOrderByCodeAscWhereClause = "1=1 order by worker asc";
	public static final String findByPositionResponseTypeWhereClause = "storageplace =? AND idresponsibility = ?";
	public static final String findByPositionResptypeWhereClause = "storageplace = ? AND resptype = ? order by organization ";
	public static final String findByPositionWhereClause = "storageplace = ?";

	public java.sql.PreparedStatement findByQBE(Boolean isStorageplace, Integer storageplace, Boolean isType, Integer type, Integer order) throws Exception;
}
