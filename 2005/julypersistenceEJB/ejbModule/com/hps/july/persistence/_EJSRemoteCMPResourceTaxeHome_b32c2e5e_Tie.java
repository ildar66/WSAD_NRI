...
public class _EJSRemoteCMPResourceTaxeHome_b32c2e5e_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPResourceTaxeHome_b32c2e5e target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPResourceTaxeHome_b32c2e5e) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 27: 
                    if (method.equals("findResourceTaxesByResource")) {
                        return findResourceTaxesByResource(in, reply);
                    }
                case 29: 
                    if (method.equals("findByResourceOrderByDateDesc")) {
                        return findByResourceOrderByDateDesc(in, reply);
                    }
                case 35: 
                    if (method.equals("findBySubtypeDateOrderByResourceAsc")) {
                        return findBySubtypeDateOrderByResourceAsc(in, reply);
                    }
                case 59: 
                    if (method.equals("create__com_hps_july_persistence_ResourceKey__java_sql_Date")) {
                        return create__com_hps_july_persistence_ResourceKey__java_sql_Date(in, reply);
                    }
                case 84: 
                    if (method.equals("create__java_sql_Date__java_lang_Integer__java_math_BigDecimal__java_math_BigDecimal")) {
                        return create__java_sql_Date__java_lang_Integer__java_math_BigDecimal__java_math_BigDecimal(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__com_hps_july_persistence_ResourceKey__java_sql_Date(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream create__java_sql_Date__java_lang_Integer__java_math_BigDecimal__java_math_BigDecimal(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Date arg0 = (Date) in.read_value(Date.class);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceTaxeKey arg0 = (ResourceTaxeKey) in.read_value(ResourceTaxeKey.class);
        ResourceTaxe result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByResourceOrderByDateDesc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByResourceOrderByDateDesc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findBySubtypeDateOrderByResourceAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Enumeration result;
        try {
            result = target.findBySubtypeDateOrderByResourceAsc(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findResourceTaxesByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findResourceTaxesByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
