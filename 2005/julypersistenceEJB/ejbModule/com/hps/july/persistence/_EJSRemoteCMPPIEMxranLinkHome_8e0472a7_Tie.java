...
public class _EJSRemoteCMPPIEMxranLinkHome_8e0472a7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEMxranLinkHome_8e0472a7 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEMxranLinkHome_8e0472a7) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findByMxrannriOwner")) {
                        return findByMxrannriOwner(in, reply);
                    }
                case 24: 
                ...
                case 32: 
                    if (method.equals("findPIEMxranLinksByMxranplatinum")) {
                        return findPIEMxranLinksByMxranplatinum(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByMxrannriOwner(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByMxrannriOwner(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEMxranLinkKey arg0 = (PIEMxranLinkKey) in.read_value(PIEMxranLinkKey.class);
        PIEMxranLink result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEMxranLinksByMxranplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEMxranPlatinumKey arg0 = (PIEMxranPlatinumKey) in.read_value(PIEMxranPlatinumKey.class);
        Enumeration result;
        try {
            result = target.findPIEMxranLinksByMxranplatinum(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
