...
public class _EJSRemoteCMPPIEDogovorNRIHome_c9266334_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEDogovorNRIHome_c9266334 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEDogovorNRIHome_c9266334) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 28: 
                    if (method.equals("findPIEDogovorNRIsByPiequery")) {
                        return findPIEDogovorNRIsByPiequery(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEDogovorNRIKey arg0 = (PIEDogovorNRIKey) in.read_value(PIEDogovorNRIKey.class);
        PIEDogovorNRI result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEDogovorNRIsByPiequery(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEQueryKey arg0 = (PIEQueryKey) in.read_value(PIEQueryKey.class);
        Enumeration result;
        try {
            result = target.findPIEDogovorNRIsByPiequery(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
