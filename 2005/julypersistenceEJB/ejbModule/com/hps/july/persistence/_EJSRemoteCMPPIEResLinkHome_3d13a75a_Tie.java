...
public class _EJSRemoteCMPPIEResLinkHome_3d13a75a_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEResLinkHome_3d13a75a target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEResLinkHome_3d13a75a) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findByIdresnriAndOwner")) {
                        return findByIdresnriAndOwner(in, reply);
                    }
                case 24: 
                ...
                case 28: 
                    if (method.equals("findPIEResLinksByResplatinum")) {
                        return findPIEResLinksByResplatinum(in, reply);
                    }
                case 58: 
                    if (method.equals("create__long__long__CORBA_WStringValue__java_sql_Timestamp")) {
                        return create__long__long__CORBA_WStringValue__java_sql_Timestamp(in, reply);
                    }
                case 77: 
                    if (method.equals("create__long__long__CORBA_WStringValue__java_sql_Timestamp__java_lang_Boolean")) {
                        return create__long__long__CORBA_WStringValue__java_sql_Timestamp__java_lang_Boolean(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__java_sql_Timestamp(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__java_sql_Timestamp__java_lang_Boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
        Timestamp arg3 = (Timestamp) in.read_value(Timestamp.class);
    ...
    private org.omg.CORBA.portable.OutputStream findByIdresnriAndOwner(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByIdresnriAndOwner(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEResLinkKey arg0 = (PIEResLinkKey) in.read_value(PIEResLinkKey.class);
        PIEResLink result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findPIEResLinksByResplatinum(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIEResPlatinumKey arg0 = (PIEResPlatinumKey) in.read_value(PIEResPlatinumKey.class);
        Enumeration result;
        try {
            result = target.findPIEResLinksByResplatinum(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
