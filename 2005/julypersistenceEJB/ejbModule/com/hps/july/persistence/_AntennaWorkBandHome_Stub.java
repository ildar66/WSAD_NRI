...
public class _AntennaWorkBandHome_Stub extends Stub implements AntennaWorkBandHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.AntennaWorkBandHome:0000000000000000", 
    ...
    public AntennaWorkBand create(int arg0, short arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennaWorkBand) in.read_Object(AntennaWorkBand.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.AntennaWorkBandHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                AntennaWorkBand result = ((com.hps.july.persistence.AntennaWorkBandHome)so.servant).create(arg0, arg1);
                return (AntennaWorkBand)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findAntennaWorkBandsByAntenna(AntennaKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("findAntennaWorkBandsByAntenna", true);
                    ...
                    return findAntennaWorkBandsByAntenna(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAntennaWorkBandsByAntenna",com.hps.july.persistence.AntennaWorkBandHome.class);
            if (so == null) {
                return findAntennaWorkBandsByAntenna(arg0);
            }
            try {
                AntennaKey arg0Copy = (AntennaKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.AntennaWorkBandHome)so.servant).findAntennaWorkBandsByAntenna(arg0Copy);
    ...
    public AntennaWorkBand findByPrimaryKey(AntennaWorkBandKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,AntennaWorkBandKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennaWorkBand) in.read_Object(AntennaWorkBand.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.AntennaWorkBandHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AntennaWorkBandKey arg0Copy = (AntennaWorkBandKey) Util.copyObject(arg0,_orb());
                AntennaWorkBand result = ((com.hps.july.persistence.AntennaWorkBandHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AntennaWorkBand)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
