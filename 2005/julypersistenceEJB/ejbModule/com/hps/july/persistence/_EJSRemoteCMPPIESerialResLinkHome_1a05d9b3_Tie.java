...
public class _EJSRemoteCMPPIESerialResLinkHome_1a05d9b3_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIESerialResLinkHome_1a05d9b3 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIESerialResLinkHome_1a05d9b3) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 38: 
                    if (method.equals("create__long__long__CORBA_WStringValue")) {
                        return create__long__long__CORBA_WStringValue(in, reply);
                    }
                case 58: 
                    if (method.equals("create__long__long__CORBA_WStringValue__CORBA_WStringValue")) {
                        return create__long__long__CORBA_WStringValue__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
        PIESerialResLink result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream create__long__long__CORBA_WStringValue__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        String arg2 = (String) in.read_value(String.class);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PIESerialResLinkKey arg0 = (PIESerialResLinkKey) in.read_value(PIESerialResLinkKey.class);
        PIESerialResLink result;
        try {
