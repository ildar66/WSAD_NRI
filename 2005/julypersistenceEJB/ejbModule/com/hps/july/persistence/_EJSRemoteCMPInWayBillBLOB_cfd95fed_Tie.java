...
public class _EJSRemoteCMPInWayBillBLOB_cfd95fed_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPInWayBillBLOB_cfd95fed target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPInWayBillBLOB_cfd95fed) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 13: 
                    if (method.equals("_get_DActText")) {
                        return _get_DActText(in, reply);
                    } else if (method.equals("_set_DActText")) {
                        return _set_DActText(in, reply);
                ...
                case 21: 
                    if (method.equals("_get_DActTextFileName")) {
                        return _get_DActTextFileName(in, reply);
                    } else if (method.equals("_set_DActTextFileName")) {
                        return _set_DActTextFileName(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_DActText(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] result = target.getDActText();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_DActTextFileName(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getDActTextFileName();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_DActText(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        byte[] arg0 = (byte[]) in.read_value(byte[].class);
        target.setDActText(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _set_DActTextFileName(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setDActTextFileName(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
