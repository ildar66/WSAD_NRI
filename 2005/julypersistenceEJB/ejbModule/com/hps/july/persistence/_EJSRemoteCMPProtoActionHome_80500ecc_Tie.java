...
public class _EJSRemoteCMPProtoActionHome_80500ecc_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPProtoActionHome_80500ecc target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPProtoActionHome_80500ecc) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findProtoActionsByProjectType")) {
                        return findProtoActionsByProjectType(in, reply);
                    }
                case 30: 
                    if (method.equals("findStepsBeforeOrderByOrderAsc")) {
                        return findStepsBeforeOrderByOrderAsc(in, reply);
                    }
                case 32: 
                    if (method.equals("findByProjecttypeOrderByOrderAsc")) {
                        return findByProjecttypeOrderByOrderAsc(in, reply);
                    }
                case 35: 
                    if (method.equals("findProtoActionsByProjectActionType")) {
                        return findProtoActionsByProjectActionType(in, reply);
                    }
                case 38: 
                    if (method.equals("findByProjectactiontypeOrderByOrderAsc")) {
                        return findByProjectactiontypeOrderByOrderAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProtoActionKey arg0 = (ProtoActionKey) in.read_value(ProtoActionKey.class);
        ProtoAction result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByProjectactiontypeOrderByOrderAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByProjectactiontypeOrderByOrderAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByProjecttypeOrderByOrderAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByProjecttypeOrderByOrderAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProtoActionsByProjectActionType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectActionTypeKey arg0 = (ProjectActionTypeKey) in.read_value(ProjectActionTypeKey.class);
        Enumeration result;
        try {
            result = target.findProtoActionsByProjectActionType(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findProtoActionsByProjectType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ProjectTypeKey arg0 = (ProjectTypeKey) in.read_value(ProjectTypeKey.class);
        Enumeration result;
        try {
            result = target.findProtoActionsByProjectType(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findStepsBeforeOrderByOrderAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findStepsBeforeOrderByOrderAsc(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
