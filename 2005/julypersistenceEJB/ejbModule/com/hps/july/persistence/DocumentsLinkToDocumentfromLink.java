...
import javax.ejb.*;
import javax.naming.*;
public class DocumentsLinkToDocumentfromLink extends ManyToSingleLink {
...
public DocumentsLinkToDocumentfromLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DocumentKey key = ((com.hps.july.persistence.DocumentsLinkBean)source).getDocumentfromKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.DocumentsLinkBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.DocumentsLinkBean)source).getDocumentfromKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.DocumentsLinkBean)source).privateSetDocumentfromKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Document)anEJB).secondaryAddDocumentsLinkFrom((com.hps.july.persistence.DocumentsLink)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Document)anEJB).secondaryRemoveDocumentsLinkFrom((com.hps.july.persistence.DocumentsLink)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.DocumentsLinkBean)source).privateSetDocumentfromKey((com.hps.july.persistence.DocumentKey)targetEJB.getPrimaryKey());
}
}
