...
public class _BaseAgreementHome_Stub extends Stub implements BaseAgreementHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.BaseAgreementHome:0000000000000000", 
    ...
    public BaseAgreement create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.BaseAgreementHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                BaseAgreement result = ((com.hps.july.persistence.BaseAgreementHome)so.servant).create(arg0);
    ...
    public BaseAgreement create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.BaseAgreementHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                BaseAgreement result = ((com.hps.july.persistence.BaseAgreementHome)so.servant).create(arg0, arg1);
                return (BaseAgreement)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.BaseAgreementHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.BaseAgreementHome)so.servant).findAllOrderByNameAsc();
    ...
    public Enumeration findAllOrderByNameDesc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllOrderByNameDesc", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Enumeration) in.read_value(Enumeration.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameDesc",com.hps.july.persistence.BaseAgreementHome.class);
            if (so == null) {
                return findAllOrderByNameDesc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.BaseAgreementHome)so.servant).findAllOrderByNameDesc();
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public BaseAgreement findByPrimaryKey(BaseAgreementKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.BaseAgreementHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                BaseAgreementKey arg0Copy = (BaseAgreementKey) Util.copyObject(arg0,_orb());
                BaseAgreement result = ((com.hps.july.persistence.BaseAgreementHome)so.servant).findByPrimaryKey(arg0Copy);
                return (BaseAgreement)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
