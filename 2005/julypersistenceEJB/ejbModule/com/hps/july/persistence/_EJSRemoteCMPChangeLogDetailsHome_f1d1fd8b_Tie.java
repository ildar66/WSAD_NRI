...
public class _EJSRemoteCMPChangeLogDetailsHome_f1d1fd8b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPChangeLogDetailsHome_f1d1fd8b target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPChangeLogDetailsHome_f1d1fd8b) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findByChangelogOrderByCodeAsc")) {
                        return findByChangelogOrderByCodeAsc(in, reply);
                    }
                case 33: 
                    if (method.equals("findChangeLogDetailsesByChangelog")) {
                        return findChangeLogDetailsesByChangelog(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByChangelogOrderByCodeAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByChangelogOrderByCodeAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ChangeLogDetailsKey arg0 = (ChangeLogDetailsKey) in.read_value(ChangeLogDetailsKey.class);
        ChangeLogDetails result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findChangeLogDetailsesByChangelog(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ChangeLogKey arg0 = (ChangeLogKey) in.read_value(ChangeLogKey.class);
        Enumeration result;
        try {
            result = target.findChangeLogDetailsesByChangelog(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
