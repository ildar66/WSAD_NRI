...
public class _EJSRemoteCMPPIEOtvUserPlatinumHome_379c5e7f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPIEOtvUserPlatinumHome_379c5e7f target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPIEOtvUserPlatinumHome_379c5e7f) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 35: 
                    if (method.equals("findByOtvuserPlatinumOrderByNameAsc")) {
                        return findByOtvuserPlatinumOrderByNameAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByOtvuserPlatinumOrderByNameAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByOtvuserPlatinumOrderByNameAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
