...
public class _PIEExpenceHome_Stub extends Stub implements PIEExpenceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEExpenceHome:0000000000000000", 
    ...
    public PIEExpence create(int arg0, int arg1, String arg2, String arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEExpence) in.read_Object(PIEExpence.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEExpenceHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                PIEExpence result = ((com.hps.july.persistence.PIEExpenceHome)so.servant).create(arg0, arg1, arg2, arg3, arg4);
                return (PIEExpence)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByOwnerAndRecordstatusOrderByNameAsc(Integer arg0, String arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByOwnerAndRecordstatusOrderByNameAsc", true);
                    ...
                    return findByOwnerAndRecordstatusOrderByNameAsc(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByOwnerAndRecordstatusOrderByNameAsc",com.hps.july.persistence.PIEExpenceHome.class);
            if (so == null) {
                return findByOwnerAndRecordstatusOrderByNameAsc(arg0, arg1);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PIEExpenceHome)so.servant).findByOwnerAndRecordstatusOrderByNameAsc(arg0Copy, arg1Copy);
    ...
    public PIEExpence findByPrimaryKey(PIEExpenceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEExpenceKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEExpence) in.read_Object(PIEExpence.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEExpenceHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEExpenceKey arg0Copy = (PIEExpenceKey) Util.copyObject(arg0,_orb());
                PIEExpence result = ((com.hps.july.persistence.PIEExpenceHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEExpence)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
