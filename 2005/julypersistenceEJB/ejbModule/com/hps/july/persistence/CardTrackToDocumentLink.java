...
import javax.ejb.*;
import javax.naming.*;
public class CardTrackToDocumentLink extends ManyToSingleLink {
...
public CardTrackToDocumentLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DocumentKey key = ((com.hps.july.persistence.CardTrackBean)source).getDocumentKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.CardTrackBean)source).getDocumentKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.CardTrackBean)source).privateSetDocumentKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Document)anEJB).secondaryAddCardTrack((com.hps.july.persistence.CardTrack)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Document)anEJB).secondaryRemoveCardTrack((com.hps.july.persistence.CardTrack)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.CardTrackBean)source).privateSetDocumentKey((com.hps.july.persistence.DocumentKey)targetEJB.getPrimaryKey());
}
}
