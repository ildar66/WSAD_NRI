...
public class _SuperRegionHome_Stub extends Stub implements SuperRegionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SuperRegionHome:0000000000000000", 
    ...
    public SuperRegion create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.SuperRegionHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                SuperRegion result = ((com.hps.july.persistence.SuperRegionHome)so.servant).create(arg0, arg1);
    ...
    public SuperRegion create(int arg0, String arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__long__CORBA_WStringValue__long", true);
                    out.write_long(arg0);
                    out.write_value(arg1,String.class);
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__long",com.hps.july.persistence.SuperRegionHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                SuperRegion result = ((com.hps.july.persistence.SuperRegionHome)so.servant).create(arg0, arg1, arg2);
                return (SuperRegion)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByCodeAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByCodeAsc",com.hps.july.persistence.SuperRegionHome.class);
            if (so == null) {
                return findAllOrderByCodeAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.SuperRegionHome)so.servant).findAllOrderByCodeAsc();
    ...
    public SuperRegion findByPrimaryKey(SuperRegionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SuperRegionHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SuperRegionKey arg0Copy = (SuperRegionKey) Util.copyObject(arg0,_orb());
                SuperRegion result = ((com.hps.july.persistence.SuperRegionHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SuperRegion)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
