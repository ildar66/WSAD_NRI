...
public class _EJSRemoteCMPLeaseSaldoHome_6f33cd6c_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseSaldoHome_6f33cd6c target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseSaldoHome_6f33cd6c) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 20: 
                    if (method.equals("findLeaseSaldosByAct")) {
                        return findLeaseSaldosByAct(in, reply);
                    }
                case 24: 
                    ...
                    } else if (method.equals("findLeaseSaldoByResource")) {
                        return findLeaseSaldoByResource(in, reply);
                    }
                case 33: 
                    if (method.equals("findLeaseSaldoMainsByMaincurrency")) {
                        return findLeaseSaldoMainsByMaincurrency(in, reply);
                    }
                case 38: 
                    if (method.equals("findLeaseSaldoAddsByAdditionalcurrency")) {
                        return findLeaseSaldoAddsByAdditionalcurrency(in, reply);
                    }
                case 42: 
                    if (method.equals("findByLeaseContractAndResourceOrderDateAsc")) {
                        return findByLeaseContractAndResourceOrderDateAsc(in, reply);
                    }
                case 43: 
                    if (method.equals("findByLeaseContractAndResourceOrderDateDesc")) {
                        return findByLeaseContractAndResourceOrderDateDesc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByLeaseContractAndResourceOrderDateAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByLeaseContractAndResourceOrderDateAsc(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findByLeaseContractAndResourceOrderDateDesc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByLeaseContractAndResourceOrderDateDesc(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseSaldoKey arg0 = (LeaseSaldoKey) in.read_value(LeaseSaldoKey.class);
        LeaseSaldo result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseSaldoAddsByAdditionalcurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencyKey arg0 = (CurrencyKey) in.read_value(CurrencyKey.class);
        Enumeration result;
        try {
            result = target.findLeaseSaldoAddsByAdditionalcurrency(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseSaldoByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findLeaseSaldoByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseSaldoMainsByMaincurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencyKey arg0 = (CurrencyKey) in.read_value(CurrencyKey.class);
        Enumeration result;
        try {
            result = target.findLeaseSaldoMainsByMaincurrency(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseSaldosByAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocumentKey arg0 = (LeaseDocumentKey) in.read_value(LeaseDocumentKey.class);
        Enumeration result;
        try {
            result = target.findLeaseSaldosByAct(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
