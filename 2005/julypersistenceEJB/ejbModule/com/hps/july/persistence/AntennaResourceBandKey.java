...
public class AntennaResourceBandKey implements java.io.Serializable {
	public short band;
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public AntennaResourceBandKey(short argBand) {
	band = argBand;
}
/**
 * Initialize a key from the passed values
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public AntennaResourceBandKey(short argBand, ResourceKey argResource) {
	band = argBand;
...
public boolean equals(java.lang.Object o) {
	if (o instanceof AntennaResourceBandKey) {
		AntennaResourceBandKey otherKey = (AntennaResourceBandKey) o;
