...
public class _CurrencyHome_Stub extends Stub implements CurrencyHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.CurrencyHome:0000000000000000", 
    ...
    public Currency create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.CurrencyHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Currency result = ((com.hps.july.persistence.CurrencyHome)so.servant).create(arg0);
    ...
    public Currency create(int arg0, String arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.CurrencyHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Currency result = ((com.hps.july.persistence.CurrencyHome)so.servant).create(arg0, arg1, arg2);
                return (Currency)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.CurrencyHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.CurrencyHome)so.servant).findAllOrderByNameAsc();
    ...
    public Enumeration findByConnectedOrderByNameAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByConnectedOrderByNameAsc",com.hps.july.persistence.CurrencyHome.class);
            if (so == null) {
                return findByConnectedOrderByNameAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.CurrencyHome)so.servant).findByConnectedOrderByNameAsc(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Currency findByPrimaryKey(CurrencyKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.CurrencyHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CurrencyKey arg0Copy = (CurrencyKey) Util.copyObject(arg0,_orb());
                Currency result = ((com.hps.july.persistence.CurrencyHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Currency)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
