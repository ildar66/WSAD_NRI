...
import javax.ejb.*;
import javax.naming.*;
public class ChanalPowerToBasestationLink extends ManyToSingleLink {
...
public ChanalPowerToBasestationLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StoragePlaceKey key = ((com.hps.july.persistence.ChanalPowerBean)source).getBasestationKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.ChanalPowerBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.ChanalPowerBean)source).getBasestationKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.ChanalPowerBean)source).privateSetBasestationKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.BaseStation)anEJB).secondaryAddChanalPowers((com.hps.july.persistence.ChanalPower)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.BaseStation)anEJB).secondaryRemoveChanalPowers((com.hps.july.persistence.ChanalPower)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.ChanalPowerBean)source).privateSetBasestationKey((com.hps.july.persistence.StoragePlaceKey)targetEJB.getPrimaryKey());
}
}
