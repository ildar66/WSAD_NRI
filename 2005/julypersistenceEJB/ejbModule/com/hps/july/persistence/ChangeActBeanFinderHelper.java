 ...
 **/
public interface ChangeActBeanFinderHelper extends com.hps.july.persistence.DocumentBeanFinderHelper { 
java.sql.PreparedStatement findByQBE(Boolean isDate, java.sql.Date datefrom, java.sql.Date dateto,
    Boolean isOwner, Integer owner,
    Boolean isContragent, Integer contragent,
    Boolean isExpeditor, Integer expeditor,
    Integer order
	) throws Exception;
	public java.sql.PreparedStatement findByQBEPosition(Boolean isDate, java.sql.Date datefrom, java.sql.Date dateto,
    Boolean isOwner, Integer owner,
