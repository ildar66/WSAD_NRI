...
public class _SupplyTypeHome_Stub extends Stub implements SupplyTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SupplyTypeHome:0000000000000000", 
    ...
    public SupplyType create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.SupplyTypeHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                SupplyType result = ((com.hps.july.persistence.SupplyTypeHome)so.servant).create(arg0);
    ...
    public SupplyType create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue",com.hps.july.persistence.SupplyTypeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                SupplyType result = ((com.hps.july.persistence.SupplyTypeHome)so.servant).create(arg0, arg1);
                return (SupplyType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.SupplyTypeHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.SupplyTypeHome)so.servant).findAllOrderByNameAsc();
    ...
    public Enumeration findAllOrderByNameDesc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameDesc",com.hps.july.persistence.SupplyTypeHome.class);
            if (so == null) {
                return findAllOrderByNameDesc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.SupplyTypeHome)so.servant).findAllOrderByNameDesc();
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public SupplyType findByPrimaryKey(SupplyTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SupplyTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SupplyTypeKey arg0Copy = (SupplyTypeKey) Util.copyObject(arg0,_orb());
                SupplyType result = ((com.hps.july.persistence.SupplyTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SupplyType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
