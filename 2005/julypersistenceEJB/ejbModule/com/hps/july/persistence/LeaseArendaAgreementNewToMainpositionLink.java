...
import javax.ejb.*;
import javax.naming.*;
public class LeaseArendaAgreementNewToMainpositionLink extends ManyToSingleLink {
...
public LeaseArendaAgreementNewToMainpositionLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.StoragePlaceKey key = ((com.hps.july.persistence.LeaseArendaAgreementNewBean)source).getMainpositionKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseArendaAgreementNewBean)source).getMainpositionKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseArendaAgreementNewBean)source).privateSetMainpositionKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Position)anEJB).secondaryAddLeaseArendaAgreementNews((com.hps.july.persistence.LeaseArendaAgreementNew)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Position)anEJB).secondaryRemoveLeaseArendaAgreementNews((com.hps.july.persistence.LeaseArendaAgreementNew)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseArendaAgreementNewBean)source).privateSetMainpositionKey((com.hps.july.persistence.StoragePlaceKey)targetEJB.getPrimaryKey());
}
}
