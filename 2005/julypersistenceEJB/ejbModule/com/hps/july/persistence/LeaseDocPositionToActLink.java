...
import javax.ejb.*;
import javax.naming.*;
public class LeaseDocPositionToActLink extends ManyToSingleLink {
...
public LeaseDocPositionToActLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.LeaseDocumentKey key = ((com.hps.july.persistence.LeaseDocPositionBean)source).getActKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseDocPositionBean)source).getActKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseDocPositionBean)source).privateSetActKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualActNew)anEJB).secondaryAddLeaseDocPositions((com.hps.july.persistence.LeaseDocPosition)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualActNew)anEJB).secondaryRemoveLeaseDocPositions((com.hps.july.persistence.LeaseDocPosition)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseDocPositionBean)source).privateSetActKey((com.hps.july.persistence.LeaseDocumentKey)targetEJB.getPrimaryKey());
}
}
