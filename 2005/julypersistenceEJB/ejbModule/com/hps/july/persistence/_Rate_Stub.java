...
public class _Rate_Stub extends Stub implements Rate {
    ...
    public Currency getCurrency() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("getCurrency",com.hps.july.persistence.Rate.class);
            if (so == null) {
                return getCurrency();
            }
            try {
                Currency result = ((com.hps.july.persistence.Rate)so.servant).getCurrency();
    ...
    public CurrencyKey getCurrencyKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_currencyKey",com.hps.july.persistence.Rate.class);
            if (so == null) {
                return getCurrencyKey();
            }
            try {
                CurrencyKey result = ((com.hps.july.persistence.Rate)so.servant).getCurrencyKey();
    ...
    public Date getDate() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_date",com.hps.july.persistence.Rate.class);
            if (so == null) {
                return getDate();
            }
            try {
                Date result = ((com.hps.july.persistence.Rate)so.servant).getDate();
    ...
    public RateType getType() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RateType) in.read_Object(RateType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    if (id.equals("IDL:javax/ejb/FinderEx:1.0")) {
            ...
            ServantObject so = _servant_preinvoke("getType",com.hps.july.persistence.Rate.class);
            if (so == null) {
                return getType();
            }
            try {
                RateType result = ((com.hps.july.persistence.Rate)so.servant).getType();
                return (RateType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
                    throw (FinderException)exCopy;
    ...
    public RateTypeKey getTypeKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RateTypeKey) in.read_value(RateTypeKey.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
            ...
            ServantObject so = _servant_preinvoke("_get_typeKey",com.hps.july.persistence.Rate.class);
            if (so == null) {
                return getTypeKey();
            }
            try {
                RateTypeKey result = ((com.hps.july.persistence.Rate)so.servant).getTypeKey();
                return (RateTypeKey)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public BigDecimal getValue() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_value",com.hps.july.persistence.Rate.class);
            if (so == null) {
                return getValue();
            }
            try {
                BigDecimal result = ((com.hps.july.persistence.Rate)so.servant).getValue();
    ...
    public void setDate(Date arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_date",com.hps.july.persistence.Rate.class);
            if (so == null) {
                setDate(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.Rate)so.servant).setDate(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setValue(BigDecimal arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_value",com.hps.july.persistence.Rate.class);
            if (so == null) {
                setValue(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.Rate)so.servant).setValue(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
