...
public class _ResponsibilityTypeHome_Stub extends Stub implements ResponsibilityTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ResponsibilityTypeHome:0000000000000000", 
    ...
    public ResponsibilityType create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.ResponsibilityTypeHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                ResponsibilityType result = ((com.hps.july.persistence.ResponsibilityTypeHome)so.servant).create(arg0);
    ...
    public ResponsibilityType create(int arg0, String arg1, Boolean arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__CORBA_WStringValue__java_lang_Boolean",com.hps.july.persistence.ResponsibilityTypeHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                ResponsibilityType result = ((com.hps.july.persistence.ResponsibilityTypeHome)so.servant).create(arg0, arg1Copy, arg2Copy);
                return (ResponsibilityType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByCodeAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByCodeAsc",com.hps.july.persistence.ResponsibilityTypeHome.class);
            if (so == null) {
                return findAllOrderByCodeAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.ResponsibilityTypeHome)so.servant).findAllOrderByCodeAsc();
    ...
    public ResponsibilityType findByPrimaryKey(ResponsibilityTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ResponsibilityTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResponsibilityTypeKey arg0Copy = (ResponsibilityTypeKey) Util.copyObject(arg0,_orb());
                ResponsibilityType result = ((com.hps.july.persistence.ResponsibilityTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ResponsibilityType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
