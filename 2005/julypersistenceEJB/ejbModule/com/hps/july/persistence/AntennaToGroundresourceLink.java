...
import javax.ejb.*;
import javax.naming.*;
public class AntennaToGroundresourceLink extends ManyToSingleLink {
...
public AntennaToGroundresourceLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.ResourceKey key = ((com.hps.july.persistence.AntennaBean)source).getGroundresourceKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.AntennaBean)source).getGroundresourceKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.AntennaBean)source).privateSetGroundresourceKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryAddGrresAntennes((com.hps.july.persistence.Antenna)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryRemoveGrresAntennes((com.hps.july.persistence.Antenna)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.AntennaBean)source).privateSetGroundresourceKey((com.hps.july.persistence.ResourceKey)targetEJB.getPrimaryKey());
}
}
