...
public class _ImportTaskHome_Stub extends Stub implements ImportTaskHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.ImportTaskHome:0000000000000000", 
    ...
    public ImportTask create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.ImportTaskHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ImportTask result = ((com.hps.july.persistence.ImportTaskHome)so.servant).create(arg0, arg1);
    ...
    public ImportTask findByPrimaryKey(ImportTaskKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.ImportTaskHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ImportTaskKey arg0Copy = (ImportTaskKey) Util.copyObject(arg0,_orb());
                ImportTask result = ((com.hps.july.persistence.ImportTaskHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ImportTask)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
