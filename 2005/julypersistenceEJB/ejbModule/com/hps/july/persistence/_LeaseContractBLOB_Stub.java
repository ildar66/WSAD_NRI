...
public class _LeaseContractBLOB_Stub extends Stub implements LeaseContractBLOB {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.LeaseContractBLOB:0000000000000000", 
    ...
    public String getComment() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_comment",com.hps.july.persistence.LeaseContractBLOB.class);
            if (so == null) {
                return getComment();
            }
            try {
                return ((com.hps.july.persistence.LeaseContractBLOB)so.servant).getComment();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getSubject() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_subject", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (String) in.read_value(String.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_subject",com.hps.july.persistence.LeaseContractBLOB.class);
            if (so == null) {
                return getSubject();
            }
            try {
                return ((com.hps.july.persistence.LeaseContractBLOB)so.servant).getSubject();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setComment(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_comment",com.hps.july.persistence.LeaseContractBLOB.class);
            if (so == null) {
                setComment(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.LeaseContractBLOB)so.servant).setComment(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setSubject(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_subject",com.hps.july.persistence.LeaseContractBLOB.class);
            if (so == null) {
                setSubject(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence.LeaseContractBLOB)so.servant).setSubject(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
