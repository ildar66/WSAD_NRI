...
import javax.ejb.*;
import javax.naming.*;
public class OrganizationToContragentDocumentLink extends SingleToManyLink {
...
public OrganizationToContragentDocumentLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
