...
public class _DepartmentHome_Stub extends Stub implements DepartmentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.DepartmentHome:0000000000000000", 
    ...
    public Department create(int arg0, String arg1, String arg2, Integer arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Department) in.read_Object(Department.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.DepartmentHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                Department result = ((com.hps.july.persistence.DepartmentHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
    ...
    public Enumeration findByParentOrderByNameAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByParentOrderByNameAsc",com.hps.july.persistence.DepartmentHome.class);
            if (so == null) {
                return findByParentOrderByNameAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.DepartmentHome)so.servant).findByParentOrderByNameAsc(arg0Copy);
    ...
    public Enumeration findByParentOrderByNameDesc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByParentOrderByNameDesc",com.hps.july.persistence.DepartmentHome.class);
            if (so == null) {
                return findByParentOrderByNameDesc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.DepartmentHome)so.servant).findByParentOrderByNameDesc(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Department findByPrimaryKey(DivisionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.DepartmentHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                DivisionKey arg0Copy = (DivisionKey) Util.copyObject(arg0,_orb());
                Department result = ((com.hps.july.persistence.DepartmentHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Department)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findByQBE(Boolean arg0, Integer arg1, Boolean arg2, Boolean arg3, Integer arg4) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByQBE",com.hps.july.persistence.DepartmentHome.class);
            if (so == null) {
                return findByQBE(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.DepartmentHome)so.servant).findByQBE(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
