...
public class _PIEOtvUserLinkHome_Stub extends Stub implements PIEOtvUserLinkHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEOtvUserLinkHome:0000000000000000", 
    ...
    public PIEOtvUserLink create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEOtvUserLink) in.read_Object(PIEOtvUserLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PIEOtvUserLinkHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                PIEOtvUserLink result = ((com.hps.july.persistence.PIEOtvUserLinkHome)so.servant).create(arg0, arg1);
                return (PIEOtvUserLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEOtvUserLink findByPrimaryKey(PIEOtvUserLinkKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEOtvUserLinkKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEOtvUserLink) in.read_Object(PIEOtvUserLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEOtvUserLinkHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEOtvUserLinkKey arg0Copy = (PIEOtvUserLinkKey) Util.copyObject(arg0,_orb());
                PIEOtvUserLink result = ((com.hps.july.persistence.PIEOtvUserLinkHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEOtvUserLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findPIEOtvUserLinksByOtvuserplatinum(PIEOtvUserPlatinumKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPIEOtvUserLinksByOtvuserplatinum", true);
                    ...
                    return findPIEOtvUserLinksByOtvuserplatinum(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPIEOtvUserLinksByOtvuserplatinum",com.hps.july.persistence.PIEOtvUserLinkHome.class);
            if (so == null) {
                return findPIEOtvUserLinksByOtvuserplatinum(arg0);
            }
            try {
                PIEOtvUserPlatinumKey arg0Copy = (PIEOtvUserPlatinumKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PIEOtvUserLinkHome)so.servant).findPIEOtvUserLinksByOtvuserplatinum(arg0Copy);
