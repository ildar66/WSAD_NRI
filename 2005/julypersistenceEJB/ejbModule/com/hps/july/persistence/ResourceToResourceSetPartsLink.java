...
import javax.ejb.*;
import javax.naming.*;
public class ResourceToResourceSetPartsLink extends SingleToManyLink {
...
public ResourceToResourceSetPartsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.ResourceSetPart)anEJB).getPartKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.ResourceSetPartHome)getTargetHome(this)).findResourceSetPartsByPart((com.hps.july.persistence.ResourceKey)getEntityContext().getPrimaryKey());
	}
