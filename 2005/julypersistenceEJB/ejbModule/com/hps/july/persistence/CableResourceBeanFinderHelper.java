 ...
 **/
public interface CableResourceBeanFinderHelper extends com.hps.july.persistence.ResourceBeanFinderHelper {
	...
	public java.sql.PreparedStatement findResourcesByQBE4(Boolean isSubtypekey, ResourceSubTypeKey subtypeKey, Boolean isModel, String model, Boolean isName, String name, Integer active, Integer order)  throws Exception;
