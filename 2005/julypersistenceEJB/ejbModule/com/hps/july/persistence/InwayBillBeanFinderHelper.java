 ...
 **/
public interface InwayBillBeanFinderHelper extends com.hps.july.persistence.DocumentBeanFinderHelper {
	public java.sql.PreparedStatement findByQBE(Boolean isStorage, Integer storage, java.sql.Date
	startDate, java.sql.Date endDate, Boolean isCordocnum, String cordocnum, Boolean isOwner, Integer owner, Boolean
	isSupplier, Integer supplier, Boolean isDActOnly, Integer order) throws Exception;
}
