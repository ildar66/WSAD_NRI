...
import javax.ejb.*;
import javax.naming.*;
public class LeaseChargesToLeaseDNOPLink extends SingleToManyLink {
...
public LeaseChargesToLeaseDNOPLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseDNOP)anEJB).getLeaseChargeKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseDNOPHome)getTargetHome(this)).findLeaseDNOPByLeaseCharge((com.hps.july.persistence.LeaseDocPositionKey)getEntityContext().getPrimaryKey());
	}
