...
import javax.ejb.*;
import javax.naming.*;
public class RequestToDivisionRequesterLink extends ManyToSingleLink {
...
public RequestToDivisionRequesterLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DivisionKey key = ((com.hps.july.persistence.RequestBean)source).getDivisionRequesterKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.RequestBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.RequestBean)source).getDivisionRequesterKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.RequestBean)source).privateSetDivisionRequesterKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryAddRequest((com.hps.july.persistence.Request)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Division)anEJB).secondaryRemoveRequest((com.hps.july.persistence.Request)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.RequestBean)source).privateSetDivisionRequesterKey((com.hps.july.persistence.DivisionKey)targetEJB.getPrimaryKey());
}
}
