...
public class _EJSRemoteCMPAbonPays2docposHome_10abaa1e_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAbonPays2docposHome_10abaa1e target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAbonPays2docposHome_10abaa1e) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findAbonPays2docposesByPaypos")) {
                        return findAbonPays2docposesByPaypos(in, reply);
                    }
                case 37: 
                    if (method.equals("findAbonPays2docposByLeasedocposition")) {
                        return findAbonPays2docposByLeasedocposition(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAbonPays2docposByLeasedocposition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LeaseDocPositionKey arg0 = (LeaseDocPositionKey) in.read_value(LeaseDocPositionKey.class);
        AbonPays2docpos result;
        try {
            result = target.findAbonPays2docposByLeasedocposition(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findAbonPays2docposesByPaypos(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AbonentPaymentKey arg0 = (AbonentPaymentKey) in.read_value(AbonentPaymentKey.class);
        Enumeration result;
        try {
            result = target.findAbonPays2docposesByPaypos(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AbonPays2docposKey arg0 = (AbonPays2docposKey) in.read_value(AbonPays2docposKey.class);
        AbonPays2docpos result;
        try {
