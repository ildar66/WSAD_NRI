...
public class _EJSRemoteCMPAntennaResourceBandHome_b73af947_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAntennaResourceBandHome_b73af947 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAntennaResourceBandHome_b73af947) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 34: 
                    if (method.equals("findAntennaResourceBandsByResource")) {
                        return findAntennaResourceBandsByResource(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAntennaResourceBandsByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findAntennaResourceBandsByResource(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AntennaResourceBandKey arg0 = (AntennaResourceBandKey) in.read_value(AntennaResourceBandKey.class);
        AntennaResourceBand result;
        try {
