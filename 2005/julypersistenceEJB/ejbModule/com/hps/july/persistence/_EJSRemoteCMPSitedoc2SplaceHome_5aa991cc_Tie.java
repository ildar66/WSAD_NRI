...
public class _EJSRemoteCMPSitedoc2SplaceHome_5aa991cc_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSitedoc2SplaceHome_5aa991cc target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSitedoc2SplaceHome_5aa991cc) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 28: 
                    if (method.equals("findSitedoc2SplacesBySiteDoc")) {
                        return findSitedoc2SplacesBySiteDoc(in, reply);
                    }
                case 33: 
                    if (method.equals("findSitedoc2SplacesByStoragePlace")) {
                        return findSitedoc2SplacesByStoragePlace(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Sitedoc2SplaceKey arg0 = (Sitedoc2SplaceKey) in.read_value(Sitedoc2SplaceKey.class);
        Sitedoc2Splace result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findSitedoc2SplacesBySiteDoc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        SiteDocKey arg0 = (SiteDocKey) in.read_value(SiteDocKey.class);
        Enumeration result;
        try {
            result = target.findSitedoc2SplacesBySiteDoc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findSitedoc2SplacesByStoragePlace(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findSitedoc2SplacesByStoragePlace(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
