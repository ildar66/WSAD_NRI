...
public class _EJSRemoteCMPChangeLogHome_7a6fd283_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPChangeLogHome_7a6fd283 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPChangeLogHome_7a6fd283) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findChangeLogsByPeople")) {
                        return findChangeLogsByPeople(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findChangeLogsByPeople(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        PeopleKey arg0 = (PeopleKey) in.read_value(PeopleKey.class);
        Enumeration result;
        try {
            result = target.findChangeLogsByPeople(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
