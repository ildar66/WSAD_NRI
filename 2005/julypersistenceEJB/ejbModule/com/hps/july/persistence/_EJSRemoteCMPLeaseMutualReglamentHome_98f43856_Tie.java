...
public class _EJSRemoteCMPLeaseMutualReglamentHome_98f43856_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeaseMutualReglamentHome_98f43856 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeaseMutualReglamentHome_98f43856) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 27: 
                    if (method.equals("findByResourceContractDates")) {
                        return findByResourceContractDates(in, reply);
                    }
                case 34: 
                    if (method.equals("findByResourceContractMaxDateStart")) {
                        return findByResourceContractMaxDateStart(in, reply);
                    } else if (method.equals("findConcurentReglamentsByReglament")) {
                        return findConcurentReglamentsByReglament(in, reply);
                    }
                case 43: 
                    if (method.equals("findByLeaseDocumentOrderByDocumentNumberAsc")) {
                        return findByLeaseDocumentOrderByDocumentNumberAsc(in, reply);
                    } else if (method.equals("findLeaseMutualReglamentsMainByMaincurrency")) {
                        return findLeaseMutualReglamentsMainByMaincurrency(in, reply);
                    }
                case 48: 
                    if (method.equals("findLeaseMutualReglamentsAddByAdditionalCurrency")) {
                        return findLeaseMutualReglamentsAddByAdditionalCurrency(in, reply);
                    }
                case 195: 
                    if (method.equals("create__long__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Boolean__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_sql_Date__java_sql_Date")) {
                        return create__long__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Boolean__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_sql_Date__java_sql_Date(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_sql_Date__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Boolean__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_sql_Date__java_sql_Date(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        ...
        Date arg9 = (Date) in.read_value(Date.class);
    ...
    private org.omg.CORBA.portable.OutputStream findByLeaseDocumentOrderByDocumentNumberAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByLeaseDocumentOrderByDocumentNumberAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByResourceContractDates(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        ...
        Enumeration result;
        try {
            result = target.findByResourceContractDates(arg0, arg1, arg2, arg3);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByResourceContractMaxDateStart(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByResourceContractMaxDateStart(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findConcurentReglamentsByReglament(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findConcurentReglamentsByReglament(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualReglamentsAddByAdditionalCurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencyKey arg0 = (CurrencyKey) in.read_value(CurrencyKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualReglamentsAddByAdditionalCurrency(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeaseMutualReglamentsMainByMaincurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencyKey arg0 = (CurrencyKey) in.read_value(CurrencyKey.class);
        Enumeration result;
        try {
            result = target.findLeaseMutualReglamentsMainByMaincurrency(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
