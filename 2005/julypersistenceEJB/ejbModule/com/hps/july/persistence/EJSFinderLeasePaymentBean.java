...
/**
 * EJSFinderLeasePaymentBean
 */
public interface EJSFinderLeasePaymentBean {
	/**
	 * findByQBE2
	 */
	 ...
	 */
	public com.ibm.ejs.persistence.EJSFinder findLeasePaymentByLeaseRule(com.hps.july.persistence.LeaseRuleKey inKey) throws javax.ejb.FinderException, java.rmi.RemoteException;
	/**
	 * findByQBE4
	 */
