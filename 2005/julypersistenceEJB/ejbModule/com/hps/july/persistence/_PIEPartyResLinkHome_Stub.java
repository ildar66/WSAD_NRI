...
public class _PIEPartyResLinkHome_Stub extends Stub implements PIEPartyResLinkHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PIEPartyResLinkHome:0000000000000000", 
    ...
    public PIEPartyResLink create(String arg0, int arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEPartyResLink) in.read_Object(PIEPartyResLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__long__CORBA_WStringValue",com.hps.july.persistence.PIEPartyResLinkHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                PIEPartyResLink result = ((com.hps.july.persistence.PIEPartyResLinkHome)so.servant).create(arg0, arg1, arg2);
                return (PIEPartyResLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PIEPartyResLink create(String arg0, int arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("create__CORBA_WStringValue__long__CORBA_WStringValue__CORBA_WStringValue", true);
                    out.write_value(arg0,String.class);
                    out.write_long(arg1);
                    out.write_value(arg2,String.class);
            ...
            ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__long__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.PIEPartyResLinkHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                PIEPartyResLink result = ((com.hps.july.persistence.PIEPartyResLinkHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (PIEPartyResLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public PIEPartyResLink findByPrimaryKey(PIEPartyResLinkKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PIEPartyResLinkKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PIEPartyResLink) in.read_Object(PIEPartyResLink.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PIEPartyResLinkHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PIEPartyResLinkKey arg0Copy = (PIEPartyResLinkKey) Util.copyObject(arg0,_orb());
                PIEPartyResLink result = ((com.hps.july.persistence.PIEPartyResLinkHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PIEPartyResLink)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
