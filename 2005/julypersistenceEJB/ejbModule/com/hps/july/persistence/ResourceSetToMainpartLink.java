...
import javax.ejb.*;
import javax.naming.*;
public class ResourceSetToMainpartLink extends ManyToSingleLink {
...
public ResourceSetToMainpartLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.ResourceKey key = ((com.hps.july.persistence.ResourceSetBean)source).getMainpartKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.ResourceSetBean)source).getMainpartKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.ResourceSetBean)source).privateSetMainpartKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryAddResourceSets((com.hps.july.persistence.ResourceSet)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.Resource)anEJB).secondaryRemoveResourceSets((com.hps.july.persistence.ResourceSet)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.ResourceSetBean)source).privateSetMainpartKey((com.hps.july.persistence.ResourceKey)targetEJB.getPrimaryKey());
}
}
