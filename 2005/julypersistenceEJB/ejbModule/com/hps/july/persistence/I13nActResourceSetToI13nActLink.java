...
import javax.ejb.*;
import javax.naming.*;
public class I13nActResourceSetToI13nActLink extends ManyToSingleLink {
...
public I13nActResourceSetToI13nActLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.DocumentKey key = ((com.hps.july.persistence.I13nActResourceSetBean)source).getI13nActKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.I13nActResourceSetBean)source).getI13nActKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.I13nActResourceSetBean)source).privateSetI13nActKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.I13nAct)anEJB).secondaryAddI13nActResourceSet((com.hps.july.persistence.I13nActResourceSet)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.I13nAct)anEJB).secondaryRemoveI13nActResourceSet((com.hps.july.persistence.I13nActResourceSet)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.I13nActResourceSetBean)source).privateSetI13nActKey((com.hps.july.persistence.DocumentKey)targetEJB.getPrimaryKey());
}
}
