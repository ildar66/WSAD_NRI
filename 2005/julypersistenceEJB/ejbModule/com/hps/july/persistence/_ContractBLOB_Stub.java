...
public class _ContractBLOB_Stub extends Stub implements ContractBLOB {
    ...
    public byte[] getText() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_get_text",com.hps.july.persistence.ContractBLOB.class);
            if (so == null) {
                return getText();
            }
            try {
                byte[] result = ((com.hps.july.persistence.ContractBLOB)so.servant).getText();
    ...
    public byte[] getTimeline() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_timeline", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (byte[]) in.read_value(byte[].class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_timeline",com.hps.july.persistence.ContractBLOB.class);
            if (so == null) {
                return getTimeline();
            }
            try {
                byte[] result = ((com.hps.july.persistence.ContractBLOB)so.servant).getTimeline();
                return (byte[])Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setText(byte[] arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_text",com.hps.july.persistence.ContractBLOB.class);
            if (so == null) {
                setText(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence.ContractBLOB)so.servant).setText(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setTimeline(byte[] arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_timeline",com.hps.july.persistence.ContractBLOB.class);
            if (so == null) {
                setTimeline(arg0);
                return;
            }
            try {
                byte[] arg0Copy = (byte[]) Util.copyObject(arg0,_orb());
                ((com.hps.july.persistence.ContractBLOB)so.servant).setTimeline(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
