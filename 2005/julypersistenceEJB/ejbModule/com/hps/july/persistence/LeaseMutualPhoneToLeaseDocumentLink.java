...
import javax.ejb.*;
import javax.naming.*;
public class LeaseMutualPhoneToLeaseDocumentLink extends ManyToSingleLink {
...
public LeaseMutualPhoneToLeaseDocumentLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.persistence.LeaseDocumentKey key = ((com.hps.july.persistence.LeaseMutualPhoneBean)source).getLeaseDocumentKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.persistence.LeaseMutualPhoneBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.persistence.LeaseMutualPhoneBean)source).getLeaseDocumentKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.persistence.LeaseMutualPhoneBean)source).privateSetLeaseDocumentKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualReglament)anEJB).secondaryAddLeaseMutualPhone((com.hps.july.persistence.LeaseMutualPhone)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.LeaseMutualReglament)anEJB).secondaryRemoveLeaseMutualPhone((com.hps.july.persistence.LeaseMutualPhone)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.persistence.LeaseMutualPhoneBean)source).privateSetLeaseDocumentKey((com.hps.july.persistence.LeaseDocumentKey)targetEJB.getPrimaryKey());
}
}
