...
import javax.ejb.*;
import javax.naming.*;
public class SiteDocToSiteDocFilesLink extends SingleToManyLink {
	private static SiteDocFileHome targetHome = null;
	private final static java.lang.String targetHomeName = "SiteDocFile";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public SiteDocToSiteDocFilesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.persistence.SiteDocFile)targetEJB).privateSetSiteDocKey((com.hps.july.persistence.SiteDocKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.SiteDocFile)anEJB).getSiteDocKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.SiteDocFileHome)getTargetHome(this)).findSiteDocFilesBySiteDoc((com.hps.july.persistence.SiteDocKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.hps.july.persistence.SiteDocFileHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized SiteDocFileHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.persistence.SiteDocFileHome)lookupTargetHome(homeName, com.hps.july.persistence.SiteDocFileHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.persistence.SiteDocFile.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.SiteDocFile)anEJB).secondarySetSiteDoc((com.hps.july.persistence.SiteDoc)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.SiteDocFile)anEJB).secondarySetSiteDoc(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.persistence.SiteDocFile)anEJB).setSiteDoc(null);
}
}
