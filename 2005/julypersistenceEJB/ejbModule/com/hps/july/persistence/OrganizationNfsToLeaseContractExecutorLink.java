...
import javax.naming.*;
/**
 * OrganizationNfsToLeaseContractExecutorLink
 * @generated
 */
public class OrganizationNfsToLeaseContractExecutorLink extends com.ibm.ivj.ejb.associations.links.SingleToManyLink {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public OrganizationNfsToLeaseContractExecutorLink(javax.ejb.EntityBean anEntityBean) {
		super(anEntityBean);
	}
	/**
	...
	protected java.util.Enumeration fetchTargetEnumeration() throws javax.ejb.FinderException, java.rmi.RemoteException {
		...
		try {
			enum =
				((com.hps.july.persistence.LeaseContractHome) getTargetHome(this)).findLeaseContractExecutorByOrgExecutor(
	...
	public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			((com.hps.july.persistence.LeaseContract) anEJB).secondarySetOrgExecutor(
	...
	public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			 ((com.hps.july.persistence.LeaseContract) anEJB).setOrgExecutor(null);
	}
	/**
	 * Send my counterLink #secondaryDisconnect by routing through my target EJB.
	 * @generated
	...
	public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			 ((com.hps.july.persistence.LeaseContract) anEJB).secondarySetOrgExecutor(null);
	}
	/**
	...
	public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
		if (targetEJB != null) {
			...
			((com.hps.july.persistence.LeaseContract) targetEJB).privateSetOrgExecutorKey((com.hps.july.persistence.OrganizationNfsKey) getEntityContext().getPrimaryKey());
		}
	}
	/**
	...
	protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		return super.currentlyContains(anEJB) || getEntityContext().getPrimaryKey().equals(((com.hps.july.persistence.LeaseContract) anEJB).getOrgExecutorKey());
	}
}
