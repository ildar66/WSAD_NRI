...
public class _RegionHome_Stub extends Stub implements RegionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.RegionHome:0000000000000000", 
    ...
    public Region create(int arg0, int arg1, String arg2, BigDecimal arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.RegionHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                Region result = ((com.hps.july.persistence.RegionHome)so.servant).create(arg0, arg1, arg2Copy, arg3Copy);
    ...
    public Region findByPrimaryKey(RegionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.RegionHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RegionKey arg0Copy = (RegionKey) Util.copyObject(arg0,_orb());
                Region result = ((com.hps.july.persistence.RegionHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Region)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByQBE(Boolean arg0, Integer arg1, Boolean arg2, String arg3, Integer arg4) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByQBE",com.hps.july.persistence.RegionHome.class);
            if (so == null) {
                return findByQBE(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.RegionHome)so.servant).findByQBE(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
    ...
    public Enumeration findRegionBySuperregion(SuperRegionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findRegionBySuperregion", true);
                    ...
                    return findRegionBySuperregion(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findRegionBySuperregion",com.hps.july.persistence.RegionHome.class);
            if (so == null) {
                return findRegionBySuperregion(arg0);
            }
            try {
                SuperRegionKey arg0Copy = (SuperRegionKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.RegionHome)so.servant).findRegionBySuperregion(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
