...
public class _EJSRemoteCMPLeasePayRuleHome_0016f96c_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPLeasePayRuleHome_0016f96c target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPLeasePayRuleHome_0016f96c) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findByLeaseDocument")) {
                        return findByLeaseDocument(in, reply);
                    }
                case 24: 
                ...
                case 26: 
                    if (method.equals("findLeasePayRuleByCurrency")) {
                        return findLeasePayRuleByCurrency(in, reply);
                    } else if (method.equals("findLeasePayRuleByResource")) {
                        return findLeasePayRuleByResource(in, reply);
                    }
                case 31: 
                    if (method.equals("findLeasePayRule4OrgAccByOrgAcc")) {
                        return findLeasePayRule4OrgAccByOrgAcc(in, reply);
                    }
                case 34: 
                    if (method.equals("findByLeasedocumentResourcePaytype")) {
                        return findByLeasedocumentResourcePaytype(in, reply);
                    }
                case 35: 
                    if (method.equals("findLeasePayRule4orgtopayByOrgToPay")) {
                        return findLeasePayRule4orgtopayByOrgToPay(in, reply);
                    }
                case 105: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_math_BigDecimal__CORBA_WStringValue")) {
                        return create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_math_BigDecimal__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_math_BigDecimal__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findByLeaseDocument(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Boolean arg1 = (Boolean) in.read_value(Boolean.class);
        Integer arg2 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByLeaseDocument(arg0, arg1, arg2);
    ...
    private org.omg.CORBA.portable.OutputStream findByLeasedocumentResourcePaytype(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        String arg2 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByLeasedocumentResourcePaytype(arg0, arg1, arg2);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeasePayRule4OrgAccByOrgAcc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AccountKey arg0 = (AccountKey) in.read_value(AccountKey.class);
        Enumeration result;
        try {
            result = target.findLeasePayRule4OrgAccByOrgAcc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeasePayRule4orgtopayByOrgToPay(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OrganizationKey arg0 = (OrganizationKey) in.read_value(OrganizationKey.class);
        Enumeration result;
        try {
            result = target.findLeasePayRule4orgtopayByOrgToPay(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeasePayRuleByCurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencyKey arg0 = (CurrencyKey) in.read_value(CurrencyKey.class);
        Enumeration result;
        try {
            result = target.findLeasePayRuleByCurrency(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findLeasePayRuleByResource(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ResourceKey arg0 = (ResourceKey) in.read_value(ResourceKey.class);
        Enumeration result;
        try {
            result = target.findLeasePayRuleByResource(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
