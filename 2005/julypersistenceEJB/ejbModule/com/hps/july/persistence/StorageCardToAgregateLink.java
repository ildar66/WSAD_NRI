...
import javax.ejb.*;
import javax.naming.*;
public class StorageCardToAgregateLink extends SingleToManyLink {
...
public StorageCardToAgregateLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.AgregateContent)anEJB).getPartsKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.AgregateContentHome)getTargetHome(this)).findAgregateByParts((com.hps.july.persistence.StorageCardKey)getEntityContext().getPrimaryKey());
	}
