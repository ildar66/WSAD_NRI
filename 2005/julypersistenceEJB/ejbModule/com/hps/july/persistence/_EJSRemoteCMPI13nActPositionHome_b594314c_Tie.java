...
public class _EJSRemoteCMPI13nActPositionHome_b594314c_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPI13nActPositionHome_b594314c target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPI13nActPositionHome_b594314c) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findI13nActPositionByContract")) {
                        return findI13nActPositionByContract(in, reply);
                    }
                case 253: 
                    if (method.equals("create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__long__java_math_BigDecimal__java_math_BigDecimal__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean")) {
                        return create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__long__java_math_BigDecimal__java_math_BigDecimal__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__long__java_lang_Integer__java_lang_Integer__java_lang_Integer__long__java_math_BigDecimal__java_math_BigDecimal__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__java_lang_Boolean__CORBA_WStringValue__java_lang_Boolean__java_lang_Boolean(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
    ...
    private org.omg.CORBA.portable.OutputStream findI13nActPositionByContract(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        DocumentKey arg0 = (DocumentKey) in.read_value(DocumentKey.class);
        Enumeration result;
        try {
            result = target.findI13nActPositionByContract(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
