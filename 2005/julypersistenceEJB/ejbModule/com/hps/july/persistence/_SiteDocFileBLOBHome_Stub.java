...
public class _SiteDocFileBLOBHome_Stub extends Stub implements SiteDocFileBLOBHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.SiteDocFileBLOBHome:0000000000000000", 
    ...
    public SiteDocFileBLOB create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (SiteDocFileBLOB) in.read_Object(SiteDocFileBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.SiteDocFileBLOBHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                SiteDocFileBLOB result = ((com.hps.july.persistence.SiteDocFileBLOBHome)so.servant).create(arg0);
                return (SiteDocFileBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public SiteDocFileBLOB findByPrimaryKey(SiteDocFileBLOBKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,SiteDocFileBLOBKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (SiteDocFileBLOB) in.read_Object(SiteDocFileBLOB.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.SiteDocFileBLOBHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                SiteDocFileBLOBKey arg0Copy = (SiteDocFileBLOBKey) Util.copyObject(arg0,_orb());
                SiteDocFileBLOB result = ((com.hps.july.persistence.SiteDocFileBLOBHome)so.servant).findByPrimaryKey(arg0Copy);
                return (SiteDocFileBLOB)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
