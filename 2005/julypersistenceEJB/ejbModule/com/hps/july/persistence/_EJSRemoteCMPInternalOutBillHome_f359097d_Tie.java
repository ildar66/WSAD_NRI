...
public class _EJSRemoteCMPInternalOutBillHome_f359097d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPInternalOutBillHome_f359097d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPInternalOutBillHome_f359097d) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 24: 
                    ...
                    } else if (method.equals("findInternalOutBillByQBE")) {
                        return findInternalOutBillByQBE(in, reply);
                    }
                case 27: 
                    if (method.equals("findInternalOutBillByMonter")) {
                        return findInternalOutBillByMonter(in, reply);
                    }
                case 29: 
                    if (method.equals("findInternalOutBillByPosition")) {
                        return findInternalOutBillByPosition(in, reply);
                    }
                case 72: 
    ...
    private org.omg.CORBA.portable.OutputStream findInternalOutBillByMonter(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        WorkerKey arg0 = (WorkerKey) in.read_value(WorkerKey.class);
        Enumeration result;
        try {
            result = target.findInternalOutBillByMonter(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findInternalOutBillByPosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StoragePlaceKey arg0 = (StoragePlaceKey) in.read_value(StoragePlaceKey.class);
        Enumeration result;
        try {
            result = target.findInternalOutBillByPosition(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findInternalOutBillByQBE(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Boolean arg0 = (Boolean) in.read_value(Boolean.class);
        Date arg1 = (Date) in.read_value(Date.class);
        Date arg2 = (Date) in.read_value(Date.class);
        Boolean arg3 = (Boolean) in.read_value(Boolean.class);
        ...
        Enumeration result;
        try {
            result = target.findInternalOutBillByQBE(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
