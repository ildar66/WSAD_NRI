...
public class _PhotoHome_Stub extends Stub implements PhotoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.PhotoHome:0000000000000000", 
    ...
    public Photo create(int arg0, Integer arg1, String arg2, Date arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Photo) in.read_Object(Photo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence.PhotoHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                Photo result = ((com.hps.july.persistence.PhotoHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
                return (Photo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Photo findByPrimaryKey(PhotoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PhotoKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Photo) in.read_Object(Photo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.PhotoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PhotoKey arg0Copy = (PhotoKey) Util.copyObject(arg0,_orb());
                Photo result = ((com.hps.july.persistence.PhotoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Photo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findPhoto(Integer arg0, Boolean arg1, Date arg2, Date arg3, Boolean arg4, Integer arg5) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    return findPhoto(arg0,arg1,arg2,arg3,arg4,arg5);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPhoto",com.hps.july.persistence.PhotoHome.class);
            if (so == null) {
                return findPhoto(arg0, arg1, arg2, arg3, arg4, arg5);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.PhotoHome)so.servant).findPhoto(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
    ...
    public Enumeration findPhotoByPhotographer(WorkerKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPhotoByPhotographer", true);
                    ...
                    return findPhotoByPhotographer(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPhotoByPhotographer",com.hps.july.persistence.PhotoHome.class);
            if (so == null) {
                return findPhotoByPhotographer(arg0);
            }
            try {
                WorkerKey arg0Copy = (WorkerKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PhotoHome)so.servant).findPhotoByPhotographer(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findPhotoByPosition(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findPhotoByPosition", true);
                    ...
                    return findPhotoByPosition(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPhotoByPosition",com.hps.july.persistence.PhotoHome.class);
            if (so == null) {
                return findPhotoByPosition(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.PhotoHome)so.servant).findPhotoByPosition(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
