...
import javax.ejb.*;
import javax.naming.*;
public class LeaseDocPositionToLeaseCalcRatesLink extends SingleToManyLink {
...
public LeaseDocPositionToLeaseCalcRatesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.persistence.LeaseCalcRate)anEJB).getDocpositionKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.persistence.LeaseCalcRateHome)getTargetHome(this)).findLeaseCalcRatesByDocposition((com.hps.july.persistence.LeaseDocPositionKey)getEntityContext().getPrimaryKey());
	}
