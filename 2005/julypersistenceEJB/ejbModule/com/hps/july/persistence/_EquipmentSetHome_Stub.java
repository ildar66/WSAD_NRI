...
public class _EquipmentSetHome_Stub extends Stub implements EquipmentSetHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence.EquipmentSetHome:0000000000000000", 
    ...
    public EquipmentSet create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                EquipmentSet result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).create(arg0);
    ...
    public EquipmentSet create(int arg0, Integer arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                EquipmentSet result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy);
                return (EquipmentSet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public EquipmentSet create(int arg0, Integer arg1, String arg2, String arg3, Integer arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create__long__java_lang_Integer__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                ...
                EquipmentSet result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).create(arg0, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
                return (EquipmentSet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof CreateException) {
    ...
    public Enumeration findAllOrderByNameAsc() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllOrderByNameAsc",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return findAllOrderByNameAsc();
            }
            try {
                Enumeration result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).findAllOrderByNameAsc();
    ...
    public Enumeration findByPlatinumAndStatus(Integer arg0, Integer arg1, String arg2, Integer arg3) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findByPlatinumAndStatus",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return findByPlatinumAndStatus(arg0, arg1, arg2, arg3);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).findByPlatinumAndStatus(arg0Copy, arg1Copy, arg2Copy, arg3Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public EquipmentSet findByPrimaryKey(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                EquipmentSet result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).findByPrimaryKey(arg0Copy);
                return (EquipmentSet)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findEquipmentSetByPosition(StoragePlaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findEquipmentSetByPosition", true);
                    out.write_value(arg0,StoragePlaceKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Enumeration) in.read_value(Enumeration.class);
                } catch (ApplicationException ex) {
                    ...
                    return findEquipmentSetByPosition(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findEquipmentSetByPosition",com.hps.july.persistence.EquipmentSetHome.class);
            if (so == null) {
                return findEquipmentSetByPosition(arg0);
            }
            try {
                StoragePlaceKey arg0Copy = (StoragePlaceKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence.EquipmentSetHome)so.servant).findEquipmentSetByPosition(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
