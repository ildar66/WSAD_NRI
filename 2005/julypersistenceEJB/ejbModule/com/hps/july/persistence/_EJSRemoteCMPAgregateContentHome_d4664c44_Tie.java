...
public class _EJSRemoteCMPAgregateContentHome_d4664c44_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAgregateContentHome_d4664c44 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAgregateContentHome_d4664c44) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findAgregateAndPart")) {
                        return findAgregateAndPart(in, reply);
                    } else if (method.equals("findAgregateByParts")) {
                        return findAgregateByParts(in, reply);
                    }
                case 24: 
                ...
                case 29: 
                    if (method.equals("findAgregateContentByAgregate")) {
                        return findAgregateContentByAgregate(in, reply);
                    }
                case 66: 
                    if (method.equals("create__java_lang_Integer__java_lang_Integer__java_math_BigDecimal")) {
                        return create__java_lang_Integer__java_lang_Integer__java_math_BigDecimal(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream create__java_lang_Integer__java_lang_Integer__java_math_BigDecimal(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
    ...
    private org.omg.CORBA.portable.OutputStream findAgregateAndPart(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        AgregateContent result;
        try {
            result = target.findAgregateAndPart(arg0, arg1);
    ...
    private org.omg.CORBA.portable.OutputStream findAgregateByParts(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCardKey arg0 = (StorageCardKey) in.read_value(StorageCardKey.class);
        Enumeration result;
        try {
            result = target.findAgregateByParts(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findAgregateContentByAgregate(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        StorageCardKey arg0 = (StorageCardKey) in.read_value(StorageCardKey.class);
        Enumeration result;
        try {
            result = target.findAgregateContentByAgregate(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AgregateContentKey arg0 = (AgregateContentKey) in.read_value(AgregateContentKey.class);
        AgregateContent result;
        try {
