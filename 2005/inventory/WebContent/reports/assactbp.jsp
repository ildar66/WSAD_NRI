...
<tr style="font-size: 10pt;">
	<td align="center">
		<B>монтажа аппаратуры БС</B> <U><%=  engine.getData(0,"bsnum") %></U>
...
<tr style="font-size: 10pt;">
	<td align="center">
		<B>Мы, нижеподписавшиеся, произвели монтаж аппаратуры, установленной на БС, блоками, указанными в приведенной ниже таблице. </B>
	</td>
</tr>
