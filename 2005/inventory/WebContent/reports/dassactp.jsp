...
<%
	...
	new DisMountactReport().getReportData( engine, "configs" );
%>
...
<tr style="font-size: 10pt;">
	<td align="center">
		<B>демонтажа аппаратуры на БС</B> <U><%=  engine.getData(0,"bsnum") %></U>
...
<tr style="font-size: 10pt;">
	<td align="center">
		...
		<B>&quot; , было демонтировано следующее оборудование:</B>
	</td>
</tr>
</table>
...
<P><B>Демонтированое оборудование возвращено на склад</B></P>
<P>&nbsp;</P>
...
<tr style="font-size: 8pt;">
	<td width="40%" style="font-size: 10pt;"> <B>на складе получил:</B></td>
	<td width="10%">&nbsp;</td>
	<td width="20%" align="center">(Ф. И. О)</td>
	<td width="10%">&nbsp;</td>
