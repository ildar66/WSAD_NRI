...
<%
	...
	new AssactBPReport().getReportData( engine, "configs" );
%>
...
<tr style="font-size: 10pt;">
	<td align="center">
		<B>демонтажа аппаратуры БС</B> <U><%=  engine.getData(0,"bsnum") %></U>
...
<tr style="font-size: 10pt;">
	<td align="center">
		<B>Мы, нижеподписавшиеся, произвели демонтаж аппаратуры, установленной на БС, блоками, указанными в приведенной ниже таблице. </B>
	</td>
</tr>
