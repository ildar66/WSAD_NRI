...
<%
	...
	new ExtraReport().getReportData( engine, "configs" );
%>
...
<tr style="font-size: 10pt;">
	<th align="center">
		Приложение к акту инвентаризации №<U><%=  engine.getData(0,"blanknumber") %></U>
...
<tr style="font-size: 10pt;">
	<td align="center">
		<B>Излишки оборудования, выявленные по результатам инвентаризации.</B>
	</td>
</tr>
</table>
...
<%-- "http://websphere:9080/TS_objects_web/Graphics_web/loginMap.jsp" 
<!-- Темповые данные -->
