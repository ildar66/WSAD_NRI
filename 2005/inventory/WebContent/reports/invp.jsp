...
<tr style="font-size: 10pt;">
	...
	<td align="left"><B>г. инвентаризации блоков в составе оборудования на позиции №</B></td>
	<td align="left"><U><%=  engine.getData(0,"posnum") %></U></td>
	<td align="left">&quot;<U><%=  engine.getData(0,"posname") %></U>&quot;</td>
</tr>
<tr><td colspan="6">&nbsp;</td></tr>
<tr style="font-size: 10pt;">
	<td align="left" colspan="6">
		<B>Мы, нижеподписавшиеся, составили настоящий акт в том, что в находящемся на позиции №</B>
		<U><%=  engine.getData(0,"posnum") %></U>
		<B>&quot;</B><U><%=  engine.getData(0,"posname") %></U><B>&quot; оборудовании типа</B>
		<U><%=  engine.getData(0,"itemtype") %></U><B>с серийным №</B><U><%=  engine.getData(0,"iserno") %></U>
	</td>
</tr>
<tr style="font-size: 10pt;">
	<td align="left" colspan="6">
		<B>в момент проведения инвентаризации установлены следующие блоки:</B>
	</td>
</tr>
</table>
