...
<%
	...
	response.setContentType("application/vnd.ms-excel;name=report"+randStr+".xls;charset=windows-1251");
	// response.setHeader("Content-Disposition", "attachment;filename=report"+randStr+".xls");
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1077 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  <!--[if gte vml 1]><v:shapetype
   ...
   <v:imagedata src="Акт%20монт
%20
.files/image001.wmz" o:title="" gain="86232f"/>
...
--%>    
    ТМЦ<span style='mso-spacerun:yes'> </span>№ 
 ...
 <tr height=32 style='mso-height-source:userset;height:24.0pt'>
  ...
  <td class=xl38><sup><span style='mso-spacerun:yes'>    
 </span>число
...
--%>  
  оборудования и комплектующих:</td>
 ...
 <tr class=xl41 height=34 style='height:25.5pt'>
  ...
  <td class=xl40 style='border-top:none;border-left:none'>Код НФС
</td>

  <td class=xl40 style='border-top:none;border-left:none'>Код NRI</td>

  <td class=xl39 width=139 style='border-top:none;border-left:none;width:104pt'>Код товара (маркировка)</td>

  <td class=xl40 style='border-top:none;border-left:none'>Оборудование (наименование, тип)</td>
  ...
  <td class=xl39 width=123 style='border-left:none;width:92pt'>Инвентарный номер</td>
 ...
 <tr height=27 style='mso-height-source:userset;height:20.25pt'>
  ...
  style='mso-spacerun:yes'><%=toFromStore%>    
</span></td>
