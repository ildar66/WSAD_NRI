...
<july:editform action="/ProcessWorkerInvActPos.do">

<%	
	WorkerInvActPosForm aform = (WorkerInvActPosForm)request.getAttribute("WorkerInvActPosForm");
	boolean browseBySerial = aform.isBrowseBySerial();
%>

<script language="javascript">
function copy2manuf() {
	WorkerInvActPosForm.manufserial.value = WorkerInvActPosForm.serialnumber.value;
}
</script>
...
<tr>
	<td class="title"><bean:message key="label.invpos.act"/>:</td>
        <td><bean:message key="label.num"/>&nbsp;<bean:write name="WorkerInvActForm" property="blankindex"/>&nbsp;<bean:write name="WorkerInvActForm" property="blanknumber" />&nbsp;<bean:message key="label.from" />&nbsp;<bean:write name="WorkerInvActForm" property="blankdatestr" /></td>
</tr>
<july:separator/>
<tr>
        <td class="title"><bean:message key="label.invpos.org"/>:</td>
        <td><bean:write name="WorkerInvActPosForm" property="ownername" /></td>
</tr>
<july:separator/>
<tr>
        <td class="title"><bean:message key="label.inventory.worker"/> / <bean:message key="label.inventory.organization"/>:</td>
        <td><bean:write name="WorkerInvActForm" property="workername" /><bean:write name="WorkerInvActForm" property="orgname" /></td>
</tr>
<july:separator/>
<tr>
...
<tr>
	...
	<td>
		<logic:notEqual name="WorkerInvActForm" property="type" value="P">
		...
		<logic:equal name="WorkerInvActForm" property="type" value="P">
			<july:string property="resourcecode" styleId="resourcecode" size="5" insertable="true" updatable="true" />
...
<tr>
	<td class="text"><bean:message key="label.invpos.serialnum"/>:</td>
        <td>
		   ...
		   <logic:equal name="WorkerInvActPosForm" property="action" value="Add"><INPUT TYPE="IMAGE" NAME="submit" VALUE="1" SRC="/images/searchsn.gif" ALT="Найти по карточке" onClick="utype.value = 'S';"></logic:equal>
		   <logic:equal name="WorkerInvActPosForm" property="action" value="Edit"><INPUT TYPE="IMAGE" NAME="submit" VALUE="1" SRC="/images/searchsn.gif" ALT="Найти по карточке" onClick="utype.value = 'S';"></logic:equal>
        </td>
</tr>
<july:separator/>
<tr>
...
<tr>
        ...
        <td>
           <july:string property="party" size="15" insertable="true" updatable="true" />
		       <logic:equal name="WorkerInvActPosForm" property="action" value="Add"><INPUT TYPE="IMAGE" NAME="submit" VALUE="2" SRC="/images/searchsn.gif" ALT="Найти по карточке" onClick="utype.value = 'P';"></logic:equal>
		       <logic:equal name="WorkerInvActPosForm" property="action" value="Edit"><INPUT TYPE="IMAGE" NAME="submit" VALUE="2" SRC="/images/searchsn.gif" ALT="Найти по карточке" onClick="utype.value = 'P';"></logic:equal>
        </td>
</tr>
<july:separator/>
<tr>
...
<july:separator/>
<logic:equal name="WorkerInvActForm" property="type" value="A">
    <tr>
