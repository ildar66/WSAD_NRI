...
<july:editform action="/ProcessChangePState.do">
...
<tr>
	<td class="title" width=30%><bean:message key="label.changeppos.document"/></td>
	<td class="text">
		<bean:message key="label.num"/>
		<bean:write name="ChangePStateForm" property="blankindex"/>&nbsp;<bean:write name="ChangePStateForm" property="blanknumber"/>
		<bean:message key="label.from"/>
		<bean:write name="ChangePStateForm" property="blankdate.string" />
	</td>
</tr>
    ...
    <tr>
		<td class="text" rowspan="3"><july:reqmark><bean:message key="label.changep.state"/>:</july:reqmark></td>
		<td>
