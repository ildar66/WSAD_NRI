...
<july:editform action="/ProcessContractorLoadExcel.do" enctype="multipart/form-data">
...
<table class="main">   
    ...
    <july:separator/>
    <tr>
        <td class="title" colspan="2"><FONT class="attention">Загрузка из Excel</FONT></td>
    </tr>
    ...
    <tr>
        ...
        <td>		
		<html:file styleClass="editbig" name="ContractorLoadXlsForm" property="xslFile"></html:file>
        </td>
    </tr>
