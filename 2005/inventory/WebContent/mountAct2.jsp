...
<%@ page import="com.hps.july.inventory.formbean.*"%>
      ...
      <SCRIPT>
        ...
        function showRowInTablePositions(){
	        if(document.all.tableID.rows(document.all.namesPosition.value)){
	           document.all.tableID.rows(document.all.namesPosition.value).style.cssText = "visibility:visible; display:inline;"
	          }
        }
      </SCRIPT>
...
<bean:define id="bsList" name="MountAct2_Form" property="bsList" scope="request" type="java.util.List"/>
<%
	MountAct2_Form frm = (MountAct2_Form)request.getAttribute("MountAct2_Form");	
...
<july:editform action="/MountAct2Process.do">
...
<%}%>
	<%} else {%>
		<html:link page="/MountAct2Process.do?action=Edit&processState=C" paramId="document" paramName="MountAct2_Form" paramProperty="document" paramScope="request" onclick="return checkPosted();"><img src="/images/calculates.gif" border=0 alt="Снять обсчёт"></html:link>
	<%}%>
<%}%>
	</july:formbuttons>
    ...
    <TR><TD class="text" colspan="2">
      ...
      <TABLE class="print" style="font-size:8pt;" id="tableID">
      <TR class="print">
        <TD COLSPAN="4" class="print" style="margin-top: 0; margin-bottom:0; padding-top: 1; padding-bottom: 1;">
		  ...
		  <%}else{%>
			  ...
			  <logic:equal name="MountAct2_Form" property="manycomplects" value="true">
			  ...
			  <logic:equal name="MountAct2_Form" property="manycomplects" value="false">
      ...
      <!-- TablePositionHeader -->
      <TR class="print">
        <TD width="30%" class="print" style="margin-top: 0; margin-bottom:0; padding-top: 1; padding-bottom: 1;">
   			<select name="namesPosition" style="font-size:8pt;width:90%;" class="edit">
   				<option value="">Позиции для добавления:</option>
    			<option value="10">Источник питания БТС</option>
    			<option value="20">Выпрямители</option>
    			<option value="30">Аккумуляторы</option>
    			<option value="40">BTS - 1</option>
    			<option value="50">BTS - 2</option>
    			<option value="60">BTS - 3</option>
    			<option value="70">BTS - 4</option>
    			<option value="75">BTS - 5</option>
    			<option value="80">Щит питания</option>
    			<option value="90">АВР</option>
    			<option value="100">Панель сигнализации</option>
    			<option value="110">Источник питания УЗО</option>
    			<option value="170">EADU установлен и подключен</option>
    			<option value="180">Инвертер аварий установлен</option>
    			<option value="200">Комбайнер 1800/900</option>
    			<option value="210">Фильтр полосовой - 1</option>
    			<option value="220">Фильтр полосовой - 2</option>
    			<option value="240">PDA - 1</option>
    			<option value="250">PDA - 2</option>
    			<option value="260">Инжектор - 1</option>
    			<option value="270">Инжектор - 2</option>
    		</select>
          <A HREF="javascript: showRowInTablePositions();">
          	<IMG SRC="/images/plus.gif" BORDER=0 alt="Добавить позицию"></A>    		
        </TD>
   ...
   %>
      ...
      <TR class="print" id="<%=i%>" style="visibility:hidden; display:none;">
        ...
        <TD class="print" VALIGN="bottom" style="margin-top: 0; margin-bottom:0; padding-top: 1; padding-bottom: 1;">
          ...
          <SPAN ID="<%= div %>">
            ...
            <july:string property="<%= qty %>" size="5"
              style="font-size:8pt;"
              insertable="true" updatable="true"/>&nbsp;<bean:message key="label.mountact2.qty"/>
          </SPAN>
        </TD>
        <TD class="print" VALIGN="bottom" style="margin-top: 0; margin-bottom:0; padding-top: 1; padding-bottom: 1;">
          <SPAN ID="<%= div %>">
      ...
      <logic:present name="MountAct2_Form" property="<%= resource %>">
      <logic:notEqual name="MountAct2_Form" property="<%= resource %>" value="">
        <SCRIPT>
           	document.all.tableID.rows('<%=i%>').style.cssText = "visibility:visible; display:inline;";
        </SCRIPT>
      </logic:notEqual>
      </logic:present>      
   <%
      ...
      <TR class="print">
        ...
        <TD class="print" VALIGN="bottom" style="margin-top: 0; margin-bottom:0; padding-top: 0; padding-bottom: 0;">
          <DIV><july:errors property="worker" shortformat="true"/></DIV>
              ...
              style="font-size:8pt; width:180px;"
