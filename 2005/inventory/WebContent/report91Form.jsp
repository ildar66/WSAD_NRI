...
<%
	Report91ParamsForm rp = (Report91ParamsForm)session.getAttribute("Report91ParamsForm");
	...
	new com.hps.july.report.word.ResShortHistoryReport().getReportData( engine, "configs" );
%>
