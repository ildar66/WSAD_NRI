...
<july:editform action="/ProcessInternalRState.do">
...
<bean:define id="docCode" name="InternalRStateForm" property="doc" scope="request" type="java.lang.Integer"/>
...
<tr>
	<td class="title" width=30%><bean:message key="label.internalrpos.document"/></td>
	<td class="text">
		<bean:message key="label.num"/>
		<bean:write name="InternalRStateForm" property="blankindex"/>&nbsp;<bean:write name="InternalRStateForm" property="blanknumber"/>
		<bean:message key="label.from"/>
		<bean:write name="InternalRStateForm" property="blankdate.string" />
	</td>
</tr>
    ...
    <tr>
		<td class="text" rowspan="3"><july:reqmark><bean:message key="label.internalr.state"/>:</july:reqmark></td>
		<td>
