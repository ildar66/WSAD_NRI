...
<july:browseform action="/ShowComplectBSLookupList.do">
...
<TR class="normal">
	...
	<tr>
		...
		<td class="title"><bean:write name="ComplectBSLookupListForm" property="posid" filter="true" />&nbsp;&nbsp;&nbsp;<bean:write name="ComplectBSLookupListForm" property="positionname" /></td>
	</tr>
	</table>
	</td>
</tr>
...
<%}catch(Exception e) {}%>
		...
		<td class="text"><july:stringwrite name="equ" property="equnumber"/></td>
