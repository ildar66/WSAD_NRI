...
<%=request.getAttribute(Regions.NETZONES_JS_DATA)%>
</script>
...
<tr>
	...
	<td class="title">
		<july:select styleId="regioncodes" property='<%=regionsSelectorProperty+".regioncodes"%>' insertable="true" onchange="refreshNetZonesSelect();" updatable="true" multiple="true" size='3' styleClass="editsearch">
