...
<july:editform action="/ProcessExternalRState.do">
...
<bean:define id="docCode" name="ExternalRStateForm" property="doc" scope="request" type="java.lang.Integer"/>
...
<july:separator/>
<tr>
	<td class="title" width=30%><bean:message key="label.externalrpos.document"/></td>
	<td class="text">
		<bean:message key="label.num"/>
		<bean:write name="ExternalRStateForm" property="blankindex"/>&nbsp;<bean:write name="ExternalRStateForm" property="blanknumber"/>
		<bean:message key="label.from"/>
		<bean:write name="ExternalRStateForm" property="blankdate.string" />
	</td>
</tr>
<july:separator/>
<tr>
	<td class="text" rowspan="3"><july:reqmark><bean:message key="label.externalr.state"/>:</july:reqmark></td>
	<td>
