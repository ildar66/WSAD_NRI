...
<july:editform action="/ProcessReqState.do">
...
<bean:define id="docCode" name="ReqStateForm" property="doc" scope="request" type="java.lang.Integer"/>
...
<tr>
	<td class="title" width=30%><bean:message key="label.reqpos.document"/></td>
	<td class="text">
		<bean:message key="label.num"/>
		<bean:write name="ReqStateForm" property="blankindex"/>&nbsp;<bean:write name="ReqStateForm" property="blanknumber"/>
		<bean:message key="label.from"/>
		<bean:write name="ReqStateForm" property="blankdate.string" />
	</td>
</tr>
    ...
    <tr>
		<td class="text" rowspan="3"><july:reqmark><bean:message key="label.req.state"/>:</july:reqmark></td>
		<td>
