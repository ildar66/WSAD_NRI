...
<%
	...
	case 3:  posType = "в функциональный комплект: ";break;
	default: posType = "";
	}
...
<%}else{%>	
 ...
 <tr style='mso-height-source:userset;height:15.0pt'>
			<td colspan=<%if(type.equals("2")){%>10<%}else{%>8<%}%> style='text-align:left;border:0'><b>Подробный отчет о приходе оборудования <%=posType%> <%= engine.getData(0,"posname") %></b></td>
 </tr> 
 ...
 <tr style='mso-height-source:userset;height:15.0pt'>			
			<td colspan=<%if(type.equals("2")){%>10<%}else{%>8<%}%> style='text-align:left;border:0'><b>Оборудование <%=  engine.getData(0,"type") %></b></td>
 </tr>
