...
<%
	Report4ParamsForm rp = (Report4ParamsForm)session.getAttribute("Report4ParamsForm");
	...
	String prompt1param = request.getParameter("prompt1");
	...
	new Report042().getReportData( engine, "configs" );
...
<%}else{%>	
 ...
 <tr style='mso-height-source:userset;height:15.0pt'>
			<td colspan=<%=cs%> style='text-align:left;border:0'><b><%if(type.equals("1")){%>Сводный<%}else{%>Подробный<%}%> отчет о приходе оборудования <%=posType%> <%=  engine.getData(0,"posname") %> </b></td>
 </tr> 
