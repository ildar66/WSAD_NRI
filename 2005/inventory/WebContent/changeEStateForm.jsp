...
<july:editform action="/ProcessChangeEState.do">
...
<bean:define id="docCode" name="ChangeEStateForm" property="doc" scope="request" type="java.lang.Integer"/>
...
<tr>
	<td class="title" width=30%><bean:message key="label.changeepos.document"/></td>
	<td class="text">
		<bean:message key="label.num"/>
		<bean:write name="ChangeEStateForm" property="blankindex"/>&nbsp;<bean:write name="ChangeEStateForm" property="blanknumber"/>
		<bean:message key="label.from"/>
		<bean:write name="ChangeEStateForm" property="blankdate.string" />
	</td>
</tr>
...
<tr>
	<td class="text" rowspan="3"><july:reqmark><bean:message key="label.changee.state"/>:</july:reqmark></td>
	<td>
