...
<DIV style="font-size: 10pt;"><B>2. Оборудование и характеристики</B></DIV>
...
<%
	...
	while (it.hasNext()) {
		com.hps.july.config.model.ReportConfig2VO vo = (com.hps.july.config.model.ReportConfig2VO)it.next();
...
<%
		java.util.List attrEquipList = vo.getAttributes();
		java.util.Iterator it2 = attrEquipList.iterator();
		while (it2.hasNext()) {
			com.hps.july.config.model.ReportConfig2AttrVO vo2 = (com.hps.july.config.model.ReportConfig2AttrVO)it2.next();
%>
<tr style="font-size: 10pt;">
	<td></td>
	<td colspan="3"><%= vo2.getAttribute() %></td>
	<td colspan="4"><%= vo2.getValue() %></td>
</tr>
<%
		}
	}
