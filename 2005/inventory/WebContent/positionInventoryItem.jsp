...
<july:editform action="/ProcessPositionInventoryItem.do">

<%
	
	PositionInventoryItem aform = (PositionInventoryItem)request.getAttribute("PositionInventoryItem");
	boolean browseBySerial = aform.isBrowseBySerial();
%>

<script language="javascript">
function copy2manuf() {
	document.all.manufserial.value = document.all.snumber.value;
}
</script>
...
<tr>
	...
	<td>
		<bean:message key="label.num"/>
			<%-- &nbsp;<bean:write name="PositionInventory" property="blankindex" /> --%>
			&nbsp;<bean:write name="PositionInventory" property="blanknumber" />&nbsp;<bean:message key="label.from" />&nbsp;<bean:write name="PositionInventory" property="blankdatestr" />
	</td>
</tr>
...
<tr>
	...
	<td>
		<bean:write name="PositionInventory" property="ownername" />
	</td>
</tr>
    ...
    <tr>
        ...
        <td>
			<bean:write name="PositionInventory" property="positionname" />,&nbsp;<bean:write name="PositionInventory" property="complectname" />
        </td>
    </tr>
...
if(document.all.action.value == 'Add' || document.all.action.value == 'Edit') {
	var itemname = 'snumber';
	if(document.all.fictionSerial[0].checked) {
		document.all[itemname].className = 'editdisabled';
		document.all[itemname].disabled = true;
		document.all[itemname].readonly = true;
	} else {
		document.all[itemname].className = 'edit';
		...
		<logic:equal name="PositionInventoryItem" property="action" value="Add"> <input type="image" src="/images/copybtn.gif" width="16" height="16" name="copybtn" onclick="copy2manuf();return false;"/> <INPUT TYPE="IMAGE" NAME="submit" src="/images/searchsn.gif"  ALT="Найти по карточке" onClick="utype.value = 'S';"></logic:equal>
		<logic:equal name="PositionInventoryItem" property="action" value="Edit"> <input type="image" src="/images/copybtn.gif" width="16" height="16" name="copybtn" onclick="copy2manuf();return false;"/> <INPUT TYPE="IMAGE" NAME="submit" src="/images/searchsn.gif"  ALT="Найти по карточке" onClick="utype.value = 'S';"></logic:equal>
    ...
    <tr>
        ...
        <td>
		   ...
		   <logic:equal name="PositionInventoryItem" property="action" value="Add"><INPUT TYPE="IMAGE" NAME="submit" src="/images/searchsn.gif"  ALT="Найти по карточке" onClick="utype.value = 'P';"></logic:equal>
		   <logic:equal name="PositionInventoryItem" property="action" value="Edit"><INPUT TYPE="IMAGE" NAME="submit" src="/images/searchsn.gif"  ALT="Найти по карточке" onClick="utype.value = 'P';"></logic:equal>
        </td>
    </tr>
...
<%--</logic:equal>--%>
    ...
    <tr>
       ...
       <td>
		      <july:string size="40" property="comment" styleId="comment" insertable="true" updatable="true" />
       </td>
    </tr>
