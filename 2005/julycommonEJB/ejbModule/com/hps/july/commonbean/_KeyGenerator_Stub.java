...
public class _KeyGenerator_Stub extends Stub implements KeyGenerator {
    ...
    public int getNextKey(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("getNextKey",com.hps.july.commonbean.KeyGenerator.class);
            if (so == null) {
                return getNextKey(arg0);
            }
            try {
                return ((com.hps.july.commonbean.KeyGenerator)so.servant).getNextKey(arg0);
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
