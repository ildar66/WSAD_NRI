...
public class _EJSRemoteStatelessKeyGenerator_96ee1f72_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessKeyGenerator_96ee1f72 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.commonbean.KeyGenerator:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessKeyGenerator_96ee1f72) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 120: 
                    if (method.equals("getNextKey")) {
                        return getNextKey(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream getNextKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        int result = target.getNextKey(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
