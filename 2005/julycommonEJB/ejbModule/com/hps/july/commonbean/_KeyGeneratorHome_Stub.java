...
public class _KeyGeneratorHome_Stub extends Stub implements KeyGeneratorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.commonbean.KeyGeneratorHome:0000000000000000", 
    ...
    public KeyGenerator create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (KeyGenerator) in.read_Object(KeyGenerator.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.commonbean.KeyGeneratorHome.class);
            if (so == null) {
                return create();
            }
            try {
                KeyGenerator result = ((com.hps.july.commonbean.KeyGeneratorHome)so.servant).create();
                return (KeyGenerator)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
