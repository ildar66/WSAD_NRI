...
public class _BufferNri2NriHome_Stub extends Stub implements BufferNri2NriHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.billing.BufferNri2NriHome:0000000000000000", 
    ...
    public BufferNri2Nri create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (BufferNri2Nri) in.read_Object(BufferNri2Nri.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.billing.BufferNri2NriHome.class);
            if (so == null) {
                return create();
            }
            try {
                BufferNri2Nri result = ((com.hps.july.arenda.billing.BufferNri2NriHome)so.servant).create();
                return (BufferNri2Nri)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
