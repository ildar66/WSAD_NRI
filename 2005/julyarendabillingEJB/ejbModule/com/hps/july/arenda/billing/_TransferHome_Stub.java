...
public class _TransferHome_Stub extends Stub implements TransferHome {
    ...
    public Transfer create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.billing.TransferHome.class);
            if (so == null) {
                return create();
            }
            try {
                Transfer result = ((com.hps.july.arenda.billing.TransferHome)so.servant).create();
