...
public class _BillingRequiredNewHome_Stub extends Stub implements BillingRequiredNewHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.billing.BillingRequiredNewHome:0000000000000000", 
    ...
    public BillingRequiredNew create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (BillingRequiredNew) in.read_Object(BillingRequiredNew.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.billing.BillingRequiredNewHome.class);
            if (so == null) {
                return create();
            }
            try {
                BillingRequiredNew result = ((com.hps.july.arenda.billing.BillingRequiredNewHome)so.servant).create();
                return (BillingRequiredNew)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
