...
public class _EJSRemoteStatelessTransfer_401727ca_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessTransfer_401727ca target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.billing.Transfer:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessTransfer_401727ca) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 14: 
                    if (method.equals("moveAllPie2Nri")) {
                        return moveAllPie2Nri(in, reply);
                    }
                case 15: 
                ...
                case 20: 
                    if (method.equals("moveAllBufferNri2Nri")) {
                        return moveAllBufferNri2Nri(in, reply);
                    } else if (method.equals("moveAllPie2BufferNri")) {
                        return moveAllPie2BufferNri(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream moveAllBufferNri2Nri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        boolean result = target.moveAllBufferNri2Nri(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_boolean(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream moveAllPie2BufferNri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        boolean result = target.moveAllPie2BufferNri(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_boolean(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream moveAllPie2Nri(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Object[] result = target.moveAllPie2Nri(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
