...
public class _Pie2NriHome_Stub extends Stub implements Pie2NriHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.arenda.billing.Pie2NriHome:0000000000000000", 
    ...
    public Pie2Nri create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Pie2Nri) in.read_Object(Pie2Nri.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.arenda.billing.Pie2NriHome.class);
            if (so == null) {
                return create();
            }
            try {
                Pie2Nri result = ((com.hps.july.arenda.billing.Pie2NriHome)so.servant).create();
                return (Pie2Nri)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
