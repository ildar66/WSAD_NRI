...
public class _Transfer_Stub extends Stub implements Transfer {
    ...
    public boolean moveAllBufferNri2Nri(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("moveAllBufferNri2Nri", true);
                    out.write_long(arg0);
                    in = _invoke(out);
                    return in.read_boolean();
                } catch (ApplicationException ex) {
                    ...
                    return moveAllBufferNri2Nri(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("moveAllBufferNri2Nri",com.hps.july.arenda.billing.Transfer.class);
            if (so == null) {
                return moveAllBufferNri2Nri(arg0);
            }
            try {
                return ((com.hps.july.arenda.billing.Transfer)so.servant).moveAllBufferNri2Nri(arg0);
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public boolean moveAllPie2BufferNri(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("moveAllPie2BufferNri", true);
                    out.write_long(arg0);
                    in = _invoke(out);
                    return in.read_boolean();
                } catch (ApplicationException ex) {
                    ...
                    return moveAllPie2BufferNri(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("moveAllPie2BufferNri",com.hps.july.arenda.billing.Transfer.class);
            if (so == null) {
                return moveAllPie2BufferNri(arg0);
            }
            try {
                return ((com.hps.july.arenda.billing.Transfer)so.servant).moveAllPie2BufferNri(arg0);
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public Object[] moveAllPie2Nri(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("moveAllPie2Nri", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("moveAllPie2Nri",com.hps.july.arenda.billing.Transfer.class);
            if (so == null) {
                return moveAllPie2Nri(arg0);
            }
            try {
                Object[] result = ((com.hps.july.arenda.billing.Transfer)so.servant).moveAllPie2Nri(arg0);
                return (Object[])Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
