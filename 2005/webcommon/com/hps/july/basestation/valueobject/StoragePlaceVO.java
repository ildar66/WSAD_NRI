...
public class StoragePlaceVO {
	...
	//type//Тип места хранения(P-Позиция (site), S-Склад, E-Функц компл оборудования, X-Экспедиция, B-БС, C-Оборудование ТС, O-Контроллер, W-Коммутатор, T-Прочее оборудование, R-Репитер, L-WLAN)
/**
...
/**
 * Insert the method's description here.
 * Creation date: (10.07.2005 13:01:39)
 * @param ro com.hps.july.cdbc.lib.CDBCRowObject
 */
public StoragePlaceVO(com.hps.july.cdbc.lib.CDBCRowObject ro) {
    setStorageplace(((Integer) ro.getColumn("storageplace").asObject()).intValue());
    setName(ro.getColumn("name").asString());
    setAddress(ro.getColumn("address").asString());
}
/**
 * Insert the method's description here.
