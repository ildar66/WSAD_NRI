 ...
 */
public class BaseStationDialogForm
...
//	private com.hps.july.persistence.ControllerAccessBean controllers;
	...
	//private java.lang.String indexRR;//Индекс обл.
	//private java.lang.String indexXX;//№ БС
	private java.lang.String indexCI;
	private java.util.List kzlRegionList = Collections.EMPTY_LIST;
	private java.util.List kzlRegionPrefixList = Collections.EMPTY_LIST;
	private int regionID;
	private int cellname_prefix;
	private java.lang.String operation = "";
	private int cellid_prefix;
/**
 */
public BaseStationDialogForm()
{
}
	...
	throws Exception
{
	...
	bs.setDatasource(0);
	//bs.setPrefixcellid(new Integer(getNumberFrm().substring(1)));
}
...
public void fillRecord(AbstractEntityAccessBean bean) {
    try {
        //System.out.println("BaseStationForm fillRecord started");//temp
        //initIndex();
        BaseStationAccessBean bs = (BaseStationAccessBean) bean;
        ...
        //System.out.println("BaseStationForm fillRecord finished");//temp
    } catch (Exception e) {
...
/**
 * Insert the method's description here.
 * Creation date: (09.09.2005 16:27:59)
 * @return int
 */
public int getCellid_prefix() {
	return cellid_prefix;
}
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 19:46:43)
 * @return int
 */
public int getCellname_prefix() {
...
public com.ibm.ivj.ejb.runtime.AbstractEntityAccessBean getDataBean(HttpServletRequest request) {
	try {
		//DebugSupport.printlnTest("BaseStationForm getDataBean basestation=" + basestation);
		BaseStationAccessBean bean = new BaseStationAccessBean();
...
/**
 * Insert the method's description here.
 * Creation date: (22.08.2005 11:51:50)
 * @return java.lang.Integer
 */
...
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 15:24:54)
 * @return java.lang.String
 */
public java.lang.String getIndexCI() {
	return indexCI;
}
/**
 * Insert the method's description here.
 * Creation date: (22.08.2005 17:47:23)
 * @return java.lang.String
 */
public java.lang.String getIndexRR() {
    String num = getNumberFrm();
    if (num != null) {
...
/**
 * Insert the method's description here.
 * Creation date: (22.08.2005 17:47:57)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 18:49:57)
...
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 18:50:27)
 * @return java.util.List
 */
...
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 19:51:03)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (22.08.2005 11:57:32)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 18:54:22)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (22.08.2005 11:52:35)
 */
private void initIndex() {
    Integer ind = CDBC_SuperRegions_Object.getIndexFromPosition(new Integer(getPositionID()));
    setIndex(ind);
}
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 18:49:24)
 */
...
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 18:49:07)
 */
...
public void initRecord(javax.servlet.http.HttpServletRequest request) throws Exception {
   ...
   // initIndex();
    setNumberFrm(String.valueOf(getIndex()));
}
/**
 * Insert the method's description here.
...
/**
 * Insert the method's description here.
 * Creation date: (14.07.2005 14:48:30)
 * @return boolean
 */
 ...
 * Insert the method's description here.
 * Creation date: (09.09.2005 16:27:59)
 * @param newCellid_prefix int
 */
public void setCellid_prefix(int newCellid_prefix) {
	cellid_prefix = newCellid_prefix;
}
/**
 * Insert the method's description here.
 * Creation date: (08.09.2005 19:46:43)
 * @param newCellname_prefix int
 */
public void setCellname_prefix(int newCellname_prefix) {
 ...
 * Insert the method's description here.
 * Creation date: (08.09.2005 15:24:54)
 * @param newIndexCI java.lang.String
 */
public void setIndexCI(java.lang.String newIndexCI) {
	indexCI = newIndexCI;
}
/**
 * Insert the method's description here.
 ...
 */
public void setKzlRegionList(java.util.List newKzlRegionList) {
 ...
 */
public void setKzlRegionPrefixList(java.util.List newKzlRegionPrefixList) {
...
public void validateValues(ActionErrors errors) throws Exception {
    //операция с "...":
    if (operation.equalsIgnoreCase("changeRegionID")) {
	    initKzlRegionList();
        initKzlRegionPrefixList();
        operation = "";
    ...
    if (BaseStationObject.TYPE_CHECK_DAMPS_D.equals(stationType)) {
        ...
        BaseStationObject.TYPE_CHECK_DCS_C.equals(stationType)
            || BaseStationObject.TYPE_CHECK_GSM_G.equals(stationType)
            || BaseStationObject.TYPE_CHECK_GSM_S.equals(stationType)) {
