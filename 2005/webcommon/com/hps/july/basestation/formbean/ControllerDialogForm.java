 ...
 */
public class ControllerDialogForm extends EquipmentPForm {
	...
	private boolean flagOperation;//признак операции
public ControllerDialogForm() {
...
public int getState() {
	if(super.getState() == 0) {
		return APPStates.CONTROLLER_DIALOG;
	} else {
...
/**
 * Insert the method's description here.
 * Creation date: (20.07.2005 16:56:19)
 * @return boolean
 */
