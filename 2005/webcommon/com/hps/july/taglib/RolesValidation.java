...
/**
 * Вспомогательный класс проверки прав доступа.
 * Creation date: (12.07.2002 11:41:36)
 * @author: Dmitry Dneprov
 */
public class RolesValidation {
/**
 * RolesValidation constructor.
 */
public RolesValidation() {
	super();
}
/**
 * Проверка наличия прав на изменение объекта.
...
/**
 * Проверка наличия прав на изменение объекта по перечню ролей.
 * Creation date: (12.07.2002 11:46:53)
 */
