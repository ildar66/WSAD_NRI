 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class WordEditSlaveTag extends javax.servlet.jsp.tagext.TagSupport {
	private java.lang.String styleId;
	private java.lang.String masterStyleId;
...
*/
			...
			results.append("   if (document.all." + getMasterStyleId() + ") if (document.all." + getMasterStyleId() + ".oversion == \"1\") {document.all." +
				getMasterStyleId() + ".callwordauth(\"" + serverUrl + getUrl() + "\"+" + getStyleId() + "_url, \"" + serverUrl + getUploadurl() + "\", \"" + 
...
public void setUrl(java.lang.String newUrl) {
	 ...
	 * @return
	 */
	public java.lang.String getMasterStyleId() {
	 ...
	 * @param string
	 */
	public void setMasterStyleId(java.lang.String string) {
