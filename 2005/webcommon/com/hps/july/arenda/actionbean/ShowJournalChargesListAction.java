...
/**
 * Action-class.
 * Действие для "Журнал начислений"(лист).
 * Creation date: (26.09.2002 11:51:20)
 * @author: Sergey Gourov
 */
public class ShowJournalChargesListAction extends com.hps.july.web.util.BrowseAction {
/**
...
public String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		ParamsParser.setState(request, Applications.ARENDA, APPStates.JOURNAL_CHARGES_LIST);
		
		JournalChargesListForm oform = (JournalChargesListForm) form;
    	try {
