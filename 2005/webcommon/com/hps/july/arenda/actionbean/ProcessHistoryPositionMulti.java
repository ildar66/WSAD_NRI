...
/**
 * Action-class.
 * действие для "позиций multi(истории)"
 * Creation date: (30.09.2002 14:31:56)
 * @author: Sergey Gourov
 */
public class ProcessHistoryPositionMulti extends NavigatedAction {
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {

		ActionForward retVal = null;	
	    ActionErrors errors = new ActionErrors();

		HistoryPositionMultiListForm pm = (HistoryPositionMultiListForm) request.getSession().getAttribute("HistoryPositionMultiListForm");
		HistoryArendaPositionsListForm ap = (HistoryArendaPositionsListForm) request.getSession().getAttribute("HistoryArendaPositionsListForm");
