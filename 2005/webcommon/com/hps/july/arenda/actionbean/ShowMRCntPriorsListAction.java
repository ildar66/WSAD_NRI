 ...
 * Creation date: (19.12.2002 5:03:54)
 * @author: Sergey Gourov
 */
public class ShowMRCntPriorsListAction extends com.hps.july.web.util.BrowseAction {
/**
...
public Object constructRowModelBean(Object o) {
	LeaseMRCntPriorAccessBean bean = (LeaseMRCntPriorAccessBean) o;
	LeaseMRCntPriorValueObject valueObject = new LeaseMRCntPriorValueObject(bean);
	
	try {
		Hashtable hashtable = new Hashtable(2);
		hashtable.put("contractcode1", new Integer(bean.getContract1Key().leaseDocument));
		hashtable.put("contractcode2", new Integer(bean.getContract2Key().leaseDocument));
...
public String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		ParamsParser.setState(request, Applications.ARENDA, APPStates.REGLAMENT_CONTRACT_PRIORS_LIST);

		MRCntPriorsListForm oform = (MRCntPriorsListForm) form;
    	try {
 	 		LeaseMutualReglamentAccessBean bean = new LeaseMutualReglamentAccessBean();
 	 		bean.setInitKey_leaseDocument(oform.getReglamentcode());
