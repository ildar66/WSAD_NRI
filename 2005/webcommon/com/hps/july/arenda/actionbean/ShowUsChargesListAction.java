 ...
 * Creation date: (08.08.2002 18:20:19)
 * @author: Sergey Gourov
 */
public class ShowUsChargesListAction extends BrowseAction {
/**
...
public String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		ParamsParser.setState(request, Applications.ARENDA, APPStates.US_CHARGES_LIST);
		
		UsChargesListForm oform = (UsChargesListForm) form;
    	try {
