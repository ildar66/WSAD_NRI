 ...
 * Creation date: (25.09.2002 10:40:23)
 * @author: Sergey Gourov
 */
public class ShowStartChargesListAction extends com.hps.july.web.util.BrowseAction {
/**
...
public String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		ParamsParser.setState(request, Applications.ARENDA, APPStates.START_CHARGES_LIST);

		StartChargesListForm oform = (StartChargesListForm) form;
    	try {
