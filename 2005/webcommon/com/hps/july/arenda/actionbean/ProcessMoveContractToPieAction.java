...
/**
 * Action-class.
 * действие для "передачи контрактов к 'PIE'"
 * Creation date: (07.04.2003 14:18:31)
 * @author: Sergey Gourov
 */
public class ProcessMoveContractToPieAction extends com.hps.july.web.util.NavigatedAction {
...
public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
	...
	try {
		o = new ArendaDocumentProcessorAccessBean().moveContractToPie(((Integer) o[0]).intValue(), (String) o[1], (String) o[2]);
	...
	request.getSession().setAttribute(getErrorMoveContractToPie(), o[1]);
