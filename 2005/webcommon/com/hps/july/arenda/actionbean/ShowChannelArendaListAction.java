...
/**
 * Action-class.
 * действие для "Аренда каналов(список)."
 * Creation date: (02.07.2002 15:35:43)
 * @author: Sergey Gourov
 */
public class ShowChannelArendaListAction extends com.hps.july.web.util.BrowseAction {
/**
...
public String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
	  	ParamsParser.setState(request, Applications.ARENDA, APPStates.CHANNEL_ARENDA_LIST);

		ChannelArendaListForm oform = (ChannelArendaListForm) form;
    	try {
