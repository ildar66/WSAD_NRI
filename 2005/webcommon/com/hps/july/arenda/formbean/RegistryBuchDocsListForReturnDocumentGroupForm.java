 ...
 */
public class RegistryBuchDocsListForReturnDocumentGroupForm extends com.hps.july.web.util.BrowseForm {
	 ...
	 */
	public RegistryBuchDocsListForReturnDocumentGroupForm() {
		super();
	...
	public java.lang.String getFinderMethodName() {
		return "getListForReturnDocumentGroup";
	}
	...
	public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		ParamsParser.setState(request, Applications.ARENDA, APPStates.REGISTRY_BUCH_DOCS_LIST_FOR_RETURN_DOCUMENT_GROUP);
		return null;
	}
	/**
	 * Insert the method's description here.
