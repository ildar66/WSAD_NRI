...
/**
 * Form-Bean.
 * список параметров 4-го отчета "Аренды".
 * Creation date: (20.02.2003 14:35:33)
 * @author: Sergey Gourov
 */
public class ArendaReport4ParamsForm extends ReportForm {
 ...
 */
public ArendaReport4ParamsForm() {
	super();
 ...
 */
public int getState() {
	return com.hps.july.arenda.APPStates.ARENDA_REPORT4_PARAMS;
}
/**
 * Insert the method's description here.
 * Creation date: (20.02.2003 14:40:42)
