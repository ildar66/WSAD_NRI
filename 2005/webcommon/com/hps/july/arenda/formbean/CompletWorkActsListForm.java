 ...
 */
public class CompletWorkActsListForm extends BrowseForm {
 ...
 */
public CompletWorkActsListForm() {
	super();
	setFinderMethodName("findListCompletWorkActs");
}
/**
...
public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response)
	...
	ParamsParser.setState(request, Applications.ARENDA, APPStates.COMPLET_WORK_ACTS_LIST);
	initAgreement();
...
public void validateValues(org.apache.struts.action.ActionErrors errors) throws Exception {
	if (operation.equalsIgnoreCase("deleteItem")) {
		deleteItem(errors);
	} else if (operation.equalsIgnoreCase("changeActState")) {
