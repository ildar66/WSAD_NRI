 ...
 */
public class RegistryBuchDocsListForInitialGroupForm extends com.hps.july.web.util.BrowseForm {
	 ...
	 */
	public RegistryBuchDocsListForInitialGroupForm() {
		super();
	...
	public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		ParamsParser.setState(request, Applications.ARENDA, APPStates.REGISTRY_BUCH_DOCS_LIST_FOR_INITIAL_GROUP);
		return null;
	}
	/**
	 * Insert the method's description here.
