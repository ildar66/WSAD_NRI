...
/**
 * Form-Bean.
 * список параметров 8-го отчета "Аренды".
 * Creation date: (20.02.2003 14:35:33)
 * @author: Sergey Gourov
 */
public class ArendaReport8ParamsForm extends ReportForm {
 ...
 */
public ArendaReport8ParamsForm() {
	super();
 ...
 */
public int getState() {
	return com.hps.july.arenda.APPStates.ARENDA_REPORT8_PARAMS;
}
/**
 * Insert the method's description here.
 * Creation date: (20.02.2003 14:40:42)
