 ...
 */
public class SchetFactListForm extends com.hps.july.web.util.BrowseForm {
	...
	private int chargeCode;//код начисления для операции формирования Счет-фактуры
	private Integer idPosSchetFakt;//Код сформированной сч\ф
	/**
	 * Insert the method's description here.
	 * Creation date: (07.11.2005 12:08:01)
	 */
	public SchetFactListForm() {
	...
	public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response)
		...
		ParamsParser.setState(request, Applications.ARENDA, APPStates.SCHET_FACT_LIST);
		initAgreementInfo();
	 ...
	 * @param i
	 */
	public void setIdPosSchetFakt(Integer i) {
		idPosSchetFakt = i;
	}
