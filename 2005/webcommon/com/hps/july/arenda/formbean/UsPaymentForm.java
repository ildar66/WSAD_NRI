 ...
 * ‘орма "платежи"
 * Form-Bean.
 * Creation date: (09.08.2002 10:17:18)
 * @author: Sergey Gourov
 */
public class UsPaymentForm extends com.hps.july.web.util.EditForm {
	...
	protected com.hps.july.jdbcpersistence.lib.StringAndBigDecimal sumRub;
	...
	private com.hps.july.jdbcpersistence.lib.StringAndBigDecimal payrate;
	private com.hps.july.jdbcpersistence.lib.StringAndBigDecimal ndsRub;
	...
	private java.lang.Integer ratecalcruleday;
	private java.lang.Integer usedinactcode;

	private String calcNdsRate;
	private String positionName;
	private com.hps.july.web.util.StringAndBigDecimalProperty ndsRate;
public UsPaymentForm() {
	super();
...
public void beforeDelete(AbstractEntityAccessBean bean, javax.servlet.http.HttpServletRequest request) throws Exception {
	...
	if(!payState.equals("G")){//–азрешаем дл€ удалени€ платежи в состо€нии редактируетс€
		if (!checkOpenPeriod()) {//ѕровер€ем, чтобы платеж небыл в открытом периоде
 ...
 */
public int getState() {
	return com.hps.july.arenda.APPStates.US_PAYMENT_EDIT;
}
/**
 * Insert the method's description here.
