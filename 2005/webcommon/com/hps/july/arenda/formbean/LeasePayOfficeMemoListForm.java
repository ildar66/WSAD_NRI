...
/**
 * "Служебные записки на оплату" BrowseForm Object.
 * Creation date: (12.10.2005 15:40:48)
 * @author: Shafigullin Ildar
 */
public class LeasePayOfficeMemoListForm extends com.hps.july.web.util.BrowseForm {
	...
	/**
	 * LeasePayOfficeMemoListForm constructor comment.
	 */
	public LeasePayOfficeMemoListForm() {
		super();
	...
	public String getBrowseBeanName() {
		return "com.hps.july.arenda.cdbcobjects.CDBC_LeasePayOfficeMemo_Object";
	}
	/**
	...
	public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		ParamsParser.setState(request, Applications.ARENDA, APPStates.LEASE_PAY_OFFICE_MEMO_LIST);
		initAgreementInfo();
	...
	private void changeState(ActionErrors errors) {
		String errorTxt = CDBC_LeasePayOfficeMemo_Object.changeStateLeasePayOfficeMemo(getIdCode(), getToState(), getOperatorCode().intValue());
		if (!errorTxt.equals("")) {
