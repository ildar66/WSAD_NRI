...
/**
 * Insert the method's description here.
 * Creation date: (27.07.2004 17:25:31)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (01.09.2004 15:12:52)
...
/**
 * Insert the method's description here.
 * Creation date: (02.09.2004 15:23:30)
 * @return java.util.ArrayList
 */
 ...
 */
public int getState() {
	return com.hps.july.arenda.APPStates.MEMO_EDIT;
}
/**
 * Insert the method's description here.
...
/**
 * Insert the method's description here.
 * Creation date: (01.09.2004 15:15:15)
 */
private void initListArendaContractsInfo(Integer abonentContract) {
	listArendaContractsInfo = CDBC_Memo_Object.findListArendaContracts(abonentContract);
}
/**
 * Insert the method's description here.
...
/**
 * Insert the method's description here.
 * Creation date: (02.09.2004 15:22:59)
 * @param abonentContract java.lang.Integer
 */
private void initListPhones(Integer abonentContract) {
	phones = new ArrayList();
	CDBCResultSet rs = CDBC_LeaseAbonentPhones_Object.findListPhones(abonentContract);
	java.util.ListIterator it = rs.listIterator();
	while (it.hasNext()) {
		CDBCRowObject ro = (CDBCRowObject) it.next();
...
public void loadRecord(javax.servlet.http.HttpServletRequest request) throws Exception {
	...
	if (ro != null) {
		...
		setAbonentContract(memo.getAbonentContract().intValue());
		//инициализируем позицию:
		memoPos = new MemoPos_VO();
		memoPos.setIdHeader(memo.getIdHeader());
	} else {
...
public String processInsert(javax.servlet.http.HttpServletRequest request, ActionErrors errors) throws Exception {
	...
	try {
		boolean ok = CDBC_Memo_Object.addMemo(getMemo());
		if (!ok) {
...
public String processUpdate(javax.servlet.http.HttpServletRequest request, ActionErrors errors) throws Exception {
	...
	try {
		boolean ok = CDBC_Memo_Object.editMemo(getMemo());
		if (!ok) {
		...
		System.out.println("MemoForm.processUpdate():errorTxt: " + e);
		errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("error.defratepayoncontr", e));
		e.printStackTrace();
	}
	return null;
 ...
 * Insert the method's description here.
 * Creation date: (27.07.2004 17:25:31)
 * @param newAbonentContract int
 */
public void setAbonentContract(int newAbonentContract) {
	abonentContract = newAbonentContract;
	initListArendaContractsInfo(new Integer(newAbonentContract));
	initListPhones(new Integer(newAbonentContract));
}
/**
 * Insert the method's description here.
 * Creation date: (26.07.2004 12:25:03)
 ...
 * Insert the method's description here.
 * Creation date: (01.09.2004 15:12:52)
 * @param newListArendaContractsInfo java.util.ArrayList
 */
public void setListArendaContractsInfo(java.util.ArrayList newListArendaContractsInfo) {
	listArendaContractsInfo = newListArendaContractsInfo;
}
/**
 * Insert the method's description here.
 * Creation date: (26.07.2004 12:25:53)
 ...
 * Insert the method's description here.
 * Creation date: (02.09.2004 15:23:30)
 * @param newPhones java.util.ArrayList
 */
public void setPhones(java.util.ArrayList newPhones) {
	phones = newPhones;
}
/**
 * Insert the method's description here.
