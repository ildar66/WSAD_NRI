...
/**
 * Form-Bean "Справочник тарифных планов".
 * Creation date: (09.09.2004 14:52:44)
 * @author: Shafigullin Ildar
 */
public class TarifPlanLookupListForm extends BrowseForm {
	private java.lang.String sortBy = "nameTarifPlan";
 ...
 */
public TarifPlanLookupListForm() {
	super();
	setFinderMethodName("findListTarifPlans");
}
/**
...
public Object constructRowModelBean(Object o) {
	...
	if (!(o instanceof CDBCRowObject)) {
		System.out.println("TarifPlanLookupListForm: CLASS_CAST: " + o.getClass().getName());
		return o;
	}
	TarifPlan_VO vo = new TarifPlan_VO((CDBCRowObject) o);
	return vo;
}
/**
...
public String getBrowseBeanName() {
	return "com.hps.july.cdbc.objects.CDBC_TarifPlans_Object";
}
/**
...
public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response)
	...
	ParamsParser.setState(request, Applications.ARENDA, APPStates.TARIF_PLAN_LOOKUP_LIST);
	return null;
}
/**
 * Insert the method's description here.
