...
/**
 * Form-Bean.
 * список параметров 10 отчета "Аренды".
 * Creation date: (20.02.2003 12:34:39)
 * @author: Sergey Gourov
 */
public class ArendaReport10ParamsForm extends ReportForm {
 ...
 */
public ArendaReport10ParamsForm() {
	super();
 ...
 */
public int getState() {
	return com.hps.july.arenda.APPStates.ARENDA_REPORT10_PARAMS;
}
/**
 * Insert the method's description here.
 * Creation date: (20.02.2003 11:44:34)
