 ...
 */
public class LoanAktGetPutWordDownload extends javax.servlet.http.HttpServlet {
/**
...
public void performTask(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) {
    ...
    if (id != null) {
        try {
            ...
            try {
                 WordDocument doc = CDBC_LoanAktGetPut_Object .loadWordExternal(id, request.getRemoteUser());
                ...
                if (text != null && text.length > 0 && name != null && !name.equals("")) {
                    ...
                    String s =
                        "<html>"
                            + "<head><title>Акт</title><link rel=\"stylesheet\" type=\"text/css\" href=\"/main.css\"></head>"
