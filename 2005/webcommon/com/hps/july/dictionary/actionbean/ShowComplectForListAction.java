...
/**
 * Обработчик списка наборов в которых используется указанное оборудование
 */
public class ShowComplectForListAction
...
public java.lang.String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
	  	ParamsParser.setState( request, Applications.DICTIONARY, APPStates.CPFLIST );
	  	ComplectForListForm lform = (ComplectForListForm)form;
	  	try {
