...
/**
 * Форма списка узлов набора оборудования
 */
public class ComplectNodesListForm extends com.hps.july.web.util.BrowseForm {
 ...
 */
public ComplectNodesListForm() {
	this.setFinderMethodName( "findComplectsByComplect" );
	}
