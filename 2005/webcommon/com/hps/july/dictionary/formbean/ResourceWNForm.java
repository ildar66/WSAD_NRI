 ...
 */
public class ResourceWNForm extends com.hps.july.web.util.EditForm {
 ...
 */
public ResourceWNForm() {
	setCountpolicy("S");
	setActive(new Boolean(true));
	setBoxable(new Boolean(false));
	setComplect(new Boolean(false));
	setComplectpart(new Boolean(false));
...
public com.ibm.ivj.ejb.runtime.AbstractEntityAccessBean constructBean(javax.servlet.http.HttpServletRequest request) throws java.lang.Exception {
    ...
    ResourceAccessBean bean = new ResourceAccessBean(
		...
		getActive(), getResourcesubtype(), Resources.SIMPLE
	);
	return bean;
}
public OrganizationAccessBean constructManufacturers() throws Exception {
	if (manufacturerab == null) {	
		if (!manufacturer.isEmpty()) 
			if (manufacturer.isOk()) {
				manufacturerab = new OrganizationAccessBean();
				manufacturerab.setInitKey_organization(getManufacturercode().intValue());
				manufacturerab.refreshCopyHelper();
			}
	}
	return manufacturerab;
}
/**
 * Insert the method's description here.
 ...
 */
public int getState() {
	return com.hps.july.dictionary.APPStates.EDITRES_WN;
}
/**
 * Insert the method's description here.
