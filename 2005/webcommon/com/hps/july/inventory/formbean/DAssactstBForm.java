...
/**
 * Форма изменения состояния документа "Акт демонтажа блоков на позиции"
 */
public class DAssactstBForm
...
public int getState() {
	return com.hps.july.inventory.APPStates.EDITDASSBST;
}
/**
 * 
...
public void validateValues(ActionErrors errors) throws Exception 
{
	if (!"1".equals(documentState) && !"2".equals(documentState)) {
		errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("error.invalid.dassactb.state"));
	}
