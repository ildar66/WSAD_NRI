...
/**
 * Форма списка документов "Акты демонтажа блоков на складе"
 */
public class DAssactListForm
	extends BaseStorageListForm
{
public DAssactListForm() {
...
public String getFinderMethodName() {
	return "listStorageDemountDocuments";
}
public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request, HttpServletResponse response)
	throws IOException, ServletException
{
  	ParamsParser.setState( request, com.hps.july.constants.Applications.INVENTORY, com.hps.july.inventory.APPStates.DASSLIST );
