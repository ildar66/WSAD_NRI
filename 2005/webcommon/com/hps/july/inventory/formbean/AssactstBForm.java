...
/**
 * Форма изменения состояния документа "Акт монтажа блоков на позиции"
 */
public class AssactstBForm extends com.hps.july.web.util.EditForm {
...
public int getState() {
	return com.hps.july.inventory.APPStates.EDITASSBST;
}
/**
 * 
...
public void validateValues(ActionErrors errors) throws Exception 
{
	if (!"1".equals(documentState) && !"2".equals(documentState)) {
		errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("error.invalid.assactb.state"));
	}
