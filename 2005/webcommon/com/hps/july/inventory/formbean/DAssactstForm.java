...
/**
 * Форма изменения состояния документа "Акт демонтажа блоков на складе"
 */
public class DAssactstForm
...
public int getState() {
	return com.hps.july.inventory.APPStates.EDITDASSST;
}
/**
 * 
...
public void validateValues(ActionErrors errors) throws Exception 
{
	if (!"1".equals(documentState) && !"2".equals(documentState)) {
		errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("error.invalid.dassact.state"));
	}
