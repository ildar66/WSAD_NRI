...
/**
 * Форма параметров отчёта "Расход с объекта"
 */
public class Report6ParamsForm extends ReportForm {
...
public int getState() {
	return com.hps.july.inventory.APPStates.RPT6PARAMS;
}
