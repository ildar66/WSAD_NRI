...
/**
 * Обработчик списка позиций документа "Акт монтажа блоков на складе"
 */
public class ShowAssactposListAction extends com.hps.july.web.util.BrowseAction {
public java.lang.String getBrowseBeanName() {
	return "com.hps.july.persistence.DocumentPositionAccessBean";
}
public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ParamsParser.setState(request, Applications.INVENTORY, APPStates.ASSPLIST);
	AssactposListForm aform = (AssactposListForm)form;
