...
/**
 * Обработчик отчёта "История перемещений"
 * Поиск документов по серийному номеру оборудования
 */
public class Report9Action
	extends ReportAction
{
public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
  	ParamsParser.setState( request, Applications.INVENTORY, APPStates.RPT9 );
 /*
