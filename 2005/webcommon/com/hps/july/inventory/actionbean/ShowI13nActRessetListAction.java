...
/**
 * Обработчик списка набора оборудования для актов инвентаризации на складе
 */
public class ShowI13nActRessetListAction
...
public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)    throws IOException, ServletException {
    ParamsParser.setState(request, Applications.INVENTORY, APPStates.IRASLIST);
	I13nActRessetListForm oform = (I13nActRessetListForm) form;
    try {
