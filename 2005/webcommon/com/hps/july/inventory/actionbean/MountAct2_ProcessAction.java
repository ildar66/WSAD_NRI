 ...
 */
public class MountAct2_ProcessAction extends NIDocumentProcessAction {
	 ...
	 * Creation date: (15.10.2004 17:57:33)
	 */
	public void generateMountAct(MountAct2_Form editForm, HttpServletRequest request) throws Exception {
			com.hps.july.commonbean.KeyGeneratorAccessBean keyGen = new com.hps.july.commonbean.KeyGeneratorAccessBean();
	 ...
	 * Creation date: (15.10.2004 17:57:33)
	 */
	public void updateMountAct(MountAct2_Form editForm, HttpServletRequest request) throws Exception {
			com.hps.july.commonbean.KeyGeneratorAccessBean keyGen = new com.hps.july.commonbean.KeyGeneratorAccessBean();
	...
	protected void generatePositions(int doc, MountAct2_Form editForm) throws Exception {
	...
	public ActionForward processInsert( ActionMapping mapping, HttpServletRequest request, ActionErrors errors, EditForm editForm) throws Exception {
		MountAct2_Form meditForm = (MountAct2_Form)editForm;
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		MountAct2_Form editForm = (MountAct2_Form)form;
