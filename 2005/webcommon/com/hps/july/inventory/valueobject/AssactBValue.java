...
/**
 * Служебный класс для вывода данных списка документов "Акты монтажа блоков на позиции"
 * Создаётся из бина AssemblingActAccessBean
 */
public class AssactBValue {
...
public AssactBValue(Object o) {
	...
	if(o instanceof AssemblingActAccessBean) {
		...
		try {
			...
			e.setInitKey_storageplace(so.getTo().getStorageplace());
			e.refreshCopyHelper();
