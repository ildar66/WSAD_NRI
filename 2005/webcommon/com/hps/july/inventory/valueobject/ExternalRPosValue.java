...
/**
 * —лужебный класс дл€ вывода данных списка строк документа "¬нешн€€ расходна€ накладна€"
 */
public class ExternalRPosValue {
	private DocumentPositionAccessBean o;
	private String serialnumber;
public ExternalRPosValue(Object oo) {
	serialnumber = "";
