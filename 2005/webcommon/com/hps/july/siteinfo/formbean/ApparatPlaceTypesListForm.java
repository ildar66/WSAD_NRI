...
/**
 * Форма списка типов мест размещения аппаратной.
 */
public class ApparatPlaceTypesListForm extends com.hps.july.web.util.BrowseForm {
public ApparatPlaceTypesListForm() {
	this.setFinderMethodName( "findAllApparatPlaceTypes" );
	setLastVisited(true);
}
/**
...
public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request,
		...
		ParamsParser.setState( request, Applications.SITEINFO, APPStates.APPARATPLACETYPESLIST );
	return null; 
}
}
