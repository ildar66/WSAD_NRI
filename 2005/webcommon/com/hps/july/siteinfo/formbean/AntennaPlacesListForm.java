 ...
 */
public class AntennaPlacesListForm extends com.hps.july.web.util.BrowseForm {
/**
 * Список мест размещения антенн.
 * Creation date: (22.01.2002 13:30:34)
 */
public AntennaPlacesListForm() {
	this.setFinderMethodName( "findAllAntennPlaces" );
	setLastVisited(true);
}
/**
...
public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request,
		...
		ParamsParser.setState( request, Applications.SITEINFO, APPStates.ANTENNAPLACESLIST );
	return null; 
}
}
