...
/**
 * Форма списка мест размещения антенн.
 */
public class ApparatPlacesListForm extends com.hps.july.web.util.BrowseForm {
/**
 * Список мест размещения аппаратной.
 * Creation date: (22.01.2002 13:30:34)
 */
public ApparatPlacesListForm() {
	this.setFinderMethodName( "findAllApparatPlaces" );
	setLastVisited(true);
}
/**
...
public ActionForward initBrowse(ActionMapping mapping, HttpServletRequest request,
		...
		ParamsParser.setState( request, Applications.SITEINFO, APPStates.APPARATPLACESLIST );
	return null; 
}
}
