 ...
 */
public class ShowWorkerListGAction extends com.hps.july.web.util.BrowseAction {
/**
...
public java.lang.String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		super.perform( mapping, form, request, response );
	  	ParamsParser.setState( request, Applications.SECURITY, APPStates.WRKLISTG );
	  	WorkerListGForm oform = (WorkerListGForm) form;
	  	try {	  		
	  		GroupAccessBean bean = new GroupAccessBean();
	  		bean.setInitKey_division( oform.getGroup() );
