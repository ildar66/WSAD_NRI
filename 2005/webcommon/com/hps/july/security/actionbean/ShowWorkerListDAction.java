...
/**
 * Список работников подразделения.
 * Creation date: (15.01.2002 16:54:13)
 * @author: Administrator
 */
public class ShowWorkerListDAction extends com.hps.july.web.util.BrowseAction {
/**
...
public java.lang.String getBrowseBeanName() {
	...
	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		super.perform( mapping, form, request, response );
	  	ParamsParser.setState( request, Applications.SECURITY, APPStates.WRKLISTD );
	  	WorkerListDForm oform = (WorkerListDForm) form;
	  	try {	  		
