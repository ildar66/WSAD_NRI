...
/**
 * Форма редактирования автомашины дирекции.
 * Creation date: (22.07.2003 11:35:04)
 * @author: Sergey Gourov
 */
public class DirectionCarForm extends com.hps.july.web.util.EditForm {
	private int car;
...
public com.ibm.ivj.ejb.runtime.AbstractEntityAccessBean constructBean(javax.servlet.http.HttpServletRequest request) throws Exception {
	...
	CarAccessBean bean = new CarAccessBean(getCar(), new Boolean(true), getCar_model(), getCar_number());
	
	DivisionAccessBean divisionBean = new DivisionAccessBean();
	divisionBean.setInitKey_division(((DirectionCarsList) request.getSession().getAttribute(getListForm())).getDivision());
	divisionBean.refreshCopyHelper();
	
	bean.setDivision((Division) divisionBean.getEJBRef());
	return bean;
}
/**
 * Insert the method's description here.
 ...
 */
public int getState() {
	return com.hps.july.security.APPStates.DIRECTION_CAR_EDIT;
}
/**
 * Insert the method's description here.
 * Creation date: (22.07.2003 11:36:03)
