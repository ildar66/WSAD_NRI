...
/**
 * Утилитарный класс: работа с cookie и др..
...
public static void createCookie(
    ...
    //deleteCookie(name, request,response);
...
public static boolean hasCookie(
    ...
    javax.servlet.http.Cookie[] cookies = request.getCookies();
     for (int i = 0; i < cookies.length; i++) {
        if (cookies[i].getName().equals(name) && cookies[i].getValue().equals("true"))
            return true;
    }
...
/**
 * Insert the method's description here.
 * Creation date: (30.05.2003 12:53:19)
 * @param app java.lang.String
 * @param href java.lang.String
 */
public static String receiveFullUrl(
    HttpServletRequest request,
    String baseApp,
    String href) {
    String serverBase =
    ...
    String link = serverBase + baseApp + href;
    return link;
}
/**
 * Insert the method's description here.
 * Creation date: (29.04.2003 16:41:17)
 */
public static void sortUpSelect(List list, int[] selNumbers) {
    ...
    for (int i = selNumbers.length - 1; i >= 0; i--) {
        obj = list.get(i);
        list.remove(obj);
        list.add(0, obj);
    }
