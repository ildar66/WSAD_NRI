...
public class _EJSRemoteStatelessChangeActProcessor_daccbe62_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessChangeActProcessor_daccbe62 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessChangeActProcessor_daccbe62) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                case 67: 
                    if (method.equals("applyChangeAct")) {
                        return applyChangeAct(in, reply);
                    }
                case 69: 
                ...
                case 108: 
                    if (method.equals("cancelChangeAct")) {
                        return cancelChangeAct(in, reply);
                    }
                case 110: 
    ...
    private org.omg.CORBA.portable.OutputStream applyChangeAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        DocumentProcessingException result = target.applyChangeAct(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
    ...
    private org.omg.CORBA.portable.OutputStream cancelChangeAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        DocumentProcessingException result = target.cancelChangeAct(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,DocumentProcessingException.class);
        return out;
