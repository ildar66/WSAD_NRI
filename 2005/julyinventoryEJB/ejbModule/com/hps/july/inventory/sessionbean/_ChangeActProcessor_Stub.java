...
public class _ChangeActProcessor_Stub extends Stub implements ChangeActProcessor {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.ChangeActProcessor:0000000000000000", 
    ...
    public DocumentProcessingException applyChangeAct(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("applyChangeAct",com.hps.july.inventory.sessionbean.ChangeActProcessor.class);
            if (so == null) {
                return applyChangeAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.ChangeActProcessor)so.servant).applyChangeAct(arg0Copy);
    ...
    public DocumentProcessingException cancelChangeAct(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("cancelChangeAct",com.hps.july.inventory.sessionbean.ChangeActProcessor.class);
            if (so == null) {
                return cancelChangeAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.ChangeActProcessor)so.servant).cancelChangeAct(arg0Copy);
                return (DocumentProcessingException)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
