...
public class _ContractSuppliesInfo_Stub extends Stub implements ContractSuppliesInfo {
    ...
    public BigDecimal getSuppliesSum(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("getSuppliesSum",com.hps.july.inventory.sessionbean.ContractSuppliesInfo.class);
            if (so == null) {
                return getSuppliesSum(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                BigDecimal result = ((com.hps.july.inventory.sessionbean.ContractSuppliesInfo)so.servant).getSuppliesSum(arg0Copy);
