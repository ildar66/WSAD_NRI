...
public class _ChangeActProcessorHome_Stub extends Stub implements ChangeActProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.ChangeActProcessorHome:0000000000000000", 
    ...
    public ChangeActProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ChangeActProcessor) in.read_Object(ChangeActProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.ChangeActProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                ChangeActProcessor result = ((com.hps.july.inventory.sessionbean.ChangeActProcessorHome)so.servant).create();
                return (ChangeActProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
