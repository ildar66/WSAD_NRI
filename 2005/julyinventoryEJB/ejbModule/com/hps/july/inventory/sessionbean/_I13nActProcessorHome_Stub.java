...
public class _I13nActProcessorHome_Stub extends Stub implements I13nActProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.I13nActProcessorHome:0000000000000000", 
    ...
    public I13nActProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (I13nActProcessor) in.read_Object(I13nActProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.I13nActProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                I13nActProcessor result = ((com.hps.july.inventory.sessionbean.I13nActProcessorHome)so.servant).create();
                return (I13nActProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
