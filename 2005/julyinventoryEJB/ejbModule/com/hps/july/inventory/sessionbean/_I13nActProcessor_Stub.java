...
public class _I13nActProcessor_Stub extends Stub implements I13nActProcessor {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.I13nActProcessor:0000000000000000", 
    ...
    public DocumentProcessingException cancelI13nAct(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("cancelI13nAct",com.hps.july.inventory.sessionbean.I13nActProcessor.class);
            if (so == null) {
                return cancelI13nAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.I13nActProcessor)so.servant).cancelI13nAct(arg0Copy);
    ...
    public DocumentProcessingException processI13nAct(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("processI13nAct",com.hps.july.inventory.sessionbean.I13nActProcessor.class);
            if (so == null) {
                return processI13nAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.I13nActProcessor)so.servant).processI13nAct(arg0Copy);
                return (DocumentProcessingException)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
