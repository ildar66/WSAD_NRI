...
public class _EJSRemoteStatelessFaultReportProcessor_974ad459_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessFaultReportProcessor_974ad459 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessFaultReportProcessor_974ad459) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 70: 
                    if (method.equals("applyFaultReport")) {
                        return applyFaultReport(in, reply);
                    }
                case 101: 
                ...
                case 108: 
                    if (method.equals("cancelFaultReport")) {
                        return cancelFaultReport(in, reply);
                    }
                case 110: 
    ...
    private org.omg.CORBA.portable.OutputStream applyFaultReport(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        DocumentProcessingException result = target.applyFaultReport(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
    ...
    private org.omg.CORBA.portable.OutputStream cancelFaultReport(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        DocumentProcessingException result = target.cancelFaultReport(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,DocumentProcessingException.class);
        return out;
