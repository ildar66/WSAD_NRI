...
public class _DocumentPreprocessorHome_Stub extends Stub implements DocumentPreprocessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.DocumentPreprocessorHome:0000000000000000", 
    ...
    public DocumentPreprocessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DocumentPreprocessor) in.read_Object(DocumentPreprocessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.DocumentPreprocessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                DocumentPreprocessor result = ((com.hps.july.inventory.sessionbean.DocumentPreprocessorHome)so.servant).create();
                return (DocumentPreprocessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
