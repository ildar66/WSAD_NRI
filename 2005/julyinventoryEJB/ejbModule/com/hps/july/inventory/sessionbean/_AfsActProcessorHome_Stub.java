...
public class _AfsActProcessorHome_Stub extends Stub implements AfsActProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.AfsActProcessorHome:0000000000000000", 
    ...
    public AfsActProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AfsActProcessor) in.read_Object(AfsActProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.AfsActProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                AfsActProcessor result = ((com.hps.july.inventory.sessionbean.AfsActProcessorHome)so.servant).create();
                return (AfsActProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
