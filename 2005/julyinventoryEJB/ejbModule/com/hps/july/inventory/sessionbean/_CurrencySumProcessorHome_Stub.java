...
public class _CurrencySumProcessorHome_Stub extends Stub implements CurrencySumProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.CurrencySumProcessorHome:0000000000000000", 
    ...
    public CurrencySumProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CurrencySumProcessor) in.read_Object(CurrencySumProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.CurrencySumProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                CurrencySumProcessor result = ((com.hps.july.inventory.sessionbean.CurrencySumProcessorHome)so.servant).create();
                return (CurrencySumProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
