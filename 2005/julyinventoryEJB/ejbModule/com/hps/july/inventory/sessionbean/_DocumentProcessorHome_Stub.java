...
public class _DocumentProcessorHome_Stub extends Stub implements DocumentProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.DocumentProcessorHome:0000000000000000", 
    ...
    public DocumentProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DocumentProcessor) in.read_Object(DocumentProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.DocumentProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                DocumentProcessor result = ((com.hps.july.inventory.sessionbean.DocumentProcessorHome)so.servant).create();
                return (DocumentProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
