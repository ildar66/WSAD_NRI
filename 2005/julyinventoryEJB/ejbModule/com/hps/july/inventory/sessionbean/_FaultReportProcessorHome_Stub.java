...
public class _FaultReportProcessorHome_Stub extends Stub implements FaultReportProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.FaultReportProcessorHome:0000000000000000", 
    ...
    public FaultReportProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (FaultReportProcessor) in.read_Object(FaultReportProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.FaultReportProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                FaultReportProcessor result = ((com.hps.july.inventory.sessionbean.FaultReportProcessorHome)so.servant).create();
                return (FaultReportProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
