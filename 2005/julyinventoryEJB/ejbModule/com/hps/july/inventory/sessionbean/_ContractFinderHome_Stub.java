...
public class _ContractFinderHome_Stub extends Stub implements ContractFinderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.ContractFinderHome:0000000000000000", 
    ...
    public ContractFinder create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ContractFinder) in.read_Object(ContractFinder.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.ContractFinderHome.class);
            if (so == null) {
                return create();
            }
            try {
                ContractFinder result = ((com.hps.july.inventory.sessionbean.ContractFinderHome)so.servant).create();
                return (ContractFinder)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
