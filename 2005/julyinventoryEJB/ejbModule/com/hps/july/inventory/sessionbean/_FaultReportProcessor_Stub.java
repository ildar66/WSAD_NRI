...
public class _FaultReportProcessor_Stub extends Stub implements FaultReportProcessor {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.FaultReportProcessor:0000000000000000", 
    ...
    public DocumentProcessingException applyFaultReport(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("applyFaultReport", true);
            ...
            ServantObject so = _servant_preinvoke("applyFaultReport",com.hps.july.inventory.sessionbean.FaultReportProcessor.class);
            if (so == null) {
                return applyFaultReport(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.FaultReportProcessor)so.servant).applyFaultReport(arg0Copy);
    ...
    public DocumentProcessingException cancelFaultReport(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("cancelFaultReport", true);
                    out.write_value(arg0,Integer.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DocumentProcessingException) in.read_value(DocumentProcessingException.class);
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("cancelFaultReport",com.hps.july.inventory.sessionbean.FaultReportProcessor.class);
            if (so == null) {
                return cancelFaultReport(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.FaultReportProcessor)so.servant).cancelFaultReport(arg0Copy);
                return (DocumentProcessingException)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
