...
public class _InWayBillProcessorHome_Stub extends Stub implements InWayBillProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.InWayBillProcessorHome:0000000000000000", 
    ...
    public InWayBillProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (InWayBillProcessor) in.read_Object(InWayBillProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.InWayBillProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                InWayBillProcessor result = ((com.hps.july.inventory.sessionbean.InWayBillProcessorHome)so.servant).create();
                return (InWayBillProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
