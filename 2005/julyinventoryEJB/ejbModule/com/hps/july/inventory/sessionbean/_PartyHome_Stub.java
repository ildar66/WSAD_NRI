...
public class _PartyHome_Stub extends Stub implements PartyHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.PartyHome:0000000000000000", 
    ...
    public Party create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Party) in.read_Object(Party.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.PartyHome.class);
            if (so == null) {
                return create();
            }
            try {
                Party result = ((com.hps.july.inventory.sessionbean.PartyHome)so.servant).create();
                return (Party)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
