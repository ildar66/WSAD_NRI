...
public class _ProcessorFacadeHome_Stub extends Stub implements ProcessorFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.ProcessorFacadeHome:0000000000000000", 
    ...
    public ProcessorFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ProcessorFacade) in.read_Object(ProcessorFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.ProcessorFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                ProcessorFacade result = ((com.hps.july.inventory.sessionbean.ProcessorFacadeHome)so.servant).create();
                return (ProcessorFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
