...
public class _ContractFinder_Stub extends Stub implements ContractFinder {
    ...
    public Integer findContractByParty(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("findContractByParty", true);
                    ...
                    return findContractByParty(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findContractByParty",com.hps.july.inventory.sessionbean.ContractFinder.class);
            if (so == null) {
                return findContractByParty(arg0);
            }
            try {
                Integer result = ((com.hps.july.inventory.sessionbean.ContractFinder)so.servant).findContractByParty(arg0);
    ...
    public Integer findContractBySerial(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findContractBySerial", true);
                    out.write_value(arg0,String.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Integer) in.read_value(Integer.class);
                } catch (ApplicationException ex) {
                    ...
                    return findContractBySerial(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findContractBySerial",com.hps.july.inventory.sessionbean.ContractFinder.class);
            if (so == null) {
                return findContractBySerial(arg0);
            }
            try {
                Integer result = ((com.hps.july.inventory.sessionbean.ContractFinder)so.servant).findContractBySerial(arg0);
                return (Integer)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
