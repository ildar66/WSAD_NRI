...
public class _ContractSuppliesInfoHome_Stub extends Stub implements ContractSuppliesInfoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.ContractSuppliesInfoHome:0000000000000000", 
    ...
    public ContractSuppliesInfo create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ContractSuppliesInfo) in.read_Object(ContractSuppliesInfo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.ContractSuppliesInfoHome.class);
            if (so == null) {
                return create();
            }
            try {
                ContractSuppliesInfo result = ((com.hps.july.inventory.sessionbean.ContractSuppliesInfoHome)so.servant).create();
                return (ContractSuppliesInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
