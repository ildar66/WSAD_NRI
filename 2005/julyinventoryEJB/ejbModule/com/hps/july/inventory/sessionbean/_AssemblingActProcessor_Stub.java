...
public class _AssemblingActProcessor_Stub extends Stub implements AssemblingActProcessor {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.AssemblingActProcessor:0000000000000000", 
    ...
    public DocumentProcessingException applyAssemblingAct(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("applyAssemblingAct", true);
                    ...
                    return applyAssemblingAct(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("applyAssemblingAct",com.hps.july.inventory.sessionbean.AssemblingActProcessor.class);
            if (so == null) {
                return applyAssemblingAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.AssemblingActProcessor)so.servant).applyAssemblingAct(arg0Copy);
    ...
    public DocumentProcessingException cancelAssemblingAct(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("cancelAssemblingAct", true);
                    out.write_value(arg0,Integer.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DocumentProcessingException) in.read_value(DocumentProcessingException.class);
                } catch (ApplicationException ex) {
                    ...
                    return cancelAssemblingAct(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("cancelAssemblingAct",com.hps.july.inventory.sessionbean.AssemblingActProcessor.class);
            if (so == null) {
                return cancelAssemblingAct(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.AssemblingActProcessor)so.servant).cancelAssemblingAct(arg0Copy);
                return (DocumentProcessingException)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
