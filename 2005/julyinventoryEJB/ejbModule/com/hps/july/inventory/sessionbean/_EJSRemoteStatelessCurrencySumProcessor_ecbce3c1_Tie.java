...
public class _EJSRemoteStatelessCurrencySumProcessor_ecbce3c1_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessCurrencySumProcessor_ecbce3c1 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessCurrencySumProcessor_ecbce3c1) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 98: 
                    if (method.equals("_get_baseCurrency")) {
                        return _get_baseCurrency(in, reply);
                    }
                case 99: 
                    if (method.equals("recalcSumToCurrency")) {
                        return recalcSumToCurrency(in, reply);
                    }
                case 100: 
                    if (method.equals("_get_defaultRateType")) {
                        return _get_defaultRateType(in, reply);
                    }
                case 101: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_baseCurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencySumProcessingError result = target.getBaseCurrency();
        org.omg.CORBA_2_3.portable.OutputStream out = 
    ...
    private org.omg.CORBA.portable.OutputStream _get_defaultRateType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CurrencySumProcessingError result = target.getDefaultRateType();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,CurrencySumProcessingError.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream recalcSumToCurrency(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        CurrencySumProcessingError result = target.recalcSumToCurrency(arg0, arg1, arg2, arg3, arg4);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,CurrencySumProcessingError.class);
        return out;
