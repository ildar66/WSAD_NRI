...
public class _DocumentPreprocessor_Stub extends Stub implements DocumentPreprocessor {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.DocumentPreprocessor:0000000000000000", 
    ...
    public DocumentProcessingException preprocessDocument(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("preprocessDocument", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return preprocessDocument(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("preprocessDocument",com.hps.july.inventory.sessionbean.DocumentPreprocessor.class);
            if (so == null) {
                return preprocessDocument(arg0);
            }
            try {
                DocumentProcessingException result = ((com.hps.july.inventory.sessionbean.DocumentPreprocessor)so.servant).preprocessDocument(arg0);
