...
public class _EJSRemoteStatelessAssemblingActProcessor_590b631d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessAssemblingActProcessor_590b631d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessAssemblingActProcessor_590b631d) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                case 65: 
                    if (method.equals("applyAssemblingAct")) {
                        return applyAssemblingAct(in, reply);
                    }
                case 69: 
                ...
                case 108: 
                    if (method.equals("cancelAssemblingAct")) {
                        return cancelAssemblingAct(in, reply);
                    }
                case 110: 
    ...
    private org.omg.CORBA.portable.OutputStream applyAssemblingAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        DocumentProcessingException result = target.applyAssemblingAct(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
    ...
    private org.omg.CORBA.portable.OutputStream cancelAssemblingAct(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        DocumentProcessingException result = target.cancelAssemblingAct(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,DocumentProcessingException.class);
        return out;
