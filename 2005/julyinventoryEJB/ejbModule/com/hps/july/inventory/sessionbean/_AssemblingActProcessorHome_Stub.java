...
public class _AssemblingActProcessorHome_Stub extends Stub implements AssemblingActProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.inventory.sessionbean.AssemblingActProcessorHome:0000000000000000", 
    ...
    public AssemblingActProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AssemblingActProcessor) in.read_Object(AssemblingActProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.inventory.sessionbean.AssemblingActProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                AssemblingActProcessor result = ((com.hps.july.inventory.sessionbean.AssemblingActProcessorHome)so.servant).create();
                return (AssemblingActProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
