...
<%@ page import="com.hps.july.basestation.formbean.PositionLookupListForm"%>
...
<july:checkbox property="isNetZone" styleId="isNetZoneCh" insertable="true" updatable="true" onclick="refreshSelectFromCheckbox('sel_netzones','isNetZoneCh');" />
<bean:message key="label.search.all"/>
</td>
...
<script language="javascript">
<%
PositionLookupListForm form=(PositionLookupListForm)session.getAttribute("PositionLookupListForm");
%>
<%=com.hps.july.siteinfo.valueobject.SuperRegionObject.createSelectData("data",form.getSupregs().elements(),request.getRemoteUser(),new Boolean(request.isUserInRole("administrator")))%>
<%=com.hps.july.siteinfo.valueobject.RegionObject.createSelectItems("items", (form.getRegioncodes()))%>
