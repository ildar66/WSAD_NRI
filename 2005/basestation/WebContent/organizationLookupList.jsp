...
function switchNameSearch(state) {
	if(state) {
		...
		OrgLookupForm.orgname.className = 'editsearch';
...
function switchInnSearch(state) {
	if(state) {
		...
		OrgLookupForm.orginn.className = 'editsearch';
...
<TR class="title">
 <TD class="title">
       <july:currmark><bean:message key="label.choose.organizations"/></july:currmark></td>
 </TD>
</TR>
...
<TR class="normal">
 <TD colspan="<%= gColSpan %>">
    ...
    <TR>
       ...
       <td class="title"><july:checkbox property="selissupplier" insertable="true" updatable="true" /></td>
     </tr>        
    <TR>
        ...
        <logic:iterate id="org" name="browseList" indexId="index">
	      <logic:present name="org">
            <tr class="normal" onMouseOver="className='select'" onMouseOut="className='normal'">
                ...
                <td class="text"><july:lookupreturn><bean:write name="org" property="inn" filter="true"/></july:lookupreturn></td>
                <td class="text">
