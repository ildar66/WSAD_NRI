...
<table class="print" STYLE="FONT-FAMILY: Arial,Verdana; FONT-SIZE: 8pt;">
	...
	<tr class="print">
		...
		<td align="left" width="35%" class="print" style="font-weight: bold">
			<bean:write name="BaseStationGSMForm" property="position.dopInfoVO.antennPlaceName"/>
		</td>
		<td align="right" width="15%" class="print"><I>Тип аппаратной:</I></td>
		<td align="left" width="35%" class="print" style="font-weight: bold">
			<bean:write name="BaseStationGSMForm" property="position.dopInfoVO.apparatTypeName"/>
		</td>
	</tr>
	<tr class="print">
		...
		<td align="left" width="35%" class="print" style="font-weight: bold">
			<bean:write name="BaseStationGSMForm" property="position.dopInfoVO.apparatPlaceName"/>
		</td>
	</tr>
	<tr class="print">
		<td align="right" class="print"><I>Место размещения опоры:</I></td>
		<td align="left" class="print" style="font-weight: bold">
			<bean:write name="BaseStationGSMForm" property="position.dopInfoVO.oporaPlaceName"/>
		</td>
		<td align="right" class="print"><I>Тип помещения:</I></td>
		<td align="left" class="print" style="font-weight: bold">
			<bean:write name="BaseStationGSMForm" property="position.dopInfoVO.applaceTypeName"/>
		</td>
	</tr>
	<tr class="print">
		<td align="right" class="print"><I>Чужая опора:</I></td>
		<td align="left" class="print" style="font-weight: bold">
			<bean:write name="BaseStationGSMForm" property="position.dopInfoVO.oporaour"/>
		</td>
		<td colspan="2">&nbsp;</td>
	</tr>
</table>
