...
<TR class="title">
 <TD class="title">
    <bean:message bundle="dictionaryResources" key="label.choose.restype"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
...
<TR>
  <TD>
    ...
    <table class="main" id="brtable">
        ...
        <!-- Table header -->
        <tr class="title">
            <july:headercolumn bundle="dictionaryResources" key="label.restype.code" colType="number"/>
            <july:headercolumn bundle="dictionaryResources" key="label.restype.name" colType="string"/>
        </tr>
