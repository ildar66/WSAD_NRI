...
<TR class="title">
 <TD class="title">
    <bean:message bundle="dictionaryResources" key="label.choose.ressbtype"/>
 </TD>
</TR>
<TR class="normal">
 <TD>
    ...
    <table class="find">
    <TR>
        <td><bean:message bundle="dictionaryResources" key="label.restype"/></td>
...
<TR>
  <TD>
    ...
    <table class="main" id="brtable">
        ...
        <!-- Table header -->
        <tr class="title">
        <july:headercolumn bundle="dictionaryResources" key="label.subtype.code" colType="number"/>
        <july:headercolumn bundle="dictionaryResources" key="label.subtype.name" colType="string"/>
        </tr>
	      ...
	      <logic:notPresent name="rstl">
            <tr class="normal">
                <td class="text" colspan="<%= gColSpan %>">
                   <bean:message bundle="dictionaryResources" key="label.norecords"/>
                </td>
            </tr>
	      </logic:notPresent>
