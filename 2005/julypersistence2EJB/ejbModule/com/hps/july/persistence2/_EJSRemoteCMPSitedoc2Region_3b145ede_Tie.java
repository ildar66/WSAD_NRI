...
public class _EJSRemoteCMPSitedoc2Region_3b145ede_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSitedoc2Region_3b145ede target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSitedoc2Region_3b145ede) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 114: 
                    if (method.equals("_get_region")) {
                        return _get_region(in, reply);
                    }
                case 115: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_region(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getRegion();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
