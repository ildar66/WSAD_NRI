...
public class _Etap2HopHome_Stub extends Stub implements Etap2HopHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Etap2HopHome:0000000000000000", 
    ...
    public Etap2Hop create(int arg0, int arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Etap2Hop) in.read_Object(Etap2Hop.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.Etap2HopHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Etap2Hop result = ((com.hps.july.persistence2.Etap2HopHome)so.servant).create(arg0, arg1, arg2);
                return (Etap2Hop)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Etap2Hop findByPrimaryKey(Etap2HopKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,Etap2HopKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Etap2Hop) in.read_Object(Etap2Hop.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.Etap2HopHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Etap2HopKey arg0Copy = (Etap2HopKey) Util.copyObject(arg0,_orb());
                Etap2Hop result = ((com.hps.july.persistence2.Etap2HopHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Etap2Hop)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findBySitedocAndPermid(Integer arg0, Integer arg1) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findBySitedocAndPermid", true);
                    ...
                    return findBySitedocAndPermid(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findBySitedocAndPermid",com.hps.july.persistence2.Etap2HopHome.class);
            if (so == null) {
                return findBySitedocAndPermid(arg0, arg1);
            }
            try {
                ...
                Enumeration result = ((com.hps.july.persistence2.Etap2HopHome)so.servant).findBySitedocAndPermid(arg0Copy, arg1Copy);
