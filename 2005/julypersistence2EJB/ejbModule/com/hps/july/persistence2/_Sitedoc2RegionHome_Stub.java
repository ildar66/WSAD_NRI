...
public class _Sitedoc2RegionHome_Stub extends Stub implements Sitedoc2RegionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Sitedoc2RegionHome:0000000000000000", 
    ...
    public Sitedoc2Region create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Sitedoc2Region) in.read_Object(Sitedoc2Region.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.Sitedoc2RegionHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Sitedoc2Region result = ((com.hps.july.persistence2.Sitedoc2RegionHome)so.servant).create(arg0, arg1);
                return (Sitedoc2Region)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findAllBySitedoc(int arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAllBySitedoc",com.hps.july.persistence2.Sitedoc2RegionHome.class);
            if (so == null) {
                return findAllBySitedoc(arg0);
            }
            try {
                Enumeration result = ((com.hps.july.persistence2.Sitedoc2RegionHome)so.servant).findAllBySitedoc(arg0);
    ...
    public Sitedoc2Region findByPrimaryKey(Sitedoc2RegionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,Sitedoc2RegionKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Sitedoc2Region) in.read_Object(Sitedoc2Region.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.Sitedoc2RegionHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Sitedoc2RegionKey arg0Copy = (Sitedoc2RegionKey) Util.copyObject(arg0,_orb());
                Sitedoc2Region result = ((com.hps.july.persistence2.Sitedoc2RegionHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Sitedoc2Region)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
