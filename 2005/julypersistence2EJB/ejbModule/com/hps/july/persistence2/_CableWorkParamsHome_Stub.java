...
public class _CableWorkParamsHome_Stub extends Stub implements CableWorkParamsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.CableWorkParamsHome:0000000000000000", 
    ...
    public CableWorkParams create(short arg0, int arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CableWorkParams) in.read_Object(CableWorkParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.CableWorkParamsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                CableWorkParams result = ((com.hps.july.persistence2.CableWorkParamsHome)so.servant).create(arg0, arg1, arg2);
                return (CableWorkParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByCable(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByCable",com.hps.july.persistence2.CableWorkParamsHome.class);
            if (so == null) {
                return findByCable(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence2.CableWorkParamsHome)so.servant).findByCable(arg0Copy);
    ...
    public CableWorkParams findByPrimaryKey(CableWorkParamsKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CableWorkParamsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CableWorkParams) in.read_Object(CableWorkParams.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.CableWorkParamsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CableWorkParamsKey arg0Copy = (CableWorkParamsKey) Util.copyObject(arg0,_orb());
                CableWorkParams result = ((com.hps.july.persistence2.CableWorkParamsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CableWorkParams)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
