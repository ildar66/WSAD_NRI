...
public class _AntennaCableHome_Stub extends Stub implements AntennaCableHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.AntennaCableHome:0000000000000000", 
    ...
    public AntennaCable create(int arg0, int arg1, int arg2, BigDecimal arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennaCable) in.read_Object(AntennaCable.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.AntennaCableHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                BigDecimal arg3Copy = (BigDecimal) Util.copyObject(arg3,_orb());
                AntennaCable result = ((com.hps.july.persistence2.AntennaCableHome)so.servant).create(arg0, arg1, arg2, arg3Copy);
                return (AntennaCable)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByAnten(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByAnten",com.hps.july.persistence2.AntennaCableHome.class);
            if (so == null) {
                return findByAnten(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.persistence2.AntennaCableHome)so.servant).findByAnten(arg0Copy);
    ...
    public AntennaCable findByPrimaryKey(AntennaCableKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,AntennaCableKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennaCable) in.read_Object(AntennaCable.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.AntennaCableHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AntennaCableKey arg0Copy = (AntennaCableKey) Util.copyObject(arg0,_orb());
                AntennaCable result = ((com.hps.july.persistence2.AntennaCableHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AntennaCable)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
