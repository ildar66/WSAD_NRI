...
public class _ApparatPlaceTypeHome_Stub extends Stub implements ApparatPlaceTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ApparatPlaceTypeHome:0000000000000000", 
    ...
    public ApparatPlaceType create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ApparatPlaceType) in.read_Object(ApparatPlaceType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ApparatPlaceTypeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ApparatPlaceType result = ((com.hps.july.persistence2.ApparatPlaceTypeHome)so.servant).create(arg0, arg1);
                return (ApparatPlaceType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ApparatPlaceType findByPrimaryKey(ApparatPlaceTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ApparatPlaceTypeKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ApparatPlaceType) in.read_Object(ApparatPlaceType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ApparatPlaceTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ApparatPlaceTypeKey arg0Copy = (ApparatPlaceTypeKey) Util.copyObject(arg0,_orb());
                ApparatPlaceType result = ((com.hps.july.persistence2.ApparatPlaceTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ApparatPlaceType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
