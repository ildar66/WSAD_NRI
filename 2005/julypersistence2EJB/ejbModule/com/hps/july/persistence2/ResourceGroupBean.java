...
/**
 * Bean implementation class for Enterprise Bean: ResourceGroup
 */
public class ResourceGroupBean implements javax.ejb.EntityBean {
	 ...
	 */
	public com.hps.july.persistence2.ResourceGroupKey ejbCreate(int groupid)
	 ...
	 * ejbPostCreate
	 */
	public void ejbPostCreate(int groupid) throws javax.ejb.CreateException {
	}
	/**
	 * ejbActivate
	 */
