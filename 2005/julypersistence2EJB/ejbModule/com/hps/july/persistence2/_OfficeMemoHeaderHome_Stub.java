...
public class _OfficeMemoHeaderHome_Stub extends Stub implements OfficeMemoHeaderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.OfficeMemoHeaderHome:0000000000000000", 
    ...
    public OfficeMemoHeader create(int arg0, int arg1, String arg2, Date arg3, int arg4, String arg5, int arg6) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg6);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OfficeMemoHeader) in.read_Object(OfficeMemoHeader.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.OfficeMemoHeaderHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
            }
            try {
                ...
                Date arg3Copy = (Date) copies[1];
                String arg5Copy = (String) copies[2];
                OfficeMemoHeader result = ((com.hps.july.persistence2.OfficeMemoHeaderHome)so.servant).create(arg0, arg1, arg2Copy, arg3Copy, arg4, arg5Copy, arg6);
                return (OfficeMemoHeader)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public OfficeMemoHeader findByPrimaryKey(OfficeMemoHeaderKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,OfficeMemoHeaderKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OfficeMemoHeader) in.read_Object(OfficeMemoHeader.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.OfficeMemoHeaderHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                OfficeMemoHeaderKey arg0Copy = (OfficeMemoHeaderKey) Util.copyObject(arg0,_orb());
                OfficeMemoHeader result = ((com.hps.july.persistence2.OfficeMemoHeaderHome)so.servant).findByPrimaryKey(arg0Copy);
                return (OfficeMemoHeader)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
