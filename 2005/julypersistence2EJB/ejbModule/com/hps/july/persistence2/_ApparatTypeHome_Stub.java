...
public class _ApparatTypeHome_Stub extends Stub implements ApparatTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ApparatTypeHome:0000000000000000", 
    ...
    public ApparatType create(int arg0, String arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ApparatType) in.read_Object(ApparatType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ApparatTypeHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ApparatType result = ((com.hps.july.persistence2.ApparatTypeHome)so.servant).create(arg0, arg1, arg2);
                return (ApparatType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ApparatType findByPrimaryKey(ApparatTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ApparatTypeKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ApparatType) in.read_Object(ApparatType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ApparatTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ApparatTypeKey arg0Copy = (ApparatTypeKey) Util.copyObject(arg0,_orb());
                ApparatType result = ((com.hps.july.persistence2.ApparatTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ApparatType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
