...
public class _CounterInfoHome_Stub extends Stub implements CounterInfoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.CounterInfoHome:0000000000000000", 
    ...
    public CounterInfo create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CounterInfo) in.read_Object(CounterInfo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.CounterInfoHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                CounterInfo result = ((com.hps.july.persistence2.CounterInfoHome)so.servant).create(arg0);
                return (CounterInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public CounterInfo findByPrimaryKey(CounterInfoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CounterInfoKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CounterInfo) in.read_Object(CounterInfo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.CounterInfoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CounterInfoKey arg0Copy = (CounterInfoKey) Util.copyObject(arg0,_orb());
                CounterInfo result = ((com.hps.july.persistence2.CounterInfoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (CounterInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
