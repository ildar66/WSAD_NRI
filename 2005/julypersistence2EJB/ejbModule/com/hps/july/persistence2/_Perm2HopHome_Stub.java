...
public class _Perm2HopHome_Stub extends Stub implements Perm2HopHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Perm2HopHome:0000000000000000", 
    ...
    public Perm2Hop create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Perm2Hop) in.read_Object(Perm2Hop.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.Perm2HopHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Perm2Hop result = ((com.hps.july.persistence2.Perm2HopHome)so.servant).create(arg0, arg1);
                return (Perm2Hop)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Perm2Hop findByPrimaryKey(Perm2HopKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,Perm2HopKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Perm2Hop) in.read_Object(Perm2Hop.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.Perm2HopHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Perm2HopKey arg0Copy = (Perm2HopKey) Util.copyObject(arg0,_orb());
                Perm2Hop result = ((com.hps.july.persistence2.Perm2HopHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Perm2Hop)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
