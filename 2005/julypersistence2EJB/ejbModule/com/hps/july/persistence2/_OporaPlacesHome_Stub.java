...
public class _OporaPlacesHome_Stub extends Stub implements OporaPlacesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.OporaPlacesHome:0000000000000000", 
    ...
    public OporaPlaces create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OporaPlaces) in.read_Object(OporaPlaces.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.OporaPlacesHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                OporaPlaces result = ((com.hps.july.persistence2.OporaPlacesHome)so.servant).create(arg0, arg1);
                return (OporaPlaces)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public OporaPlaces findByPrimaryKey(OporaPlacesKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,OporaPlacesKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OporaPlaces) in.read_Object(OporaPlaces.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.OporaPlacesHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                OporaPlacesKey arg0Copy = (OporaPlacesKey) Util.copyObject(arg0,_orb());
                OporaPlaces result = ((com.hps.july.persistence2.OporaPlacesHome)so.servant).findByPrimaryKey(arg0Copy);
                return (OporaPlaces)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
