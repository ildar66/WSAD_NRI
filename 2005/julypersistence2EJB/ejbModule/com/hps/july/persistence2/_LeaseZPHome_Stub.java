...
public class _LeaseZPHome_Stub extends Stub implements LeaseZPHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.LeaseZPHome:0000000000000000", 
    ...
    public LeaseZP create(int arg0, int arg1, boolean arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseZP) in.read_Object(LeaseZP.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.LeaseZPHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                LeaseZP result = ((com.hps.july.persistence2.LeaseZPHome)so.servant).create(arg0, arg1, arg2);
                return (LeaseZP)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LeaseZP findByPrimaryKey(LeaseZPKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LeaseZPKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LeaseZP) in.read_Object(LeaseZP.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.LeaseZPHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LeaseZPKey arg0Copy = (LeaseZPKey) Util.copyObject(arg0,_orb());
                LeaseZP result = ((com.hps.july.persistence2.LeaseZPHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LeaseZP)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
