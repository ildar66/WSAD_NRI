...
public class _EtapDocHome_Stub extends Stub implements EtapDocHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.EtapDocHome:0000000000000000", 
    ...
    public EtapDoc create(int arg0, int arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EtapDoc) in.read_Object(EtapDoc.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.EtapDocHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                EtapDoc result = ((com.hps.july.persistence2.EtapDocHome)so.servant).create(arg0, arg1, arg2);
                return (EtapDoc)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public EtapDoc findByPrimaryKey(EtapDocKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,EtapDocKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EtapDoc) in.read_Object(EtapDoc.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.EtapDocHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                EtapDocKey arg0Copy = (EtapDocKey) Util.copyObject(arg0,_orb());
                EtapDoc result = ((com.hps.july.persistence2.EtapDocHome)so.servant).findByPrimaryKey(arg0Copy);
                return (EtapDoc)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
