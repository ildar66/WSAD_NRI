...
public class _BeenetCategory_Stub extends Stub implements BeenetCategory {
    ...
    public int getCategid() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_categid", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_categid",com.hps.july.persistence2.BeenetCategory.class);
            if (so == null) {
                return getCategid();
            }
            try {
                return ((com.hps.july.persistence2.BeenetCategory)so.servant).getCategid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getCategname() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_categname", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_categname",com.hps.july.persistence2.BeenetCategory.class);
            if (so == null) {
                return getCategname();
            }
            try {
                return ((com.hps.july.persistence2.BeenetCategory)so.servant).getCategname();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getPattern() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_pattern", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (String) in.read_value(String.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_pattern",com.hps.july.persistence2.BeenetCategory.class);
            if (so == null) {
                return getPattern();
            }
            try {
                return ((com.hps.july.persistence2.BeenetCategory)so.servant).getPattern();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setCategname(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_categname",com.hps.july.persistence2.BeenetCategory.class);
            if (so == null) {
                setCategname(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.BeenetCategory)so.servant).setCategname(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setPattern(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_set_pattern",com.hps.july.persistence2.BeenetCategory.class);
            if (so == null) {
                setPattern(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.BeenetCategory)so.servant).setPattern(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
