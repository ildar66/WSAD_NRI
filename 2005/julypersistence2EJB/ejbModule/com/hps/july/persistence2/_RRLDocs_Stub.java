...
public class _RRLDocs_Stub extends Stub implements RRLDocs {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.RRLDocs:0000000000000000", 
    ...
    public int getOrganization() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_organization",com.hps.july.persistence2.RRLDocs.class);
            if (so == null) {
                return getOrganization();
            }
            try {
                return ((com.hps.july.persistence2.RRLDocs)so.servant).getOrganization();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getSitedoc() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_sitedoc",com.hps.july.persistence2.RRLDocs.class);
            if (so == null) {
                return getSitedoc();
            }
            try {
                return ((com.hps.july.persistence2.RRLDocs)so.servant).getSitedoc();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setOrganization(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_organization", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_organization",com.hps.july.persistence2.RRLDocs.class);
            if (so == null) {
                setOrganization(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.RRLDocs)so.servant).setOrganization(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
