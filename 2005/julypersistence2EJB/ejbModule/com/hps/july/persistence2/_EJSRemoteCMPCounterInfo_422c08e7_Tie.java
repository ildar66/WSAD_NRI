...
public class _EJSRemoteCMPCounterInfo_422c08e7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPCounterInfo_422c08e7 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPCounterInfo_422c08e7) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 99: 
                    ...
                    } else if (method.equals("_set_code")) {
                ...
                case 118: 
                    if (method.equals("_get_verification_inter")) {
                        return _get_verification_inter(in, reply);
                    } else if (method.equals("_set_verification_inter")) {
                        return _set_verification_inter(in, reply);
                    }
                case 121: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_verification_inter(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer result = target.getVerification_inter();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_verification_inter(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        target.setVerification_inter(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
