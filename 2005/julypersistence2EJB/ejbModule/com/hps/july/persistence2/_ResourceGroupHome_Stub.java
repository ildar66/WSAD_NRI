...
public class _ResourceGroupHome_Stub extends Stub implements ResourceGroupHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ResourceGroupHome:0000000000000000", 
    ...
    public ResourceGroup create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ResourceGroup) in.read_Object(ResourceGroup.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ResourceGroupHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                ResourceGroup result = ((com.hps.july.persistence2.ResourceGroupHome)so.servant).create(arg0);
                return (ResourceGroup)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ResourceGroup findByPrimaryKey(ResourceGroupKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ResourceGroupKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ResourceGroup) in.read_Object(ResourceGroup.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ResourceGroupHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResourceGroupKey arg0Copy = (ResourceGroupKey) Util.copyObject(arg0,_orb());
                ResourceGroup result = ((com.hps.july.persistence2.ResourceGroupHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ResourceGroup)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
