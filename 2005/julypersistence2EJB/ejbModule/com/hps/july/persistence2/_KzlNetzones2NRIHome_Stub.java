...
public class _KzlNetzones2NRIHome_Stub extends Stub implements KzlNetzones2NRIHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.KzlNetzones2NRIHome:0000000000000000", 
    ...
    public KzlNetzones2NRI create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (KzlNetzones2NRI) in.read_Object(KzlNetzones2NRI.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.KzlNetzones2NRIHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                KzlNetzones2NRI result = ((com.hps.july.persistence2.KzlNetzones2NRIHome)so.servant).create(arg0, arg1);
                return (KzlNetzones2NRI)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public KzlNetzones2NRI findByPrimaryKey(KzlNetzones2NRIKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,KzlNetzones2NRIKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (KzlNetzones2NRI) in.read_Object(KzlNetzones2NRI.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.KzlNetzones2NRIHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                KzlNetzones2NRIKey arg0Copy = (KzlNetzones2NRIKey) Util.copyObject(arg0,_orb());
                KzlNetzones2NRI result = ((com.hps.july.persistence2.KzlNetzones2NRIHome)so.servant).findByPrimaryKey(arg0Copy);
                return (KzlNetzones2NRI)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
