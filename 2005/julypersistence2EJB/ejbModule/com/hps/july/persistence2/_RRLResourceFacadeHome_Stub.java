...
public class _RRLResourceFacadeHome_Stub extends Stub implements RRLResourceFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.RRLResourceFacadeHome:0000000000000000", 
    ...
    public RRLResourceFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLResourceFacade) in.read_Object(RRLResourceFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.RRLResourceFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                RRLResourceFacade result = ((com.hps.july.persistence2.RRLResourceFacadeHome)so.servant).create();
                return (RRLResourceFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
