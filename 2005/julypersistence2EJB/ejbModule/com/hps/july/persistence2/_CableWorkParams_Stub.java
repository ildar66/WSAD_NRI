...
public class _CableWorkParams_Stub extends Stub implements CableWorkParams {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.CableWorkParams:0000000000000000", 
    ...
    public short getBand() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_band",com.hps.july.persistence2.CableWorkParams.class);
            if (so == null) {
                return getBand();
            }
            try {
                return ((com.hps.july.persistence2.CableWorkParams)so.servant).getBand();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getId_anten() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_id_anten",com.hps.july.persistence2.CableWorkParams.class);
            if (so == null) {
                return getId_anten();
            }
            try {
                return ((com.hps.july.persistence2.CableWorkParams)so.servant).getId_anten();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getId_cable() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_id_cable", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_id_cable",com.hps.july.persistence2.CableWorkParams.class);
            if (so == null) {
                return getId_cable();
            }
            try {
                return ((com.hps.july.persistence2.CableWorkParams)so.servant).getId_cable();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public BigDecimal getKsvn() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_ksvn",com.hps.july.persistence2.CableWorkParams.class);
            if (so == null) {
                return getKsvn();
            }
            try {
                BigDecimal result = ((com.hps.july.persistence2.CableWorkParams)so.servant).getKsvn();
    ...
    public void setKsvn(BigDecimal arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_ksvn",com.hps.july.persistence2.CableWorkParams.class);
            if (so == null) {
                setKsvn(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence2.CableWorkParams)so.servant).setKsvn(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
