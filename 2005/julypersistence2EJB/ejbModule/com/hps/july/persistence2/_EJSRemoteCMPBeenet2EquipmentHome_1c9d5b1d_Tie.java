...
public class _EJSRemoteCMPBeenet2EquipmentHome_1c9d5b1d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPBeenet2EquipmentHome_1c9d5b1d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPBeenet2EquipmentHome_1c9d5b1d) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 14: 
                    if (method.equals("findByBeenetid")) {
                        return findByBeenetid(in, reply);
                    }
                case 15: 
    ...
    private org.omg.CORBA.portable.OutputStream findByBeenetid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByBeenetid(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Beenet2EquipmentKey arg0 = (Beenet2EquipmentKey) in.read_value(Beenet2EquipmentKey.class);
        Beenet2Equipment result;
        try {
