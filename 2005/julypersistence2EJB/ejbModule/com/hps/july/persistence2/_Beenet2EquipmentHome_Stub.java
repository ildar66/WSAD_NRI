...
public class _Beenet2EquipmentHome_Stub extends Stub implements Beenet2EquipmentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Beenet2EquipmentHome:0000000000000000", 
    ...
    public Beenet2Equipment create(String arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Beenet2Equipment) in.read_Object(Beenet2Equipment.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.Beenet2EquipmentHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Beenet2Equipment result = ((com.hps.july.persistence2.Beenet2EquipmentHome)so.servant).create(arg0, arg1);
                return (Beenet2Equipment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByBeenetid(String arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByBeenetid",com.hps.july.persistence2.Beenet2EquipmentHome.class);
            if (so == null) {
                return findByBeenetid(arg0);
            }
            try {
                Enumeration result = ((com.hps.july.persistence2.Beenet2EquipmentHome)so.servant).findByBeenetid(arg0);
    ...
    public Beenet2Equipment findByPrimaryKey(Beenet2EquipmentKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,Beenet2EquipmentKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Beenet2Equipment) in.read_Object(Beenet2Equipment.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.Beenet2EquipmentHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Beenet2EquipmentKey arg0Copy = (Beenet2EquipmentKey) Util.copyObject(arg0,_orb());
                Beenet2Equipment result = ((com.hps.july.persistence2.Beenet2EquipmentHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Beenet2Equipment)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
