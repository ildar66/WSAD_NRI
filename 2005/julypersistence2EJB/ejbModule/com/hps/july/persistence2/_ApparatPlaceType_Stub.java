...
public class _ApparatPlaceType_Stub extends Stub implements ApparatPlaceType {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ApparatPlaceType:0000000000000000", 
    ...
    public int getApplacetypeid() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_get_applacetypeid",com.hps.july.persistence2.ApparatPlaceType.class);
            if (so == null) {
                return getApplacetypeid();
            }
            try {
                return ((com.hps.july.persistence2.ApparatPlaceType)so.servant).getApplacetypeid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getName() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_name",com.hps.july.persistence2.ApparatPlaceType.class);
            if (so == null) {
                return getName();
            }
            try {
                return ((com.hps.july.persistence2.ApparatPlaceType)so.servant).getName();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setName(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_name",com.hps.july.persistence2.ApparatPlaceType.class);
            if (so == null) {
                setName(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.ApparatPlaceType)so.servant).setName(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
