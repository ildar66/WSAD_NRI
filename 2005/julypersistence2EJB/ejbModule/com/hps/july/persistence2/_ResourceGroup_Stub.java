...
public class _ResourceGroup_Stub extends Stub implements ResourceGroup {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ResourceGroup:0000000000000000", 
    ...
    public String getName() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_name",com.hps.july.persistence2.ResourceGroup.class);
            if (so == null) {
                return getName();
            }
            try {
                return ((com.hps.july.persistence2.ResourceGroup)so.servant).getName();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setName(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_name",com.hps.july.persistence2.ResourceGroup.class);
            if (so == null) {
                setName(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.ResourceGroup)so.servant).setName(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public int getClassid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_classid",com.hps.july.persistence2.ResourceGroup.class);
            if (so == null) {
                return getClassid();
            }
            try {
                return ((com.hps.july.persistence2.ResourceGroup)so.servant).getClassid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setClassid(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_classid",com.hps.july.persistence2.ResourceGroup.class);
            if (so == null) {
                setClassid(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.ResourceGroup)so.servant).setClassid(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
