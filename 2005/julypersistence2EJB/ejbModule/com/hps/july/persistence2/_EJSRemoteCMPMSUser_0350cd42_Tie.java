...
public class _EJSRemoteCMPMSUser_0350cd42_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPMSUser_0350cd42 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.MSUser:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPMSUser_0350cd42) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 12: 
                    ...
                    } else if (method.equals("_get_msucode")) {
                        return _get_msucode(in, reply);
                    } else if (method.equals("_get_msuser_")) {
                        return _get_msuser_(in, reply);
                    } else if (method.equals("_set_msuser_")) {
                        return _set_msuser_(in, reply);
                    }
                case 13: 
                ...
                case 15: 
                    ...
                    } else if (method.equals("_get_mspassword")) {
                        return _get_mspassword(in, reply);
                    } else if (method.equals("_set_mspassword")) {
                        return _set_mspassword(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_mspassword(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getMspassword();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _get_msucode(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getMsucode();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _get_msuser_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getMsuser();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,String.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream _set_mspassword(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setMspassword(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _set_msuser_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setMsuser(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
