...
public class _RRLDocsHome_Stub extends Stub implements RRLDocsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.RRLDocsHome:0000000000000000", 
    ...
    public RRLDocs create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLDocs) in.read_Object(RRLDocs.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.RRLDocsHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                RRLDocs result = ((com.hps.july.persistence2.RRLDocsHome)so.servant).create(arg0, arg1);
                return (RRLDocs)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RRLDocs findByPrimaryKey(RRLDocsKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,RRLDocsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLDocs) in.read_Object(RRLDocs.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.RRLDocsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RRLDocsKey arg0Copy = (RRLDocsKey) Util.copyObject(arg0,_orb());
                RRLDocs result = ((com.hps.july.persistence2.RRLDocsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (RRLDocs)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
