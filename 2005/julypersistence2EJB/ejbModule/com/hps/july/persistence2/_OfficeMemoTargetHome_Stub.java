...
public class _OfficeMemoTargetHome_Stub extends Stub implements OfficeMemoTargetHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.OfficeMemoTargetHome:0000000000000000", 
    ...
    public OfficeMemoTarget create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OfficeMemoTarget) in.read_Object(OfficeMemoTarget.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.OfficeMemoTargetHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                OfficeMemoTarget result = ((com.hps.july.persistence2.OfficeMemoTargetHome)so.servant).create(arg0, arg1);
                return (OfficeMemoTarget)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public OfficeMemoTarget findByPrimaryKey(OfficeMemoTargetKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,OfficeMemoTargetKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OfficeMemoTarget) in.read_Object(OfficeMemoTarget.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.OfficeMemoTargetHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                OfficeMemoTargetKey arg0Copy = (OfficeMemoTargetKey) Util.copyObject(arg0,_orb());
                OfficeMemoTarget result = ((com.hps.july.persistence2.OfficeMemoTargetHome)so.servant).findByPrimaryKey(arg0Copy);
                return (OfficeMemoTarget)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
