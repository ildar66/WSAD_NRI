...
public class _EJSRemoteCMPFreqPermission_85b7d5de_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPFreqPermission_85b7d5de target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPFreqPermission_85b7d5de) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 101: 
                    ...
                    } else if (method.equals("_get_etap")) {
                        return _get_etap(in, reply);
                    } else if (method.equals("_set_etap")) {
                        return _set_etap(in, reply);
                    }
                case 102: 
                    if (method.equals("_get_filenumber")) {
                        return _get_filenumber(in, reply);
                    } else if (method.equals("_get_freqpermid")) {
                        return _get_freqpermid(in, reply);
                    } else if (method.equals("_set_filenumber")) {
                        return _set_filenumber(in, reply);
                    }
                case 104: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_etap(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String result = target.getEtap();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,String.class);
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream _get_filenumber(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer result = target.getFilenumber();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_etap(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setEtap(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    ...
    private org.omg.CORBA.portable.OutputStream _set_filenumber(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        target.setFilenumber(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
