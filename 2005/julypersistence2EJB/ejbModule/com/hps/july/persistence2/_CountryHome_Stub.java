...
public class _CountryHome_Stub extends Stub implements CountryHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.CountryHome:0000000000000000", 
    ...
    public Country findByPrimaryKey(CountryKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CountryKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Country) in.read_Object(Country.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.CountryHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CountryKey arg0Copy = (CountryKey) Util.copyObject(arg0,_orb());
                Country result = ((com.hps.july.persistence2.CountryHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Country)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Country create(int arg0, String arg1, BigDecimal arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.CountryHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                Country result = ((com.hps.july.persistence2.CountryHome)so.servant).create(arg0, arg1Copy, arg2Copy);
                return (Country)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
