...
public class _EJSRemoteCMPBeenetObject_f8cb309f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPBeenetObject_f8cb309f target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPBeenetObject_f8cb309f) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 99: 
                    ...
                    } else if (method.equals("_set_categid")) {
                        return _set_categid(in, reply);
                    }
                case 101: 
                ...
                case 112: 
                    ...
                    } else if (method.equals("_get_position")) {
                        return _get_position(in, reply);
                    } else if (method.equals("_set_position")) {
    ...
    private org.omg.CORBA.portable.OutputStream _get_position(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getPosition();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _set_categid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        target.setCategid(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream _set_position(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
