...
public class _Sitedoc2Resource_Stub extends Stub implements Sitedoc2Resource {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Sitedoc2Resource:0000000000000000", 
    ...
    public String getFreqrange() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_freqrange",com.hps.july.persistence2.Sitedoc2Resource.class);
            if (so == null) {
                return getFreqrange();
            }
            try {
                return ((com.hps.july.persistence2.Sitedoc2Resource)so.servant).getFreqrange();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getResource() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_resource",com.hps.july.persistence2.Sitedoc2Resource.class);
            if (so == null) {
                return getResource();
            }
            try {
                return ((com.hps.july.persistence2.Sitedoc2Resource)so.servant).getResource();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getSitedoc() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_sitedoc",com.hps.july.persistence2.Sitedoc2Resource.class);
            if (so == null) {
                return getSitedoc();
            }
            try {
                return ((com.hps.july.persistence2.Sitedoc2Resource)so.servant).getSitedoc();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setFreqrange(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_freqrange",com.hps.july.persistence2.Sitedoc2Resource.class);
            if (so == null) {
                setFreqrange(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.Sitedoc2Resource)so.servant).setFreqrange(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
