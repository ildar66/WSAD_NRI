...
public class _Group2ResourceHome_Stub extends Stub implements Group2ResourceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Group2ResourceHome:0000000000000000", 
    ...
    public Group2Resource findByPrimaryKey(Group2ResourceKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,Group2ResourceKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Group2Resource) in.read_Object(Group2Resource.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.Group2ResourceHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Group2ResourceKey arg0Copy = (Group2ResourceKey) Util.copyObject(arg0,_orb());
                Group2Resource result = ((com.hps.july.persistence2.Group2ResourceHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Group2Resource)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Group2Resource create(int arg0, int arg1, BigDecimal arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.Group2ResourceHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                BigDecimal arg2Copy = (BigDecimal) Util.copyObject(arg2,_orb());
                Group2Resource result = ((com.hps.july.persistence2.Group2ResourceHome)so.servant).create(arg0, arg1, arg2Copy);
                return (Group2Resource)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
