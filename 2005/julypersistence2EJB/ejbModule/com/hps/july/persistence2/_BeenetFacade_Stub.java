...
public class _BeenetFacade_Stub extends Stub implements BeenetFacade {
    ...
    public void createBeenet(String arg0, int arg1, int arg2, int[] arg3) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("createBeenet", true);
                    out.write_value(arg0,String.class);
                    out.write_long(arg1);
                    out.write_long(arg2);
                    out.write_value(cast_array(arg3),int[].class);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    ...
                    createBeenet(arg0,arg1,arg2,arg3);
                    return;
                } finally {
                    _releaseReply(in);
                }
            ...
            ServantObject so = _servant_preinvoke("createBeenet",com.hps.july.persistence2.BeenetFacade.class);
            if (so == null) {
                createBeenet(arg0, arg1, arg2, arg3);
                return;
            }
            try {
                ...
                int[] arg3Copy = (int[]) copies[1];
                ((com.hps.july.persistence2.BeenetFacade)so.servant).createBeenet(arg0Copy, arg1, arg2, arg3Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void deleteBeenet(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("deleteBeenet",com.hps.july.persistence2.BeenetFacade.class);
            if (so == null) {
                deleteBeenet(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.BeenetFacade)so.servant).deleteBeenet(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void updateBeenet(String arg0, int arg1, int[] arg2) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("updateBeenet",com.hps.july.persistence2.BeenetFacade.class);
            if (so == null) {
                updateBeenet(arg0, arg1, arg2);
                return;
            }
            try {
                ...
                String arg0Copy = (String) copies[0];
                int[] arg2Copy = (int[]) copies[1];
                ((com.hps.july.persistence2.BeenetFacade)so.servant).updateBeenet(arg0Copy, arg1, arg2Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
