...
public class _ResourceSetClass_Stub extends Stub implements ResourceSetClass {
    ...
    public String getClassname() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_classname",com.hps.july.persistence2.ResourceSetClass.class);
            if (so == null) {
                return getClassname();
            }
            try {
                return ((com.hps.july.persistence2.ResourceSetClass)so.servant).getClassname();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setClassname(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_classname",com.hps.july.persistence2.ResourceSetClass.class);
            if (so == null) {
                setClassname(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.ResourceSetClass)so.servant).setClassname(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public int getClassid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_classid",com.hps.july.persistence2.ResourceSetClass.class);
            if (so == null) {
                return getClassid();
            }
            try {
                return ((com.hps.july.persistence2.ResourceSetClass)so.servant).getClassid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setClassid(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_classid",com.hps.july.persistence2.ResourceSetClass.class);
            if (so == null) {
                setClassid(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.ResourceSetClass)so.servant).setClassid(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
