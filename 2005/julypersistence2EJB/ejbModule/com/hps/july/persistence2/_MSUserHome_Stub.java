...
public class _MSUserHome_Stub extends Stub implements MSUserHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.MSUserHome:0000000000000000", 
    ...
    public MSUser create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (MSUser) in.read_Object(MSUser.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.MSUserHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                MSUser result = ((com.hps.july.persistence2.MSUserHome)so.servant).create(arg0, arg1);
    ...
    public MSUser findByPrimaryKey(MSUserKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,MSUserKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (MSUser) in.read_Object(MSUser.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.MSUserHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                MSUserKey arg0Copy = (MSUserKey) Util.copyObject(arg0,_orb());
                MSUser result = ((com.hps.july.persistence2.MSUserHome)so.servant).findByPrimaryKey(arg0Copy);
                return (MSUser)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
