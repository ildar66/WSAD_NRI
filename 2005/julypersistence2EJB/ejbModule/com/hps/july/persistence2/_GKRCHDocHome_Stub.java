...
public class _GKRCHDocHome_Stub extends Stub implements GKRCHDocHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.GKRCHDocHome:0000000000000000", 
    ...
    public GKRCHDoc create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (GKRCHDoc) in.read_Object(GKRCHDoc.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.GKRCHDocHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                GKRCHDoc result = ((com.hps.july.persistence2.GKRCHDocHome)so.servant).create(arg0);
                return (GKRCHDoc)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public GKRCHDoc findByPrimaryKey(GKRCHDocKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,GKRCHDocKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (GKRCHDoc) in.read_Object(GKRCHDoc.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.GKRCHDocHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                GKRCHDocKey arg0Copy = (GKRCHDocKey) Util.copyObject(arg0,_orb());
                GKRCHDoc result = ((com.hps.july.persistence2.GKRCHDocHome)so.servant).findByPrimaryKey(arg0Copy);
                return (GKRCHDoc)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
