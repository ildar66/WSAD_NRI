...
public class _EtapTypeHome_Stub extends Stub implements EtapTypeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.EtapTypeHome:0000000000000000", 
    ...
    public EtapType create(int arg0, String arg1, boolean arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EtapType) in.read_Object(EtapType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.EtapTypeHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                EtapType result = ((com.hps.july.persistence2.EtapTypeHome)so.servant).create(arg0, arg1, arg2);
                return (EtapType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public EtapType findByPrimaryKey(EtapTypeKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,EtapTypeKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EtapType) in.read_Object(EtapType.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.EtapTypeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                EtapTypeKey arg0Copy = (EtapTypeKey) Util.copyObject(arg0,_orb());
                EtapType result = ((com.hps.july.persistence2.EtapTypeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (EtapType)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
