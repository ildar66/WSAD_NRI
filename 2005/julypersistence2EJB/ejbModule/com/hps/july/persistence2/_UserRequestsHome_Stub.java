...
public class _UserRequestsHome_Stub extends Stub implements UserRequestsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.UserRequestsHome:0000000000000000", 
    ...
    public UserRequests findByPrimaryKey(UserRequestsKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,UserRequestsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (UserRequests) in.read_Object(UserRequests.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.UserRequestsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                UserRequestsKey arg0Copy = (UserRequestsKey) Util.copyObject(arg0,_orb());
                UserRequests result = ((com.hps.july.persistence2.UserRequestsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (UserRequests)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public UserRequests create(int arg0, Date arg1, int arg2, int arg3, int arg4, int arg5, String arg6, String arg7) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.UserRequestsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg1,arg6,arg7},_orb());
                Date arg1Copy = (Date) copies[0];
                String arg6Copy = (String) copies[1];
                String arg7Copy = (String) copies[2];
                UserRequests result = ((com.hps.july.persistence2.UserRequestsHome)so.servant).create(arg0, arg1Copy, arg2, arg3, arg4, arg5, arg6Copy, arg7Copy);
                return (UserRequests)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
