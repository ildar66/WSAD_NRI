...
public class _ResourceClassHome_Stub extends Stub implements ResourceClassHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ResourceClassHome:0000000000000000", 
    ...
    public ResourceClass findByPrimaryKey(ResourceClassKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ResourceClassKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ResourceClass) in.read_Object(ResourceClass.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ResourceClassHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResourceClassKey arg0Copy = (ResourceClassKey) Util.copyObject(arg0,_orb());
                ResourceClass result = ((com.hps.july.persistence2.ResourceClassHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ResourceClass)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ResourceClass create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ResourceClassHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ResourceClass result = ((com.hps.july.persistence2.ResourceClassHome)so.servant).create(arg0, arg1);
                return (ResourceClass)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
