...
public class _EJSRemoteCMPPerm2Hop_acbed29c_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPPerm2Hop_acbed29c target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPPerm2Hop_acbed29c) target;
    }
        ...
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 104: 
                    ...
                    } else if (method.equals("_get_hopsid")) {
                        return _get_hopsid(in, reply);
                    }
                case 110: 
                    if (method.equals("isIdentical")) {
                        return isIdentical(in, reply);
                    } else if (method.equals("_get_numberinfile")) {
                        return _get_numberinfile(in, reply);
                    } else if (method.equals("_set_numberinfile")) {
                        return _set_numberinfile(in, reply);
                    }
                case 112: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_numberinfile(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer result = target.getNumberinfile();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _set_numberinfile(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        target.setNumberinfile(arg0);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
