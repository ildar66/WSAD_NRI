...
public class _BeenetObject_Stub extends Stub implements BeenetObject {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.BeenetObject:0000000000000000", 
    ...
    public String getBeenetid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_beenetid",com.hps.july.persistence2.BeenetObject.class);
            if (so == null) {
                return getBeenetid();
            }
            try {
                return ((com.hps.july.persistence2.BeenetObject)so.servant).getBeenetid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getCategid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_categid",com.hps.july.persistence2.BeenetObject.class);
            if (so == null) {
                return getCategid();
            }
            try {
                return ((com.hps.july.persistence2.BeenetObject)so.servant).getCategid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getPosition() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_position", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_position",com.hps.july.persistence2.BeenetObject.class);
            if (so == null) {
                return getPosition();
            }
            try {
                return ((com.hps.july.persistence2.BeenetObject)so.servant).getPosition();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setCategid(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_categid", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_categid",com.hps.july.persistence2.BeenetObject.class);
            if (so == null) {
                setCategid(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.BeenetObject)so.servant).setCategid(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setPosition(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_position", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_position",com.hps.july.persistence2.BeenetObject.class);
            if (so == null) {
                setPosition(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.BeenetObject)so.servant).setPosition(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
