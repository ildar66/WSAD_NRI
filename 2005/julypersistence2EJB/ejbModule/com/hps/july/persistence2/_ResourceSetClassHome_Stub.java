...
public class _ResourceSetClassHome_Stub extends Stub implements ResourceSetClassHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ResourceSetClassHome:0000000000000000", 
    ...
    public ResourceSetClass findByPrimaryKey(ResourceSetClassKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ResourceSetClassKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ResourceSetClass) in.read_Object(ResourceSetClass.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ResourceSetClassHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ResourceSetClassKey arg0Copy = (ResourceSetClassKey) Util.copyObject(arg0,_orb());
                ResourceSetClass result = ((com.hps.july.persistence2.ResourceSetClassHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ResourceSetClass)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ResourceSetClass create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ResourceSetClassHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ResourceSetClass result = ((com.hps.july.persistence2.ResourceSetClassHome)so.servant).create(arg0, arg1);
                return (ResourceSetClass)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
