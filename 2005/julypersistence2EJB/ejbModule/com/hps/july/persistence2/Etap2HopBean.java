...
import javax.ejb.*;
/**
 * Связь этапов получения частотных разрешений и пролетов
 * This is an Entity Bean class with CMP fields
 */
public class Etap2HopBean implements EntityBean {
 ...
 * @exception java.rmi.RemoteException The exception description.
 */
public void ejbCreate(int argHopsid, int argSitedoc, int argFreqpermid) throws javax.ejb.CreateException, java.rmi.RemoteException {
	_initLinks();
 ...
 * @exception java.rmi.RemoteException The exception description.
 */
public void ejbPostCreate(int argHopsid, int argSitedoc) throws java.rmi.RemoteException {}
/**
 ...
 * Creation date: (28.06.2004 16:46:27)
 * @return int
 */
