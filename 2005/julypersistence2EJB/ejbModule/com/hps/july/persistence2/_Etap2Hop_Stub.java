...
public class _Etap2Hop_Stub extends Stub implements Etap2Hop {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Etap2Hop:0000000000000000", 
    ...
    public int getFreqpermid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_freqpermid",com.hps.july.persistence2.Etap2Hop.class);
            if (so == null) {
                return getFreqpermid();
            }
            try {
                return ((com.hps.july.persistence2.Etap2Hop)so.servant).getFreqpermid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getHopsid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_hopsid",com.hps.july.persistence2.Etap2Hop.class);
            if (so == null) {
                return getHopsid();
            }
            try {
                return ((com.hps.july.persistence2.Etap2Hop)so.servant).getHopsid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getSitedoc() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_sitedoc",com.hps.july.persistence2.Etap2Hop.class);
            if (so == null) {
                return getSitedoc();
            }
            try {
                return ((com.hps.july.persistence2.Etap2Hop)so.servant).getSitedoc();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setFreqpermid(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_freqpermid",com.hps.july.persistence2.Etap2Hop.class);
            if (so == null) {
                setFreqpermid(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.Etap2Hop)so.servant).setFreqpermid(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
