...
public class _FreqPermissionHome_Stub extends Stub implements FreqPermissionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.FreqPermissionHome:0000000000000000", 
    ...
    public FreqPermission create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (FreqPermission) in.read_Object(FreqPermission.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.FreqPermissionHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                FreqPermission result = ((com.hps.july.persistence2.FreqPermissionHome)so.servant).create(arg0);
                return (FreqPermission)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public FreqPermission findByPrimaryKey(FreqPermissionKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,FreqPermissionKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (FreqPermission) in.read_Object(FreqPermission.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.FreqPermissionHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                FreqPermissionKey arg0Copy = (FreqPermissionKey) Util.copyObject(arg0,_orb());
                FreqPermission result = ((com.hps.july.persistence2.FreqPermissionHome)so.servant).findByPrimaryKey(arg0Copy);
                return (FreqPermission)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
