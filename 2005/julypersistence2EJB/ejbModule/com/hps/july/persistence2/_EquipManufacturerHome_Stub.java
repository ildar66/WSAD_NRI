...
public class _EquipManufacturerHome_Stub extends Stub implements EquipManufacturerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.EquipManufacturerHome:0000000000000000", 
    ...
    public EquipManufacturer findByPrimaryKey(Integer arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EquipManufacturer) in.read_Object(EquipManufacturer.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.EquipManufacturerHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                EquipManufacturer result = ((com.hps.july.persistence2.EquipManufacturerHome)so.servant).findByPrimaryKey(arg0Copy);
                return (EquipManufacturer)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public EquipManufacturer create(Integer arg0, String arg1, String arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.EquipManufacturerHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                ...
                EquipManufacturer result = ((com.hps.july.persistence2.EquipManufacturerHome)so.servant).create(arg0Copy, arg1Copy, arg2Copy);
                return (EquipManufacturer)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
