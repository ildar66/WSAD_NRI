...
public class _Sitedoc2Region_Stub extends Stub implements Sitedoc2Region {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Sitedoc2Region:0000000000000000", 
    ...
    public int getRegion() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_region", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_region",com.hps.july.persistence2.Sitedoc2Region.class);
            if (so == null) {
                return getRegion();
            }
            try {
                return ((com.hps.july.persistence2.Sitedoc2Region)so.servant).getRegion();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getSitedoc() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_sitedoc",com.hps.july.persistence2.Sitedoc2Region.class);
            if (so == null) {
                return getSitedoc();
            }
            try {
                return ((com.hps.july.persistence2.Sitedoc2Region)so.servant).getSitedoc();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
