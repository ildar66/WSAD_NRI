...
public class _SitedocFacadeHome_Stub extends Stub implements SitedocFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.SitedocFacadeHome:0000000000000000", 
    ...
    public SitedocFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (SitedocFacade) in.read_Object(SitedocFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.SitedocFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                SitedocFacade result = ((com.hps.july.persistence2.SitedocFacadeHome)so.servant).create();
                return (SitedocFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
