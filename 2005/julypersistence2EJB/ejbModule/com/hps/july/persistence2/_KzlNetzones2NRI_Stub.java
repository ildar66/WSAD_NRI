...
public class _KzlNetzones2NRI_Stub extends Stub implements KzlNetzones2NRI {
    ...
    public int getKzlregionid() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_kzlregionid", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_kzlregionid",com.hps.july.persistence2.KzlNetzones2NRI.class);
            if (so == null) {
                return getKzlregionid();
            }
            try {
                return ((com.hps.july.persistence2.KzlNetzones2NRI)so.servant).getKzlregionid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getNetzone() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_netzone", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_netzone",com.hps.july.persistence2.KzlNetzones2NRI.class);
            if (so == null) {
                return getNetzone();
            }
            try {
                return ((com.hps.july.persistence2.KzlNetzones2NRI)so.servant).getNetzone();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setNetzone(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_netzone", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_netzone",com.hps.july.persistence2.KzlNetzones2NRI.class);
            if (so == null) {
                setNetzone(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.KzlNetzones2NRI)so.servant).setNetzone(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
