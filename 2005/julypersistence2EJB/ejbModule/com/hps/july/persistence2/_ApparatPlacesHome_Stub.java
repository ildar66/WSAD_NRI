...
public class _ApparatPlacesHome_Stub extends Stub implements ApparatPlacesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ApparatPlacesHome:0000000000000000", 
    ...
    public ApparatPlaces create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ApparatPlaces) in.read_Object(ApparatPlaces.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ApparatPlacesHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                ApparatPlaces result = ((com.hps.july.persistence2.ApparatPlacesHome)so.servant).create(arg0, arg1);
                return (ApparatPlaces)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ApparatPlaces findByPrimaryKey(ApparatPlacesKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ApparatPlacesKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ApparatPlaces) in.read_Object(ApparatPlaces.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ApparatPlacesHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ApparatPlacesKey arg0Copy = (ApparatPlacesKey) Util.copyObject(arg0,_orb());
                ApparatPlaces result = ((com.hps.july.persistence2.ApparatPlacesHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ApparatPlaces)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
