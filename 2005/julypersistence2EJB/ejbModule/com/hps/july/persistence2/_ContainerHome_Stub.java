...
public class _ContainerHome_Stub extends Stub implements ContainerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ContainerHome:0000000000000000", 
    ...
    public Container create(int arg0, int arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Container) in.read_Object(Container.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ContainerHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Container result = ((com.hps.july.persistence2.ContainerHome)so.servant).create(arg0, arg1, arg2);
                return (Container)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Container findByPrimaryKey(ContainerKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ContainerKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Container) in.read_Object(Container.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ContainerHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ContainerKey arg0Copy = (ContainerKey) Util.copyObject(arg0,_orb());
                Container result = ((com.hps.july.persistence2.ContainerHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Container)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
