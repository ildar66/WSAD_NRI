...
public class _Perm2Hop_Stub extends Stub implements Perm2Hop {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Perm2Hop:0000000000000000", 
    ...
    public int getFreqpermid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_freqpermid",com.hps.july.persistence2.Perm2Hop.class);
            if (so == null) {
                return getFreqpermid();
            }
            try {
                return ((com.hps.july.persistence2.Perm2Hop)so.servant).getFreqpermid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getHopsid() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_hopsid",com.hps.july.persistence2.Perm2Hop.class);
            if (so == null) {
                return getHopsid();
            }
            try {
                return ((com.hps.july.persistence2.Perm2Hop)so.servant).getHopsid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public Integer getNumberinfile() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_numberinfile", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_numberinfile",com.hps.july.persistence2.Perm2Hop.class);
            if (so == null) {
                return getNumberinfile();
            }
            try {
                Integer result = ((com.hps.july.persistence2.Perm2Hop)so.servant).getNumberinfile();
    ...
    public void setNumberinfile(Integer arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_numberinfile", true);
            ...
            ServantObject so = _servant_preinvoke("_set_numberinfile",com.hps.july.persistence2.Perm2Hop.class);
            if (so == null) {
                setNumberinfile(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence2.Perm2Hop)so.servant).setNumberinfile(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
