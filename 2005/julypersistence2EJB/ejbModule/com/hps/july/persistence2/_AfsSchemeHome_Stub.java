...
public class _AfsSchemeHome_Stub extends Stub implements AfsSchemeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.AfsSchemeHome:0000000000000000", 
    ...
    public AfsScheme create(Integer arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AfsScheme) in.read_Object(AfsScheme.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.AfsSchemeHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                AfsScheme result = ((com.hps.july.persistence2.AfsSchemeHome)so.servant).create(arg0Copy);
                return (AfsScheme)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public AfsScheme findByPrimaryKey(AfsSchemeKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,AfsSchemeKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AfsScheme) in.read_Object(AfsScheme.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.AfsSchemeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AfsSchemeKey arg0Copy = (AfsSchemeKey) Util.copyObject(arg0,_orb());
                AfsScheme result = ((com.hps.july.persistence2.AfsSchemeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AfsScheme)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
