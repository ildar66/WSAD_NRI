...
public class _OfficeMemoPosHome_Stub extends Stub implements OfficeMemoPosHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.OfficeMemoPosHome:0000000000000000", 
    ...
    public OfficeMemoPos create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OfficeMemoPos) in.read_Object(OfficeMemoPos.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.OfficeMemoPosHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                OfficeMemoPos result = ((com.hps.july.persistence2.OfficeMemoPosHome)so.servant).create(arg0, arg1);
                return (OfficeMemoPos)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public OfficeMemoPos findByPrimaryKey(OfficeMemoPosKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,OfficeMemoPosKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OfficeMemoPos) in.read_Object(OfficeMemoPos.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.OfficeMemoPosHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                OfficeMemoPosKey arg0Copy = (OfficeMemoPosKey) Util.copyObject(arg0,_orb());
                OfficeMemoPos result = ((com.hps.july.persistence2.OfficeMemoPosHome)so.servant).findByPrimaryKey(arg0Copy);
                return (OfficeMemoPos)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
