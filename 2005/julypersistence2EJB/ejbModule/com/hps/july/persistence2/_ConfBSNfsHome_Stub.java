...
public class _ConfBSNfsHome_Stub extends Stub implements ConfBSNfsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ConfBSNfsHome:0000000000000000", 
    ...
    public ConfBSNfs findByPrimaryKey(ConfBSNfsKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,ConfBSNfsKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ConfBSNfs) in.read_Object(ConfBSNfs.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.ConfBSNfsHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ConfBSNfsKey arg0Copy = (ConfBSNfsKey) Util.copyObject(arg0,_orb());
                ConfBSNfs result = ((com.hps.july.persistence2.ConfBSNfsHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ConfBSNfs)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByAll(String arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, BigDecimal arg9, String arg10, int arg11) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    return findByAll(arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByAll",com.hps.july.persistence2.ConfBSNfsHome.class);
            if (so == null) {
                return findByAll(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
            }
            try {
                Object[] copies = Util.copyObjects(new Object[]{arg0,arg9,arg10},_orb());
                String arg0Copy = (String) copies[0];
                BigDecimal arg9Copy = (BigDecimal) copies[1];
                String arg10Copy = (String) copies[2];
                Enumeration result = ((com.hps.july.persistence2.ConfBSNfsHome)so.servant).findByAll(arg0Copy, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9Copy, arg10Copy, arg11);
    ...
    public ConfBSNfs create(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, String arg10, String arg11, int arg12, int arg13) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.ConfBSNfsHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
            }
            try {
                ConfBSNfs result = ((com.hps.july.persistence2.ConfBSNfsHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
                return (ConfBSNfs)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
