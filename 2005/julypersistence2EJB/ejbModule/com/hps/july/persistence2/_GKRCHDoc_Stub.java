...
public class _GKRCHDoc_Stub extends Stub implements GKRCHDoc {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.GKRCHDoc:0000000000000000", 
    ...
    public String getRestrictions() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_restrictions", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_restrictions",com.hps.july.persistence2.GKRCHDoc.class);
            if (so == null) {
                return getRestrictions();
            }
            try {
                return ((com.hps.july.persistence2.GKRCHDoc)so.servant).getRestrictions();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getSitedoc() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_sitedoc",com.hps.july.persistence2.GKRCHDoc.class);
            if (so == null) {
                return getSitedoc();
            }
            try {
                return ((com.hps.july.persistence2.GKRCHDoc)so.servant).getSitedoc();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setRestrictions(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("_set_restrictions", true);
            ...
            ServantObject so = _servant_preinvoke("_set_restrictions",com.hps.july.persistence2.GKRCHDoc.class);
            if (so == null) {
                setRestrictions(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.GKRCHDoc)so.servant).setRestrictions(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
