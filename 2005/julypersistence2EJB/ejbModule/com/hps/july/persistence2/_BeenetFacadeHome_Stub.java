...
public class _BeenetFacadeHome_Stub extends Stub implements BeenetFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.BeenetFacadeHome:0000000000000000", 
    ...
    public BeenetFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (BeenetFacade) in.read_Object(BeenetFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.BeenetFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                BeenetFacade result = ((com.hps.july.persistence2.BeenetFacadeHome)so.servant).create();
                return (BeenetFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
