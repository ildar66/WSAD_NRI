...
public class _AntennPlacesHome_Stub extends Stub implements AntennPlacesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.AntennPlacesHome:0000000000000000", 
    ...
    public AntennPlaces create(int arg0, String arg1, boolean arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennPlaces) in.read_Object(AntennPlaces.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.AntennPlacesHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                AntennPlaces result = ((com.hps.july.persistence2.AntennPlacesHome)so.servant).create(arg0, arg1, arg2);
                return (AntennPlaces)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public AntennPlaces findByPrimaryKey(AntennPlacesKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,AntennPlacesKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AntennPlaces) in.read_Object(AntennPlaces.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.AntennPlacesHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AntennPlacesKey arg0Copy = (AntennPlacesKey) Util.copyObject(arg0,_orb());
                AntennPlaces result = ((com.hps.july.persistence2.AntennPlacesHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AntennPlaces)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
