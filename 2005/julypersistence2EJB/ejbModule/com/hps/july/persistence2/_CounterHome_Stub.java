...
public class _CounterHome_Stub extends Stub implements CounterHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.CounterHome:0000000000000000", 
    ...
    public Counter create(int arg0, int arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Counter) in.read_Object(Counter.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.CounterHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Counter result = ((com.hps.july.persistence2.CounterHome)so.servant).create(arg0, arg1, arg2);
                return (Counter)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Counter findByPrimaryKey(CounterKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,CounterKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Counter) in.read_Object(Counter.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.CounterHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                CounterKey arg0Copy = (CounterKey) Util.copyObject(arg0,_orb());
                Counter result = ((com.hps.july.persistence2.CounterHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Counter)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
