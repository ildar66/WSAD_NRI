...
public class _ApparatPlaces_Stub extends Stub implements ApparatPlaces {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.ApparatPlaces:0000000000000000", 
    ...
    public int getApplaceid() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("_get_applaceid",com.hps.july.persistence2.ApparatPlaces.class);
            if (so == null) {
                return getApplaceid();
            }
            try {
                return ((com.hps.july.persistence2.ApparatPlaces)so.servant).getApplaceid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getName() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_name",com.hps.july.persistence2.ApparatPlaces.class);
            if (so == null) {
                return getName();
            }
            try {
                return ((com.hps.july.persistence2.ApparatPlaces)so.servant).getName();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setName(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_name",com.hps.july.persistence2.ApparatPlaces.class);
            if (so == null) {
                setName(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.ApparatPlaces)so.servant).setName(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
