...
public class _KzlAntennes2NRI_Stub extends Stub implements KzlAntennes2NRI {
    ...
    public int getAntposantennid() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_antposantennid", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_antposantennid",com.hps.july.persistence2.KzlAntennes2NRI.class);
            if (so == null) {
                return getAntposantennid();
            }
            try {
                return ((com.hps.july.persistence2.KzlAntennes2NRI)so.servant).getAntposantennid();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getResource() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_resource",com.hps.july.persistence2.KzlAntennes2NRI.class);
            if (so == null) {
                return getResource();
            }
            try {
                return ((com.hps.july.persistence2.KzlAntennes2NRI)so.servant).getResource();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setResource(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_resource",com.hps.july.persistence2.KzlAntennes2NRI.class);
            if (so == null) {
                setResource(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.KzlAntennes2NRI)so.servant).setResource(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
