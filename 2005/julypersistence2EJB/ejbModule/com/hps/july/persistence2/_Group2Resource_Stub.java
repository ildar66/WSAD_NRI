...
public class _Group2Resource_Stub extends Stub implements Group2Resource {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.Group2Resource:0000000000000000", 
    ...
    public BigDecimal getQty() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_qty",com.hps.july.persistence2.Group2Resource.class);
            if (so == null) {
                return getQty();
            }
            try {
                BigDecimal result = ((com.hps.july.persistence2.Group2Resource)so.servant).getQty();
    ...
    public void setQty(BigDecimal arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_qty",com.hps.july.persistence2.Group2Resource.class);
            if (so == null) {
                setQty(arg0);
                return;
            }
            try {
                ...
                ((com.hps.july.persistence2.Group2Resource)so.servant).setQty(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
