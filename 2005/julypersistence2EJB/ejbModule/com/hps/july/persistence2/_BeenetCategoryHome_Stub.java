...
public class _BeenetCategoryHome_Stub extends Stub implements BeenetCategoryHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.BeenetCategoryHome:0000000000000000", 
    ...
    public BeenetCategory create(int arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (BeenetCategory) in.read_Object(BeenetCategory.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.BeenetCategoryHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                BeenetCategory result = ((com.hps.july.persistence2.BeenetCategoryHome)so.servant).create(arg0, arg1);
                return (BeenetCategory)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public BeenetCategory findByPrimaryKey(BeenetCategoryKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,BeenetCategoryKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (BeenetCategory) in.read_Object(BeenetCategory.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.BeenetCategoryHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                BeenetCategoryKey arg0Copy = (BeenetCategoryKey) Util.copyObject(arg0,_orb());
                BeenetCategory result = ((com.hps.july.persistence2.BeenetCategoryHome)so.servant).findByPrimaryKey(arg0Copy);
                return (BeenetCategory)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
