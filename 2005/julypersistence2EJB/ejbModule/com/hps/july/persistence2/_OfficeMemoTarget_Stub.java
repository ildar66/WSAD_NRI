...
public class _OfficeMemoTarget_Stub extends Stub implements OfficeMemoTarget {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.OfficeMemoTarget:0000000000000000", 
    ...
    public int getIdtarget() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_idtarget", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_idtarget",com.hps.july.persistence2.OfficeMemoTarget.class);
            if (so == null) {
                return getIdtarget();
            }
            try {
                return ((com.hps.july.persistence2.OfficeMemoTarget)so.servant).getIdtarget();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getName() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_name",com.hps.july.persistence2.OfficeMemoTarget.class);
            if (so == null) {
                return getName();
            }
            try {
                return ((com.hps.july.persistence2.OfficeMemoTarget)so.servant).getName();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setName(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_name",com.hps.july.persistence2.OfficeMemoTarget.class);
            if (so == null) {
                setName(arg0);
                return;
            }
            try {
                ((com.hps.july.persistence2.OfficeMemoTarget)so.servant).setName(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
