...
public class _EJSRemoteCMPCableWorkParamsHome_80ac4c0f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPCableWorkParamsHome_80ac4c0f target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPCableWorkParamsHome_80ac4c0f) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 11: 
                    if (method.equals("findByCable")) {
                        return findByCable(in, reply);
                    }
                case 15: 
    ...
    private org.omg.CORBA.portable.OutputStream findByCable(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByCable(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        CableWorkParamsKey arg0 = (CableWorkParamsKey) in.read_value(CableWorkParamsKey.class);
        CableWorkParams result;
        try {
