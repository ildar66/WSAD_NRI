...
public class _KzlAntennes2NRIHome_Stub extends Stub implements KzlAntennes2NRIHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.persistence2.KzlAntennes2NRIHome:0000000000000000", 
    ...
    public KzlAntennes2NRI create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (KzlAntennes2NRI) in.read_Object(KzlAntennes2NRI.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.persistence2.KzlAntennes2NRIHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                KzlAntennes2NRI result = ((com.hps.july.persistence2.KzlAntennes2NRIHome)so.servant).create(arg0, arg1);
                return (KzlAntennes2NRI)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public KzlAntennes2NRI findByPrimaryKey(KzlAntennes2NRIKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,KzlAntennes2NRIKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (KzlAntennes2NRI) in.read_Object(KzlAntennes2NRI.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.persistence2.KzlAntennes2NRIHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                KzlAntennes2NRIKey arg0Copy = (KzlAntennes2NRIKey) Util.copyObject(arg0,_orb());
                KzlAntennes2NRI result = ((com.hps.july.persistence2.KzlAntennes2NRIHome)so.servant).findByPrimaryKey(arg0Copy);
                return (KzlAntennes2NRI)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
