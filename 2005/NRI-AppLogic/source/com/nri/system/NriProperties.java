...
/**
 * This demonstrates how to obtain the NriProperties
 */
public class NriProperties implements PropertyCapable {
/**
 * NriProperties constructor comment.
 */
public NriProperties() {
	super();
	initialize();
}
/**
...
public void initialize() {
	...
	String path = platformFilePath()+"nri.properties";
...
private String platformFilePath() {
	...
	return drive+separator+"nri"+separator;
}	
