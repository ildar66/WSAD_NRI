...
public class _AddressInfoHome_Stub extends Stub implements AddressInfoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.trailcom.beans.AddressInfoHome:0000000000000000", 
    ...
    public AddressInfo create(int arg0, short arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.trailcom.beans.AddressInfoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                AddressInfo result = ((com.hps.july.trailcom.beans.AddressInfoHome)so.servant).create(arg0, arg1);
    ...
    public AddressInfo findByPrimaryKey(AddressInfoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.trailcom.beans.AddressInfoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AddressInfoKey arg0Copy = (AddressInfoKey) Util.copyObject(arg0,_orb());
                AddressInfo result = ((com.hps.july.trailcom.beans.AddressInfoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AddressInfo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByResource(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByResource",com.hps.july.trailcom.beans.AddressInfoHome.class);
            if (so == null) {
                return findByResource(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.trailcom.beans.AddressInfoHome)so.servant).findByResource(arg0Copy);
