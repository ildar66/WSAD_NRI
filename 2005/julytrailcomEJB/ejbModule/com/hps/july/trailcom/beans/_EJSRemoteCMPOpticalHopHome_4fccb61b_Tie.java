...
public class _EJSRemoteCMPOpticalHopHome_4fccb61b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPOpticalHopHome_4fccb61b target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPOpticalHopHome_4fccb61b) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findOpticalHopByHopid")) {
                        return findOpticalHopByHopid(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        OpticalHopKey arg0 = (OpticalHopKey) in.read_value(OpticalHopKey.class);
        OpticalHop result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findOpticalHopByHopid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        HopKey arg0 = (HopKey) in.read_value(HopKey.class);
        OpticalHop result;
        try {
            result = target.findOpticalHopByHopid(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
