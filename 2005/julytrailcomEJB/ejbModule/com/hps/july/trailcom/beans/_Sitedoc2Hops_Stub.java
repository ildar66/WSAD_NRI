...
public class _Sitedoc2Hops_Stub extends Stub implements Sitedoc2Hops {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.trailcom.beans.Sitedoc2Hops:0000000000000000", 
    ...
    public Hop getHop() throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("getHop", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("getHop",com.hps.july.trailcom.beans.Sitedoc2Hops.class);
            if (so == null) {
                return getHop();
            }
            try {
                Hop result = ((com.hps.july.trailcom.beans.Sitedoc2Hops)so.servant).getHop();
    ...
    public HopKey getHopKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_hopKey", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_hopKey",com.hps.july.trailcom.beans.Sitedoc2Hops.class);
            if (so == null) {
                return getHopKey();
            }
            try {
                HopKey result = ((com.hps.july.trailcom.beans.Sitedoc2Hops)so.servant).getHopKey();
    ...
    public int getSitedoc() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_sitedoc",com.hps.july.trailcom.beans.Sitedoc2Hops.class);
            if (so == null) {
                return getSitedoc();
            }
            try {
                return ((com.hps.july.trailcom.beans.Sitedoc2Hops)so.servant).getSitedoc();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
