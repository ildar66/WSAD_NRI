 ...
 **/
public interface HopBeanFinderHelper { 

	public static final String findBySiteid_endaOrderByHopsidAscWhereClause = "siteid_enda = ? order by hopsid asc";
	public static final String findBySiteid_endbOrderByHopsidAscWhereClause = "siteid_endb = ? order by hopsid asc";
	public static final String findByPositionAndTypeWhereClause = 
	" hopstype = ? and (equipmentid_enda = ? or equipmentid_endb = ?) order by hopsid";
	...
	java.lang.Boolean isWorker, 				java.lang.Integer argWorker) throws Exception;
	public java.sql.PreparedStatement findHopsByPosition(Integer position) throws Exception;
	public java.sql.PreparedStatement findNestedLines(Boolean useType, String type, Integer hop, Integer position) throws Exception;
}
