...
import javax.ejb.*;
import javax.naming.*;
public class AddressInfoToAddressSpacesLink extends SingleToManyLink {
	private static AddressSpaceHome targetHome = null;
	private final static java.lang.String targetHomeName = "AddressSpace";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public AddressInfoToAddressSpacesLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.hps.july.trailcom.beans.AddressSpace)targetEJB).privateSetAddressinfoKey((com.hps.july.trailcom.beans.AddressInfoKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.trailcom.beans.AddressSpace)anEJB).getAddressinfoKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.trailcom.beans.AddressSpaceHome)getTargetHome(this)).findAddressSpacesByAddressinfo((com.hps.july.trailcom.beans.AddressInfoKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.trailcom.beans.AddressInfoBean)source).getEntityContext();
}
/**
 * Get the target home for the link.
 * @return com.hps.july.trailcom.beans.AddressSpaceHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized AddressSpaceHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.trailcom.beans.AddressSpaceHome)lookupTargetHome(homeName, com.hps.july.trailcom.beans.AddressSpaceHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.trailcom.beans.AddressSpace.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.AddressSpace)anEJB).secondarySetAddressinfo((com.hps.july.trailcom.beans.AddressInfo)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.AddressSpace)anEJB).secondarySetAddressinfo(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.AddressSpace)anEJB).setAddressinfo(null);
}
}
