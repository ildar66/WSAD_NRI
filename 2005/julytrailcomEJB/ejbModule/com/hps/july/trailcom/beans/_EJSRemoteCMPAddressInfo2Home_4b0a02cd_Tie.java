...
public class _EJSRemoteCMPAddressInfo2Home_4b0a02cd_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAddressInfo2Home_4b0a02cd target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAddressInfo2Home_4b0a02cd) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findByResourceTypeport")) {
                        return findByResourceTypeport(in, reply);
                    }
                case 24: 
                ...
                case 30: 
                    if (method.equals("findAddressInfo2sByAddressinfo")) {
                        return findAddressInfo2sByAddressinfo(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAddressInfo2sByAddressinfo(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AddressInfoKey arg0 = (AddressInfoKey) in.read_value(AddressInfoKey.class);
        Enumeration result;
        try {
            result = target.findAddressInfo2sByAddressinfo(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AddressInfo2Key arg0 = (AddressInfo2Key) in.read_value(AddressInfo2Key.class);
        AddressInfo2 result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByResourceTypeport(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Short arg1 = (Short) in.read_value(Short.class);
        Enumeration result;
        try {
            result = target.findByResourceTypeport(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
