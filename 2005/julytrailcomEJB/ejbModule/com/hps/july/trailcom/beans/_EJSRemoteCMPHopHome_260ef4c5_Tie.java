...
public class _EJSRemoteCMPHopHome_260ef4c5_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPHopHome_260ef4c5 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPHopHome_260ef4c5) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 15: 
                    ...
                    } else if (method.equals("findByPositions")) {
                        return findByPositions(in, reply);
                    } else if (method.equals("findNestedLines")) {
                        return findNestedLines(in, reply);
                    }
                case 16: 
                ...
                case 18: 
                    if (method.equals("findHopsByPosition")) {
                        return findHopsByPosition(in, reply);
                    }
                case 21: 
                    if (method.equals("findByPositionAndType")) {
                        return findByPositionAndType(in, reply);
                    }
                case 24: 
                ...
                case 33: 
                    if (method.equals("findBySiteid_endaOrderByHopsidAsc")) {
                        return findBySiteid_endaOrderByHopsidAsc(in, reply);
                    } else if (method.equals("findBySiteid_endbOrderByHopsidAsc")) {
                        return findBySiteid_endbOrderByHopsidAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPositionAndType(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Integer arg1 = (Integer) in.read_value(Integer.class);
        Integer arg2 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByPositionAndType(arg0, arg1, arg2);
    ...
    private org.omg.CORBA.portable.OutputStream findByPositions(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        Enumeration result;
        try {
            result = target.findByPositions(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findBySiteid_endaOrderByHopsidAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findBySiteid_endaOrderByHopsidAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findBySiteid_endbOrderByHopsidAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findBySiteid_endbOrderByHopsidAsc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findHopsByPosition(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findHopsByPosition(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findNestedLines(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Boolean arg0 = (Boolean) in.read_value(Boolean.class);
        ...
        Enumeration result;
        try {
            result = target.findNestedLines(arg0, arg1, arg2, arg3);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
