...
public class _AddressSpaceHome_Stub extends Stub implements AddressSpaceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.trailcom.beans.AddressSpaceHome:0000000000000000", 
    ...
    public AddressSpace create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AddressSpace) in.read_Object(AddressSpace.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.trailcom.beans.AddressSpaceHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                AddressSpace result = ((com.hps.july.trailcom.beans.AddressSpaceHome)so.servant).create(arg0);
                return (AddressSpace)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findAddressSpacesByAddressinfo(AddressInfoKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("findAddressSpacesByAddressinfo", true);
                    ...
                    return findAddressSpacesByAddressinfo(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAddressSpacesByAddressinfo",com.hps.july.trailcom.beans.AddressSpaceHome.class);
            if (so == null) {
                return findAddressSpacesByAddressinfo(arg0);
            }
            try {
                AddressInfoKey arg0Copy = (AddressInfoKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.trailcom.beans.AddressSpaceHome)so.servant).findAddressSpacesByAddressinfo(arg0Copy);
    ...
    public AddressSpace findByPrimaryKey(AddressSpaceKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,AddressSpaceKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AddressSpace) in.read_Object(AddressSpace.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.trailcom.beans.AddressSpaceHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AddressSpaceKey arg0Copy = (AddressSpaceKey) Util.copyObject(arg0,_orb());
                AddressSpace result = ((com.hps.july.trailcom.beans.AddressSpaceHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AddressSpace)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findByStoragecard(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findByStoragecard", true);
            ...
            ServantObject so = _servant_preinvoke("findByStoragecard",com.hps.july.trailcom.beans.AddressSpaceHome.class);
            if (so == null) {
                return findByStoragecard(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.trailcom.beans.AddressSpaceHome)so.servant).findByStoragecard(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
