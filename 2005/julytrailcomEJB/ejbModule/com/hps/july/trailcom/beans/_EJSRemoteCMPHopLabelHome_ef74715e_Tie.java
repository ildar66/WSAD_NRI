...
public class _EJSRemoteCMPHopLabelHome_ef74715e_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPHopLabelHome_ef74715e target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPHopLabelHome_ef74715e) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 20: 
                    if (method.equals("findHopLabelsByHopid")) {
                        return findHopLabelsByHopid(in, reply);
                    }
                case 24: 
                ...
                case 33: 
                    if (method.equals("findByHopsidOrderByHopslabelidAsc")) {
                        return findByHopsidOrderByHopslabelidAsc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByHopsidOrderByHopslabelidAsc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByHopsidOrderByHopslabelidAsc(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        HopLabelKey arg0 = (HopLabelKey) in.read_value(HopLabelKey.class);
        HopLabel result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findHopLabelsByHopid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        HopKey arg0 = (HopKey) in.read_value(HopKey.class);
        Enumeration result;
        try {
            result = target.findHopLabelsByHopid(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
