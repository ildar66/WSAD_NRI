...
public class _EJSRemoteCMPAddressSpaceHome_4288f116_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPAddressSpaceHome_4288f116 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPAddressSpaceHome_4288f116) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 17: 
                    if (method.equals("findByStoragecard")) {
                        return findByStoragecard(in, reply);
                    }
                case 24: 
                ...
                case 30: 
                    if (method.equals("findAddressSpacesByAddressinfo")) {
                        return findAddressSpacesByAddressinfo(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAddressSpacesByAddressinfo(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AddressInfoKey arg0 = (AddressInfoKey) in.read_value(AddressInfoKey.class);
        Enumeration result;
        try {
            result = target.findAddressSpacesByAddressinfo(arg0);
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        AddressSpaceKey arg0 = (AddressSpaceKey) in.read_value(AddressSpaceKey.class);
        AddressSpace result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findByStoragecard(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findByStoragecard(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
