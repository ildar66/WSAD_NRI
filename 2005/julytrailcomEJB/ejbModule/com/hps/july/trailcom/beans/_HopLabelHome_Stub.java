...
public class _HopLabelHome_Stub extends Stub implements HopLabelHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.trailcom.beans.HopLabelHome:0000000000000000", 
    ...
    public HopLabel create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (HopLabel) in.read_Object(HopLabel.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.trailcom.beans.HopLabelHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                HopLabel result = ((com.hps.july.trailcom.beans.HopLabelHome)so.servant).create(arg0);
                return (HopLabel)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findByHopsidOrderByHopslabelidAsc(Integer arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("findByHopsidOrderByHopslabelidAsc", true);
                    ...
                    return findByHopsidOrderByHopslabelidAsc(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByHopsidOrderByHopslabelidAsc",com.hps.july.trailcom.beans.HopLabelHome.class);
            if (so == null) {
                return findByHopsidOrderByHopslabelidAsc(arg0);
            }
            try {
                Integer arg0Copy = (Integer) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.trailcom.beans.HopLabelHome)so.servant).findByHopsidOrderByHopslabelidAsc(arg0Copy);
    ...
    public HopLabel findByPrimaryKey(HopLabelKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,HopLabelKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (HopLabel) in.read_Object(HopLabel.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.trailcom.beans.HopLabelHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                HopLabelKey arg0Copy = (HopLabelKey) Util.copyObject(arg0,_orb());
                HopLabel result = ((com.hps.july.trailcom.beans.HopLabelHome)so.servant).findByPrimaryKey(arg0Copy);
                return (HopLabel)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Enumeration findHopLabelsByHopid(HopKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findHopLabelsByHopid", true);
                    ...
                    return findHopLabelsByHopid(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findHopLabelsByHopid",com.hps.july.trailcom.beans.HopLabelHome.class);
            if (so == null) {
                return findHopLabelsByHopid(arg0);
            }
            try {
                HopKey arg0Copy = (HopKey) Util.copyObject(arg0,_orb());
                Enumeration result = ((com.hps.july.trailcom.beans.HopLabelHome)so.servant).findHopLabelsByHopid(arg0Copy);
                return (Enumeration)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
