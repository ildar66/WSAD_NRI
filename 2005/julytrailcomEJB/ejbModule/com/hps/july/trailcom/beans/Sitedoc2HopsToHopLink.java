...
import javax.ejb.*;
import javax.naming.*;
public class Sitedoc2HopsToHopLink extends ManyToSingleLink {
...
public Sitedoc2HopsToHopLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.trailcom.beans.HopKey key = ((com.hps.july.trailcom.beans.Sitedoc2HopsBean)source).getHopKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.trailcom.beans.Sitedoc2HopsBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.trailcom.beans.Sitedoc2HopsBean)source).getHopKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.trailcom.beans.Sitedoc2HopsBean)source).privateSetHopKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.Hop)anEJB).secondaryAddSitedoc2Hops((com.hps.july.trailcom.beans.Sitedoc2Hops)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.Hop)anEJB).secondaryRemoveSitedoc2Hops((com.hps.july.trailcom.beans.Sitedoc2Hops)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.trailcom.beans.Sitedoc2HopsBean)source).privateSetHopKey((com.hps.july.trailcom.beans.HopKey)targetEJB.getPrimaryKey());
}
}
