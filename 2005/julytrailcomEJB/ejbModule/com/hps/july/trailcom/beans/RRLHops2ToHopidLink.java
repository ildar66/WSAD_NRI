...
import javax.ejb.*;
import javax.naming.*;
public class RRLHops2ToHopidLink extends SingleToSingleLink {
...
public RRLHops2ToHopidLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.trailcom.beans.HopKey key = ((com.hps.july.trailcom.beans.RRLHops2Bean)source).getHopidKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.trailcom.beans.RRLHops2Bean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.trailcom.beans.RRLHops2Bean)source).getHopidKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.trailcom.beans.RRLHops2Bean)source).privateSetHopidKey(null);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.Hop)anEJB).secondarySetRrlHops2((com.hps.july.trailcom.beans.RRLHops2)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.Hop)anEJB).secondarySetRrlHops2(null);
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.trailcom.beans.RRLHops2Bean)source).privateSetHopidKey((com.hps.july.trailcom.beans.HopKey)targetEJB.getPrimaryKey());
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
