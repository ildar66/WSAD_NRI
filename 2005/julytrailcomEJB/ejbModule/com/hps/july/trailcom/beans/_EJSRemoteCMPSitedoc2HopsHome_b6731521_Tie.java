...
public class _EJSRemoteCMPSitedoc2HopsHome_b6731521_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPSitedoc2HopsHome_b6731521 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPSitedoc2HopsHome_b6731521) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findSitedoc2HopsByHop")) {
                        return findSitedoc2HopsByHop(in, reply);
                    }
                case 24: 
                ...
                case 25: 
                    if (method.equals("findSitedoc2HopsBySitedoc")) {
                        return findSitedoc2HopsBySitedoc(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Sitedoc2HopsKey arg0 = (Sitedoc2HopsKey) in.read_value(Sitedoc2HopsKey.class);
        Sitedoc2Hops result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findSitedoc2HopsByHop(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        HopKey arg0 = (HopKey) in.read_value(HopKey.class);
        Enumeration result;
        try {
            result = target.findSitedoc2HopsByHop(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findSitedoc2HopsBySitedoc(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Integer arg0 = (Integer) in.read_value(Integer.class);
        Enumeration result;
        try {
            result = target.findSitedoc2HopsBySitedoc(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
