...
import javax.ejb.*;
import javax.naming.*;
public class AddressSpaceToAddressinfoLink extends ManyToSingleLink {
...
public AddressSpaceToAddressinfoLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.hps.july.trailcom.beans.AddressInfoKey key = ((com.hps.july.trailcom.beans.AddressSpaceBean)source).getAddressinfoKey();
	try {
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.hps.july.trailcom.beans.AddressSpaceBean)source).getEntityContext();
}
/**
...
protected boolean isKeyValid() {
	return (((com.hps.july.trailcom.beans.AddressSpaceBean)source).getAddressinfoKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.hps.july.trailcom.beans.AddressSpaceBean)source).privateSetAddressinfoKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.AddressInfo)anEJB).secondaryAddAddressSpaces((com.hps.july.trailcom.beans.AddressSpace)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.hps.july.trailcom.beans.AddressInfo)anEJB).secondaryRemoveAddressSpaces((com.hps.july.trailcom.beans.AddressSpace)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.hps.july.trailcom.beans.AddressSpaceBean)source).privateSetAddressinfoKey((com.hps.july.trailcom.beans.AddressInfoKey)targetEJB.getPrimaryKey());
}
}
