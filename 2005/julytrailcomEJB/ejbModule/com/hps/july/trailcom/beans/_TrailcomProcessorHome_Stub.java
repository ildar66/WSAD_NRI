...
public class _TrailcomProcessorHome_Stub extends Stub implements TrailcomProcessorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.trailcom.beans.TrailcomProcessorHome:0000000000000000", 
    ...
    public TrailcomProcessor create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TrailcomProcessor) in.read_Object(TrailcomProcessor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.trailcom.beans.TrailcomProcessorHome.class);
            if (so == null) {
                return create();
            }
            try {
                TrailcomProcessor result = ((com.hps.july.trailcom.beans.TrailcomProcessorHome)so.servant).create();
                return (TrailcomProcessor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
