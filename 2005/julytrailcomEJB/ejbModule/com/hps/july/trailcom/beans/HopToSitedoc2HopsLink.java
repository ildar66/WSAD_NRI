...
import javax.ejb.*;
import javax.naming.*;
public class HopToSitedoc2HopsLink extends SingleToManyLink {
	private static Sitedoc2HopsHome targetHome = null;
	private final static java.lang.String targetHomeName = "Sitedoc2Hops";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public HopToSitedoc2HopsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.hps.july.trailcom.beans.Sitedoc2Hops)anEJB).getHopKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((com.hps.july.trailcom.beans.Sitedoc2HopsHome)getTargetHome(this)).findSitedoc2HopsByHop((com.hps.july.trailcom.beans.HopKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.hps.july.trailcom.beans.Sitedoc2HopsHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized Sitedoc2HopsHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (com.hps.july.trailcom.beans.Sitedoc2HopsHome)lookupTargetHome(homeName, com.hps.july.trailcom.beans.Sitedoc2HopsHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.hps.july.trailcom.beans.Sitedoc2Hops.class);
}
/**
