...
public class _RRLHops2Home_Stub extends Stub implements RRLHops2Home {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.trailcom.beans.RRLHops2Home:0000000000000000", 
    ...
    public RRLHops2 create(int arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.trailcom.beans.RRLHops2Home.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                RRLHops2 result = ((com.hps.july.trailcom.beans.RRLHops2Home)so.servant).create(arg0);
    ...
    public RRLHops2 findByPrimaryKey(RRLHops2Key arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,RRLHops2Key.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RRLHops2) in.read_Object(RRLHops2.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",com.hps.july.trailcom.beans.RRLHops2Home.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RRLHops2Key arg0Copy = (RRLHops2Key) Util.copyObject(arg0,_orb());
                RRLHops2 result = ((com.hps.july.trailcom.beans.RRLHops2Home)so.servant).findByPrimaryKey(arg0Copy);
                return (RRLHops2)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RRLHops2 findRrlHops2ByHopid(HopKey arg0) throws RemoteException, FinderException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        (org.omg.CORBA_2_3.portable.OutputStream)
                        _request("findRrlHops2ByHopid", true);
                    ...
                    return findRrlHops2ByHopid(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findRrlHops2ByHopid",com.hps.july.trailcom.beans.RRLHops2Home.class);
            if (so == null) {
                return findRrlHops2ByHopid(arg0);
            }
            try {
                HopKey arg0Copy = (HopKey) Util.copyObject(arg0,_orb());
                RRLHops2 result = ((com.hps.july.trailcom.beans.RRLHops2Home)so.servant).findRrlHops2ByHopid(arg0Copy);
                return (RRLHops2)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
