...
public class _EJSRemoteCMPRRLHops2Home_04b3f8f3_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPRRLHops2Home_04b3f8f3 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPRRLHops2Home_04b3f8f3) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findRrlHops2ByHopid")) {
                        return findRrlHops2ByHopid(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RRLHops2Key arg0 = (RRLHops2Key) in.read_value(RRLHops2Key.class);
        RRLHops2 result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findRrlHops2ByHopid(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        HopKey arg0 = (HopKey) in.read_value(HopKey.class);
        RRLHops2 result;
        try {
            result = target.findRrlHops2ByHopid(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
