...
public class _EJSRemoteStatelessDataImport_bdddcc6f_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessDataImport_bdddcc6f target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessDataImport_bdddcc6f) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 9: 
                    if (method.equals("processBs")) {
                        return processBs(in, reply);
                    }
                case 11: 
                    ...
                    } else if (method.equals("processTest")) {
                        return processTest(in, reply);
                    }
                case 12: 
    ...
    private org.omg.CORBA.portable.OutputStream process(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        int result = target.process(arg0, arg1, arg2, arg3);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream processBs(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        byte[] arg1 = (byte[]) in.read_value(byte[].class);
        int arg2 = in.read_long();
        int arg3 = in.read_long();
        Map arg4 = (Map) in.read_value(Map.class);
        int result = target.processBs(arg0, arg1, arg2, arg3, arg4);
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
    
    private org.omg.CORBA.portable.OutputStream processTest(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.processTest();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        out.write_long(result);
        return out;
    }
