...
public class _DataImportHome_Stub extends Stub implements DataImportHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.dataimport.beans.DataImportHome:0000000000000000", 
    ...
    public DataImport create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (DataImport) in.read_Object(DataImport.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.dataimport.beans.DataImportHome.class);
            if (so == null) {
                return create();
            }
            try {
                DataImport result = ((com.hps.july.dataimport.beans.DataImportHome)so.servant).create();
                return (DataImport)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
