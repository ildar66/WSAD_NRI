...
public class _OrganizerHome_Stub extends Stub implements OrganizerHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.commonbean.OrganizerHome:0000000000000000", 
    ...
    public Organizer create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Organizer) in.read_Object(Organizer.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.commonbean.OrganizerHome.class);
            if (so == null) {
                return create();
            }
            try {
                Organizer result = ((com.hps.july.commonbean.OrganizerHome)so.servant).create();
                return (Organizer)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
