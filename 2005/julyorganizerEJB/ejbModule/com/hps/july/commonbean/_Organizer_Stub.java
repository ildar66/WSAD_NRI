...
public class _Organizer_Stub extends Stub implements Organizer {
    ...
    public OperatorTask[] getOperatorTasks(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA_2_3.portable.OutputStream out = 
                        ...
                        _request("getOperatorTasks", true);
                    out.write_value(arg0,String.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (OperatorTask[]) in.read_value(OperatorTask[].class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    throw new UnexpectedException(id);
                } catch (RemarshalException ex) {
                    return getOperatorTasks(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("getOperatorTasks",com.hps.july.commonbean.Organizer.class);
            if (so == null) {
                return getOperatorTasks(arg0);
            }
            try {
                OperatorTask[] result = ((com.hps.july.commonbean.Organizer)so.servant).getOperatorTasks(arg0);
                return (OperatorTask[])Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
